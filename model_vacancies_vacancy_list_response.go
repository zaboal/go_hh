...
func (src VacanciesVacancyListResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VacanciesMatchListItems != nil {
...
type NullableVacanciesVacancyListResponse struct {
	value *VacanciesVacancyListResponse
	isSet bool
}

func (v NullableVacanciesVacancyListResponse) Get() *VacanciesVacancyListResponse {
	return v.value
}

func (v *NullableVacanciesVacancyListResponse) Set(val *VacanciesVacancyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyListResponse(val *VacanciesVacancyListResponse) *NullableVacanciesVacancyListResponse {
	return &NullableVacanciesVacancyListResponse{value: val, isSet: true}
}

func (v NullableVacanciesVacancyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
