...
// checks if the DictionariesBranchItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DictionariesBranchItem{}

// DictionariesBranchItem struct for DictionariesBranchItem
...
type _DictionariesBranchItem DictionariesBranchItem
...
func (o DictionariesBranchItem) MarshalJSON() ([]byte, error) {
...
func (o DictionariesBranchItem) ToMap() (map[string]interface{}, error) {
...
func (o *DictionariesBranchItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDictionariesBranchItem := _DictionariesBranchItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDictionariesBranchItem)

	if err != nil {
		return err
	}

	*o = DictionariesBranchItem(varDictionariesBranchItem)

	return err
}

type NullableDictionariesBranchItem struct {
	value *DictionariesBranchItem
	isSet bool
}

func (v NullableDictionariesBranchItem) Get() *DictionariesBranchItem {
	return v.value
}

func (v *NullableDictionariesBranchItem) Set(val *DictionariesBranchItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDictionariesBranchItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDictionariesBranchItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDictionariesBranchItem(val *DictionariesBranchItem) *NullableDictionariesBranchItem {
	return &NullableDictionariesBranchItem{value: val, isSet: true}
}

func (v NullableDictionariesBranchItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDictionariesBranchItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
