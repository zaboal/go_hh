...
// checks if the ApplicantCommentsApplicantCommentItemAccessType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicantCommentsApplicantCommentItemAccessType{}

// ApplicantCommentsApplicantCommentItemAccessType Тип доступа для комментария. Возможные значения перечислены [в справочнике](#tag/Obshie-spravochniki/operation/get-dictionaries) в поле `applicant_comment_access_type`
type ApplicantCommentsApplicantCommentItemAccessType struct {
...
type _ApplicantCommentsApplicantCommentItemAccessType ApplicantCommentsApplicantCommentItemAccessType
...
func NewApplicantCommentsApplicantCommentItemAccessType(id string, name string) *ApplicantCommentsApplicantCommentItemAccessType {
	this := ApplicantCommentsApplicantCommentItemAccessType{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ApplicantCommentsApplicantCommentItemAccessType) MarshalJSON() ([]byte, error) {
...
func (o ApplicantCommentsApplicantCommentItemAccessType) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicantCommentsApplicantCommentItemAccessType) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicantCommentsApplicantCommentItemAccessType := _ApplicantCommentsApplicantCommentItemAccessType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicantCommentsApplicantCommentItemAccessType)

	if err != nil {
		return err
	}

	*o = ApplicantCommentsApplicantCommentItemAccessType(varApplicantCommentsApplicantCommentItemAccessType)

	return err
}

type NullableApplicantCommentsApplicantCommentItemAccessType struct {
	value *ApplicantCommentsApplicantCommentItemAccessType
	isSet bool
}

func (v NullableApplicantCommentsApplicantCommentItemAccessType) Get() *ApplicantCommentsApplicantCommentItemAccessType {
	return v.value
}

func (v *NullableApplicantCommentsApplicantCommentItemAccessType) Set(val *ApplicantCommentsApplicantCommentItemAccessType) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicantCommentsApplicantCommentItemAccessType) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicantCommentsApplicantCommentItemAccessType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicantCommentsApplicantCommentItemAccessType(val *ApplicantCommentsApplicantCommentItemAccessType) *NullableApplicantCommentsApplicantCommentItemAccessType {
	return &NullableApplicantCommentsApplicantCommentItemAccessType{value: val, isSet: true}
}

func (v NullableApplicantCommentsApplicantCommentItemAccessType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicantCommentsApplicantCommentItemAccessType) UnmarshalJSON(src []byte) error {
	v.isSet = true
