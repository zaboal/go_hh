...
// checks if the VacancyHiddenDeprecated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyHiddenDeprecated{}

// VacancyHiddenDeprecated struct for VacancyHiddenDeprecated
type VacancyHiddenDeprecated struct {
...
func (o VacancyHiddenDeprecated) MarshalJSON() ([]byte, error) {
...
func (o VacancyHiddenDeprecated) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyHiddenDeprecated struct {
	value *VacancyHiddenDeprecated
	isSet bool
}

func (v NullableVacancyHiddenDeprecated) Get() *VacancyHiddenDeprecated {
	return v.value
}

func (v *NullableVacancyHiddenDeprecated) Set(val *VacancyHiddenDeprecated) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyHiddenDeprecated) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyHiddenDeprecated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyHiddenDeprecated(val *VacancyHiddenDeprecated) *NullableVacancyHiddenDeprecated {
	return &NullableVacancyHiddenDeprecated{value: val, isSet: true}
}

func (v NullableVacancyHiddenDeprecated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyHiddenDeprecated) UnmarshalJSON(src []byte) error {
	v.isSet = true
