...
// checks if the IncludesIdNameUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesIdNameUrl{}

// IncludesIdNameUrl struct for IncludesIdNameUrl
type IncludesIdNameUrl struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _IncludesIdNameUrl IncludesIdNameUrl
...
func (o IncludesIdNameUrl) MarshalJSON() ([]byte, error) {
...
func (o IncludesIdNameUrl) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesIdNameUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesIdNameUrl := _IncludesIdNameUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesIdNameUrl)

	if err != nil {
		return err
	}

	*o = IncludesIdNameUrl(varIncludesIdNameUrl)

	return err
}

type NullableIncludesIdNameUrl struct {
	value *IncludesIdNameUrl
	isSet bool
}

func (v NullableIncludesIdNameUrl) Get() *IncludesIdNameUrl {
	return v.value
}

func (v *NullableIncludesIdNameUrl) Set(val *IncludesIdNameUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesIdNameUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesIdNameUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesIdNameUrl(val *IncludesIdNameUrl) *NullableIncludesIdNameUrl {
	return &NullableIncludesIdNameUrl{value: val, isSet: true}
}

func (v NullableIncludesIdNameUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesIdNameUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
