...
// checks if the ResumesResumeConditionFieldsContactCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsContactCondition{}

// ResumesResumeConditionFieldsContactCondition struct for ResumesResumeConditionFieldsContactCondition
type ResumesResumeConditionFieldsContactCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsContactFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsContactCondition() *ResumesResumeConditionFieldsContactCondition {
	this := ResumesResumeConditionFieldsContactCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsContactCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsContactCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsContactCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsContactCondition) GetFields() ResumesResumeConditionFieldsContactFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsContactFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsContactFields and assigns it to the Fields field.
func (o *ResumesResumeConditionFieldsContactCondition) SetFields(v ResumesResumeConditionFieldsContactFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *ResumesResumeConditionFieldsContactCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsContactCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsContactCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsContactCondition struct {
	value *ResumesResumeConditionFieldsContactCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsContactCondition) Get() *ResumesResumeConditionFieldsContactCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsContactCondition) Set(val *ResumesResumeConditionFieldsContactCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsContactCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsContactCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsContactCondition(val *ResumesResumeConditionFieldsContactCondition) *NullableResumesResumeConditionFieldsContactCondition {
	return &NullableResumesResumeConditionFieldsContactCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsContactCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsContactCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
