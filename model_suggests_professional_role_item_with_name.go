...
// checks if the SuggestsProfessionalRoleItemWithName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsProfessionalRoleItemWithName{}

// SuggestsProfessionalRoleItemWithName struct for SuggestsProfessionalRoleItemWithName
...
type _SuggestsProfessionalRoleItemWithName SuggestsProfessionalRoleItemWithName
...
func NewSuggestsProfessionalRoleItemWithName(acceptIncompleteResumes bool, id string, name string) *SuggestsProfessionalRoleItemWithName {
	this := SuggestsProfessionalRoleItemWithName{}
...
func (o SuggestsProfessionalRoleItemWithName) MarshalJSON() ([]byte, error) {
...
func (o SuggestsProfessionalRoleItemWithName) ToMap() (map[string]interface{}, error) {
...
func (o *SuggestsProfessionalRoleItemWithName) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsProfessionalRoleItemWithName := _SuggestsProfessionalRoleItemWithName{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsProfessionalRoleItemWithName)

	if err != nil {
		return err
	}

	*o = SuggestsProfessionalRoleItemWithName(varSuggestsProfessionalRoleItemWithName)

	return err
}

type NullableSuggestsProfessionalRoleItemWithName struct {
	value *SuggestsProfessionalRoleItemWithName
	isSet bool
}

func (v NullableSuggestsProfessionalRoleItemWithName) Get() *SuggestsProfessionalRoleItemWithName {
	return v.value
}

func (v *NullableSuggestsProfessionalRoleItemWithName) Set(val *SuggestsProfessionalRoleItemWithName) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsProfessionalRoleItemWithName) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsProfessionalRoleItemWithName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsProfessionalRoleItemWithName(val *SuggestsProfessionalRoleItemWithName) *NullableSuggestsProfessionalRoleItemWithName {
	return &NullableSuggestsProfessionalRoleItemWithName{value: val, isSet: true}
}

func (v NullableSuggestsProfessionalRoleItemWithName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsProfessionalRoleItemWithName) UnmarshalJSON(src []byte) error {
	v.isSet = true
