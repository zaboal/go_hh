...
// checks if the VacancyDuplicates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDuplicates{}

// VacancyDuplicates struct for VacancyDuplicates
type VacancyDuplicates struct {
...
type _VacancyDuplicates VacancyDuplicates
...
// GetHasDuplicates returns the HasDuplicates field value
func (o *VacancyDuplicates) GetHasDuplicates() bool {
	...
	return o.HasDuplicates
}

// GetHasDuplicatesOk returns a tuple with the HasDuplicates field value
// and a boolean to check if the value has been set.
func (o *VacancyDuplicates) GetHasDuplicatesOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HasDuplicates, true
}

// SetHasDuplicates sets field value
...
func (o VacancyDuplicates) MarshalJSON() ([]byte, error) {
...
func (o VacancyDuplicates) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["found"] = o.Found
	toSerialize["has_duplicates"] = o.HasDuplicates
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *VacancyDuplicates) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDuplicates := _VacancyDuplicates{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDuplicates)

	if err != nil {
		return err
	}

	*o = VacancyDuplicates(varVacancyDuplicates)

	return err
}

type NullableVacancyDuplicates struct {
	value *VacancyDuplicates
	isSet bool
}

func (v NullableVacancyDuplicates) Get() *VacancyDuplicates {
	return v.value
}

func (v *NullableVacancyDuplicates) Set(val *VacancyDuplicates) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDuplicates) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDuplicates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDuplicates(val *VacancyDuplicates) *NullableVacancyDuplicates {
	return &NullableVacancyDuplicates{value: val, isSet: true}
}

func (v NullableVacancyDuplicates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDuplicates) UnmarshalJSON(src []byte) error {
	v.isSet = true
