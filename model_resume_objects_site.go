...
// checks if the ResumeObjectsSite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsSite{}

// ResumeObjectsSite struct for ResumeObjectsSite
type ResumeObjectsSite struct {
...
func (o *ResumeObjectsSite) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o ResumeObjectsSite) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsSite) ToMap() (map[string]interface{}, error) {
...
type NullableResumeObjectsSite struct {
	value *ResumeObjectsSite
	isSet bool
}

func (v NullableResumeObjectsSite) Get() *ResumeObjectsSite {
	return v.value
}

func (v *NullableResumeObjectsSite) Set(val *ResumeObjectsSite) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsSite) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsSite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsSite(val *ResumeObjectsSite) *NullableResumeObjectsSite {
	return &NullableResumeObjectsSite{value: val, isSet: true}
}

func (v NullableResumeObjectsSite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsSite) UnmarshalJSON(src []byte) error {
	v.isSet = true
