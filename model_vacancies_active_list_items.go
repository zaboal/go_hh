...
// checks if the VacanciesActiveListItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesActiveListItems{}

// VacanciesActiveListItems struct for VacanciesActiveListItems
type VacanciesActiveListItems struct {
	// Найдено результатов
	...
	Items []VacanciesActiveListItem `json:"items"`
}

type _VacanciesActiveListItems VacanciesActiveListItems
...
func (o *VacanciesActiveListItems) GetItems() []VacanciesActiveListItem {
	if o == nil {
		var ret []VacanciesActiveListItem
		return ret
	}
...
func (o VacanciesActiveListItems) MarshalJSON() ([]byte, error) {
...
func (o VacanciesActiveListItems) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesActiveListItems) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesActiveListItems := _VacanciesActiveListItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesActiveListItems)

	if err != nil {
		return err
	}

	*o = VacanciesActiveListItems(varVacanciesActiveListItems)

	return err
}

type NullableVacanciesActiveListItems struct {
	value *VacanciesActiveListItems
	isSet bool
}

func (v NullableVacanciesActiveListItems) Get() *VacanciesActiveListItems {
	return v.value
}

func (v *NullableVacanciesActiveListItems) Set(val *VacanciesActiveListItems) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesActiveListItems) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesActiveListItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesActiveListItems(val *VacanciesActiveListItems) *NullableVacanciesActiveListItems {
	return &NullableVacanciesActiveListItems{value: val, isSet: true}
}

func (v NullableVacanciesActiveListItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesActiveListItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
