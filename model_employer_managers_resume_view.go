...
// checks if the EmployerManagersResumeView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersResumeView{}

// EmployerManagersResumeView struct for EmployerManagersResumeView
type EmployerManagersResumeView struct {
	// Просмотры резюме через сайт
	ResumeView int32 `json:"resume_view"`
	// Просмотры резюме из API. Возвращаются, если они предусмотрены в текущей конфигурации доступа к резюме для работодателя
	ResumeViewFromApi *int32 `json:"resume_view_from_api,omitempty"`
}

type _EmployerManagersResumeView EmployerManagersResumeView
...
func NewEmployerManagersResumeView(resumeView int32) *EmployerManagersResumeView {
	this := EmployerManagersResumeView{}
...
// GetResumeView returns the ResumeView field value
...
// GetResumeViewOk returns a tuple with the ResumeView field value
// and a boolean to check if the value has been set.
func (o *EmployerManagersResumeView) GetResumeViewOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ResumeView, true
}

// SetResumeView sets field value
func (o *EmployerManagersResumeView) SetResumeView(v int32) {
	o.ResumeView = v
}

// GetResumeViewFromApi returns the ResumeViewFromApi field value if set, zero value otherwise.
func (o *EmployerManagersResumeView) GetResumeViewFromApi() int32 {
	if o == nil || IsNil(o.ResumeViewFromApi) {
		var ret int32
		return ret
	}
	return *o.ResumeViewFromApi
}

// GetResumeViewFromApiOk returns a tuple with the ResumeViewFromApi field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EmployerManagersResumeView) GetResumeViewFromApiOk() (*int32, bool) {
	if o == nil || IsNil(o.ResumeViewFromApi) {
		return nil, false
	}
	return o.ResumeViewFromApi, true
}
...
// SetResumeViewFromApi gets a reference to the given int32 and assigns it to the ResumeViewFromApi field.
func (o *EmployerManagersResumeView) SetResumeViewFromApi(v int32) {
	o.ResumeViewFromApi = &v
}

func (o EmployerManagersResumeView) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersResumeView) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["resume_view"] = o.ResumeView
	if !IsNil(o.ResumeViewFromApi) {
		toSerialize["resume_view_from_api"] = o.ResumeViewFromApi
	}
	return toSerialize, nil
}

func (o *EmployerManagersResumeView) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersResumeView := _EmployerManagersResumeView{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersResumeView)

	if err != nil {
		return err
	}

	*o = EmployerManagersResumeView(varEmployerManagersResumeView)

	return err
}

type NullableEmployerManagersResumeView struct {
	value *EmployerManagersResumeView
	isSet bool
}

func (v NullableEmployerManagersResumeView) Get() *EmployerManagersResumeView {
	return v.value
}

func (v *NullableEmployerManagersResumeView) Set(val *EmployerManagersResumeView) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersResumeView) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersResumeView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersResumeView(val *EmployerManagersResumeView) *NullableEmployerManagersResumeView {
	return &NullableEmployerManagersResumeView{value: val, isSet: true}
}

func (v NullableEmployerManagersResumeView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersResumeView) UnmarshalJSON(src []byte) error {
	v.isSet = true
