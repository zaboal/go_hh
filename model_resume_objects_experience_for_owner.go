...
// checks if the ResumeObjectsExperienceForOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsExperienceForOwner{}

// ResumeObjectsExperienceForOwner struct for ResumeObjectsExperienceForOwner
type ResumeObjectsExperienceForOwner struct {
...
type _ResumeObjectsExperienceForOwner ResumeObjectsExperienceForOwner
...
func NewResumeObjectsExperienceForOwner(industries []IncludesIdName, position string, start string) *ResumeObjectsExperienceForOwner {
	this := ResumeObjectsExperienceForOwner{}
...
func (o *ResumeObjectsExperienceForOwner) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumeObjectsExperienceForOwner) SetCompanyNil() {
	o.Company.Set(nil)
}
...
func (o *ResumeObjectsExperienceForOwner) SetCompanyIdNil() {
	o.CompanyId.Set(nil)
}
...
func (o *ResumeObjectsExperienceForOwner) SetCompanyUrlNil() {
...
func (o *ResumeObjectsExperienceForOwner) SetEmployerNil() {
	o.Employer.Set(nil)
}
...
func (o *ResumeObjectsExperienceForOwner) SetEndNil() {
	o.End.Set(nil)
}
...
func (o *ResumeObjectsExperienceForOwner) SetIndustryNil() {
	o.Industry.Set(nil)
}
...
func (o ResumeObjectsExperienceForOwner) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsExperienceForOwner) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsExperienceForOwner) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsExperienceForOwner := _ResumeObjectsExperienceForOwner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsExperienceForOwner)

	if err != nil {
		return err
	}

	*o = ResumeObjectsExperienceForOwner(varResumeObjectsExperienceForOwner)

	return err
}

type NullableResumeObjectsExperienceForOwner struct {
	value *ResumeObjectsExperienceForOwner
	isSet bool
}

func (v NullableResumeObjectsExperienceForOwner) Get() *ResumeObjectsExperienceForOwner {
	return v.value
}

func (v *NullableResumeObjectsExperienceForOwner) Set(val *ResumeObjectsExperienceForOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsExperienceForOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsExperienceForOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsExperienceForOwner(val *ResumeObjectsExperienceForOwner) *NullableResumeObjectsExperienceForOwner {
	return &NullableResumeObjectsExperienceForOwner{value: val, isSet: true}
}

func (v NullableResumeObjectsExperienceForOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsExperienceForOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
