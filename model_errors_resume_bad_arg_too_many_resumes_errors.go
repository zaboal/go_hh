...
// ErrorsResumeBadArgTooManyResumesErrors struct for ErrorsResumeBadArgTooManyResumesErrors
type ErrorsResumeBadArgTooManyResumesErrors struct {
	ErrorsCommonBadArgumentErrors *ErrorsCommonBadArgumentErrors
	ErrorsResumeAddEditErrors *ErrorsResumeAddEditErrors
	ErrorsResumeTooManyResumesErrors *ErrorsResumeTooManyResumesErrors
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ErrorsResumeBadArgTooManyResumesErrors) UnmarshalJSON(data []byte) error {
	var err error
	...
	// try to unmarshal JSON data into ErrorsResumeAddEditErrors
	err = json.Unmarshal(data, &dst.ErrorsResumeAddEditErrors);
	if err == nil {
		jsonErrorsResumeAddEditErrors, _ := json.Marshal(dst.ErrorsResumeAddEditErrors)
		if string(jsonErrorsResumeAddEditErrors) == "{}" { // empty struct
			dst.ErrorsResumeAddEditErrors = nil
		} else {
			return nil // data stored in dst.ErrorsResumeAddEditErrors, return on the first match
		}
	} else {
		dst.ErrorsResumeAddEditErrors = nil
	}

	// try to unmarshal JSON data into ErrorsResumeTooManyResumesErrors
	err = json.Unmarshal(data, &dst.ErrorsResumeTooManyResumesErrors);
	if err == nil {
		jsonErrorsResumeTooManyResumesErrors, _ := json.Marshal(dst.ErrorsResumeTooManyResumesErrors)
		if string(jsonErrorsResumeTooManyResumesErrors) == "{}" { // empty struct
			dst.ErrorsResumeTooManyResumesErrors = nil
		} else {
			return nil // data stored in dst.ErrorsResumeTooManyResumesErrors, return on the first match
		}
	} else {
		dst.ErrorsResumeTooManyResumesErrors = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ErrorsResumeBadArgTooManyResumesErrors)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ErrorsResumeBadArgTooManyResumesErrors) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadArgumentErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadArgumentErrors)
	}

	if src.ErrorsResumeAddEditErrors != nil {
		return json.Marshal(&src.ErrorsResumeAddEditErrors)
	}

	if src.ErrorsResumeTooManyResumesErrors != nil {
		return json.Marshal(&src.ErrorsResumeTooManyResumesErrors)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableErrorsResumeBadArgTooManyResumesErrors struct {
	value *ErrorsResumeBadArgTooManyResumesErrors
	isSet bool
}

func (v NullableErrorsResumeBadArgTooManyResumesErrors) Get() *ErrorsResumeBadArgTooManyResumesErrors {
	return v.value
}

func (v *NullableErrorsResumeBadArgTooManyResumesErrors) Set(val *ErrorsResumeBadArgTooManyResumesErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsResumeBadArgTooManyResumesErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsResumeBadArgTooManyResumesErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsResumeBadArgTooManyResumesErrors(val *ErrorsResumeBadArgTooManyResumesErrors) *NullableErrorsResumeBadArgTooManyResumesErrors {
	return &NullableErrorsResumeBadArgTooManyResumesErrors{value: val, isSet: true}
}

func (v NullableErrorsResumeBadArgTooManyResumesErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsResumeBadArgTooManyResumesErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
