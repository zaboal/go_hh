...
// checks if the VacanciesVacancyConditionFieldsResponseUrlCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsResponseUrlCondition{}

// VacanciesVacancyConditionFieldsResponseUrlCondition struct for VacanciesVacancyConditionFieldsResponseUrlCondition
type VacanciesVacancyConditionFieldsResponseUrlCondition struct {
...
func NewVacanciesVacancyConditionFieldsResponseUrlCondition() *VacanciesVacancyConditionFieldsResponseUrlCondition {
	this := VacanciesVacancyConditionFieldsResponseUrlCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsResponseUrlCondition) SetMaxLength(v float32) {
	o.MaxLength.Set(&v)
}
// SetMaxLengthNil sets the value for MaxLength to be an explicit nil
func (o *VacanciesVacancyConditionFieldsResponseUrlCondition) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsResponseUrlCondition) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsResponseUrlCondition) GetRequired() bool {
...
func (o *VacanciesVacancyConditionFieldsResponseUrlCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsResponseUrlCondition) SetRegexpNil() {
	o.Regexp.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsResponseUrlCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsResponseUrlCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsResponseUrlCondition struct {
	value *VacanciesVacancyConditionFieldsResponseUrlCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsResponseUrlCondition) Get() *VacanciesVacancyConditionFieldsResponseUrlCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsResponseUrlCondition) Set(val *VacanciesVacancyConditionFieldsResponseUrlCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsResponseUrlCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsResponseUrlCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsResponseUrlCondition(val *VacanciesVacancyConditionFieldsResponseUrlCondition) *NullableVacanciesVacancyConditionFieldsResponseUrlCondition {
	return &NullableVacanciesVacancyConditionFieldsResponseUrlCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsResponseUrlCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsResponseUrlCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
