...
// checks if the ResumesResumeViewHistoryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeViewHistoryResponse{}

// ResumesResumeViewHistoryResponse struct for ResumesResumeViewHistoryResponse
type ResumesResumeViewHistoryResponse struct {
	// Найдено результатов
	...
	Items []ResumesResumeViewHistoryItem `json:"items"`
	Resume ResumesResumeViewHistoryResume `json:"resume"`
}

type _ResumesResumeViewHistoryResponse ResumesResumeViewHistoryResponse
...
func NewResumesResumeViewHistoryResponse(found float32, page float32, pages float32, perPage float32, items []ResumesResumeViewHistoryItem, resume ResumesResumeViewHistoryResume) *ResumesResumeViewHistoryResponse {
	this := ResumesResumeViewHistoryResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *ResumesResumeViewHistoryResponse) GetItems() []ResumesResumeViewHistoryItem {
	if o == nil {
		var ret []ResumesResumeViewHistoryItem
		return ret
	}
...
// GetResumeOk returns a tuple with the Resume field value
// and a boolean to check if the value has been set.
...
// SetResume sets field value
func (o *ResumesResumeViewHistoryResponse) SetResume(v ResumesResumeViewHistoryResume) {
	o.Resume = v
}

func (o ResumesResumeViewHistoryResponse) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeViewHistoryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesResumeViewHistoryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeViewHistoryResponse := _ResumesResumeViewHistoryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeViewHistoryResponse)

	if err != nil {
		return err
	}

	*o = ResumesResumeViewHistoryResponse(varResumesResumeViewHistoryResponse)

	return err
}

type NullableResumesResumeViewHistoryResponse struct {
	value *ResumesResumeViewHistoryResponse
	isSet bool
}

func (v NullableResumesResumeViewHistoryResponse) Get() *ResumesResumeViewHistoryResponse {
	return v.value
}

func (v *NullableResumesResumeViewHistoryResponse) Set(val *ResumesResumeViewHistoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeViewHistoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeViewHistoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeViewHistoryResponse(val *ResumesResumeViewHistoryResponse) *NullableResumesResumeViewHistoryResponse {
	return &NullableResumesResumeViewHistoryResponse{value: val, isSet: true}
}

func (v NullableResumesResumeViewHistoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeViewHistoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
