...
// checks if the NegotiationsListItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsListItems{}

// NegotiationsListItems struct for NegotiationsListItems
type NegotiationsListItems struct {
	// Список откликов
	Items []NegotiationsListItem `json:"items"`
}

type _NegotiationsListItems NegotiationsListItems
...
func (o NegotiationsListItems) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsListItems) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *NegotiationsListItems) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsListItems := _NegotiationsListItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsListItems)

	if err != nil {
		return err
	}

	*o = NegotiationsListItems(varNegotiationsListItems)

	return err
}

type NullableNegotiationsListItems struct {
	value *NegotiationsListItems
	isSet bool
}

func (v NullableNegotiationsListItems) Get() *NegotiationsListItems {
	return v.value
}

func (v *NullableNegotiationsListItems) Set(val *NegotiationsListItems) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsListItems) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsListItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsListItems(val *NegotiationsListItems) *NullableNegotiationsListItems {
	return &NullableNegotiationsListItems{value: val, isSet: true}
}

func (v NullableNegotiationsListItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsListItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
