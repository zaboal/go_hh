...
// checks if the IncludesPagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesPagination{}

// IncludesPagination struct for IncludesPagination
type IncludesPagination struct {
	// Найдено результатов
...
type _IncludesPagination IncludesPagination
...
func (o IncludesPagination) MarshalJSON() ([]byte, error) {
...
func (o IncludesPagination) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesPagination) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesPagination := _IncludesPagination{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesPagination)

	if err != nil {
		return err
	}

	*o = IncludesPagination(varIncludesPagination)

	return err
}

type NullableIncludesPagination struct {
	value *IncludesPagination
	isSet bool
}

func (v NullableIncludesPagination) Get() *IncludesPagination {
	return v.value
}

func (v *NullableIncludesPagination) Set(val *IncludesPagination) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesPagination) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesPagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesPagination(val *IncludesPagination) *NullableIncludesPagination {
	return &NullableIncludesPagination{value: val, isSet: true}
}

func (v NullableIncludesPagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesPagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
