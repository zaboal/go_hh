...
// checks if the VacanciesVacanciesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacanciesResponse{}

// VacanciesVacanciesResponse struct for VacanciesVacanciesResponse
type VacanciesVacanciesResponse struct {
	// Список вакансий
	Items []VacanciesVacanciesItem `json:"items"`
	// Найдено результатов
	...
	Clusters []VacanciesClusterItem `json:"clusters,omitempty"`
	...
	Arguments []VacanciesArgumentItem `json:"arguments,omitempty"`
	// Ссылка на вакансию
	AlternateUrl NullableString `json:"alternate_url,omitempty"`
	Fixes NullableVacanciesFixes `json:"fixes,omitempty"`
	Suggests NullableVacanciesSuggests `json:"suggests,omitempty"`
}

type _VacanciesVacanciesResponse VacanciesVacanciesResponse
...
func NewVacanciesVacanciesResponse(items []VacanciesVacanciesItem, found float32, page float32, pages float32, perPage float32) *VacanciesVacanciesResponse {
	this := VacanciesVacanciesResponse{}
	this.Items = items
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *VacanciesVacanciesResponse) GetItems() []VacanciesVacanciesItem {
	if o == nil {
		var ret []VacanciesVacanciesItem
		return ret
	}
...
// SetClusters gets a reference to the given []VacanciesClusterItem and assigns it to the Clusters field.
...
// SetArguments gets a reference to the given []VacanciesArgumentItem and assigns it to the Arguments field.
...
func (o *VacanciesVacanciesResponse) SetAlternateUrlNil() {
...
// GetFixes returns the Fixes field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *VacanciesVacanciesResponse) GetFixes() VacanciesFixes {
	if o == nil || IsNil(o.Fixes.Get()) {
		var ret VacanciesFixes
		return ret
	}
	return *o.Fixes.Get()
}
...
// SetFixes gets a reference to the given NullableVacanciesFixes and assigns it to the Fixes field.
func (o *VacanciesVacanciesResponse) SetFixes(v VacanciesFixes) {
	o.Fixes.Set(&v)
}
// SetFixesNil sets the value for Fixes to be an explicit nil
func (o *VacanciesVacanciesResponse) SetFixesNil() {
	o.Fixes.Set(nil)
}
...
func (o *VacanciesVacanciesResponse) GetSuggests() VacanciesSuggests {
	if o == nil || IsNil(o.Suggests.Get()) {
		var ret VacanciesSuggests
		return ret
	}
	return *o.Suggests.Get()
}
...
// SetSuggests gets a reference to the given NullableVacanciesSuggests and assigns it to the Suggests field.
...
func (o *VacanciesVacanciesResponse) SetSuggestsNil() {
	o.Suggests.Set(nil)
}
...
func (o VacanciesVacanciesResponse) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacanciesResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.Fixes.IsSet() {
		toSerialize["fixes"] = o.Fixes.Get()
	}
	if o.Suggests.IsSet() {
		toSerialize["suggests"] = o.Suggests.Get()
	}
	return toSerialize, nil
}

func (o *VacanciesVacanciesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacanciesResponse := _VacanciesVacanciesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacanciesResponse)

	if err != nil {
		return err
	}

	*o = VacanciesVacanciesResponse(varVacanciesVacanciesResponse)

	return err
}

type NullableVacanciesVacanciesResponse struct {
	value *VacanciesVacanciesResponse
	isSet bool
}

func (v NullableVacanciesVacanciesResponse) Get() *VacanciesVacanciesResponse {
	return v.value
}

func (v *NullableVacanciesVacanciesResponse) Set(val *VacanciesVacanciesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacanciesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacanciesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacanciesResponse(val *VacanciesVacanciesResponse) *NullableVacanciesVacanciesResponse {
	return &NullableVacanciesVacanciesResponse{value: val, isSet: true}
}

func (v NullableVacanciesVacanciesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacanciesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
