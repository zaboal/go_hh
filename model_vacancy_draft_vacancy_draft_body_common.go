...
// checks if the VacancyDraftVacancyDraftBodyCommon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftVacancyDraftBodyCommon{}

// VacancyDraftVacancyDraftBodyCommon struct for VacancyDraftVacancyDraftBodyCommon
type VacancyDraftVacancyDraftBodyCommon struct {
...
func NewVacancyDraftVacancyDraftBodyCommon() *VacancyDraftVacancyDraftBodyCommon {
	this := VacancyDraftVacancyDraftBodyCommon{}
	return &this
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetAcceptTemporaryNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetAssignedManagerIdNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetBillingTypeNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetBrandedTemplateNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetContactsNil() {
	o.Contacts.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetCustomEmployerNameNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetDepartmentNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetDescriptionNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetEmploymentNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetExperienceNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetResponseUrlNil() {
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetScheduleNil() {
	o.Schedule.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetTestNil() {
	o.Test.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftBodyCommon) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o VacancyDraftVacancyDraftBodyCommon) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftVacancyDraftBodyCommon) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftVacancyDraftBodyCommon struct {
	value *VacancyDraftVacancyDraftBodyCommon
	isSet bool
}

func (v NullableVacancyDraftVacancyDraftBodyCommon) Get() *VacancyDraftVacancyDraftBodyCommon {
	return v.value
}

func (v *NullableVacancyDraftVacancyDraftBodyCommon) Set(val *VacancyDraftVacancyDraftBodyCommon) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftVacancyDraftBodyCommon) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftVacancyDraftBodyCommon) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftVacancyDraftBodyCommon(val *VacancyDraftVacancyDraftBodyCommon) *NullableVacancyDraftVacancyDraftBodyCommon {
	return &NullableVacancyDraftVacancyDraftBodyCommon{value: val, isSet: true}
}

func (v NullableVacancyDraftVacancyDraftBodyCommon) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftVacancyDraftBodyCommon) UnmarshalJSON(src []byte) error {
	v.isSet = true
