...
// checks if the ResumeAddResumeRequestAllOfEducation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeAddResumeRequestAllOfEducation{}
...
type ResumeAddResumeRequestAllOfEducation struct {
...
type _ResumeAddResumeRequestAllOfEducation ResumeAddResumeRequestAllOfEducation
...
func NewResumeAddResumeRequestAllOfEducation(level IncludesIdName) *ResumeAddResumeRequestAllOfEducation {
	this := ResumeAddResumeRequestAllOfEducation{}
	this.Level = level
	return &this
}
...
func (o ResumeAddResumeRequestAllOfEducation) MarshalJSON() ([]byte, error) {
...
func (o ResumeAddResumeRequestAllOfEducation) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeAddResumeRequestAllOfEducation) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeAddResumeRequestAllOfEducation := _ResumeAddResumeRequestAllOfEducation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeAddResumeRequestAllOfEducation)

	if err != nil {
		return err
	}

	*o = ResumeAddResumeRequestAllOfEducation(varResumeAddResumeRequestAllOfEducation)

	return err
}

type NullableResumeAddResumeRequestAllOfEducation struct {
	value *ResumeAddResumeRequestAllOfEducation
	isSet bool
}

func (v NullableResumeAddResumeRequestAllOfEducation) Get() *ResumeAddResumeRequestAllOfEducation {
	return v.value
}

func (v *NullableResumeAddResumeRequestAllOfEducation) Set(val *ResumeAddResumeRequestAllOfEducation) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeAddResumeRequestAllOfEducation) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeAddResumeRequestAllOfEducation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeAddResumeRequestAllOfEducation(val *ResumeAddResumeRequestAllOfEducation) *NullableResumeAddResumeRequestAllOfEducation {
	return &NullableResumeAddResumeRequestAllOfEducation{value: val, isSet: true}
}

func (v NullableResumeAddResumeRequestAllOfEducation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeAddResumeRequestAllOfEducation) UnmarshalJSON(src []byte) error {
	v.isSet = true
