...
// checks if the VacanciesNegotiationsVacancyShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesNegotiationsVacancyShort{}

// VacanciesNegotiationsVacancyShort struct for VacanciesNegotiationsVacancyShort
type VacanciesNegotiationsVacancyShort struct {
	...
	ProfessionalRoles []VacancyProfessionalRoleItemOutput `json:"professional_roles,omitempty"`
	// Дата и время публикации вакансии
...
type _VacanciesNegotiationsVacancyShort VacanciesNegotiationsVacancyShort
...
func NewVacanciesNegotiationsVacancyShort(alternateUrl string, applyAlternateUrl string, archived bool, area IncludesArea, department NullableVacancyDepartmentOutput, employer NullableVacanciesEmployerPublic, hasTest bool, id string, name string, premium bool, publishedAt string, responseLetterRequired bool, salary NullableVacancySalary, type_ VacancyTypeOutput, url string) *VacanciesNegotiationsVacancyShort {
	this := VacanciesNegotiationsVacancyShort{}
...
func (o *VacanciesNegotiationsVacancyShort) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o *VacanciesNegotiationsVacancyShort) SetInsiderInterviewNil() {
...
// SetProfessionalRoles gets a reference to the given []VacancyProfessionalRoleItemOutput and assigns it to the ProfessionalRoles field.
...
func (o *VacanciesNegotiationsVacancyShort) SetResponseUrlNil() {
...
func (o *VacanciesNegotiationsVacancyShort) SetShowLogoInSearchNil() {
...
func (o *VacanciesNegotiationsVacancyShort) SetSortPointDistanceNil() {
...
func (o VacanciesNegotiationsVacancyShort) MarshalJSON() ([]byte, error) {
...
func (o VacanciesNegotiationsVacancyShort) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesNegotiationsVacancyShort) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesNegotiationsVacancyShort := _VacanciesNegotiationsVacancyShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesNegotiationsVacancyShort)

	if err != nil {
		return err
	}

	*o = VacanciesNegotiationsVacancyShort(varVacanciesNegotiationsVacancyShort)

	return err
}

type NullableVacanciesNegotiationsVacancyShort struct {
	value *VacanciesNegotiationsVacancyShort
	isSet bool
}

func (v NullableVacanciesNegotiationsVacancyShort) Get() *VacanciesNegotiationsVacancyShort {
	return v.value
}

func (v *NullableVacanciesNegotiationsVacancyShort) Set(val *VacanciesNegotiationsVacancyShort) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesNegotiationsVacancyShort) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesNegotiationsVacancyShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesNegotiationsVacancyShort(val *VacanciesNegotiationsVacancyShort) *NullableVacanciesNegotiationsVacancyShort {
	return &NullableVacanciesNegotiationsVacancyShort{value: val, isSet: true}
}

func (v NullableVacanciesNegotiationsVacancyShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesNegotiationsVacancyShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
