...
// checks if the NegotiationsNegotiationMessageTemplates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationMessageTemplates{}
...
func (o NegotiationsNegotiationMessageTemplates) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationMessageTemplates) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsNegotiationMessageTemplates) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationMessageTemplates := _NegotiationsNegotiationMessageTemplates{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationMessageTemplates)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationMessageTemplates(varNegotiationsNegotiationMessageTemplates)

	return err
}

type NullableNegotiationsNegotiationMessageTemplates struct {
	value *NegotiationsNegotiationMessageTemplates
	isSet bool
}

func (v NullableNegotiationsNegotiationMessageTemplates) Get() *NegotiationsNegotiationMessageTemplates {
	return v.value
}

func (v *NullableNegotiationsNegotiationMessageTemplates) Set(val *NegotiationsNegotiationMessageTemplates) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationMessageTemplates) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationMessageTemplates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationMessageTemplates(val *NegotiationsNegotiationMessageTemplates) *NullableNegotiationsNegotiationMessageTemplates {
	return &NullableNegotiationsNegotiationMessageTemplates{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationMessageTemplates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationMessageTemplates) UnmarshalJSON(src []byte) error {
	v.isSet = true
