...
// checks if the EmployersVacancyBrandedTemplatesListItemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersVacancyBrandedTemplatesListItemsInner{}

// EmployersVacancyBrandedTemplatesListItemsInner struct for EmployersVacancyBrandedTemplatesListItemsInner
type EmployersVacancyBrandedTemplatesListItemsInner struct {
	// Идентификатор брендированного шаблона вакансий
	Id string `json:"id"`
	// Название брендированного шаблона вакансий
	Name string `json:"name"`
	// Идентификатор активной версии брендированного шаблона.  Равен null в случае шаблонов-конструкторов и шаблонов-гибридов 
	VersionId NullableString `json:"version_id"`
}

type _EmployersVacancyBrandedTemplatesListItemsInner EmployersVacancyBrandedTemplatesListItemsInner
...
func NewEmployersVacancyBrandedTemplatesListItemsInner(id string, name string, versionId NullableString) *EmployersVacancyBrandedTemplatesListItemsInner {
	this := EmployersVacancyBrandedTemplatesListItemsInner{}
	this.Id = id
	this.Name = name
...
func (o EmployersVacancyBrandedTemplatesListItemsInner) MarshalJSON() ([]byte, error) {
...
func (o EmployersVacancyBrandedTemplatesListItemsInner) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersVacancyBrandedTemplatesListItemsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersVacancyBrandedTemplatesListItemsInner := _EmployersVacancyBrandedTemplatesListItemsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersVacancyBrandedTemplatesListItemsInner)

	if err != nil {
		return err
	}

	*o = EmployersVacancyBrandedTemplatesListItemsInner(varEmployersVacancyBrandedTemplatesListItemsInner)

	return err
}

type NullableEmployersVacancyBrandedTemplatesListItemsInner struct {
	value *EmployersVacancyBrandedTemplatesListItemsInner
	isSet bool
}

func (v NullableEmployersVacancyBrandedTemplatesListItemsInner) Get() *EmployersVacancyBrandedTemplatesListItemsInner {
	return v.value
}

func (v *NullableEmployersVacancyBrandedTemplatesListItemsInner) Set(val *EmployersVacancyBrandedTemplatesListItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersVacancyBrandedTemplatesListItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersVacancyBrandedTemplatesListItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersVacancyBrandedTemplatesListItemsInner(val *EmployersVacancyBrandedTemplatesListItemsInner) *NullableEmployersVacancyBrandedTemplatesListItemsInner {
	return &NullableEmployersVacancyBrandedTemplatesListItemsInner{value: val, isSet: true}
}

func (v NullableEmployersVacancyBrandedTemplatesListItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersVacancyBrandedTemplatesListItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
