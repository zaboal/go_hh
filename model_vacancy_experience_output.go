...
// checks if the VacancyExperienceOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyExperienceOutput{}

// VacancyExperienceOutput struct for VacancyExperienceOutput
type VacancyExperienceOutput struct {
...
func (o VacancyExperienceOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyExperienceOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyExperienceOutput struct {
	value *VacancyExperienceOutput
	isSet bool
}

func (v NullableVacancyExperienceOutput) Get() *VacancyExperienceOutput {
	return v.value
}

func (v *NullableVacancyExperienceOutput) Set(val *VacancyExperienceOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyExperienceOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyExperienceOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyExperienceOutput(val *VacancyExperienceOutput) *NullableVacancyExperienceOutput {
	return &NullableVacancyExperienceOutput{value: val, isSet: true}
}

func (v NullableVacancyExperienceOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyExperienceOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
