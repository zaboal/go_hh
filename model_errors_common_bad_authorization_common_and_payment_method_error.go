...
// ErrorsCommonBadAuthorizationCommonAndPaymentMethodError - struct for ErrorsCommonBadAuthorizationCommonAndPaymentMethodError
type ErrorsCommonBadAuthorizationCommonAndPaymentMethodError struct {
	ErrorsCommonBadAuthorizationErrors *ErrorsCommonBadAuthorizationErrors
	ErrorsCommonBadAuthorizationPaymentMethodErrors *ErrorsCommonBadAuthorizationPaymentMethodErrors
}

// ErrorsCommonBadAuthorizationErrorsAsErrorsCommonBadAuthorizationCommonAndPaymentMethodError is a convenience function that returns ErrorsCommonBadAuthorizationErrors wrapped in ErrorsCommonBadAuthorizationCommonAndPaymentMethodError
func ErrorsCommonBadAuthorizationErrorsAsErrorsCommonBadAuthorizationCommonAndPaymentMethodError(v *ErrorsCommonBadAuthorizationErrors) ErrorsCommonBadAuthorizationCommonAndPaymentMethodError {
	return ErrorsCommonBadAuthorizationCommonAndPaymentMethodError{
		ErrorsCommonBadAuthorizationErrors: v,
	}
}

// ErrorsCommonBadAuthorizationPaymentMethodErrorsAsErrorsCommonBadAuthorizationCommonAndPaymentMethodError is a convenience function that returns ErrorsCommonBadAuthorizationPaymentMethodErrors wrapped in ErrorsCommonBadAuthorizationCommonAndPaymentMethodError
func ErrorsCommonBadAuthorizationPaymentMethodErrorsAsErrorsCommonBadAuthorizationCommonAndPaymentMethodError(v *ErrorsCommonBadAuthorizationPaymentMethodErrors) ErrorsCommonBadAuthorizationCommonAndPaymentMethodError {
	return ErrorsCommonBadAuthorizationCommonAndPaymentMethodError{
		ErrorsCommonBadAuthorizationPaymentMethodErrors: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ErrorsCommonBadAuthorizationCommonAndPaymentMethodError) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	// try to unmarshal data into ErrorsCommonBadAuthorizationPaymentMethodErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsCommonBadAuthorizationPaymentMethodErrors)
	if err == nil {
		jsonErrorsCommonBadAuthorizationPaymentMethodErrors, _ := json.Marshal(dst.ErrorsCommonBadAuthorizationPaymentMethodErrors)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ErrorsCommonBadAuthorizationCommonAndPaymentMethodError)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ErrorsCommonBadAuthorizationCommonAndPaymentMethodError)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ErrorsCommonBadAuthorizationCommonAndPaymentMethodError) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadAuthorizationErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadAuthorizationErrors)
	}

	if src.ErrorsCommonBadAuthorizationPaymentMethodErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadAuthorizationPaymentMethodErrors)
	}
...
func (obj *ErrorsCommonBadAuthorizationCommonAndPaymentMethodError) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	...
	if obj.ErrorsCommonBadAuthorizationPaymentMethodErrors != nil {
		return obj.ErrorsCommonBadAuthorizationPaymentMethodErrors
	}
...
type NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError struct {
	value *ErrorsCommonBadAuthorizationCommonAndPaymentMethodError
	isSet bool
}

func (v NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError) Get() *ErrorsCommonBadAuthorizationCommonAndPaymentMethodError {
	return v.value
}

func (v *NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError) Set(val *ErrorsCommonBadAuthorizationCommonAndPaymentMethodError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError(val *ErrorsCommonBadAuthorizationCommonAndPaymentMethodError) *NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError {
	return &NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError{value: val, isSet: true}
}

func (v NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadAuthorizationCommonAndPaymentMethodError) UnmarshalJSON(src []byte) error {
	v.isSet = true
