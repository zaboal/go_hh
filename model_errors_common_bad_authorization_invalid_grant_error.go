...
// checks if the ErrorsCommonBadAuthorizationInvalidGrantError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonBadAuthorizationInvalidGrantError{}

// ErrorsCommonBadAuthorizationInvalidGrantError struct for ErrorsCommonBadAuthorizationInvalidGrantError
...
type _ErrorsCommonBadAuthorizationInvalidGrantError ErrorsCommonBadAuthorizationInvalidGrantError
...
func NewErrorsCommonBadAuthorizationInvalidGrantError(error_ string, errorDescription string) *ErrorsCommonBadAuthorizationInvalidGrantError {
	this := ErrorsCommonBadAuthorizationInvalidGrantError{}
	this.Error = error_
...
func (o ErrorsCommonBadAuthorizationInvalidGrantError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonBadAuthorizationInvalidGrantError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonBadAuthorizationInvalidGrantError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonBadAuthorizationInvalidGrantError := _ErrorsCommonBadAuthorizationInvalidGrantError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonBadAuthorizationInvalidGrantError)

	if err != nil {
		return err
	}

	*o = ErrorsCommonBadAuthorizationInvalidGrantError(varErrorsCommonBadAuthorizationInvalidGrantError)

	return err
}

type NullableErrorsCommonBadAuthorizationInvalidGrantError struct {
	value *ErrorsCommonBadAuthorizationInvalidGrantError
	isSet bool
}

func (v NullableErrorsCommonBadAuthorizationInvalidGrantError) Get() *ErrorsCommonBadAuthorizationInvalidGrantError {
	return v.value
}

func (v *NullableErrorsCommonBadAuthorizationInvalidGrantError) Set(val *ErrorsCommonBadAuthorizationInvalidGrantError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadAuthorizationInvalidGrantError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadAuthorizationInvalidGrantError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadAuthorizationInvalidGrantError(val *ErrorsCommonBadAuthorizationInvalidGrantError) *NullableErrorsCommonBadAuthorizationInvalidGrantError {
	return &NullableErrorsCommonBadAuthorizationInvalidGrantError{value: val, isSet: true}
}

func (v NullableErrorsCommonBadAuthorizationInvalidGrantError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadAuthorizationInvalidGrantError) UnmarshalJSON(src []byte) error {
	v.isSet = true
