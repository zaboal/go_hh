...
// checks if the EmployerServicesMethodAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerServicesMethodAccess{}

// EmployerServicesMethodAccess struct for EmployerServicesMethodAccess
type EmployerServicesMethodAccess struct {
	Items []EmployerServicesMethodAccessItem `json:"items"`
}

type _EmployerServicesMethodAccess EmployerServicesMethodAccess
...
func NewEmployerServicesMethodAccess(items []EmployerServicesMethodAccessItem) *EmployerServicesMethodAccess {
	this := EmployerServicesMethodAccess{}
	this.Items = items
	return &this
}
...
func (o *EmployerServicesMethodAccess) GetItems() []EmployerServicesMethodAccessItem {
	if o == nil {
		var ret []EmployerServicesMethodAccessItem
		return ret
	}
...
func (o EmployerServicesMethodAccess) MarshalJSON() ([]byte, error) {
...
func (o EmployerServicesMethodAccess) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *EmployerServicesMethodAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerServicesMethodAccess := _EmployerServicesMethodAccess{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerServicesMethodAccess)

	if err != nil {
		return err
	}

	*o = EmployerServicesMethodAccess(varEmployerServicesMethodAccess)

	return err
}

type NullableEmployerServicesMethodAccess struct {
	value *EmployerServicesMethodAccess
	isSet bool
}

func (v NullableEmployerServicesMethodAccess) Get() *EmployerServicesMethodAccess {
	return v.value
}

func (v *NullableEmployerServicesMethodAccess) Set(val *EmployerServicesMethodAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerServicesMethodAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerServicesMethodAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerServicesMethodAccess(val *EmployerServicesMethodAccess) *NullableEmployerServicesMethodAccess {
	return &NullableEmployerServicesMethodAccess{value: val, isSet: true}
}

func (v NullableEmployerServicesMethodAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerServicesMethodAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
