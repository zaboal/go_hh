...
// checks if the ResumeObjectsDriverLicenseTypes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsDriverLicenseTypes{}

// ResumeObjectsDriverLicenseTypes struct for ResumeObjectsDriverLicenseTypes
type ResumeObjectsDriverLicenseTypes struct {
...
type _ResumeObjectsDriverLicenseTypes ResumeObjectsDriverLicenseTypes
...
func NewResumeObjectsDriverLicenseTypes(id string) *ResumeObjectsDriverLicenseTypes {
	this := ResumeObjectsDriverLicenseTypes{}
	this.Id = id
	return &this
}
...
func (o ResumeObjectsDriverLicenseTypes) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsDriverLicenseTypes) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *ResumeObjectsDriverLicenseTypes) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsDriverLicenseTypes := _ResumeObjectsDriverLicenseTypes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsDriverLicenseTypes)

	if err != nil {
		return err
	}

	*o = ResumeObjectsDriverLicenseTypes(varResumeObjectsDriverLicenseTypes)

	return err
}

type NullableResumeObjectsDriverLicenseTypes struct {
	value *ResumeObjectsDriverLicenseTypes
	isSet bool
}

func (v NullableResumeObjectsDriverLicenseTypes) Get() *ResumeObjectsDriverLicenseTypes {
	return v.value
}

func (v *NullableResumeObjectsDriverLicenseTypes) Set(val *ResumeObjectsDriverLicenseTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsDriverLicenseTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsDriverLicenseTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsDriverLicenseTypes(val *ResumeObjectsDriverLicenseTypes) *NullableResumeObjectsDriverLicenseTypes {
	return &NullableResumeObjectsDriverLicenseTypes{value: val, isSet: true}
}

func (v NullableResumeObjectsDriverLicenseTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsDriverLicenseTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
