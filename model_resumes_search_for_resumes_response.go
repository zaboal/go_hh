...
// checks if the ResumesSearchForResumesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesSearchForResumesResponse{}

// ResumesSearchForResumesResponse struct for ResumesSearchForResumesResponse
type ResumesSearchForResumesResponse struct {
	// Найдено результатов
	...
	Items []ResumesSearchForEmployerAndApplicant `json:"items"`
}

type _ResumesSearchForResumesResponse ResumesSearchForResumesResponse
...
func NewResumesSearchForResumesResponse(found float32, page float32, pages float32, perPage float32, items []ResumesSearchForEmployerAndApplicant) *ResumesSearchForResumesResponse {
	this := ResumesSearchForResumesResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *ResumesSearchForResumesResponse) GetItems() []ResumesSearchForEmployerAndApplicant {
	if o == nil {
		var ret []ResumesSearchForEmployerAndApplicant
		return ret
	}
...
func (o ResumesSearchForResumesResponse) MarshalJSON() ([]byte, error) {
...
func (o ResumesSearchForResumesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesSearchForResumesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesSearchForResumesResponse := _ResumesSearchForResumesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesSearchForResumesResponse)

	if err != nil {
		return err
	}

	*o = ResumesSearchForResumesResponse(varResumesSearchForResumesResponse)

	return err
}

type NullableResumesSearchForResumesResponse struct {
	value *ResumesSearchForResumesResponse
	isSet bool
}

func (v NullableResumesSearchForResumesResponse) Get() *ResumesSearchForResumesResponse {
	return v.value
}

func (v *NullableResumesSearchForResumesResponse) Set(val *ResumesSearchForResumesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesSearchForResumesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesSearchForResumesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesSearchForResumesResponse(val *ResumesSearchForResumesResponse) *NullableResumesSearchForResumesResponse {
	return &NullableResumesSearchForResumesResponse{value: val, isSet: true}
}

func (v NullableResumesSearchForResumesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesSearchForResumesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
