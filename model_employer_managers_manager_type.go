...
// checks if the EmployerManagersManagerType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersManagerType{}

// EmployerManagersManagerType struct for EmployerManagersManagerType
type EmployerManagersManagerType struct {
...
type _EmployerManagersManagerType EmployerManagersManagerType
...
func NewEmployerManagersManagerType(id string, name string) *EmployerManagersManagerType {
	this := EmployerManagersManagerType{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o EmployerManagersManagerType) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersManagerType) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersManagerType) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersManagerType := _EmployerManagersManagerType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersManagerType)

	if err != nil {
		return err
	}

	*o = EmployerManagersManagerType(varEmployerManagersManagerType)

	return err
}

type NullableEmployerManagersManagerType struct {
	value *EmployerManagersManagerType
	isSet bool
}

func (v NullableEmployerManagersManagerType) Get() *EmployerManagersManagerType {
	return v.value
}

func (v *NullableEmployerManagersManagerType) Set(val *EmployerManagersManagerType) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersManagerType) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersManagerType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersManagerType(val *EmployerManagersManagerType) *NullableEmployerManagersManagerType {
	return &NullableEmployerManagersManagerType{value: val, isSet: true}
}

func (v NullableEmployerManagersManagerType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersManagerType) UnmarshalJSON(src []byte) error {
	v.isSet = true
