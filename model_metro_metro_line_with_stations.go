...
// checks if the MetroMetroLineWithStations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetroMetroLineWithStations{}
...
type MetroMetroLineWithStations struct {
	...
	Stations []MetroLineStation `json:"stations"`
}

type _MetroMetroLineWithStations MetroMetroLineWithStations
...
func NewMetroMetroLineWithStations(hexColor string, id string, name string, stations []MetroLineStation) *MetroMetroLineWithStations {
	this := MetroMetroLineWithStations{}
...
func (o MetroMetroLineWithStations) MarshalJSON() ([]byte, error) {
...
func (o MetroMetroLineWithStations) ToMap() (map[string]interface{}, error) {
...
func (o *MetroMetroLineWithStations) UnmarshalJSON(data []byte) (err error) {
	...
	varMetroMetroLineWithStations := _MetroMetroLineWithStations{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetroMetroLineWithStations)

	if err != nil {
		return err
	}

	*o = MetroMetroLineWithStations(varMetroMetroLineWithStations)

	return err
}

type NullableMetroMetroLineWithStations struct {
	value *MetroMetroLineWithStations
	isSet bool
}

func (v NullableMetroMetroLineWithStations) Get() *MetroMetroLineWithStations {
	return v.value
}

func (v *NullableMetroMetroLineWithStations) Set(val *MetroMetroLineWithStations) {
	v.value = val
	v.isSet = true
}

func (v NullableMetroMetroLineWithStations) IsSet() bool {
	return v.isSet
}

func (v *NullableMetroMetroLineWithStations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetroMetroLineWithStations(val *MetroMetroLineWithStations) *NullableMetroMetroLineWithStations {
	return &NullableMetroMetroLineWithStations{value: val, isSet: true}
}

func (v NullableMetroMetroLineWithStations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetroMetroLineWithStations) UnmarshalJSON(src []byte) error {
	v.isSet = true
