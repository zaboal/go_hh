...
// checks if the ResumesSuitableResumeOverall type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesSuitableResumeOverall{}

// ResumesSuitableResumeOverall Содержит информацию об общем количестве резюме у соискателя
type ResumesSuitableResumeOverall struct {
...
type _ResumesSuitableResumeOverall ResumesSuitableResumeOverall
...
func NewResumesSuitableResumeOverall(alreadyApplied float32, notPublished float32, unavailable float32) *ResumesSuitableResumeOverall {
	this := ResumesSuitableResumeOverall{}
...
func (o ResumesSuitableResumeOverall) MarshalJSON() ([]byte, error) {
...
func (o ResumesSuitableResumeOverall) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesSuitableResumeOverall) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesSuitableResumeOverall := _ResumesSuitableResumeOverall{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesSuitableResumeOverall)

	if err != nil {
		return err
	}

	*o = ResumesSuitableResumeOverall(varResumesSuitableResumeOverall)

	return err
}

type NullableResumesSuitableResumeOverall struct {
	value *ResumesSuitableResumeOverall
	isSet bool
}

func (v NullableResumesSuitableResumeOverall) Get() *ResumesSuitableResumeOverall {
	return v.value
}

func (v *NullableResumesSuitableResumeOverall) Set(val *ResumesSuitableResumeOverall) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesSuitableResumeOverall) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesSuitableResumeOverall) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesSuitableResumeOverall(val *ResumesSuitableResumeOverall) *NullableResumesSuitableResumeOverall {
	return &NullableResumesSuitableResumeOverall{value: val, isSet: true}
}

func (v NullableResumesSuitableResumeOverall) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesSuitableResumeOverall) UnmarshalJSON(src []byte) error {
	v.isSet = true
