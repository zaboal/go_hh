...
// checks if the NegotiationsPhoneCallItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsPhoneCallItem{}

// NegotiationsPhoneCallItem struct for NegotiationsPhoneCallItem
type NegotiationsPhoneCallItem struct {
...
type _NegotiationsPhoneCallItem NegotiationsPhoneCallItem
...
func NewNegotiationsPhoneCallItem(creationTime string, id float32, status string) *NegotiationsPhoneCallItem {
	this := NegotiationsPhoneCallItem{}
...
func (o *NegotiationsPhoneCallItem) SetDurationSecondsNil() {
...
func (o *NegotiationsPhoneCallItem) SetLastChangeTimeNil() {
...
func (o NegotiationsPhoneCallItem) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsPhoneCallItem) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsPhoneCallItem) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsPhoneCallItem := _NegotiationsPhoneCallItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsPhoneCallItem)

	if err != nil {
		return err
	}

	*o = NegotiationsPhoneCallItem(varNegotiationsPhoneCallItem)

	return err
}

type NullableNegotiationsPhoneCallItem struct {
	value *NegotiationsPhoneCallItem
	isSet bool
}

func (v NullableNegotiationsPhoneCallItem) Get() *NegotiationsPhoneCallItem {
	return v.value
}

func (v *NullableNegotiationsPhoneCallItem) Set(val *NegotiationsPhoneCallItem) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsPhoneCallItem) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsPhoneCallItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsPhoneCallItem(val *NegotiationsPhoneCallItem) *NullableNegotiationsPhoneCallItem {
	return &NullableNegotiationsPhoneCallItem{value: val, isSet: true}
}

func (v NullableNegotiationsPhoneCallItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsPhoneCallItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
