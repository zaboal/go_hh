...
// checks if the EmployersBrandingEmployerBranding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersBrandingEmployerBranding{}

// EmployersBrandingEmployerBranding Дополнительные параметры брендирования
type EmployersBrandingEmployerBranding struct {
	// Тип брендирования   * constructor - Брендирование типом конструктор          * makeup      - Брендирование типом makeup (хамелеон) 
	Type string `json:"type"`
	Constructor EmployersBrandingConstructorConstructor `json:"constructor"`
	Makeup EmployersBrandingMakeupMakeup `json:"makeup"`
...
type _EmployersBrandingEmployerBranding EmployersBrandingEmployerBranding
...
func NewEmployersBrandingEmployerBranding(type_ string, constructor EmployersBrandingConstructorConstructor, makeup EmployersBrandingMakeupMakeup, templateCode string, templateVersionId string) *EmployersBrandingEmployerBranding {
	this := EmployersBrandingEmployerBranding{}
	this.Type = type_
...
func (o *EmployersBrandingEmployerBranding) GetConstructor() EmployersBrandingConstructorConstructor {
	if o == nil {
		var ret EmployersBrandingConstructorConstructor
		return ret
	}
...
// GetMakeupOk returns a tuple with the Makeup field value
// and a boolean to check if the value has been set.
func (o *EmployersBrandingEmployerBranding) GetMakeupOk() (*EmployersBrandingMakeupMakeup, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Makeup, true
}

// SetMakeup sets field value
...
// GetTemplateVersionId returns the TemplateVersionId field value
...
// GetTemplateVersionIdOk returns a tuple with the TemplateVersionId field value
// and a boolean to check if the value has been set.
...
// SetTemplateVersionId sets field value
func (o *EmployersBrandingEmployerBranding) SetTemplateVersionId(v string) {
	o.TemplateVersionId = v
}

func (o EmployersBrandingEmployerBranding) MarshalJSON() ([]byte, error) {
...
func (o EmployersBrandingEmployerBranding) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["type"] = o.Type
	toSerialize["constructor"] = o.Constructor
	toSerialize["makeup"] = o.Makeup
	toSerialize["template_code"] = o.TemplateCode
	toSerialize["template_version_id"] = o.TemplateVersionId
	return toSerialize, nil
}

func (o *EmployersBrandingEmployerBranding) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersBrandingEmployerBranding := _EmployersBrandingEmployerBranding{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersBrandingEmployerBranding)

	if err != nil {
		return err
	}

	*o = EmployersBrandingEmployerBranding(varEmployersBrandingEmployerBranding)

	return err
}

type NullableEmployersBrandingEmployerBranding struct {
	value *EmployersBrandingEmployerBranding
	isSet bool
}

func (v NullableEmployersBrandingEmployerBranding) Get() *EmployersBrandingEmployerBranding {
	return v.value
}

func (v *NullableEmployersBrandingEmployerBranding) Set(val *EmployersBrandingEmployerBranding) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersBrandingEmployerBranding) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersBrandingEmployerBranding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersBrandingEmployerBranding(val *EmployersBrandingEmployerBranding) *NullableEmployersBrandingEmployerBranding {
	return &NullableEmployersBrandingEmployerBranding{value: val, isSet: true}
}

func (v NullableEmployersBrandingEmployerBranding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersBrandingEmployerBranding) UnmarshalJSON(src []byte) error {
	v.isSet = true
