...
// checks if the ErrorsCommonBadAuthorizationInvalidClientError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonBadAuthorizationInvalidClientError{}

// ErrorsCommonBadAuthorizationInvalidClientError struct for ErrorsCommonBadAuthorizationInvalidClientError
...
type _ErrorsCommonBadAuthorizationInvalidClientError ErrorsCommonBadAuthorizationInvalidClientError
...
func NewErrorsCommonBadAuthorizationInvalidClientError(error_ string, errorDescription string) *ErrorsCommonBadAuthorizationInvalidClientError {
	this := ErrorsCommonBadAuthorizationInvalidClientError{}
	this.Error = error_
...
func (o ErrorsCommonBadAuthorizationInvalidClientError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonBadAuthorizationInvalidClientError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonBadAuthorizationInvalidClientError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonBadAuthorizationInvalidClientError := _ErrorsCommonBadAuthorizationInvalidClientError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonBadAuthorizationInvalidClientError)

	if err != nil {
		return err
	}

	*o = ErrorsCommonBadAuthorizationInvalidClientError(varErrorsCommonBadAuthorizationInvalidClientError)

	return err
}

type NullableErrorsCommonBadAuthorizationInvalidClientError struct {
	value *ErrorsCommonBadAuthorizationInvalidClientError
	isSet bool
}

func (v NullableErrorsCommonBadAuthorizationInvalidClientError) Get() *ErrorsCommonBadAuthorizationInvalidClientError {
	return v.value
}

func (v *NullableErrorsCommonBadAuthorizationInvalidClientError) Set(val *ErrorsCommonBadAuthorizationInvalidClientError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadAuthorizationInvalidClientError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadAuthorizationInvalidClientError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadAuthorizationInvalidClientError(val *ErrorsCommonBadAuthorizationInvalidClientError) *NullableErrorsCommonBadAuthorizationInvalidClientError {
	return &NullableErrorsCommonBadAuthorizationInvalidClientError{value: val, isSet: true}
}

func (v NullableErrorsCommonBadAuthorizationInvalidClientError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadAuthorizationInvalidClientError) UnmarshalJSON(src []byte) error {
	v.isSet = true
