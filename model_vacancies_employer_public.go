...
// checks if the VacanciesEmployerPublic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesEmployerPublic{}

// VacanciesEmployerPublic struct for VacanciesEmployerPublic
type VacanciesEmployerPublic struct {
...
type _VacanciesEmployerPublic VacanciesEmployerPublic
...
func (o *VacanciesEmployerPublic) SetAlternateUrlNil() {
...
func (o *VacanciesEmployerPublic) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *VacanciesEmployerPublic) SetLogoUrlsNil() {
	o.LogoUrls.Set(nil)
}
...
func (o *VacanciesEmployerPublic) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *VacanciesEmployerPublic) SetVacanciesUrlNil() {
...
func (o VacanciesEmployerPublic) MarshalJSON() ([]byte, error) {
...
func (o VacanciesEmployerPublic) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesEmployerPublic) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesEmployerPublic := _VacanciesEmployerPublic{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesEmployerPublic)

	if err != nil {
		return err
	}

	*o = VacanciesEmployerPublic(varVacanciesEmployerPublic)

	return err
}

type NullableVacanciesEmployerPublic struct {
	value *VacanciesEmployerPublic
	isSet bool
}

func (v NullableVacanciesEmployerPublic) Get() *VacanciesEmployerPublic {
	return v.value
}

func (v *NullableVacanciesEmployerPublic) Set(val *VacanciesEmployerPublic) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesEmployerPublic) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesEmployerPublic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesEmployerPublic(val *VacanciesEmployerPublic) *NullableVacanciesEmployerPublic {
	return &NullableVacanciesEmployerPublic{value: val, isSet: true}
}

func (v NullableVacanciesEmployerPublic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesEmployerPublic) UnmarshalJSON(src []byte) error {
	v.isSet = true
