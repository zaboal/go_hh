...
// checks if the MeEmployerProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeEmployerProfile{}

// MeEmployerProfile Профиль текущего пользователя, авторизованного как работодатель
type MeEmployerProfile struct {
	MeCommonProfile
	Employer *MeEmployerProfileCompany `json:"employer,omitempty"`
	PersonalManager *MeEmployerProfilePersonalManager `json:"personal_manager,omitempty"`
}

type _MeEmployerProfile MeEmployerProfile

// NewMeEmployerProfile instantiates a new MeEmployerProfile object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMeEmployerProfile(authType NullableString, isAdmin bool, isApplicant bool, isApplication bool, isEmployer bool, isEmployerIntegration bool) *MeEmployerProfile {
	this := MeEmployerProfile{}
...
func (o *MeEmployerProfile) GetEmployer() MeEmployerProfileCompany {
	if o == nil || IsNil(o.Employer) {
		var ret MeEmployerProfileCompany
		return ret
	}
	return *o.Employer
}
...
// SetEmployer gets a reference to the given MeEmployerProfileCompany and assigns it to the Employer field.
...
func (o MeEmployerProfile) MarshalJSON() ([]byte, error) {
...
func (o MeEmployerProfile) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	serializedMeCommonProfile, errMeCommonProfile := json.Marshal(o.MeCommonProfile)
	if errMeCommonProfile != nil {
		return map[string]interface{}{}, errMeCommonProfile
	}
	errMeCommonProfile = json.Unmarshal([]byte(serializedMeCommonProfile), &toSerialize)
	if errMeCommonProfile != nil {
		return map[string]interface{}{}, errMeCommonProfile
	}
	if !IsNil(o.Employer) {
...
func (o *MeEmployerProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varMeEmployerProfile := _MeEmployerProfile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMeEmployerProfile)

	if err != nil {
		return err
	}

	*o = MeEmployerProfile(varMeEmployerProfile)

	return err
}

type NullableMeEmployerProfile struct {
	value *MeEmployerProfile
	isSet bool
}

func (v NullableMeEmployerProfile) Get() *MeEmployerProfile {
	return v.value
}

func (v *NullableMeEmployerProfile) Set(val *MeEmployerProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableMeEmployerProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableMeEmployerProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeEmployerProfile(val *MeEmployerProfile) *NullableMeEmployerProfile {
	return &NullableMeEmployerProfile{value: val, isSet: true}
}

func (v NullableMeEmployerProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeEmployerProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
