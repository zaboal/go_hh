...
// checks if the IncludesArea type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesArea{}

// IncludesArea struct for IncludesArea
type IncludesArea struct {
...
type _IncludesArea IncludesArea
...
func (o IncludesArea) MarshalJSON() ([]byte, error) {
...
func (o IncludesArea) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesArea) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesArea := _IncludesArea{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesArea)

	if err != nil {
		return err
	}

	*o = IncludesArea(varIncludesArea)

	return err
}

type NullableIncludesArea struct {
	value *IncludesArea
	isSet bool
}

func (v NullableIncludesArea) Get() *IncludesArea {
	return v.value
}

func (v *NullableIncludesArea) Set(val *IncludesArea) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesArea) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesArea) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesArea(val *IncludesArea) *NullableIncludesArea {
	return &NullableIncludesArea{value: val, isSet: true}
}

func (v NullableIncludesArea) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesArea) UnmarshalJSON(src []byte) error {
	v.isSet = true
