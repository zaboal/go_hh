...
// checks if the ErrorsNegotiationForbiddenErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsNegotiationForbiddenErrors{}

// ErrorsNegotiationForbiddenErrors Информация о возникших ошибках
type ErrorsNegotiationForbiddenErrors struct {
...
type _ErrorsNegotiationForbiddenErrors ErrorsNegotiationForbiddenErrors
...
func NewErrorsNegotiationForbiddenErrors(requestId string, errors []ErrorsNegotiationForbiddenError) *ErrorsNegotiationForbiddenErrors {
	this := ErrorsNegotiationForbiddenErrors{}
...
func (o *ErrorsNegotiationForbiddenErrors) GetErrors() []ErrorsNegotiationForbiddenError {
	if o == nil {
		var ret []ErrorsNegotiationForbiddenError
		return ret
	}
...
func (o ErrorsNegotiationForbiddenErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsNegotiationForbiddenErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsNegotiationForbiddenErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsNegotiationForbiddenErrors := _ErrorsNegotiationForbiddenErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsNegotiationForbiddenErrors)

	if err != nil {
		return err
	}

	*o = ErrorsNegotiationForbiddenErrors(varErrorsNegotiationForbiddenErrors)

	return err
}

type NullableErrorsNegotiationForbiddenErrors struct {
	value *ErrorsNegotiationForbiddenErrors
	isSet bool
}

func (v NullableErrorsNegotiationForbiddenErrors) Get() *ErrorsNegotiationForbiddenErrors {
	return v.value
}

func (v *NullableErrorsNegotiationForbiddenErrors) Set(val *ErrorsNegotiationForbiddenErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationForbiddenErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationForbiddenErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationForbiddenErrors(val *ErrorsNegotiationForbiddenErrors) *NullableErrorsNegotiationForbiddenErrors {
	return &NullableErrorsNegotiationForbiddenErrors{value: val, isSet: true}
}

func (v NullableErrorsNegotiationForbiddenErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationForbiddenErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
