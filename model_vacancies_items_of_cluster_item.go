...
// checks if the VacanciesItemsOfClusterItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesItemsOfClusterItem{}

// VacanciesItemsOfClusterItem struct for VacanciesItemsOfClusterItem
type VacanciesItemsOfClusterItem struct {
	// Количество вакансий в данном элементе кластера
	Count float32 `json:"count"`
	MetroLine NullableIncludesClusterMetroLine `json:"metro_line,omitempty"`
	MetroStation NullableIncludesClusterMetroStation `json:"metro_station,omitempty"`
...
type _VacanciesItemsOfClusterItem VacanciesItemsOfClusterItem
...
func NewVacanciesItemsOfClusterItem(count float32, name string, url string) *VacanciesItemsOfClusterItem {
	this := VacanciesItemsOfClusterItem{}
	this.Count = count
	this.Name = name
	this.Url = url
	return &this
...
// GetMetroLine returns the MetroLine field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *VacanciesItemsOfClusterItem) GetMetroLine() IncludesClusterMetroLine {
	if o == nil || IsNil(o.MetroLine.Get()) {
		var ret IncludesClusterMetroLine
		return ret
	}
	return *o.MetroLine.Get()
}

// GetMetroLineOk returns a tuple with the MetroLine field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMetroLine gets a reference to the given NullableIncludesClusterMetroLine and assigns it to the MetroLine field.
...
func (o *VacanciesItemsOfClusterItem) SetMetroLineNil() {
	o.MetroLine.Set(nil)
}
...
// GetMetroStation returns the MetroStation field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *VacanciesItemsOfClusterItem) GetMetroStation() IncludesClusterMetroStation {
	if o == nil || IsNil(o.MetroStation.Get()) {
		var ret IncludesClusterMetroStation
		return ret
	}
	return *o.MetroStation.Get()
}

// GetMetroStationOk returns a tuple with the MetroStation field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetMetroStation gets a reference to the given NullableIncludesClusterMetroStation and assigns it to the MetroStation field.
func (o *VacanciesItemsOfClusterItem) SetMetroStation(v IncludesClusterMetroStation) {
	o.MetroStation.Set(&v)
}
// SetMetroStationNil sets the value for MetroStation to be an explicit nil
func (o *VacanciesItemsOfClusterItem) SetMetroStationNil() {
	o.MetroStation.Set(nil)
}
...
func (o *VacanciesItemsOfClusterItem) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o VacanciesItemsOfClusterItem) MarshalJSON() ([]byte, error) {
...
func (o VacanciesItemsOfClusterItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["count"] = o.Count
	if o.MetroLine.IsSet() {
		toSerialize["metro_line"] = o.MetroLine.Get()
	}
	if o.MetroStation.IsSet() {
		toSerialize["metro_station"] = o.MetroStation.Get()
	}
...
func (o *VacanciesItemsOfClusterItem) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesItemsOfClusterItem := _VacanciesItemsOfClusterItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesItemsOfClusterItem)

	if err != nil {
		return err
	}

	*o = VacanciesItemsOfClusterItem(varVacanciesItemsOfClusterItem)

	return err
}

type NullableVacanciesItemsOfClusterItem struct {
	value *VacanciesItemsOfClusterItem
	isSet bool
}

func (v NullableVacanciesItemsOfClusterItem) Get() *VacanciesItemsOfClusterItem {
	return v.value
}

func (v *NullableVacanciesItemsOfClusterItem) Set(val *VacanciesItemsOfClusterItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesItemsOfClusterItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesItemsOfClusterItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesItemsOfClusterItem(val *VacanciesItemsOfClusterItem) *NullableVacanciesItemsOfClusterItem {
	return &NullableVacanciesItemsOfClusterItem{value: val, isSet: true}
}

func (v NullableVacanciesItemsOfClusterItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesItemsOfClusterItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
