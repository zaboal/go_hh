...
// checks if the NegotiationsMessagesGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsMessagesGetResponse{}

// NegotiationsMessagesGetResponse Получение списка сообщений в отклике
type NegotiationsMessagesGetResponse struct {
	// Найдено результатов
	...
	// Список сообщений
	Items []NegotiationsMessagesGet `json:"items,omitempty"`
}

type _NegotiationsMessagesGetResponse NegotiationsMessagesGetResponse
...
func NewNegotiationsMessagesGetResponse(found float32, page float32, pages float32, perPage float32) *NegotiationsMessagesGetResponse {
	this := NegotiationsMessagesGetResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *NegotiationsMessagesGetResponse) GetItems() []NegotiationsMessagesGet {
	if o == nil || IsNil(o.Items) {
		var ret []NegotiationsMessagesGet
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []NegotiationsMessagesGet and assigns it to the Items field.
func (o *NegotiationsMessagesGetResponse) SetItems(v []NegotiationsMessagesGet) {
	o.Items = v
}

func (o NegotiationsMessagesGetResponse) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsMessagesGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsMessagesGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsMessagesGetResponse := _NegotiationsMessagesGetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsMessagesGetResponse)

	if err != nil {
		return err
	}

	*o = NegotiationsMessagesGetResponse(varNegotiationsMessagesGetResponse)

	return err
}

type NullableNegotiationsMessagesGetResponse struct {
	value *NegotiationsMessagesGetResponse
	isSet bool
}

func (v NullableNegotiationsMessagesGetResponse) Get() *NegotiationsMessagesGetResponse {
	return v.value
}

func (v *NullableNegotiationsMessagesGetResponse) Set(val *NegotiationsMessagesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsMessagesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsMessagesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsMessagesGetResponse(val *NegotiationsMessagesGetResponse) *NullableNegotiationsMessagesGetResponse {
	return &NullableNegotiationsMessagesGetResponse{value: val, isSet: true}
}

func (v NullableNegotiationsMessagesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsMessagesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
