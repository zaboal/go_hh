...
// checks if the MeEmployerProfilePersonalManager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeEmployerProfilePersonalManager{}

// MeEmployerProfilePersonalManager Информация о персональном менеджере для работодателя
type MeEmployerProfilePersonalManager struct {
	...
	PhotoUrls NullableMeEmployerProfilePersonalManagerPhotoUrls `json:"photo_urls,omitempty"`
	Unavailable NullableMeEmployerProfilePersonalManagerUnavailable `json:"unavailable,omitempty"`
}

type _MeEmployerProfilePersonalManager MeEmployerProfilePersonalManager
...
func NewMeEmployerProfilePersonalManager(email string, firstName string, id string, isAvailable bool, lastName string) *MeEmployerProfilePersonalManager {
	this := MeEmployerProfilePersonalManager{}
	this.Email = email
...
// GetPhotoUrls returns the PhotoUrls field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MeEmployerProfilePersonalManager) GetPhotoUrls() MeEmployerProfilePersonalManagerPhotoUrls {
	if o == nil || IsNil(o.PhotoUrls.Get()) {
		var ret MeEmployerProfilePersonalManagerPhotoUrls
		return ret
	}
	return *o.PhotoUrls.Get()
}
...
// SetPhotoUrls gets a reference to the given NullableMeEmployerProfilePersonalManagerPhotoUrls and assigns it to the PhotoUrls field.
...
func (o *MeEmployerProfilePersonalManager) SetPhotoUrlsNil() {
	o.PhotoUrls.Set(nil)
}
...
// GetUnavailable returns the Unavailable field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MeEmployerProfilePersonalManager) GetUnavailable() MeEmployerProfilePersonalManagerUnavailable {
	if o == nil || IsNil(o.Unavailable.Get()) {
		var ret MeEmployerProfilePersonalManagerUnavailable
		return ret
	}
	return *o.Unavailable.Get()
}
...
// SetUnavailable gets a reference to the given NullableMeEmployerProfilePersonalManagerUnavailable and assigns it to the Unavailable field.
...
func (o *MeEmployerProfilePersonalManager) SetUnavailableNil() {
	o.Unavailable.Set(nil)
}
...
func (o MeEmployerProfilePersonalManager) MarshalJSON() ([]byte, error) {
...
func (o MeEmployerProfilePersonalManager) ToMap() (map[string]interface{}, error) {
	...
	if o.PhotoUrls.IsSet() {
		toSerialize["photo_urls"] = o.PhotoUrls.Get()
	}
	if o.Unavailable.IsSet() {
		toSerialize["unavailable"] = o.Unavailable.Get()
	}
	return toSerialize, nil
}

func (o *MeEmployerProfilePersonalManager) UnmarshalJSON(data []byte) (err error) {
	...
	varMeEmployerProfilePersonalManager := _MeEmployerProfilePersonalManager{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMeEmployerProfilePersonalManager)

	if err != nil {
		return err
	}

	*o = MeEmployerProfilePersonalManager(varMeEmployerProfilePersonalManager)

	return err
}

type NullableMeEmployerProfilePersonalManager struct {
	value *MeEmployerProfilePersonalManager
	isSet bool
}

func (v NullableMeEmployerProfilePersonalManager) Get() *MeEmployerProfilePersonalManager {
	return v.value
}

func (v *NullableMeEmployerProfilePersonalManager) Set(val *MeEmployerProfilePersonalManager) {
	v.value = val
	v.isSet = true
}

func (v NullableMeEmployerProfilePersonalManager) IsSet() bool {
	return v.isSet
}

func (v *NullableMeEmployerProfilePersonalManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeEmployerProfilePersonalManager(val *MeEmployerProfilePersonalManager) *NullableMeEmployerProfilePersonalManager {
	return &NullableMeEmployerProfilePersonalManager{value: val, isSet: true}
}

func (v NullableMeEmployerProfilePersonalManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeEmployerProfilePersonalManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
