...
// checks if the VacancyCounters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyCounters{}

// VacancyCounters Число откликов на вакансию. Доступно для соискательской авторизации и авторизации приложения при использовании параметра `responses_count_enabled=true` 
type VacancyCounters struct {
...
func (o VacancyCounters) MarshalJSON() ([]byte, error) {
...
func (o VacancyCounters) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyCounters struct {
	value *VacancyCounters
	isSet bool
}

func (v NullableVacancyCounters) Get() *VacancyCounters {
	return v.value
}

func (v *NullableVacancyCounters) Set(val *VacancyCounters) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyCounters) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyCounters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyCounters(val *VacancyCounters) *NullableVacancyCounters {
	return &NullableVacancyCounters{value: val, isSet: true}
}

func (v NullableVacancyCounters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyCounters) UnmarshalJSON(src []byte) error {
	v.isSet = true
