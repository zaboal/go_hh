...
// checks if the ResumesResumeNegotiationsHistoryVacancyItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeNegotiationsHistoryVacancyItem{}

// ResumesResumeNegotiationsHistoryVacancyItem struct for ResumesResumeNegotiationsHistoryVacancyItem
type ResumesResumeNegotiationsHistoryVacancyItem struct {
	// Дата изменения состояния отклика/приглашения
	CreatedAt string `json:"created_at"`
	EmployerState ResumesNegotiationNanoEmployerState `json:"employer_state"`
...
type _ResumesResumeNegotiationsHistoryVacancyItem ResumesResumeNegotiationsHistoryVacancyItem
...
func NewResumesResumeNegotiationsHistoryVacancyItem(createdAt string, employerState ResumesNegotiationNanoEmployerState, withMessage bool) *ResumesResumeNegotiationsHistoryVacancyItem {
	this := ResumesResumeNegotiationsHistoryVacancyItem{}
...
func (o *ResumesResumeNegotiationsHistoryVacancyItem) GetEmployerState() ResumesNegotiationNanoEmployerState {
	if o == nil {
		var ret ResumesNegotiationNanoEmployerState
		return ret
	}
...
// GetWithMessage returns the WithMessage field value
...
// GetWithMessageOk returns a tuple with the WithMessage field value
// and a boolean to check if the value has been set.
func (o *ResumesResumeNegotiationsHistoryVacancyItem) GetWithMessageOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.WithMessage, true
}

// SetWithMessage sets field value
func (o *ResumesResumeNegotiationsHistoryVacancyItem) SetWithMessage(v bool) {
	o.WithMessage = v
}

func (o ResumesResumeNegotiationsHistoryVacancyItem) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeNegotiationsHistoryVacancyItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["created_at"] = o.CreatedAt
	toSerialize["employer_state"] = o.EmployerState
	toSerialize["with_message"] = o.WithMessage
	return toSerialize, nil
}

func (o *ResumesResumeNegotiationsHistoryVacancyItem) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeNegotiationsHistoryVacancyItem := _ResumesResumeNegotiationsHistoryVacancyItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeNegotiationsHistoryVacancyItem)

	if err != nil {
		return err
	}

	*o = ResumesResumeNegotiationsHistoryVacancyItem(varResumesResumeNegotiationsHistoryVacancyItem)

	return err
}

type NullableResumesResumeNegotiationsHistoryVacancyItem struct {
	value *ResumesResumeNegotiationsHistoryVacancyItem
	isSet bool
}

func (v NullableResumesResumeNegotiationsHistoryVacancyItem) Get() *ResumesResumeNegotiationsHistoryVacancyItem {
	return v.value
}

func (v *NullableResumesResumeNegotiationsHistoryVacancyItem) Set(val *ResumesResumeNegotiationsHistoryVacancyItem) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeNegotiationsHistoryVacancyItem) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeNegotiationsHistoryVacancyItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeNegotiationsHistoryVacancyItem(val *ResumesResumeNegotiationsHistoryVacancyItem) *NullableResumesResumeNegotiationsHistoryVacancyItem {
	return &NullableResumesResumeNegotiationsHistoryVacancyItem{value: val, isSet: true}
}

func (v NullableResumesResumeNegotiationsHistoryVacancyItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeNegotiationsHistoryVacancyItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
