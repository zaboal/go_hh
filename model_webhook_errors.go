...
// checks if the WebhookErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookErrors{}

// WebhookErrors Информация о возникших ошибках
...
type _WebhookErrors WebhookErrors
...
func (o WebhookErrors) MarshalJSON() ([]byte, error) {
...
func (o WebhookErrors) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookErrors := _WebhookErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookErrors)

	if err != nil {
		return err
	}

	*o = WebhookErrors(varWebhookErrors)

	return err
}

type NullableWebhookErrors struct {
	value *WebhookErrors
	isSet bool
}

func (v NullableWebhookErrors) Get() *WebhookErrors {
	return v.value
}

func (v *NullableWebhookErrors) Set(val *WebhookErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookErrors(val *WebhookErrors) *NullableWebhookErrors {
	return &NullableWebhookErrors{value: val, isSet: true}
}

func (v NullableWebhookErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
