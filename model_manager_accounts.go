...
// checks if the ManagerAccounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagerAccounts{}

// ManagerAccounts Информация о рабочих аккаунтах менеджера
type ManagerAccounts struct {
	...
	IsPrimaryAccountBlocked bool `json:"is_primary_account_blocked"`
...
type _ManagerAccounts ManagerAccounts
...
// GetCurrentAccountId returns the CurrentAccountId field value
func (o *ManagerAccounts) GetCurrentAccountId() string {
	...
	return o.CurrentAccountId
}

// GetCurrentAccountIdOk returns a tuple with the CurrentAccountId field value
// and a boolean to check if the value has been set.
func (o *ManagerAccounts) GetCurrentAccountIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CurrentAccountId, true
}

// SetCurrentAccountId sets field value
func (o *ManagerAccounts) SetCurrentAccountId(v string) {
	o.CurrentAccountId = v
}

// GetIsPrimaryAccountBlocked returns the IsPrimaryAccountBlocked field value
func (o *ManagerAccounts) GetIsPrimaryAccountBlocked() bool {
	...
	return o.IsPrimaryAccountBlocked
}

// GetIsPrimaryAccountBlockedOk returns a tuple with the IsPrimaryAccountBlocked field value
// and a boolean to check if the value has been set.
func (o *ManagerAccounts) GetIsPrimaryAccountBlockedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsPrimaryAccountBlocked, true
}

// SetIsPrimaryAccountBlocked sets field value
func (o *ManagerAccounts) SetIsPrimaryAccountBlocked(v bool) {
	o.IsPrimaryAccountBlocked = v
}
...
// GetPrimaryAccountId returns the PrimaryAccountId field value
...
// GetPrimaryAccountIdOk returns a tuple with the PrimaryAccountId field value
// and a boolean to check if the value has been set.
...
// SetPrimaryAccountId sets field value
func (o *ManagerAccounts) SetPrimaryAccountId(v string) {
	o.PrimaryAccountId = v
}

func (o ManagerAccounts) MarshalJSON() ([]byte, error) {
...
func (o ManagerAccounts) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["current_account_id"] = o.CurrentAccountId
	toSerialize["is_primary_account_blocked"] = o.IsPrimaryAccountBlocked
	toSerialize["items"] = o.Items
	toSerialize["primary_account_id"] = o.PrimaryAccountId
	return toSerialize, nil
}

func (o *ManagerAccounts) UnmarshalJSON(data []byte) (err error) {
	...
	varManagerAccounts := _ManagerAccounts{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagerAccounts)

	if err != nil {
		return err
	}

	*o = ManagerAccounts(varManagerAccounts)

	return err
}

type NullableManagerAccounts struct {
	value *ManagerAccounts
	isSet bool
}

func (v NullableManagerAccounts) Get() *ManagerAccounts {
	return v.value
}

func (v *NullableManagerAccounts) Set(val *ManagerAccounts) {
	v.value = val
	v.isSet = true
}

func (v NullableManagerAccounts) IsSet() bool {
	return v.isSet
}

func (v *NullableManagerAccounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagerAccounts(val *ManagerAccounts) *NullableManagerAccounts {
	return &NullableManagerAccounts{value: val, isSet: true}
}

func (v NullableManagerAccounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagerAccounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
