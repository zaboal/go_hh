...
// checks if the VacancyScheduleOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyScheduleOutput{}

// VacancyScheduleOutput struct for VacancyScheduleOutput
type VacancyScheduleOutput struct {
...
func (o *VacancyScheduleOutput) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o VacancyScheduleOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyScheduleOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyScheduleOutput struct {
	value *VacancyScheduleOutput
	isSet bool
}

func (v NullableVacancyScheduleOutput) Get() *VacancyScheduleOutput {
	return v.value
}

func (v *NullableVacancyScheduleOutput) Set(val *VacancyScheduleOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyScheduleOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyScheduleOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyScheduleOutput(val *VacancyScheduleOutput) *NullableVacancyScheduleOutput {
	return &NullableVacancyScheduleOutput{value: val, isSet: true}
}

func (v NullableVacancyScheduleOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyScheduleOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
