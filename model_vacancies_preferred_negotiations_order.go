...
// checks if the VacanciesPreferredNegotiationsOrder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesPreferredNegotiationsOrder{}

// VacanciesPreferredNegotiationsOrder struct for VacanciesPreferredNegotiationsOrder
type VacanciesPreferredNegotiationsOrder struct {
	// Тип сортировки
	OrderType IncludesIdName `json:"order_type"`
}

type _VacanciesPreferredNegotiationsOrder VacanciesPreferredNegotiationsOrder
...
func NewVacanciesPreferredNegotiationsOrder(orderType IncludesIdName) *VacanciesPreferredNegotiationsOrder {
	this := VacanciesPreferredNegotiationsOrder{}
...
func (o VacanciesPreferredNegotiationsOrder) MarshalJSON() ([]byte, error) {
...
func (o VacanciesPreferredNegotiationsOrder) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["order_type"] = o.OrderType
	return toSerialize, nil
}

func (o *VacanciesPreferredNegotiationsOrder) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesPreferredNegotiationsOrder := _VacanciesPreferredNegotiationsOrder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesPreferredNegotiationsOrder)

	if err != nil {
		return err
	}

	*o = VacanciesPreferredNegotiationsOrder(varVacanciesPreferredNegotiationsOrder)

	return err
}

type NullableVacanciesPreferredNegotiationsOrder struct {
	value *VacanciesPreferredNegotiationsOrder
	isSet bool
}

func (v NullableVacanciesPreferredNegotiationsOrder) Get() *VacanciesPreferredNegotiationsOrder {
	return v.value
}

func (v *NullableVacanciesPreferredNegotiationsOrder) Set(val *VacanciesPreferredNegotiationsOrder) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesPreferredNegotiationsOrder) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesPreferredNegotiationsOrder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesPreferredNegotiationsOrder(val *VacanciesPreferredNegotiationsOrder) *NullableVacanciesPreferredNegotiationsOrder {
	return &NullableVacanciesPreferredNegotiationsOrder{value: val, isSet: true}
}

func (v NullableVacanciesPreferredNegotiationsOrder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesPreferredNegotiationsOrder) UnmarshalJSON(src []byte) error {
	v.isSet = true
