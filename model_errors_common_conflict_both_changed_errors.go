...
// checks if the ErrorsCommonConflictBothChangedErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonConflictBothChangedErrors{}

// ErrorsCommonConflictBothChangedErrors Информация о возникших ошибках
type ErrorsCommonConflictBothChangedErrors struct {
	...
	BadArguments []IncludesNameDescription `json:"bad_arguments,omitempty"`
	// Описание причины ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsCommonConflictBothChangedError `json:"errors"`
}

type _ErrorsCommonConflictBothChangedErrors ErrorsCommonConflictBothChangedErrors
...
func NewErrorsCommonConflictBothChangedErrors(requestId string, errors []ErrorsCommonConflictBothChangedError) *ErrorsCommonConflictBothChangedErrors {
	this := ErrorsCommonConflictBothChangedErrors{}
...
func (o *ErrorsCommonConflictBothChangedErrors) GetBadArguments() []IncludesNameDescription {
	if o == nil || IsNil(o.BadArguments) {
		var ret []IncludesNameDescription
		return ret
	}
...
// SetBadArguments gets a reference to the given []IncludesNameDescription and assigns it to the BadArguments field.
...
func (o *ErrorsCommonConflictBothChangedErrors) GetErrors() []ErrorsCommonConflictBothChangedError {
	if o == nil {
		var ret []ErrorsCommonConflictBothChangedError
		return ret
	}
...
func (o ErrorsCommonConflictBothChangedErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonConflictBothChangedErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonConflictBothChangedErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonConflictBothChangedErrors := _ErrorsCommonConflictBothChangedErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonConflictBothChangedErrors)

	if err != nil {
		return err
	}

	*o = ErrorsCommonConflictBothChangedErrors(varErrorsCommonConflictBothChangedErrors)

	return err
}

type NullableErrorsCommonConflictBothChangedErrors struct {
	value *ErrorsCommonConflictBothChangedErrors
	isSet bool
}

func (v NullableErrorsCommonConflictBothChangedErrors) Get() *ErrorsCommonConflictBothChangedErrors {
	return v.value
}

func (v *NullableErrorsCommonConflictBothChangedErrors) Set(val *ErrorsCommonConflictBothChangedErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonConflictBothChangedErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonConflictBothChangedErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonConflictBothChangedErrors(val *ErrorsCommonConflictBothChangedErrors) *NullableErrorsCommonConflictBothChangedErrors {
	return &NullableErrorsCommonConflictBothChangedErrors{value: val, isSet: true}
}

func (v NullableErrorsCommonConflictBothChangedErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonConflictBothChangedErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
