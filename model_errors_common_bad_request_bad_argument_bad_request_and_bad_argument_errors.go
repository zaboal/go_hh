...
// ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors - struct for ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors
type ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors struct {
	...
	ErrorsCommonBadRequestErrors *ErrorsCommonBadRequestErrors
}

// ErrorsCommonBadArgumentErrorsAsErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors is a convenience function that returns ErrorsCommonBadArgumentErrors wrapped in ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors
func ErrorsCommonBadArgumentErrorsAsErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors(v *ErrorsCommonBadArgumentErrors) ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors {
	return ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors{
		ErrorsCommonBadArgumentErrors: v,
	}
}

// ErrorsCommonBadRequestErrorsAsErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors is a convenience function that returns ErrorsCommonBadRequestErrors wrapped in ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors
func ErrorsCommonBadRequestErrorsAsErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors(v *ErrorsCommonBadRequestErrors) ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors {
	return ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors{
		ErrorsCommonBadRequestErrors: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ErrorsCommonBadArgumentErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsCommonBadArgumentErrors)
	if err == nil {
	...
	// try to unmarshal data into ErrorsCommonBadRequestErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsCommonBadRequestErrors)
	if err == nil {
		jsonErrorsCommonBadRequestErrors, _ := json.Marshal(dst.ErrorsCommonBadRequestErrors)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadArgumentErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadArgumentErrors)
	}

	if src.ErrorsCommonBadRequestErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadRequestErrors)
	}
...
func (obj *ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.ErrorsCommonBadArgumentErrors != nil {
		return obj.ErrorsCommonBadArgumentErrors
	}

	if obj.ErrorsCommonBadRequestErrors != nil {
		return obj.ErrorsCommonBadRequestErrors
	}
...
type NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors struct {
	value *ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors
	isSet bool
}

func (v NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) Get() *ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors {
	return v.value
}

func (v *NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) Set(val *ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors(val *ErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) *NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors {
	return &NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors{value: val, isSet: true}
}

func (v NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadRequestBadArgumentBadRequestAndBadArgumentErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
