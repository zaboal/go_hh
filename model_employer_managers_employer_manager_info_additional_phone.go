...
// checks if the EmployerManagersEmployerManagerInfoAdditionalPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersEmployerManagerInfoAdditionalPhone{}

// EmployerManagersEmployerManagerInfoAdditionalPhone Дополнительный телефон менеджера
type EmployerManagersEmployerManagerInfoAdditionalPhone struct {
	// Код города
...
type _EmployerManagersEmployerManagerInfoAdditionalPhone EmployerManagersEmployerManagerInfoAdditionalPhone
...
func NewEmployerManagersEmployerManagerInfoAdditionalPhone(city string, country string, number string) *EmployerManagersEmployerManagerInfoAdditionalPhone {
	this := EmployerManagersEmployerManagerInfoAdditionalPhone{}
	this.City = city
...
func (o *EmployerManagersEmployerManagerInfoAdditionalPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersEmployerManagerInfoAdditionalPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersEmployerManagerInfoAdditionalPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersEmployerManagerInfoAdditionalPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersEmployerManagerInfoAdditionalPhone := _EmployerManagersEmployerManagerInfoAdditionalPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersEmployerManagerInfoAdditionalPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersEmployerManagerInfoAdditionalPhone(varEmployerManagersEmployerManagerInfoAdditionalPhone)

	return err
}

type NullableEmployerManagersEmployerManagerInfoAdditionalPhone struct {
	value *EmployerManagersEmployerManagerInfoAdditionalPhone
	isSet bool
}

func (v NullableEmployerManagersEmployerManagerInfoAdditionalPhone) Get() *EmployerManagersEmployerManagerInfoAdditionalPhone {
	return v.value
}

func (v *NullableEmployerManagersEmployerManagerInfoAdditionalPhone) Set(val *EmployerManagersEmployerManagerInfoAdditionalPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersEmployerManagerInfoAdditionalPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersEmployerManagerInfoAdditionalPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersEmployerManagerInfoAdditionalPhone(val *EmployerManagersEmployerManagerInfoAdditionalPhone) *NullableEmployerManagersEmployerManagerInfoAdditionalPhone {
	return &NullableEmployerManagersEmployerManagerInfoAdditionalPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersEmployerManagerInfoAdditionalPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersEmployerManagerInfoAdditionalPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
