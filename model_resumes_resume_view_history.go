...
// checks if the ResumesResumeViewHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeViewHistory{}

// ResumesResumeViewHistory struct for ResumesResumeViewHistory
type ResumesResumeViewHistory struct {
	// Список просмотров резюме
	Items []ResumesResumeViewHistoryItem `json:"items"`
	Resume ResumesResumeViewHistoryResume `json:"resume"`
}

type _ResumesResumeViewHistory ResumesResumeViewHistory
...
func (o ResumesResumeViewHistory) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeViewHistory) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesResumeViewHistory) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeViewHistory := _ResumesResumeViewHistory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeViewHistory)

	if err != nil {
		return err
	}

	*o = ResumesResumeViewHistory(varResumesResumeViewHistory)

	return err
}

type NullableResumesResumeViewHistory struct {
	value *ResumesResumeViewHistory
	isSet bool
}

func (v NullableResumesResumeViewHistory) Get() *ResumesResumeViewHistory {
	return v.value
}

func (v *NullableResumesResumeViewHistory) Set(val *ResumesResumeViewHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeViewHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeViewHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeViewHistory(val *ResumesResumeViewHistory) *NullableResumesResumeViewHistory {
	return &NullableResumesResumeViewHistory{value: val, isSet: true}
}

func (v NullableResumesResumeViewHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeViewHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
