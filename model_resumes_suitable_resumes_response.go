...
// checks if the ResumesSuitableResumesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesSuitableResumesResponse{}

// ResumesSuitableResumesResponse struct for ResumesSuitableResumesResponse
type ResumesSuitableResumesResponse struct {
	// Найдено результатов
	...
	Items []ResumesSuitableResumeItem `json:"items"`
	Overall ResumesSuitableResumeOverall `json:"overall"`
}

type _ResumesSuitableResumesResponse ResumesSuitableResumesResponse
...
func NewResumesSuitableResumesResponse(found float32, page float32, pages float32, perPage float32, items []ResumesSuitableResumeItem, overall ResumesSuitableResumeOverall) *ResumesSuitableResumesResponse {
	this := ResumesSuitableResumesResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *ResumesSuitableResumesResponse) GetOverall() ResumesSuitableResumeOverall {
	if o == nil {
		var ret ResumesSuitableResumeOverall
		return ret
	}
...
func (o ResumesSuitableResumesResponse) MarshalJSON() ([]byte, error) {
...
func (o ResumesSuitableResumesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesSuitableResumesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesSuitableResumesResponse := _ResumesSuitableResumesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesSuitableResumesResponse)

	if err != nil {
		return err
	}

	*o = ResumesSuitableResumesResponse(varResumesSuitableResumesResponse)

	return err
}

type NullableResumesSuitableResumesResponse struct {
	value *ResumesSuitableResumesResponse
	isSet bool
}

func (v NullableResumesSuitableResumesResponse) Get() *ResumesSuitableResumesResponse {
	return v.value
}

func (v *NullableResumesSuitableResumesResponse) Set(val *ResumesSuitableResumesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesSuitableResumesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesSuitableResumesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesSuitableResumesResponse(val *ResumesSuitableResumesResponse) *NullableResumesSuitableResumesResponse {
	return &NullableResumesSuitableResumesResponse{value: val, isSet: true}
}

func (v NullableResumesSuitableResumesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesSuitableResumesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
