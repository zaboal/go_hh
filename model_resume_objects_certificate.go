...
// checks if the ResumeObjectsCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsCertificate{}

// ResumeObjectsCertificate struct for ResumeObjectsCertificate
type ResumeObjectsCertificate struct {
...
// GetAchievedAt returns the AchievedAt field value if set, zero value otherwise.
func (o *ResumeObjectsCertificate) GetAchievedAt() string {
	if o == nil || IsNil(o.AchievedAt) {
		var ret string
		return ret
	}
	return *o.AchievedAt
...
// GetAchievedAtOk returns a tuple with the AchievedAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResumeObjectsCertificate) GetAchievedAtOk() (*string, bool) {
	if o == nil || IsNil(o.AchievedAt) {
		return nil, false
	}
	return o.AchievedAt, true
}
...
// SetAchievedAt gets a reference to the given string and assigns it to the AchievedAt field.
...
func (o *ResumeObjectsCertificate) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *ResumeObjectsCertificate) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o ResumeObjectsCertificate) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsCertificate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AchievedAt) {
		toSerialize["achieved_at"] = o.AchievedAt
	}
	if o.Owner.IsSet() {
...
type NullableResumeObjectsCertificate struct {
	value *ResumeObjectsCertificate
	isSet bool
}

func (v NullableResumeObjectsCertificate) Get() *ResumeObjectsCertificate {
	return v.value
}

func (v *NullableResumeObjectsCertificate) Set(val *ResumeObjectsCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsCertificate(val *ResumeObjectsCertificate) *NullableResumeObjectsCertificate {
	return &NullableResumeObjectsCertificate{value: val, isSet: true}
}

func (v NullableResumeObjectsCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
