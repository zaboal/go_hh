...
// checks if the ResumesResumeVisibilityListSearchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeVisibilityListSearchResponse{}

// ResumesResumeVisibilityListSearchResponse struct for ResumesResumeVisibilityListSearchResponse
type ResumesResumeVisibilityListSearchResponse struct {
	// Найдено результатов
...
type _ResumesResumeVisibilityListSearchResponse ResumesResumeVisibilityListSearchResponse
...
func NewResumesResumeVisibilityListSearchResponse(found float32, page float32, pages float32, perPage float32, items []ResumesResumeVisibilityListSearchPropertiesItemsInner) *ResumesResumeVisibilityListSearchResponse {
	this := ResumesResumeVisibilityListSearchResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o ResumesResumeVisibilityListSearchResponse) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeVisibilityListSearchResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesResumeVisibilityListSearchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeVisibilityListSearchResponse := _ResumesResumeVisibilityListSearchResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeVisibilityListSearchResponse)

	if err != nil {
		return err
	}

	*o = ResumesResumeVisibilityListSearchResponse(varResumesResumeVisibilityListSearchResponse)

	return err
}

type NullableResumesResumeVisibilityListSearchResponse struct {
	value *ResumesResumeVisibilityListSearchResponse
	isSet bool
}

func (v NullableResumesResumeVisibilityListSearchResponse) Get() *ResumesResumeVisibilityListSearchResponse {
	return v.value
}

func (v *NullableResumesResumeVisibilityListSearchResponse) Set(val *ResumesResumeVisibilityListSearchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeVisibilityListSearchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeVisibilityListSearchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeVisibilityListSearchResponse(val *ResumesResumeVisibilityListSearchResponse) *NullableResumesResumeVisibilityListSearchResponse {
	return &NullableResumesResumeVisibilityListSearchResponse{value: val, isSet: true}
}

func (v NullableResumesResumeVisibilityListSearchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeVisibilityListSearchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
