...
// checks if the GeocoderAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeocoderAddress{}

// GeocoderAddress Адрес
...
func (o *GeocoderAddress) SetBuildingNil() {
	o.Building.Set(nil)
}
...
func (o *GeocoderAddress) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *GeocoderAddress) SetLatNil() {
	o.Lat.Set(nil)
}
...
func (o *GeocoderAddress) SetLngNil() {
	o.Lng.Set(nil)
}
...
func (o *GeocoderAddress) SetStreetNil() {
	o.Street.Set(nil)
}
...
func (o GeocoderAddress) MarshalJSON() ([]byte, error) {
...
func (o GeocoderAddress) ToMap() (map[string]interface{}, error) {
...
type NullableGeocoderAddress struct {
	value *GeocoderAddress
	isSet bool
}

func (v NullableGeocoderAddress) Get() *GeocoderAddress {
	return v.value
}

func (v *NullableGeocoderAddress) Set(val *GeocoderAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableGeocoderAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableGeocoderAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeocoderAddress(val *GeocoderAddress) *NullableGeocoderAddress {
	return &NullableGeocoderAddress{value: val, isSet: true}
}

func (v NullableGeocoderAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeocoderAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
