...
// checks if the ResumesResumeConditionFieldsSalaryCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsSalaryCondition{}

// ResumesResumeConditionFieldsSalaryCondition struct for ResumesResumeConditionFieldsSalaryCondition
type ResumesResumeConditionFieldsSalaryCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsSalaryFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsSalaryCondition() *ResumesResumeConditionFieldsSalaryCondition {
	this := ResumesResumeConditionFieldsSalaryCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsSalaryCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsSalaryCondition) GetFields() ResumesResumeConditionFieldsSalaryFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsSalaryFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsSalaryFields and assigns it to the Fields field.
func (o *ResumesResumeConditionFieldsSalaryCondition) SetFields(v ResumesResumeConditionFieldsSalaryFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *ResumesResumeConditionFieldsSalaryCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsSalaryCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsSalaryCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsSalaryCondition struct {
	value *ResumesResumeConditionFieldsSalaryCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsSalaryCondition) Get() *ResumesResumeConditionFieldsSalaryCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsSalaryCondition) Set(val *ResumesResumeConditionFieldsSalaryCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsSalaryCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsSalaryCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsSalaryCondition(val *ResumesResumeConditionFieldsSalaryCondition) *NullableResumesResumeConditionFieldsSalaryCondition {
	return &NullableResumesResumeConditionFieldsSalaryCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsSalaryCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsSalaryCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
