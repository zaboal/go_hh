...
// checks if the VacanciesVacancyConditionFieldsCityCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsCityCondition{}

// VacanciesVacancyConditionFieldsCityCondition struct for VacanciesVacancyConditionFieldsCityCondition
type VacanciesVacancyConditionFieldsCityCondition struct {
...
func NewVacanciesVacancyConditionFieldsCityCondition() *VacanciesVacancyConditionFieldsCityCondition {
	this := VacanciesVacancyConditionFieldsCityCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsCityCondition) SetMaxLength(v float32) {
	o.MaxLength.Set(&v)
}
// SetMaxLengthNil sets the value for MaxLength to be an explicit nil
func (o *VacanciesVacancyConditionFieldsCityCondition) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsCityCondition) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsCityCondition) GetRequired() bool {
...
func (o *VacanciesVacancyConditionFieldsCityCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsCityCondition) SetRegexpNil() {
	o.Regexp.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsCityCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsCityCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsCityCondition struct {
	value *VacanciesVacancyConditionFieldsCityCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsCityCondition) Get() *VacanciesVacancyConditionFieldsCityCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsCityCondition) Set(val *VacanciesVacancyConditionFieldsCityCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsCityCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsCityCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsCityCondition(val *VacanciesVacancyConditionFieldsCityCondition) *NullableVacanciesVacancyConditionFieldsCityCondition {
	return &NullableVacanciesVacancyConditionFieldsCityCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsCityCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsCityCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
