...
// checks if the EmployerManagersResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersResponse{}

// EmployerManagersResponse struct for EmployerManagersResponse
type EmployerManagersResponse struct {
	Found float32 `json:"found"`
	Items []EmployerManagersEmployerManagerItem `json:"items"`
	Page float32 `json:"page"`
	Pages float32 `json:"pages"`
	PerPage float32 `json:"per_page"`
}

type _EmployerManagersResponse EmployerManagersResponse
...
func (o *EmployerManagersResponse) GetItems() []EmployerManagersEmployerManagerItem {
	if o == nil {
		var ret []EmployerManagersEmployerManagerItem
		return ret
	}
...
func (o EmployerManagersResponse) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersResponse := _EmployerManagersResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersResponse)

	if err != nil {
		return err
	}

	*o = EmployerManagersResponse(varEmployerManagersResponse)

	return err
}

type NullableEmployerManagersResponse struct {
	value *EmployerManagersResponse
	isSet bool
}

func (v NullableEmployerManagersResponse) Get() *EmployerManagersResponse {
	return v.value
}

func (v *NullableEmployerManagersResponse) Set(val *EmployerManagersResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersResponse(val *EmployerManagersResponse) *NullableEmployerManagersResponse {
	return &NullableEmployerManagersResponse{value: val, isSet: true}
}

func (v NullableEmployerManagersResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
