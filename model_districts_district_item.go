...
// checks if the DistrictsDistrictItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DistrictsDistrictItem{}

// DistrictsDistrictItem struct for DistrictsDistrictItem
type DistrictsDistrictItem struct {
...
type _DistrictsDistrictItem DistrictsDistrictItem
...
func (o DistrictsDistrictItem) MarshalJSON() ([]byte, error) {
...
func (o DistrictsDistrictItem) ToMap() (map[string]interface{}, error) {
...
func (o *DistrictsDistrictItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDistrictsDistrictItem := _DistrictsDistrictItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDistrictsDistrictItem)

	if err != nil {
		return err
	}

	*o = DistrictsDistrictItem(varDistrictsDistrictItem)

	return err
}

type NullableDistrictsDistrictItem struct {
	value *DistrictsDistrictItem
	isSet bool
}

func (v NullableDistrictsDistrictItem) Get() *DistrictsDistrictItem {
	return v.value
}

func (v *NullableDistrictsDistrictItem) Set(val *DistrictsDistrictItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDistrictsDistrictItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDistrictsDistrictItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDistrictsDistrictItem(val *DistrictsDistrictItem) *NullableDistrictsDistrictItem {
	return &NullableDistrictsDistrictItem{value: val, isSet: true}
}

func (v NullableDistrictsDistrictItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDistrictsDistrictItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
