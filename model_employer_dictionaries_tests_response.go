...
// checks if the EmployerDictionariesTestsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerDictionariesTestsResponse{}

// EmployerDictionariesTestsResponse struct for EmployerDictionariesTestsResponse
type EmployerDictionariesTestsResponse struct {
	Items []EmployerDictionariesTestItem `json:"items"`
}

type _EmployerDictionariesTestsResponse EmployerDictionariesTestsResponse
...
func NewEmployerDictionariesTestsResponse(items []EmployerDictionariesTestItem) *EmployerDictionariesTestsResponse {
	this := EmployerDictionariesTestsResponse{}
	this.Items = items
	return &this
}
...
func (o *EmployerDictionariesTestsResponse) GetItems() []EmployerDictionariesTestItem {
	if o == nil {
		var ret []EmployerDictionariesTestItem
		return ret
	}
...
func (o EmployerDictionariesTestsResponse) MarshalJSON() ([]byte, error) {
...
func (o EmployerDictionariesTestsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *EmployerDictionariesTestsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerDictionariesTestsResponse := _EmployerDictionariesTestsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerDictionariesTestsResponse)

	if err != nil {
		return err
	}

	*o = EmployerDictionariesTestsResponse(varEmployerDictionariesTestsResponse)

	return err
}

type NullableEmployerDictionariesTestsResponse struct {
	value *EmployerDictionariesTestsResponse
	isSet bool
}

func (v NullableEmployerDictionariesTestsResponse) Get() *EmployerDictionariesTestsResponse {
	return v.value
}

func (v *NullableEmployerDictionariesTestsResponse) Set(val *EmployerDictionariesTestsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerDictionariesTestsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerDictionariesTestsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerDictionariesTestsResponse(val *EmployerDictionariesTestsResponse) *NullableEmployerDictionariesTestsResponse {
	return &NullableEmployerDictionariesTestsResponse{value: val, isSet: true}
}

func (v NullableEmployerDictionariesTestsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerDictionariesTestsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
