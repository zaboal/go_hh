...
// checks if the IncludesNumericId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesNumericId{}

// IncludesNumericId struct for IncludesNumericId
type IncludesNumericId struct {
	// Идентификатор
	Id float32 `json:"id"`
}

type _IncludesNumericId IncludesNumericId
...
func (o IncludesNumericId) MarshalJSON() ([]byte, error) {
...
func (o IncludesNumericId) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *IncludesNumericId) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesNumericId := _IncludesNumericId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesNumericId)

	if err != nil {
		return err
	}

	*o = IncludesNumericId(varIncludesNumericId)

	return err
}

type NullableIncludesNumericId struct {
	value *IncludesNumericId
	isSet bool
}

func (v NullableIncludesNumericId) Get() *IncludesNumericId {
	return v.value
}

func (v *NullableIncludesNumericId) Set(val *IncludesNumericId) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesNumericId) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesNumericId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesNumericId(val *IncludesNumericId) *NullableIncludesNumericId {
	return &NullableIncludesNumericId{value: val, isSet: true}
}

func (v NullableIncludesNumericId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesNumericId) UnmarshalJSON(src []byte) error {
	v.isSet = true
