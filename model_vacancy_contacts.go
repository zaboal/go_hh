...
// checks if the VacancyContacts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyContacts{}

// VacancyContacts Контактная информация. В случае, если параметр используется, необходимо наличие атрибута phones или email
...
type _VacancyContacts VacancyContacts
...
func (o *VacancyContacts) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o VacancyContacts) MarshalJSON() ([]byte, error) {
...
func (o VacancyContacts) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyContacts) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyContacts := _VacancyContacts{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyContacts)

	if err != nil {
		return err
	}

	*o = VacancyContacts(varVacancyContacts)

	return err
}

type NullableVacancyContacts struct {
	value *VacancyContacts
	isSet bool
}

func (v NullableVacancyContacts) Get() *VacancyContacts {
	return v.value
}

func (v *NullableVacancyContacts) Set(val *VacancyContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyContacts(val *VacancyContacts) *NullableVacancyContacts {
	return &NullableVacancyContacts{value: val, isSet: true}
}

func (v NullableVacancyContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
