...
// checks if the EmployersBrandingConstructorConstructor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersBrandingConstructorConstructor{}

// EmployersBrandingConstructorConstructor struct for EmployersBrandingConstructorConstructor
type EmployersBrandingConstructorConstructor struct {
	HeaderPicture NullableEmployersBrandingConstructorHeaderPicture `json:"header_picture"`
	// Ссылка на webview версию бренд страницы
	Url string `json:"url"`
	// Список виджетов на странице
	Widgets []EmployersBrandingConstructorConstructorWidgetsInner `json:"widgets"`
}

type _EmployersBrandingConstructorConstructor EmployersBrandingConstructorConstructor
...
func NewEmployersBrandingConstructorConstructor(headerPicture NullableEmployersBrandingConstructorHeaderPicture, url string, widgets []EmployersBrandingConstructorConstructorWidgetsInner) *EmployersBrandingConstructorConstructor {
	this := EmployersBrandingConstructorConstructor{}
...
// GetHeaderPicture returns the HeaderPicture field value
// If the value is explicit nil, the zero value for EmployersBrandingConstructorHeaderPicture will be returned
func (o *EmployersBrandingConstructorConstructor) GetHeaderPicture() EmployersBrandingConstructorHeaderPicture {
	if o == nil || o.HeaderPicture.Get() == nil {
		var ret EmployersBrandingConstructorHeaderPicture
		return ret
	}

	return *o.HeaderPicture.Get()
}

// GetHeaderPictureOk returns a tuple with the HeaderPicture field value
...
func (o *EmployersBrandingConstructorConstructor) GetWidgets() []EmployersBrandingConstructorConstructorWidgetsInner {
	if o == nil {
		var ret []EmployersBrandingConstructorConstructorWidgetsInner
		return ret
	}
...
func (o EmployersBrandingConstructorConstructor) MarshalJSON() ([]byte, error) {
...
func (o EmployersBrandingConstructorConstructor) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["header_picture"] = o.HeaderPicture.Get()
	toSerialize["url"] = o.Url
	toSerialize["widgets"] = o.Widgets
	return toSerialize, nil
}

func (o *EmployersBrandingConstructorConstructor) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersBrandingConstructorConstructor := _EmployersBrandingConstructorConstructor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersBrandingConstructorConstructor)

	if err != nil {
		return err
	}

	*o = EmployersBrandingConstructorConstructor(varEmployersBrandingConstructorConstructor)

	return err
}

type NullableEmployersBrandingConstructorConstructor struct {
	value *EmployersBrandingConstructorConstructor
	isSet bool
}

func (v NullableEmployersBrandingConstructorConstructor) Get() *EmployersBrandingConstructorConstructor {
	return v.value
}

func (v *NullableEmployersBrandingConstructorConstructor) Set(val *EmployersBrandingConstructorConstructor) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersBrandingConstructorConstructor) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersBrandingConstructorConstructor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersBrandingConstructorConstructor(val *EmployersBrandingConstructorConstructor) *NullableEmployersBrandingConstructorConstructor {
	return &NullableEmployersBrandingConstructorConstructor{value: val, isSet: true}
}

func (v NullableEmployersBrandingConstructorConstructor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersBrandingConstructorConstructor) UnmarshalJSON(src []byte) error {
	v.isSet = true
