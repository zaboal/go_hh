...
// checks if the ArtifactsFieldsDescription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsFieldsDescription{}

// ArtifactsFieldsDescription Условия для поля `description`
type ArtifactsFieldsDescription struct {
...
type _ArtifactsFieldsDescription ArtifactsFieldsDescription
...
func NewArtifactsFieldsDescription(maxLength float32, minLength float32, required bool) *ArtifactsFieldsDescription {
	this := ArtifactsFieldsDescription{}
...
func (o ArtifactsFieldsDescription) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsFieldsDescription) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsFieldsDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsFieldsDescription := _ArtifactsFieldsDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsFieldsDescription)

	if err != nil {
		return err
	}

	*o = ArtifactsFieldsDescription(varArtifactsFieldsDescription)

	return err
}

type NullableArtifactsFieldsDescription struct {
	value *ArtifactsFieldsDescription
	isSet bool
}

func (v NullableArtifactsFieldsDescription) Get() *ArtifactsFieldsDescription {
	return v.value
}

func (v *NullableArtifactsFieldsDescription) Set(val *ArtifactsFieldsDescription) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsFieldsDescription) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsFieldsDescription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsFieldsDescription(val *ArtifactsFieldsDescription) *NullableArtifactsFieldsDescription {
	return &NullableArtifactsFieldsDescription{value: val, isSet: true}
}

func (v NullableArtifactsFieldsDescription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsFieldsDescription) UnmarshalJSON(src []byte) error {
	v.isSet = true
