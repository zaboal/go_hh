...
// checks if the ErrorsNegotiationTopicsStateChangeDeniedError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsNegotiationTopicsStateChangeDeniedError{}

// ErrorsNegotiationTopicsStateChangeDeniedError struct for ErrorsNegotiationTopicsStateChangeDeniedError
type ErrorsNegotiationTopicsStateChangeDeniedError struct {
...
type _ErrorsNegotiationTopicsStateChangeDeniedError ErrorsNegotiationTopicsStateChangeDeniedError
...
func NewErrorsNegotiationTopicsStateChangeDeniedError(type_ string, value string) *ErrorsNegotiationTopicsStateChangeDeniedError {
	this := ErrorsNegotiationTopicsStateChangeDeniedError{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o ErrorsNegotiationTopicsStateChangeDeniedError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsNegotiationTopicsStateChangeDeniedError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsNegotiationTopicsStateChangeDeniedError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsNegotiationTopicsStateChangeDeniedError := _ErrorsNegotiationTopicsStateChangeDeniedError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsNegotiationTopicsStateChangeDeniedError)

	if err != nil {
		return err
	}

	*o = ErrorsNegotiationTopicsStateChangeDeniedError(varErrorsNegotiationTopicsStateChangeDeniedError)

	return err
}

type NullableErrorsNegotiationTopicsStateChangeDeniedError struct {
	value *ErrorsNegotiationTopicsStateChangeDeniedError
	isSet bool
}

func (v NullableErrorsNegotiationTopicsStateChangeDeniedError) Get() *ErrorsNegotiationTopicsStateChangeDeniedError {
	return v.value
}

func (v *NullableErrorsNegotiationTopicsStateChangeDeniedError) Set(val *ErrorsNegotiationTopicsStateChangeDeniedError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationTopicsStateChangeDeniedError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationTopicsStateChangeDeniedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationTopicsStateChangeDeniedError(val *ErrorsNegotiationTopicsStateChangeDeniedError) *NullableErrorsNegotiationTopicsStateChangeDeniedError {
	return &NullableErrorsNegotiationTopicsStateChangeDeniedError{value: val, isSet: true}
}

func (v NullableErrorsNegotiationTopicsStateChangeDeniedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationTopicsStateChangeDeniedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
