...
// checks if the ErrorsNegotiationSendMessageNotFoundErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsNegotiationSendMessageNotFoundErrors{}

// ErrorsNegotiationSendMessageNotFoundErrors Информация о возникших ошибках
type ErrorsNegotiationSendMessageNotFoundErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Описание типа ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsNegotiationSendMessageNotFoundError `json:"errors"`
}

type _ErrorsNegotiationSendMessageNotFoundErrors ErrorsNegotiationSendMessageNotFoundErrors
...
func NewErrorsNegotiationSendMessageNotFoundErrors(requestId string, errors []ErrorsNegotiationSendMessageNotFoundError) *ErrorsNegotiationSendMessageNotFoundErrors {
	this := ErrorsNegotiationSendMessageNotFoundErrors{}
...
func (o *ErrorsNegotiationSendMessageNotFoundErrors) GetErrors() []ErrorsNegotiationSendMessageNotFoundError {
	if o == nil {
		var ret []ErrorsNegotiationSendMessageNotFoundError
		return ret
	}
...
func (o ErrorsNegotiationSendMessageNotFoundErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsNegotiationSendMessageNotFoundErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsNegotiationSendMessageNotFoundErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsNegotiationSendMessageNotFoundErrors := _ErrorsNegotiationSendMessageNotFoundErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsNegotiationSendMessageNotFoundErrors)

	if err != nil {
		return err
	}

	*o = ErrorsNegotiationSendMessageNotFoundErrors(varErrorsNegotiationSendMessageNotFoundErrors)

	return err
}

type NullableErrorsNegotiationSendMessageNotFoundErrors struct {
	value *ErrorsNegotiationSendMessageNotFoundErrors
	isSet bool
}

func (v NullableErrorsNegotiationSendMessageNotFoundErrors) Get() *ErrorsNegotiationSendMessageNotFoundErrors {
	return v.value
}

func (v *NullableErrorsNegotiationSendMessageNotFoundErrors) Set(val *ErrorsNegotiationSendMessageNotFoundErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationSendMessageNotFoundErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationSendMessageNotFoundErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationSendMessageNotFoundErrors(val *ErrorsNegotiationSendMessageNotFoundErrors) *NullableErrorsNegotiationSendMessageNotFoundErrors {
	return &NullableErrorsNegotiationSendMessageNotFoundErrors{value: val, isSet: true}
}

func (v NullableErrorsNegotiationSendMessageNotFoundErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationSendMessageNotFoundErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
