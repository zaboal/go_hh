...
// checks if the ArtifactsDescription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsDescription{}

// ArtifactsDescription struct for ArtifactsDescription
type ArtifactsDescription struct {
...
type _ArtifactsDescription ArtifactsDescription
...
func (o ArtifactsDescription) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsDescription) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsDescription := _ArtifactsDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsDescription)

	if err != nil {
		return err
	}

	*o = ArtifactsDescription(varArtifactsDescription)

	return err
}

type NullableArtifactsDescription struct {
	value *ArtifactsDescription
	isSet bool
}

func (v NullableArtifactsDescription) Get() *ArtifactsDescription {
	return v.value
}

func (v *NullableArtifactsDescription) Set(val *ArtifactsDescription) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsDescription) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsDescription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsDescription(val *ArtifactsDescription) *NullableArtifactsDescription {
	return &NullableArtifactsDescription{value: val, isSet: true}
}

func (v NullableArtifactsDescription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsDescription) UnmarshalJSON(src []byte) error {
	v.isSet = true
