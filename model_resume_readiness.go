...
// checks if the ResumeReadiness type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeReadiness{}

// ResumeReadiness struct for ResumeReadiness
...
type _ResumeReadiness ResumeReadiness
...
func (o ResumeReadiness) MarshalJSON() ([]byte, error) {
...
func (o ResumeReadiness) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeReadiness) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeReadiness := _ResumeReadiness{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeReadiness)

	if err != nil {
		return err
	}

	*o = ResumeReadiness(varResumeReadiness)

	return err
}

type NullableResumeReadiness struct {
	value *ResumeReadiness
	isSet bool
}

func (v NullableResumeReadiness) Get() *ResumeReadiness {
	return v.value
}

func (v *NullableResumeReadiness) Set(val *ResumeReadiness) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeReadiness) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeReadiness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeReadiness(val *ResumeReadiness) *NullableResumeReadiness {
	return &NullableResumeReadiness{value: val, isSet: true}
}

func (v NullableResumeReadiness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeReadiness) UnmarshalJSON(src []byte) error {
	v.isSet = true
