...
// checks if the ResumesResumeConditionFieldsAccessFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsAccessFields{}

// ResumesResumeConditionFieldsAccessFields struct for ResumesResumeConditionFieldsAccessFields
type ResumesResumeConditionFieldsAccessFields struct {
...
func NewResumesResumeConditionFieldsAccessFields() *ResumesResumeConditionFieldsAccessFields {
	this := ResumesResumeConditionFieldsAccessFields{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsAccessFields) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o ResumesResumeConditionFieldsAccessFields) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsAccessFields) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsAccessFields struct {
	value *ResumesResumeConditionFieldsAccessFields
	isSet bool
}

func (v NullableResumesResumeConditionFieldsAccessFields) Get() *ResumesResumeConditionFieldsAccessFields {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsAccessFields) Set(val *ResumesResumeConditionFieldsAccessFields) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsAccessFields) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsAccessFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsAccessFields(val *ResumesResumeConditionFieldsAccessFields) *NullableResumesResumeConditionFieldsAccessFields {
	return &NullableResumesResumeConditionFieldsAccessFields{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsAccessFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsAccessFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
