...
// checks if the ErrorsVacancyAddEditBadJsonDataError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyAddEditBadJsonDataError{}

// ErrorsVacancyAddEditBadJsonDataError struct for ErrorsVacancyAddEditBadJsonDataError
type ErrorsVacancyAddEditBadJsonDataError struct {
	// Описание ошибки
...
type _ErrorsVacancyAddEditBadJsonDataError ErrorsVacancyAddEditBadJsonDataError
...
func NewErrorsVacancyAddEditBadJsonDataError(type_ string) *ErrorsVacancyAddEditBadJsonDataError {
	this := ErrorsVacancyAddEditBadJsonDataError{}
	this.Type = type_
	return &this
}
...
func (o *ErrorsVacancyAddEditBadJsonDataError) SetDescriptionNil() {
...
func (o ErrorsVacancyAddEditBadJsonDataError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyAddEditBadJsonDataError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyAddEditBadJsonDataError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyAddEditBadJsonDataError := _ErrorsVacancyAddEditBadJsonDataError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyAddEditBadJsonDataError)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyAddEditBadJsonDataError(varErrorsVacancyAddEditBadJsonDataError)

	return err
}

type NullableErrorsVacancyAddEditBadJsonDataError struct {
	value *ErrorsVacancyAddEditBadJsonDataError
	isSet bool
}

func (v NullableErrorsVacancyAddEditBadJsonDataError) Get() *ErrorsVacancyAddEditBadJsonDataError {
	return v.value
}

func (v *NullableErrorsVacancyAddEditBadJsonDataError) Set(val *ErrorsVacancyAddEditBadJsonDataError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyAddEditBadJsonDataError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyAddEditBadJsonDataError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyAddEditBadJsonDataError(val *ErrorsVacancyAddEditBadJsonDataError) *NullableErrorsVacancyAddEditBadJsonDataError {
	return &NullableErrorsVacancyAddEditBadJsonDataError{value: val, isSet: true}
}

func (v NullableErrorsVacancyAddEditBadJsonDataError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyAddEditBadJsonDataError) UnmarshalJSON(src []byte) error {
	v.isSet = true
