...
// checks if the VacancyDraftProfessionalRoleItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftProfessionalRoleItem{}
...
func NewVacancyDraftProfessionalRoleItem() *VacancyDraftProfessionalRoleItem {
	this := VacancyDraftProfessionalRoleItem{}
	return &this
}
...
func (o VacancyDraftProfessionalRoleItem) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftProfessionalRoleItem) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftProfessionalRoleItem struct {
	value *VacancyDraftProfessionalRoleItem
	isSet bool
}

func (v NullableVacancyDraftProfessionalRoleItem) Get() *VacancyDraftProfessionalRoleItem {
	return v.value
}

func (v *NullableVacancyDraftProfessionalRoleItem) Set(val *VacancyDraftProfessionalRoleItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftProfessionalRoleItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftProfessionalRoleItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftProfessionalRoleItem(val *VacancyDraftProfessionalRoleItem) *NullableVacancyDraftProfessionalRoleItem {
	return &NullableVacancyDraftProfessionalRoleItem{value: val, isSet: true}
}

func (v NullableVacancyDraftProfessionalRoleItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftProfessionalRoleItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
