...
// WebhookSubscriptionsPostRequest - struct for WebhookSubscriptionsPostRequest
type WebhookSubscriptionsPostRequest struct {
	WebhookSendObjectBaseUser *WebhookSendObjectBaseUser
}

// WebhookSendObjectBaseUserAsWebhookSubscriptionsPostRequest is a convenience function that returns WebhookSendObjectBaseUser wrapped in WebhookSubscriptionsPostRequest
func WebhookSendObjectBaseUserAsWebhookSubscriptionsPostRequest(v *WebhookSendObjectBaseUser) WebhookSubscriptionsPostRequest {
	return WebhookSubscriptionsPostRequest{
		WebhookSendObjectBaseUser: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *WebhookSubscriptionsPostRequest) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into WebhookSendObjectBaseUser
	err = newStrictDecoder(data).Decode(&dst.WebhookSendObjectBaseUser)
	if err == nil {
		jsonWebhookSendObjectBaseUser, _ := json.Marshal(dst.WebhookSendObjectBaseUser)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(WebhookSubscriptionsPostRequest)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(WebhookSubscriptionsPostRequest)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src WebhookSubscriptionsPostRequest) MarshalJSON() ([]byte, error) {
	if src.WebhookSendObjectBaseUser != nil {
		return json.Marshal(&src.WebhookSendObjectBaseUser)
	}
...
func (obj *WebhookSubscriptionsPostRequest) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.WebhookSendObjectBaseUser != nil {
		return obj.WebhookSendObjectBaseUser
	}
...
type NullableWebhookSubscriptionsPostRequest struct {
	value *WebhookSubscriptionsPostRequest
	isSet bool
}

func (v NullableWebhookSubscriptionsPostRequest) Get() *WebhookSubscriptionsPostRequest {
	return v.value
}

func (v *NullableWebhookSubscriptionsPostRequest) Set(val *WebhookSubscriptionsPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookSubscriptionsPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookSubscriptionsPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookSubscriptionsPostRequest(val *WebhookSubscriptionsPostRequest) *NullableWebhookSubscriptionsPostRequest {
	return &NullableWebhookSubscriptionsPostRequest{value: val, isSet: true}
}

func (v NullableWebhookSubscriptionsPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookSubscriptionsPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
