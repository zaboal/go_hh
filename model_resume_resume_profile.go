...
// checks if the ResumeResumeProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeProfile{}

// ResumeResumeProfile struct for ResumeResumeProfile
type ResumeResumeProfile struct {
	// URL резюме на сайте
...
func NewResumeResumeProfile(alternateUrl string, id string, title NullableString, certificate []ResumeObjectsCertificate, createdAt string, download ResumeResumeProfileAllOfDownload, education ResumeResumeProfileAllOfEducation, experience []ResumeObjectsExperience, hiddenFields []IncludesIdName, updatedAt string) *ResumeResumeProfile {
...
func (o *ResumeResumeProfile) SetAgeNil() {
	o.Age.Set(nil)
}
...
func (o *ResumeResumeProfile) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumeResumeProfile) SetCanViewFullInfoNil() {
...
func (o *ResumeResumeProfile) GetDownload() ResumeResumeProfileAllOfDownload {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ResumeResumeProfile) GetDownloadOk() (*ResumeResumeProfileAllOfDownload, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ResumeResumeProfile) SetDownload(v ResumeResumeProfileAllOfDownload) {
	o.Download = v
}

// GetEducation returns the Education field value
func (o *ResumeResumeProfile) GetEducation() ResumeResumeProfileAllOfEducation {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ResumeResumeProfile) GetEducationOk() (*ResumeResumeProfileAllOfEducation, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ResumeResumeProfile) SetEducation(v ResumeResumeProfileAllOfEducation) {
	o.Education = v
}
...
func (o *ResumeResumeProfile) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ResumeResumeProfile) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ResumeResumeProfile) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ResumeResumeProfile) SetMiddleNameNil() {
...
func (o *ResumeResumeProfile) GetPlatform() ResumeResumeProfileAllOfPlatform {
...
// and a boolean to check if the value has been set.
func (o *ResumeResumeProfile) GetPlatformOk() (*ResumeResumeProfileAllOfPlatform, bool) {
	if o == nil || IsNil(o.Platform) {
		return nil, false
	}
...
func (o *ResumeResumeProfile) SetPlatform(v ResumeResumeProfileAllOfPlatform) {
	o.Platform = &v
}
...
func (o *ResumeResumeProfile) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *ResumeResumeProfile) SetTotalExperienceNil() {
...
func (o ResumeResumeProfile) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeProfile := _ResumeResumeProfile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeProfile)

	if err != nil {
		return err
	}

	*o = ResumeResumeProfile(varResumeResumeProfile)

	return err
}

type NullableResumeResumeProfile struct {
	value *ResumeResumeProfile
	isSet bool
}

func (v NullableResumeResumeProfile) Get() *ResumeResumeProfile {
	return v.value
}

func (v *NullableResumeResumeProfile) Set(val *ResumeResumeProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeProfile(val *ResumeResumeProfile) *NullableResumeResumeProfile {
	return &NullableResumeResumeProfile{value: val, isSet: true}
}

func (v NullableResumeResumeProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
