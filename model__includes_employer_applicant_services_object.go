...
// checks if the IncludesEmployerApplicantServicesObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesEmployerApplicantServicesObject{}

// IncludesEmployerApplicantServicesObject struct for IncludesEmployerApplicantServicesObject
type IncludesEmployerApplicantServicesObject struct {
...
func NewIncludesEmployerApplicantServicesObject() *IncludesEmployerApplicantServicesObject {
	this := IncludesEmployerApplicantServicesObject{}
	return &this
}
...
func (o IncludesEmployerApplicantServicesObject) MarshalJSON() ([]byte, error) {
...
func (o IncludesEmployerApplicantServicesObject) ToMap() (map[string]interface{}, error) {
...
type NullableIncludesEmployerApplicantServicesObject struct {
	value *IncludesEmployerApplicantServicesObject
	isSet bool
}

func (v NullableIncludesEmployerApplicantServicesObject) Get() *IncludesEmployerApplicantServicesObject {
	return v.value
}

func (v *NullableIncludesEmployerApplicantServicesObject) Set(val *IncludesEmployerApplicantServicesObject) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesEmployerApplicantServicesObject) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesEmployerApplicantServicesObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesEmployerApplicantServicesObject(val *IncludesEmployerApplicantServicesObject) *NullableIncludesEmployerApplicantServicesObject {
	return &NullableIncludesEmployerApplicantServicesObject{value: val, isSet: true}
}

func (v NullableIncludesEmployerApplicantServicesObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesEmployerApplicantServicesObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
