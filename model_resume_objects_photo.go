...
// checks if the ResumeObjectsPhoto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsPhoto{}

// ResumeObjectsPhoto Значение может быть `null`, если у работодателя отсутствует брендирование страницы
type ResumeObjectsPhoto struct {
...
type _ResumeObjectsPhoto ResumeObjectsPhoto
...
func (o *ResumeObjectsPhoto) SetVar40Nil() {
	o.Var40.Set(nil)
}
...
func (o *ResumeObjectsPhoto) SetVar100Nil() {
	o.Var100.Set(nil)
}
...
func (o *ResumeObjectsPhoto) SetVar500Nil() {
	o.Var500.Set(nil)
}
...
func (o ResumeObjectsPhoto) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsPhoto) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsPhoto) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsPhoto := _ResumeObjectsPhoto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsPhoto)

	if err != nil {
		return err
	}

	*o = ResumeObjectsPhoto(varResumeObjectsPhoto)

	return err
}

type NullableResumeObjectsPhoto struct {
	value *ResumeObjectsPhoto
	isSet bool
}

func (v NullableResumeObjectsPhoto) Get() *ResumeObjectsPhoto {
	return v.value
}

func (v *NullableResumeObjectsPhoto) Set(val *ResumeObjectsPhoto) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsPhoto) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsPhoto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsPhoto(val *ResumeObjectsPhoto) *NullableResumeObjectsPhoto {
	return &NullableResumeObjectsPhoto{value: val, isSet: true}
}

func (v NullableResumeObjectsPhoto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsPhoto) UnmarshalJSON(src []byte) error {
	v.isSet = true
