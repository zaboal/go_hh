...
// checks if the AuthUserToken type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthUserToken{}

// AuthUserToken struct for AuthUserToken
...
type _AuthUserToken AuthUserToken
...
func (o AuthUserToken) MarshalJSON() ([]byte, error) {
...
func (o AuthUserToken) ToMap() (map[string]interface{}, error) {
...
func (o *AuthUserToken) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthUserToken := _AuthUserToken{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthUserToken)

	if err != nil {
		return err
	}

	*o = AuthUserToken(varAuthUserToken)

	return err
}

type NullableAuthUserToken struct {
	value *AuthUserToken
	isSet bool
}

func (v NullableAuthUserToken) Get() *AuthUserToken {
	return v.value
}

func (v *NullableAuthUserToken) Set(val *AuthUserToken) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthUserToken) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthUserToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthUserToken(val *AuthUserToken) *NullableAuthUserToken {
	return &NullableAuthUserToken{value: val, isSet: true}
}

func (v NullableAuthUserToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthUserToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
