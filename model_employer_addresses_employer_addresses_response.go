...
// checks if the EmployerAddressesEmployerAddressesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerAddressesEmployerAddressesResponse{}

// EmployerAddressesEmployerAddressesResponse struct for EmployerAddressesEmployerAddressesResponse
type EmployerAddressesEmployerAddressesResponse struct {
	// Список адресов работодателя
	Items []EmployerAddressesEmployerAddressItem `json:"items"`
	// Найдено результатов
...
type _EmployerAddressesEmployerAddressesResponse EmployerAddressesEmployerAddressesResponse
...
func NewEmployerAddressesEmployerAddressesResponse(items []EmployerAddressesEmployerAddressItem, found float32, page float32, pages float32, perPage float32) *EmployerAddressesEmployerAddressesResponse {
	this := EmployerAddressesEmployerAddressesResponse{}
	this.Items = items
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *EmployerAddressesEmployerAddressesResponse) GetItems() []EmployerAddressesEmployerAddressItem {
	if o == nil {
		var ret []EmployerAddressesEmployerAddressItem
		return ret
	}
...
func (o EmployerAddressesEmployerAddressesResponse) MarshalJSON() ([]byte, error) {
...
func (o EmployerAddressesEmployerAddressesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerAddressesEmployerAddressesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerAddressesEmployerAddressesResponse := _EmployerAddressesEmployerAddressesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerAddressesEmployerAddressesResponse)

	if err != nil {
		return err
	}

	*o = EmployerAddressesEmployerAddressesResponse(varEmployerAddressesEmployerAddressesResponse)

	return err
}

type NullableEmployerAddressesEmployerAddressesResponse struct {
	value *EmployerAddressesEmployerAddressesResponse
	isSet bool
}

func (v NullableEmployerAddressesEmployerAddressesResponse) Get() *EmployerAddressesEmployerAddressesResponse {
	return v.value
}

func (v *NullableEmployerAddressesEmployerAddressesResponse) Set(val *EmployerAddressesEmployerAddressesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerAddressesEmployerAddressesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerAddressesEmployerAddressesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerAddressesEmployerAddressesResponse(val *EmployerAddressesEmployerAddressesResponse) *NullableEmployerAddressesEmployerAddressesResponse {
	return &NullableEmployerAddressesEmployerAddressesResponse{value: val, isSet: true}
}

func (v NullableEmployerAddressesEmployerAddressesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerAddressesEmployerAddressesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
