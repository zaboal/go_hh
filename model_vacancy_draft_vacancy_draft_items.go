...
// checks if the VacancyDraftVacancyDraftItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftVacancyDraftItems{}

// VacancyDraftVacancyDraftItems struct for VacancyDraftVacancyDraftItems
type VacancyDraftVacancyDraftItems struct {
	Found float32 `json:"found"`
	// Список черновиков
	Items []VacancyDraftVacancyDraftItem `json:"items"`
	Page float32 `json:"page"`
	Pages float32 `json:"pages"`
	PerPage float32 `json:"per_page"`
}

type _VacancyDraftVacancyDraftItems VacancyDraftVacancyDraftItems
...
func NewVacancyDraftVacancyDraftItems(found float32, items []VacancyDraftVacancyDraftItem, page float32, pages float32, perPage float32) *VacancyDraftVacancyDraftItems {
	this := VacancyDraftVacancyDraftItems{}
	this.Found = found
	this.Items = items
	this.Page = page
	this.Pages = pages
...
func (o *VacancyDraftVacancyDraftItems) GetItems() []VacancyDraftVacancyDraftItem {
	if o == nil {
		var ret []VacancyDraftVacancyDraftItem
		return ret
	}
...
func (o VacancyDraftVacancyDraftItems) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftVacancyDraftItems) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyDraftVacancyDraftItems) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDraftVacancyDraftItems := _VacancyDraftVacancyDraftItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDraftVacancyDraftItems)

	if err != nil {
		return err
	}

	*o = VacancyDraftVacancyDraftItems(varVacancyDraftVacancyDraftItems)

	return err
}

type NullableVacancyDraftVacancyDraftItems struct {
	value *VacancyDraftVacancyDraftItems
	isSet bool
}

func (v NullableVacancyDraftVacancyDraftItems) Get() *VacancyDraftVacancyDraftItems {
	return v.value
}

func (v *NullableVacancyDraftVacancyDraftItems) Set(val *VacancyDraftVacancyDraftItems) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftVacancyDraftItems) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftVacancyDraftItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftVacancyDraftItems(val *VacancyDraftVacancyDraftItems) *NullableVacancyDraftVacancyDraftItems {
	return &NullableVacancyDraftVacancyDraftItems{value: val, isSet: true}
}

func (v NullableVacancyDraftVacancyDraftItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftVacancyDraftItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
