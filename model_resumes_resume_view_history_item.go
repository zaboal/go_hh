...
// checks if the ResumesResumeViewHistoryItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeViewHistoryItem{}

// ResumesResumeViewHistoryItem struct for ResumesResumeViewHistoryItem
type ResumesResumeViewHistoryItem struct {
	// Дата создания записи (дата просмотра резюме работодателем)
	CreatedAt string `json:"created_at"`
	Employer ResumesResumeViewHistoryItemEmployer `json:"employer"`
	// Отметка о просмотре записи
	Viewed bool `json:"viewed"`
}

type _ResumesResumeViewHistoryItem ResumesResumeViewHistoryItem
...
func NewResumesResumeViewHistoryItem(createdAt string, employer ResumesResumeViewHistoryItemEmployer, viewed bool) *ResumesResumeViewHistoryItem {
	this := ResumesResumeViewHistoryItem{}
...
func (o *ResumesResumeViewHistoryItem) GetEmployer() ResumesResumeViewHistoryItemEmployer {
	if o == nil {
		var ret ResumesResumeViewHistoryItemEmployer
		return ret
	}
...
func (o ResumesResumeViewHistoryItem) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeViewHistoryItem) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesResumeViewHistoryItem) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeViewHistoryItem := _ResumesResumeViewHistoryItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeViewHistoryItem)

	if err != nil {
		return err
	}

	*o = ResumesResumeViewHistoryItem(varResumesResumeViewHistoryItem)

	return err
}

type NullableResumesResumeViewHistoryItem struct {
	value *ResumesResumeViewHistoryItem
	isSet bool
}

func (v NullableResumesResumeViewHistoryItem) Get() *ResumesResumeViewHistoryItem {
	return v.value
}

func (v *NullableResumesResumeViewHistoryItem) Set(val *ResumesResumeViewHistoryItem) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeViewHistoryItem) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeViewHistoryItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeViewHistoryItem(val *ResumesResumeViewHistoryItem) *NullableResumesResumeViewHistoryItem {
	return &NullableResumesResumeViewHistoryItem{value: val, isSet: true}
}

func (v NullableResumesResumeViewHistoryItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeViewHistoryItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
