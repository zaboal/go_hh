...
// checks if the VacancyBillingType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyBillingType{}

// VacancyBillingType struct for VacancyBillingType
type VacancyBillingType struct {
	// Биллинговый тип [из справочника vacancy_billing_type](#tag/Obshie-spravochniki/operation/get-dictionaries)
	Id string `json:"id"`
}

type _VacancyBillingType VacancyBillingType
...
func (o VacancyBillingType) MarshalJSON() ([]byte, error) {
...
func (o VacancyBillingType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *VacancyBillingType) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyBillingType := _VacancyBillingType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyBillingType)

	if err != nil {
		return err
	}

	*o = VacancyBillingType(varVacancyBillingType)

	return err
}

type NullableVacancyBillingType struct {
	value *VacancyBillingType
	isSet bool
}

func (v NullableVacancyBillingType) Get() *VacancyBillingType {
	return v.value
}

func (v *NullableVacancyBillingType) Set(val *VacancyBillingType) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyBillingType) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyBillingType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyBillingType(val *VacancyBillingType) *NullableVacancyBillingType {
	return &NullableVacancyBillingType{value: val, isSet: true}
}

func (v NullableVacancyBillingType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyBillingType) UnmarshalJSON(src []byte) error {
	v.isSet = true
