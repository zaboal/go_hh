...
// checks if the VacancyWorkingTimeIntervalItemOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyWorkingTimeIntervalItemOutput{}

// VacancyWorkingTimeIntervalItemOutput struct for VacancyWorkingTimeIntervalItemOutput
type VacancyWorkingTimeIntervalItemOutput struct {
...
func NewVacancyWorkingTimeIntervalItemOutput() *VacancyWorkingTimeIntervalItemOutput {
	this := VacancyWorkingTimeIntervalItemOutput{}
	return &this
}
...
func (o VacancyWorkingTimeIntervalItemOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyWorkingTimeIntervalItemOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyWorkingTimeIntervalItemOutput struct {
	value *VacancyWorkingTimeIntervalItemOutput
	isSet bool
}

func (v NullableVacancyWorkingTimeIntervalItemOutput) Get() *VacancyWorkingTimeIntervalItemOutput {
	return v.value
}

func (v *NullableVacancyWorkingTimeIntervalItemOutput) Set(val *VacancyWorkingTimeIntervalItemOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyWorkingTimeIntervalItemOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyWorkingTimeIntervalItemOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyWorkingTimeIntervalItemOutput(val *VacancyWorkingTimeIntervalItemOutput) *NullableVacancyWorkingTimeIntervalItemOutput {
	return &NullableVacancyWorkingTimeIntervalItemOutput{value: val, isSet: true}
}

func (v NullableVacancyWorkingTimeIntervalItemOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyWorkingTimeIntervalItemOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
