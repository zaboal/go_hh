...
// checks if the VacanciesVacancyConditionFieldsContactsCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsContactsCondition{}

// VacanciesVacancyConditionFieldsContactsCondition struct for VacanciesVacancyConditionFieldsContactsCondition
type VacanciesVacancyConditionFieldsContactsCondition struct {
	// Является ли поле необходимым?
	Required NullableBool `json:"required,omitempty"`
	Fields NullableVacanciesVacancyConditionFieldsContactFields `json:"fields,omitempty"`
}
...
func NewVacanciesVacancyConditionFieldsContactsCondition() *VacanciesVacancyConditionFieldsContactsCondition {
	this := VacanciesVacancyConditionFieldsContactsCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsContactsCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsContactsCondition) GetFields() VacanciesVacancyConditionFieldsContactFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret VacanciesVacancyConditionFieldsContactFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableVacanciesVacancyConditionFieldsContactFields and assigns it to the Fields field.
...
func (o *VacanciesVacancyConditionFieldsContactsCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsContactsCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsContactsCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsContactsCondition struct {
	value *VacanciesVacancyConditionFieldsContactsCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsContactsCondition) Get() *VacanciesVacancyConditionFieldsContactsCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsContactsCondition) Set(val *VacanciesVacancyConditionFieldsContactsCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsContactsCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsContactsCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsContactsCondition(val *VacanciesVacancyConditionFieldsContactsCondition) *NullableVacanciesVacancyConditionFieldsContactsCondition {
	return &NullableVacanciesVacancyConditionFieldsContactsCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsContactsCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsContactsCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
