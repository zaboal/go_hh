...
// checks if the ErrorsEmployerManagerBadArgumentError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsEmployerManagerBadArgumentError{}

// ErrorsEmployerManagerBadArgumentError struct for ErrorsEmployerManagerBadArgumentError
type ErrorsEmployerManagerBadArgumentError struct {
	// Описание ошибки
...
type _ErrorsEmployerManagerBadArgumentError ErrorsEmployerManagerBadArgumentError
...
func NewErrorsEmployerManagerBadArgumentError(type_ string) *ErrorsEmployerManagerBadArgumentError {
	this := ErrorsEmployerManagerBadArgumentError{}
	this.Type = type_
	return &this
}
...
func (o ErrorsEmployerManagerBadArgumentError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsEmployerManagerBadArgumentError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsEmployerManagerBadArgumentError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsEmployerManagerBadArgumentError := _ErrorsEmployerManagerBadArgumentError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsEmployerManagerBadArgumentError)

	if err != nil {
		return err
	}

	*o = ErrorsEmployerManagerBadArgumentError(varErrorsEmployerManagerBadArgumentError)

	return err
}

type NullableErrorsEmployerManagerBadArgumentError struct {
	value *ErrorsEmployerManagerBadArgumentError
	isSet bool
}

func (v NullableErrorsEmployerManagerBadArgumentError) Get() *ErrorsEmployerManagerBadArgumentError {
	return v.value
}

func (v *NullableErrorsEmployerManagerBadArgumentError) Set(val *ErrorsEmployerManagerBadArgumentError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsEmployerManagerBadArgumentError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsEmployerManagerBadArgumentError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsEmployerManagerBadArgumentError(val *ErrorsEmployerManagerBadArgumentError) *NullableErrorsEmployerManagerBadArgumentError {
	return &NullableErrorsEmployerManagerBadArgumentError{value: val, isSet: true}
}

func (v NullableErrorsEmployerManagerBadArgumentError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsEmployerManagerBadArgumentError) UnmarshalJSON(src []byte) error {
	v.isSet = true
