...
// checks if the VacancyDraftVacancyDraftCommon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftVacancyDraftCommon{}

// VacancyDraftVacancyDraftCommon struct for VacancyDraftVacancyDraftCommon
type VacancyDraftVacancyDraftCommon struct {
...
type _VacancyDraftVacancyDraftCommon VacancyDraftVacancyDraftCommon
...
func NewVacancyDraftVacancyDraftCommon(acceptHandicapped bool, acceptIncompleteResumes bool, acceptKids bool, allowMessages bool, billingType NullableVacancyBillingTypeOutput, description string, driverLicenseTypes []VacancyDriverLicenceTypeItem, experience NullableVacancyExperienceOutput, hasTest bool, keySkills []VacancyKeySkillItem, languages []VacancyLanguageOutput, manager VacancyManager, name string, professionalRoles []VacancyProfessionalRoleItemOutput, responseLetterRequired bool, responseNotifications bool, schedule VacancyScheduleOutput, type_ VacancyTypeOutput) *VacancyDraftVacancyDraftCommon {
	this := VacancyDraftVacancyDraftCommon{}
...
func (o *VacancyDraftVacancyDraftCommon) SetAcceptTemporaryNil() {
...
func (o *VacancyDraftVacancyDraftCommon) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftCommon) SetDepartmentNil() {
...
func (o *VacancyDraftVacancyDraftCommon) SetEmploymentNil() {
...
func (o *VacancyDraftVacancyDraftCommon) SetResponseUrlNil() {
...
func (o *VacancyDraftVacancyDraftCommon) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *VacancyDraftVacancyDraftCommon) SetTestNil() {
	o.Test.Set(nil)
}
...
func (o VacancyDraftVacancyDraftCommon) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftVacancyDraftCommon) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyDraftVacancyDraftCommon) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDraftVacancyDraftCommon := _VacancyDraftVacancyDraftCommon{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDraftVacancyDraftCommon)

	if err != nil {
		return err
	}

	*o = VacancyDraftVacancyDraftCommon(varVacancyDraftVacancyDraftCommon)

	return err
}

type NullableVacancyDraftVacancyDraftCommon struct {
	value *VacancyDraftVacancyDraftCommon
	isSet bool
}

func (v NullableVacancyDraftVacancyDraftCommon) Get() *VacancyDraftVacancyDraftCommon {
	return v.value
}

func (v *NullableVacancyDraftVacancyDraftCommon) Set(val *VacancyDraftVacancyDraftCommon) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftVacancyDraftCommon) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftVacancyDraftCommon) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftVacancyDraftCommon(val *VacancyDraftVacancyDraftCommon) *NullableVacancyDraftVacancyDraftCommon {
	return &NullableVacancyDraftVacancyDraftCommon{value: val, isSet: true}
}

func (v NullableVacancyDraftVacancyDraftCommon) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftVacancyDraftCommon) UnmarshalJSON(src []byte) error {
	v.isSet = true
