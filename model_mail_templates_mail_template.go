...
// checks if the MailTemplatesMailTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailTemplatesMailTemplate{}
...
type MailTemplatesMailTemplate struct {
	...
	Variables []IncludesIdName `json:"variables"`
}

type _MailTemplatesMailTemplate MailTemplatesMailTemplate
...
func (o MailTemplatesMailTemplate) MarshalJSON() ([]byte, error) {
...
func (o *MailTemplatesMailTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varMailTemplatesMailTemplate := _MailTemplatesMailTemplate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMailTemplatesMailTemplate)

	if err != nil {
		return err
	}

	*o = MailTemplatesMailTemplate(varMailTemplatesMailTemplate)

	return err
}

type NullableMailTemplatesMailTemplate struct {
	value *MailTemplatesMailTemplate
	isSet bool
}

func (v NullableMailTemplatesMailTemplate) Get() *MailTemplatesMailTemplate {
	return v.value
}

func (v *NullableMailTemplatesMailTemplate) Set(val *MailTemplatesMailTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableMailTemplatesMailTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableMailTemplatesMailTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailTemplatesMailTemplate(val *MailTemplatesMailTemplate) *NullableMailTemplatesMailTemplate {
	return &NullableMailTemplatesMailTemplate{value: val, isSet: true}
}

func (v NullableMailTemplatesMailTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailTemplatesMailTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
