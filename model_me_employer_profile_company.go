...
// checks if the MeEmployerProfileCompany type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeEmployerProfileCompany{}

// MeEmployerProfileCompany Информация о компании работодателя
type MeEmployerProfileCompany struct {
...
type _MeEmployerProfileCompany MeEmployerProfileCompany
...
func (o MeEmployerProfileCompany) MarshalJSON() ([]byte, error) {
...
func (o MeEmployerProfileCompany) ToMap() (map[string]interface{}, error) {
...
func (o *MeEmployerProfileCompany) UnmarshalJSON(data []byte) (err error) {
	...
	varMeEmployerProfileCompany := _MeEmployerProfileCompany{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMeEmployerProfileCompany)

	if err != nil {
		return err
	}

	*o = MeEmployerProfileCompany(varMeEmployerProfileCompany)

	return err
}

type NullableMeEmployerProfileCompany struct {
	value *MeEmployerProfileCompany
	isSet bool
}

func (v NullableMeEmployerProfileCompany) Get() *MeEmployerProfileCompany {
	return v.value
}

func (v *NullableMeEmployerProfileCompany) Set(val *MeEmployerProfileCompany) {
	v.value = val
	v.isSet = true
}

func (v NullableMeEmployerProfileCompany) IsSet() bool {
	return v.isSet
}

func (v *NullableMeEmployerProfileCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeEmployerProfileCompany(val *MeEmployerProfileCompany) *NullableMeEmployerProfileCompany {
	return &NullableMeEmployerProfileCompany{value: val, isSet: true}
}

func (v NullableMeEmployerProfileCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeEmployerProfileCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
