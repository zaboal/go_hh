...
// checks if the NegotiationsNegotiationsStatisticsManagerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationsStatisticsManagerResponse{}

// NegotiationsNegotiationsStatisticsManagerResponse struct for NegotiationsNegotiationsStatisticsManagerResponse
type NegotiationsNegotiationsStatisticsManagerResponse struct {
	ManagerStatistics NegotiationsNegotiationsStatistics `json:"manager_statistics"`
}

type _NegotiationsNegotiationsStatisticsManagerResponse NegotiationsNegotiationsStatisticsManagerResponse
...
func NewNegotiationsNegotiationsStatisticsManagerResponse(managerStatistics NegotiationsNegotiationsStatistics) *NegotiationsNegotiationsStatisticsManagerResponse {
	this := NegotiationsNegotiationsStatisticsManagerResponse{}
...
// GetManagerStatistics returns the ManagerStatistics field value
func (o *NegotiationsNegotiationsStatisticsManagerResponse) GetManagerStatistics() NegotiationsNegotiationsStatistics {
	...
	return o.ManagerStatistics
}

// GetManagerStatisticsOk returns a tuple with the ManagerStatistics field value
...
func (o *NegotiationsNegotiationsStatisticsManagerResponse) GetManagerStatisticsOk() (*NegotiationsNegotiationsStatistics, bool) {
	...
	return &o.ManagerStatistics, true
}

// SetManagerStatistics sets field value
func (o *NegotiationsNegotiationsStatisticsManagerResponse) SetManagerStatistics(v NegotiationsNegotiationsStatistics) {
	o.ManagerStatistics = v
}

func (o NegotiationsNegotiationsStatisticsManagerResponse) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationsStatisticsManagerResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["manager_statistics"] = o.ManagerStatistics
	return toSerialize, nil
}

func (o *NegotiationsNegotiationsStatisticsManagerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationsStatisticsManagerResponse := _NegotiationsNegotiationsStatisticsManagerResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationsStatisticsManagerResponse)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationsStatisticsManagerResponse(varNegotiationsNegotiationsStatisticsManagerResponse)

	return err
}

type NullableNegotiationsNegotiationsStatisticsManagerResponse struct {
	value *NegotiationsNegotiationsStatisticsManagerResponse
	isSet bool
}

func (v NullableNegotiationsNegotiationsStatisticsManagerResponse) Get() *NegotiationsNegotiationsStatisticsManagerResponse {
	return v.value
}

func (v *NullableNegotiationsNegotiationsStatisticsManagerResponse) Set(val *NegotiationsNegotiationsStatisticsManagerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationsStatisticsManagerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationsStatisticsManagerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationsStatisticsManagerResponse(val *NegotiationsNegotiationsStatisticsManagerResponse) *NullableNegotiationsNegotiationsStatisticsManagerResponse {
	return &NullableNegotiationsNegotiationsStatisticsManagerResponse{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationsStatisticsManagerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationsStatisticsManagerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
