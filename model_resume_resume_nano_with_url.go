...
// checks if the ResumeResumeNanoWithUrl type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeNanoWithUrl{}

// ResumeResumeNanoWithUrl struct for ResumeResumeNanoWithUrl
type ResumeResumeNanoWithUrl struct {
	// URL резюме на сайте
...
type _ResumeResumeNanoWithUrl ResumeResumeNanoWithUrl
...
func (o ResumeResumeNanoWithUrl) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeNanoWithUrl) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeNanoWithUrl) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeNanoWithUrl := _ResumeResumeNanoWithUrl{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeNanoWithUrl)

	if err != nil {
		return err
	}

	*o = ResumeResumeNanoWithUrl(varResumeResumeNanoWithUrl)

	return err
}

type NullableResumeResumeNanoWithUrl struct {
	value *ResumeResumeNanoWithUrl
	isSet bool
}

func (v NullableResumeResumeNanoWithUrl) Get() *ResumeResumeNanoWithUrl {
	return v.value
}

func (v *NullableResumeResumeNanoWithUrl) Set(val *ResumeResumeNanoWithUrl) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeNanoWithUrl) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeNanoWithUrl) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeNanoWithUrl(val *ResumeResumeNanoWithUrl) *NullableResumeResumeNanoWithUrl {
	return &NullableResumeResumeNanoWithUrl{value: val, isSet: true}
}

func (v NullableResumeResumeNanoWithUrl) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeNanoWithUrl) UnmarshalJSON(src []byte) error {
	v.isSet = true
