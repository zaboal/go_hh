...
// checks if the EmployerManagersManagerTypeId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersManagerTypeId{}

// EmployerManagersManagerTypeId struct for EmployerManagersManagerTypeId
type EmployerManagersManagerTypeId struct {
	// Идентификатор [типа менеджера](#tag/Menedzhery-rabotodatelya/operation/get-employer-manager-types)
	Id string `json:"id"`
}

type _EmployerManagersManagerTypeId EmployerManagersManagerTypeId
...
func NewEmployerManagersManagerTypeId(id string) *EmployerManagersManagerTypeId {
	this := EmployerManagersManagerTypeId{}
	this.Id = id
	return &this
}
...
func (o EmployerManagersManagerTypeId) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersManagerTypeId) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *EmployerManagersManagerTypeId) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersManagerTypeId := _EmployerManagersManagerTypeId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersManagerTypeId)

	if err != nil {
		return err
	}

	*o = EmployerManagersManagerTypeId(varEmployerManagersManagerTypeId)

	return err
}

type NullableEmployerManagersManagerTypeId struct {
	value *EmployerManagersManagerTypeId
	isSet bool
}

func (v NullableEmployerManagersManagerTypeId) Get() *EmployerManagersManagerTypeId {
	return v.value
}

func (v *NullableEmployerManagersManagerTypeId) Set(val *EmployerManagersManagerTypeId) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersManagerTypeId) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersManagerTypeId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersManagerTypeId(val *EmployerManagersManagerTypeId) *NullableEmployerManagersManagerTypeId {
	return &NullableEmployerManagersManagerTypeId{value: val, isSet: true}
}

func (v NullableEmployerManagersManagerTypeId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersManagerTypeId) UnmarshalJSON(src []byte) error {
	v.isSet = true
