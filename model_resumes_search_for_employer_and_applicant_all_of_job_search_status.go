...
// checks if the ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus{}

// ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus Для получения данных нужно передать параметр `with_job_search_status=true` 
type ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus
...
func NewResumesSearchForEmployerAndApplicantAllOfJobSearchStatus(id string, name string) *ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus {
	this := ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) MarshalJSON() ([]byte, error) {
...
func (o ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesSearchForEmployerAndApplicantAllOfJobSearchStatus := _ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesSearchForEmployerAndApplicantAllOfJobSearchStatus)

	if err != nil {
		return err
	}

	*o = ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus(varResumesSearchForEmployerAndApplicantAllOfJobSearchStatus)

	return err
}

type NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus struct {
	value *ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus
	isSet bool
}

func (v NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) Get() *ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus {
	return v.value
}

func (v *NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) Set(val *ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus(val *ResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) *NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus {
	return &NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus{value: val, isSet: true}
}

func (v NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesSearchForEmployerAndApplicantAllOfJobSearchStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
