...
// checks if the ResumeObjectsPaidServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsPaidServices{}

// ResumeObjectsPaidServices struct for ResumeObjectsPaidServices
type ResumeObjectsPaidServices struct {
...
type _ResumeObjectsPaidServices ResumeObjectsPaidServices
...
func NewResumeObjectsPaidServices(active bool, id string, name string) *ResumeObjectsPaidServices {
	this := ResumeObjectsPaidServices{}
	this.Active = active
	this.Id = id
	this.Name = name
	return &this
...
func (o ResumeObjectsPaidServices) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsPaidServices) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsPaidServices) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsPaidServices := _ResumeObjectsPaidServices{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsPaidServices)

	if err != nil {
		return err
	}

	*o = ResumeObjectsPaidServices(varResumeObjectsPaidServices)

	return err
}

type NullableResumeObjectsPaidServices struct {
	value *ResumeObjectsPaidServices
	isSet bool
}

func (v NullableResumeObjectsPaidServices) Get() *ResumeObjectsPaidServices {
	return v.value
}

func (v *NullableResumeObjectsPaidServices) Set(val *ResumeObjectsPaidServices) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsPaidServices) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsPaidServices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsPaidServices(val *ResumeObjectsPaidServices) *NullableResumeObjectsPaidServices {
	return &NullableResumeObjectsPaidServices{value: val, isSet: true}
}

func (v NullableResumeObjectsPaidServices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsPaidServices) UnmarshalJSON(src []byte) error {
	v.isSet = true
