...
// checks if the ResumesMineResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesMineResponse{}

// ResumesMineResponse struct for ResumesMineResponse
type ResumesMineResponse struct {
	// Найдено результатов
	...
	Items []ResumesMineItem `json:"items"`
}

type _ResumesMineResponse ResumesMineResponse
...
func (o ResumesMineResponse) MarshalJSON() ([]byte, error) {
...
func (o ResumesMineResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesMineResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesMineResponse := _ResumesMineResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesMineResponse)

	if err != nil {
		return err
	}

	*o = ResumesMineResponse(varResumesMineResponse)

	return err
}

type NullableResumesMineResponse struct {
	value *ResumesMineResponse
	isSet bool
}

func (v NullableResumesMineResponse) Get() *ResumesMineResponse {
	return v.value
}

func (v *NullableResumesMineResponse) Set(val *ResumesMineResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesMineResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesMineResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesMineResponse(val *ResumesMineResponse) *NullableResumesMineResponse {
	return &NullableResumesMineResponse{value: val, isSet: true}
}

func (v NullableResumesMineResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesMineResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
