...
// checks if the MeEmployerProfileManager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeEmployerProfileManager{}

// MeEmployerProfileManager Информация о пользователе, как о менеджере компании
type MeEmployerProfileManager struct {
	...
	HasMultipleManagerAccounts bool `json:"has_multiple_manager_accounts"`
...
type _MeEmployerProfileManager MeEmployerProfileManager
...
// GetHasAdminRights returns the HasAdminRights field value
func (o *MeEmployerProfileManager) GetHasAdminRights() bool {
	...
	return o.HasAdminRights
}

// GetHasAdminRightsOk returns a tuple with the HasAdminRights field value
// and a boolean to check if the value has been set.
func (o *MeEmployerProfileManager) GetHasAdminRightsOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HasAdminRights, true
}

// SetHasAdminRights sets field value
func (o *MeEmployerProfileManager) SetHasAdminRights(v bool) {
	o.HasAdminRights = v
}

// GetHasMultipleManagerAccounts returns the HasMultipleManagerAccounts field value
func (o *MeEmployerProfileManager) GetHasMultipleManagerAccounts() bool {
	...
	return o.HasMultipleManagerAccounts
}

// GetHasMultipleManagerAccountsOk returns a tuple with the HasMultipleManagerAccounts field value
// and a boolean to check if the value has been set.
func (o *MeEmployerProfileManager) GetHasMultipleManagerAccountsOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HasMultipleManagerAccounts, true
}

// SetHasMultipleManagerAccounts sets field value
func (o *MeEmployerProfileManager) SetHasMultipleManagerAccounts(v bool) {
	o.HasMultipleManagerAccounts = v
}
...
// GetManagerSettingsUrl returns the ManagerSettingsUrl field value
func (o *MeEmployerProfileManager) GetManagerSettingsUrl() string {
	...
	return o.ManagerSettingsUrl
}

// GetManagerSettingsUrlOk returns a tuple with the ManagerSettingsUrl field value
// and a boolean to check if the value has been set.
func (o *MeEmployerProfileManager) GetManagerSettingsUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ManagerSettingsUrl, true
}

// SetManagerSettingsUrl sets field value
func (o *MeEmployerProfileManager) SetManagerSettingsUrl(v string) {
	o.ManagerSettingsUrl = v
}

func (o MeEmployerProfileManager) MarshalJSON() ([]byte, error) {
...
func (o MeEmployerProfileManager) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["has_admin_rights"] = o.HasAdminRights
	toSerialize["has_multiple_manager_accounts"] = o.HasMultipleManagerAccounts
	toSerialize["id"] = o.Id
	toSerialize["is_main_contact_person"] = o.IsMainContactPerson
	toSerialize["manager_settings_url"] = o.ManagerSettingsUrl
	return toSerialize, nil
}

func (o *MeEmployerProfileManager) UnmarshalJSON(data []byte) (err error) {
	...
	varMeEmployerProfileManager := _MeEmployerProfileManager{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMeEmployerProfileManager)

	if err != nil {
		return err
	}

	*o = MeEmployerProfileManager(varMeEmployerProfileManager)

	return err
}

type NullableMeEmployerProfileManager struct {
	value *MeEmployerProfileManager
	isSet bool
}

func (v NullableMeEmployerProfileManager) Get() *MeEmployerProfileManager {
	return v.value
}

func (v *NullableMeEmployerProfileManager) Set(val *MeEmployerProfileManager) {
	v.value = val
	v.isSet = true
}

func (v NullableMeEmployerProfileManager) IsSet() bool {
	return v.isSet
}

func (v *NullableMeEmployerProfileManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeEmployerProfileManager(val *MeEmployerProfileManager) *NullableMeEmployerProfileManager {
	return &NullableMeEmployerProfileManager{value: val, isSet: true}
}

func (v NullableMeEmployerProfileManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeEmployerProfileManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
