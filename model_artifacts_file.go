...
// checks if the ArtifactsFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsFile{}

// ArtifactsFile struct for ArtifactsFile
...
type _ArtifactsFile ArtifactsFile
...
func (o ArtifactsFile) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsFile) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsFile) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsFile := _ArtifactsFile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsFile)

	if err != nil {
		return err
	}

	*o = ArtifactsFile(varArtifactsFile)

	return err
}

type NullableArtifactsFile struct {
	value *ArtifactsFile
	isSet bool
}

func (v NullableArtifactsFile) Get() *ArtifactsFile {
	return v.value
}

func (v *NullableArtifactsFile) Set(val *ArtifactsFile) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsFile) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsFile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsFile(val *ArtifactsFile) *NullableArtifactsFile {
	return &NullableArtifactsFile{value: val, isSet: true}
}

func (v NullableArtifactsFile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsFile) UnmarshalJSON(src []byte) error {
	v.isSet = true
