...
// checks if the EmployerManagersEmployerManagerLimits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersEmployerManagerLimits{}

// EmployerManagersEmployerManagerLimits struct for EmployerManagersEmployerManagerLimits
type EmployerManagersEmployerManagerLimits struct {
	...
	Left EmployerManagersResumeView `json:"left"`
	// Лимит на просмотр резюме
	Limits EmployerManagersResumeView `json:"limits"`
	// Количество просмотренных резюме
	Spend EmployerManagersResumeView `json:"spend"`
}

type _EmployerManagersEmployerManagerLimits EmployerManagersEmployerManagerLimits
...
func NewEmployerManagersEmployerManagerLimits(left EmployerManagersResumeView, limits EmployerManagersResumeView, spend EmployerManagersResumeView) *EmployerManagersEmployerManagerLimits {
	this := EmployerManagersEmployerManagerLimits{}
	this.Left = left
	this.Limits = limits
	this.Spend = spend
	return &this
...
func (o *EmployerManagersEmployerManagerLimits) GetLeft() EmployerManagersResumeView {
	if o == nil {
		var ret EmployerManagersResumeView
		return ret
	}
...
func (o EmployerManagersEmployerManagerLimits) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersEmployerManagerLimits) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersEmployerManagerLimits) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersEmployerManagerLimits := _EmployerManagersEmployerManagerLimits{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersEmployerManagerLimits)

	if err != nil {
		return err
	}

	*o = EmployerManagersEmployerManagerLimits(varEmployerManagersEmployerManagerLimits)

	return err
}

type NullableEmployerManagersEmployerManagerLimits struct {
	value *EmployerManagersEmployerManagerLimits
	isSet bool
}

func (v NullableEmployerManagersEmployerManagerLimits) Get() *EmployerManagersEmployerManagerLimits {
	return v.value
}

func (v *NullableEmployerManagersEmployerManagerLimits) Set(val *EmployerManagersEmployerManagerLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersEmployerManagerLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersEmployerManagerLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersEmployerManagerLimits(val *EmployerManagersEmployerManagerLimits) *NullableEmployerManagersEmployerManagerLimits {
	return &NullableEmployerManagersEmployerManagerLimits{value: val, isSet: true}
}

func (v NullableEmployerManagersEmployerManagerLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersEmployerManagerLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
