...
// checks if the VacanciesMatchListItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesMatchListItems{}

// VacanciesMatchListItems struct for VacanciesMatchListItems
type VacanciesMatchListItems struct {
	// Найдено результатов
	...
	Items []VacanciesMatchListItem `json:"items"`
}

type _VacanciesMatchListItems VacanciesMatchListItems
...
func (o *VacanciesMatchListItems) GetItems() []VacanciesMatchListItem {
	if o == nil {
		var ret []VacanciesMatchListItem
		return ret
	}
...
func (o VacanciesMatchListItems) MarshalJSON() ([]byte, error) {
...
func (o VacanciesMatchListItems) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesMatchListItems) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesMatchListItems := _VacanciesMatchListItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesMatchListItems)

	if err != nil {
		return err
	}

	*o = VacanciesMatchListItems(varVacanciesMatchListItems)

	return err
}

type NullableVacanciesMatchListItems struct {
	value *VacanciesMatchListItems
	isSet bool
}

func (v NullableVacanciesMatchListItems) Get() *VacanciesMatchListItems {
	return v.value
}

func (v *NullableVacanciesMatchListItems) Set(val *VacanciesMatchListItems) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesMatchListItems) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesMatchListItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesMatchListItems(val *VacanciesMatchListItems) *NullableVacanciesMatchListItems {
	return &NullableVacanciesMatchListItems{value: val, isSet: true}
}

func (v NullableVacanciesMatchListItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesMatchListItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
