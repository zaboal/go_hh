...
// checks if the VacancyVideoVacancyCoverPicture type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyVideoVacancyCoverPicture{}

// VacancyVideoVacancyCoverPicture Обложка видео вакансии, либо `null`, если обложка отсутствует
type VacancyVideoVacancyCoverPicture struct {
	// Высота изображения
...
type _VacancyVideoVacancyCoverPicture VacancyVideoVacancyCoverPicture
...
func NewVacancyVideoVacancyCoverPicture(resizedHeight float32, resizedPath string, resizedWidth float32) *VacancyVideoVacancyCoverPicture {
	this := VacancyVideoVacancyCoverPicture{}
...
func (o VacancyVideoVacancyCoverPicture) MarshalJSON() ([]byte, error) {
...
func (o VacancyVideoVacancyCoverPicture) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyVideoVacancyCoverPicture) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyVideoVacancyCoverPicture := _VacancyVideoVacancyCoverPicture{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyVideoVacancyCoverPicture)

	if err != nil {
		return err
	}

	*o = VacancyVideoVacancyCoverPicture(varVacancyVideoVacancyCoverPicture)

	return err
}

type NullableVacancyVideoVacancyCoverPicture struct {
	value *VacancyVideoVacancyCoverPicture
	isSet bool
}

func (v NullableVacancyVideoVacancyCoverPicture) Get() *VacancyVideoVacancyCoverPicture {
	return v.value
}

func (v *NullableVacancyVideoVacancyCoverPicture) Set(val *VacancyVideoVacancyCoverPicture) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyVideoVacancyCoverPicture) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyVideoVacancyCoverPicture) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyVideoVacancyCoverPicture(val *VacancyVideoVacancyCoverPicture) *NullableVacancyVideoVacancyCoverPicture {
	return &NullableVacancyVideoVacancyCoverPicture{value: val, isSet: true}
}

func (v NullableVacancyVideoVacancyCoverPicture) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyVideoVacancyCoverPicture) UnmarshalJSON(src []byte) error {
	v.isSet = true
