...
// checks if the EmployersEmployersList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployersList{}

// EmployersEmployersList struct for EmployersEmployersList
type EmployersEmployersList struct {
	// Найдено результатов
	Found float32 `json:"found"`
	// Найденные работодатели
	Items []EmployersEmployerItem `json:"items"`
	// Номер страницы
...
type _EmployersEmployersList EmployersEmployersList
...
func (o EmployersEmployersList) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployersList) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersEmployersList) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersEmployersList := _EmployersEmployersList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersEmployersList)

	if err != nil {
		return err
	}

	*o = EmployersEmployersList(varEmployersEmployersList)

	return err
}

type NullableEmployersEmployersList struct {
	value *EmployersEmployersList
	isSet bool
}

func (v NullableEmployersEmployersList) Get() *EmployersEmployersList {
	return v.value
}

func (v *NullableEmployersEmployersList) Set(val *EmployersEmployersList) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployersList) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployersList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployersList(val *EmployersEmployersList) *NullableEmployersEmployersList {
	return &NullableEmployersEmployersList{value: val, isSet: true}
}

func (v NullableEmployersEmployersList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployersList) UnmarshalJSON(src []byte) error {
	v.isSet = true
