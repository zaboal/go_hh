...
// checks if the ArtifactsArtifactConditions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsArtifactConditions{}

// ArtifactsArtifactConditions struct for ArtifactsArtifactConditions
type ArtifactsArtifactConditions struct {
	Counters ArtifactsArtifactConditionsCounters `json:"counters"`
	Fields ArtifactsArtifactConditionsFields `json:"fields"`
}

type _ArtifactsArtifactConditions ArtifactsArtifactConditions
...
func NewArtifactsArtifactConditions(counters ArtifactsArtifactConditionsCounters, fields ArtifactsArtifactConditionsFields) *ArtifactsArtifactConditions {
	this := ArtifactsArtifactConditions{}
...
func (o *ArtifactsArtifactConditions) GetCounters() ArtifactsArtifactConditionsCounters {
	if o == nil {
		var ret ArtifactsArtifactConditionsCounters
		return ret
	}
...
func (o *ArtifactsArtifactConditions) GetFields() ArtifactsArtifactConditionsFields {
	if o == nil {
		var ret ArtifactsArtifactConditionsFields
		return ret
	}
...
func (o ArtifactsArtifactConditions) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsArtifactConditions) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsArtifactConditions) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsArtifactConditions := _ArtifactsArtifactConditions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsArtifactConditions)

	if err != nil {
		return err
	}

	*o = ArtifactsArtifactConditions(varArtifactsArtifactConditions)

	return err
}

type NullableArtifactsArtifactConditions struct {
	value *ArtifactsArtifactConditions
	isSet bool
}

func (v NullableArtifactsArtifactConditions) Get() *ArtifactsArtifactConditions {
	return v.value
}

func (v *NullableArtifactsArtifactConditions) Set(val *ArtifactsArtifactConditions) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsArtifactConditions) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsArtifactConditions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsArtifactConditions(val *ArtifactsArtifactConditions) *NullableArtifactsArtifactConditions {
	return &NullableArtifactsArtifactConditions{value: val, isSet: true}
}

func (v NullableArtifactsArtifactConditions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsArtifactConditions) UnmarshalJSON(src []byte) error {
	v.isSet = true
