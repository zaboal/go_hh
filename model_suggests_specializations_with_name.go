...
// checks if the SuggestsSpecializationsWithName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsSpecializationsWithName{}

// SuggestsSpecializationsWithName struct for SuggestsSpecializationsWithName
...
type _SuggestsSpecializationsWithName SuggestsSpecializationsWithName
...
func NewSuggestsSpecializationsWithName(id string, name string, profareaId string, profareaName string) *SuggestsSpecializationsWithName {
	this := SuggestsSpecializationsWithName{}
	this.Id = id
	this.Name = name
...
// GetProfareaId returns the ProfareaId field value
...
// GetProfareaIdOk returns a tuple with the ProfareaId field value
// and a boolean to check if the value has been set.
func (o *SuggestsSpecializationsWithName) GetProfareaIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ProfareaId, true
}

// SetProfareaId sets field value
func (o *SuggestsSpecializationsWithName) SetProfareaId(v string) {
	o.ProfareaId = v
}

// GetProfareaName returns the ProfareaName field value
func (o *SuggestsSpecializationsWithName) GetProfareaName() string {
	...
	return o.ProfareaName
}

// GetProfareaNameOk returns a tuple with the ProfareaName field value
// and a boolean to check if the value has been set.
func (o *SuggestsSpecializationsWithName) GetProfareaNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ProfareaName, true
}

// SetProfareaName sets field value
func (o *SuggestsSpecializationsWithName) SetProfareaName(v string) {
	o.ProfareaName = v
}

func (o SuggestsSpecializationsWithName) MarshalJSON() ([]byte, error) {
...
func (o SuggestsSpecializationsWithName) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["name"] = o.Name
	toSerialize["profarea_id"] = o.ProfareaId
	toSerialize["profarea_name"] = o.ProfareaName
	return toSerialize, nil
}

func (o *SuggestsSpecializationsWithName) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsSpecializationsWithName := _SuggestsSpecializationsWithName{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsSpecializationsWithName)

	if err != nil {
		return err
	}

	*o = SuggestsSpecializationsWithName(varSuggestsSpecializationsWithName)

	return err
}

type NullableSuggestsSpecializationsWithName struct {
	value *SuggestsSpecializationsWithName
	isSet bool
}

func (v NullableSuggestsSpecializationsWithName) Get() *SuggestsSpecializationsWithName {
	return v.value
}

func (v *NullableSuggestsSpecializationsWithName) Set(val *SuggestsSpecializationsWithName) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsSpecializationsWithName) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsSpecializationsWithName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsSpecializationsWithName(val *SuggestsSpecializationsWithName) *NullableSuggestsSpecializationsWithName {
	return &NullableSuggestsSpecializationsWithName{value: val, isSet: true}
}

func (v NullableSuggestsSpecializationsWithName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsSpecializationsWithName) UnmarshalJSON(src []byte) error {
	v.isSet = true
