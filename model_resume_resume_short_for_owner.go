...
// checks if the ResumeResumeShortForOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeShortForOwner{}

// ResumeResumeShortForOwner struct for ResumeResumeShortForOwner
type ResumeResumeShortForOwner struct {
...
type _ResumeResumeShortForOwner ResumeResumeShortForOwner
...
func NewResumeResumeShortForOwner(actions ResumeObjectsActionsForOwner, alternateUrl string, certificate []ResumeObjectsCertificate, createdAt string, download ResumeObjectsDownload, education ResumeObjectsEducation, experience []ResumeObjectsExperienceForOwner, hiddenFields []IncludesIdName, id string, marked bool, updatedAt string, url string) *ResumeResumeShortForOwner {
	this := ResumeResumeShortForOwner{}
...
func (o *ResumeResumeShortForOwner) SetAgeNil() {
	o.Age.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetAutoHideTimeNil() {
...
func (o *ResumeResumeShortForOwner) SetCanViewFullInfoNil() {
...
func (o *ResumeResumeShortForOwner) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetMiddleNameNil() {
...
func (o *ResumeResumeShortForOwner) SetPhotoNil() {
	o.Photo.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *ResumeResumeShortForOwner) SetTotalExperienceNil() {
...
func (o ResumeResumeShortForOwner) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeShortForOwner) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeShortForOwner) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeShortForOwner := _ResumeResumeShortForOwner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeShortForOwner)

	if err != nil {
		return err
	}

	*o = ResumeResumeShortForOwner(varResumeResumeShortForOwner)

	return err
}

type NullableResumeResumeShortForOwner struct {
	value *ResumeResumeShortForOwner
	isSet bool
}

func (v NullableResumeResumeShortForOwner) Get() *ResumeResumeShortForOwner {
	return v.value
}

func (v *NullableResumeResumeShortForOwner) Set(val *ResumeResumeShortForOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeShortForOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeShortForOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeShortForOwner(val *ResumeResumeShortForOwner) *NullableResumeResumeShortForOwner {
	return &NullableResumeResumeShortForOwner{value: val, isSet: true}
}

func (v NullableResumeResumeShortForOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeShortForOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
