...
// checks if the ResumeAddResumeRequestAllOfArea type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeAddResumeRequestAllOfArea{}

// ResumeAddResumeRequestAllOfArea Город проживания. Элемент справочника [areas](#tag/Obshie-spravochniki/operation/get-areas)
type ResumeAddResumeRequestAllOfArea struct {
	// Идентификатор созданного объекта
	Id string `json:"id"`
}

type _ResumeAddResumeRequestAllOfArea ResumeAddResumeRequestAllOfArea
...
func NewResumeAddResumeRequestAllOfArea(id string) *ResumeAddResumeRequestAllOfArea {
	this := ResumeAddResumeRequestAllOfArea{}
	this.Id = id
	return &this
}
...
func (o ResumeAddResumeRequestAllOfArea) MarshalJSON() ([]byte, error) {
...
func (o ResumeAddResumeRequestAllOfArea) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *ResumeAddResumeRequestAllOfArea) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeAddResumeRequestAllOfArea := _ResumeAddResumeRequestAllOfArea{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeAddResumeRequestAllOfArea)

	if err != nil {
		return err
	}

	*o = ResumeAddResumeRequestAllOfArea(varResumeAddResumeRequestAllOfArea)

	return err
}

type NullableResumeAddResumeRequestAllOfArea struct {
	value *ResumeAddResumeRequestAllOfArea
	isSet bool
}

func (v NullableResumeAddResumeRequestAllOfArea) Get() *ResumeAddResumeRequestAllOfArea {
	return v.value
}

func (v *NullableResumeAddResumeRequestAllOfArea) Set(val *ResumeAddResumeRequestAllOfArea) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeAddResumeRequestAllOfArea) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeAddResumeRequestAllOfArea) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeAddResumeRequestAllOfArea(val *ResumeAddResumeRequestAllOfArea) *NullableResumeAddResumeRequestAllOfArea {
	return &NullableResumeAddResumeRequestAllOfArea{value: val, isSet: true}
}

func (v NullableResumeAddResumeRequestAllOfArea) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeAddResumeRequestAllOfArea) UnmarshalJSON(src []byte) error {
	v.isSet = true
