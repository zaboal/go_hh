...
// checks if the VacanciesVacancyConditionFieldsTestCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsTestCondition{}

// VacanciesVacancyConditionFieldsTestCondition struct for VacanciesVacancyConditionFieldsTestCondition
type VacanciesVacancyConditionFieldsTestCondition struct {
	// Является ли поле необходимым?
	Required NullableBool `json:"required,omitempty"`
	Fields NullableVacanciesVacancyConditionFieldsTestFields `json:"fields,omitempty"`
}
...
func NewVacanciesVacancyConditionFieldsTestCondition() *VacanciesVacancyConditionFieldsTestCondition {
	this := VacanciesVacancyConditionFieldsTestCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsTestCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsTestCondition) GetFields() VacanciesVacancyConditionFieldsTestFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret VacanciesVacancyConditionFieldsTestFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableVacanciesVacancyConditionFieldsTestFields and assigns it to the Fields field.
func (o *VacanciesVacancyConditionFieldsTestCondition) SetFields(v VacanciesVacancyConditionFieldsTestFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *VacanciesVacancyConditionFieldsTestCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsTestCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsTestCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsTestCondition struct {
	value *VacanciesVacancyConditionFieldsTestCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsTestCondition) Get() *VacanciesVacancyConditionFieldsTestCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsTestCondition) Set(val *VacanciesVacancyConditionFieldsTestCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsTestCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsTestCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsTestCondition(val *VacanciesVacancyConditionFieldsTestCondition) *NullableVacanciesVacancyConditionFieldsTestCondition {
	return &NullableVacanciesVacancyConditionFieldsTestCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsTestCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsTestCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
