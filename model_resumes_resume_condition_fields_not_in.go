...
// checks if the ResumesResumeConditionFieldsNotIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsNotIn{}

// ResumesResumeConditionFieldsNotIn struct for ResumesResumeConditionFieldsNotIn
type ResumesResumeConditionFieldsNotIn struct {
...
func NewResumesResumeConditionFieldsNotIn() *ResumesResumeConditionFieldsNotIn {
	this := ResumesResumeConditionFieldsNotIn{}
	return &this
}
...
func (o ResumesResumeConditionFieldsNotIn) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsNotIn) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsNotIn struct {
	value *ResumesResumeConditionFieldsNotIn
	isSet bool
}

func (v NullableResumesResumeConditionFieldsNotIn) Get() *ResumesResumeConditionFieldsNotIn {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsNotIn) Set(val *ResumesResumeConditionFieldsNotIn) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsNotIn) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsNotIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsNotIn(val *ResumesResumeConditionFieldsNotIn) *NullableResumesResumeConditionFieldsNotIn {
	return &NullableResumesResumeConditionFieldsNotIn{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsNotIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsNotIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
