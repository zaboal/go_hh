...
// checks if the EmployersFunnelSubstate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersFunnelSubstate{}

// EmployersFunnelSubstate struct for EmployersFunnelSubstate
type EmployersFunnelSubstate struct {
	// Название подстатуса этапа, которое задал работодатель
	Name string `json:"name"`
}

type _EmployersFunnelSubstate EmployersFunnelSubstate
...
func (o EmployersFunnelSubstate) MarshalJSON() ([]byte, error) {
...
func (o EmployersFunnelSubstate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *EmployersFunnelSubstate) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersFunnelSubstate := _EmployersFunnelSubstate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersFunnelSubstate)

	if err != nil {
		return err
	}

	*o = EmployersFunnelSubstate(varEmployersFunnelSubstate)

	return err
}

type NullableEmployersFunnelSubstate struct {
	value *EmployersFunnelSubstate
	isSet bool
}

func (v NullableEmployersFunnelSubstate) Get() *EmployersFunnelSubstate {
	return v.value
}

func (v *NullableEmployersFunnelSubstate) Set(val *EmployersFunnelSubstate) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersFunnelSubstate) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersFunnelSubstate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersFunnelSubstate(val *EmployersFunnelSubstate) *NullableEmployersFunnelSubstate {
	return &NullableEmployersFunnelSubstate{value: val, isSet: true}
}

func (v NullableEmployersFunnelSubstate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersFunnelSubstate) UnmarshalJSON(src []byte) error {
	v.isSet = true
