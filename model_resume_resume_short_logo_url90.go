...
// checks if the ResumeResumeShortLogoUrl90 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeShortLogoUrl90{}

// ResumeResumeShortLogoUrl90 struct for ResumeResumeShortLogoUrl90
type ResumeResumeShortLogoUrl90 struct {
	// URL резюме на сайте
...
type _ResumeResumeShortLogoUrl90 ResumeResumeShortLogoUrl90
...
func NewResumeResumeShortLogoUrl90(alternateUrl string, id string, title NullableString, url string, certificate []ResumeObjectsCertificate, createdAt string, download map[string]interface{}, education map[string]interface{}, experience []ResumeObjectsExperienceLogoUrl90, hiddenFields []IncludesIdName, updatedAt string, actions ResumeObjectsActions, favorited bool, negotiationsHistory ResumeObjectsNegotiationsHistoryUrl, owner ResumeObjectsOwner, viewed bool) *ResumeResumeShortLogoUrl90 {
	this := ResumeResumeShortLogoUrl90{}
...
func (o *ResumeResumeShortLogoUrl90) SetAgeNil() {
	o.Age.Set(nil)
}
...
func (o *ResumeResumeShortLogoUrl90) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumeResumeShortLogoUrl90) SetCanViewFullInfoNil() {
...
func (o *ResumeResumeShortLogoUrl90) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ResumeResumeShortLogoUrl90) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ResumeResumeShortLogoUrl90) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ResumeResumeShortLogoUrl90) SetMiddleNameNil() {
...
func (o *ResumeResumeShortLogoUrl90) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *ResumeResumeShortLogoUrl90) SetTotalExperienceNil() {
...
func (o *ResumeResumeShortLogoUrl90) SetPhotoNil() {
	o.Photo.Set(nil)
}
...
func (o ResumeResumeShortLogoUrl90) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeShortLogoUrl90) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeShortLogoUrl90) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeShortLogoUrl90 := _ResumeResumeShortLogoUrl90{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeShortLogoUrl90)

	if err != nil {
		return err
	}

	*o = ResumeResumeShortLogoUrl90(varResumeResumeShortLogoUrl90)

	return err
}

type NullableResumeResumeShortLogoUrl90 struct {
	value *ResumeResumeShortLogoUrl90
	isSet bool
}

func (v NullableResumeResumeShortLogoUrl90) Get() *ResumeResumeShortLogoUrl90 {
	return v.value
}

func (v *NullableResumeResumeShortLogoUrl90) Set(val *ResumeResumeShortLogoUrl90) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeShortLogoUrl90) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeShortLogoUrl90) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeShortLogoUrl90(val *ResumeResumeShortLogoUrl90) *NullableResumeResumeShortLogoUrl90 {
	return &NullableResumeResumeShortLogoUrl90{value: val, isSet: true}
}

func (v NullableResumeResumeShortLogoUrl90) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeShortLogoUrl90) UnmarshalJSON(src []byte) error {
	v.isSet = true
