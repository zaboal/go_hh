...
// checks if the VacancyPublication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyPublication{}

// VacancyPublication struct for VacancyPublication
type VacancyPublication struct {
	...
	AreasUrl string `json:"areas_url"`
...
type _VacancyPublication VacancyPublication
...
// GetAreasUrl returns the AreasUrl field value
...
// GetAreasUrlOk returns a tuple with the AreasUrl field value
// and a boolean to check if the value has been set.
func (o *VacancyPublication) GetAreasUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AreasUrl, true
}

// SetAreasUrl sets field value
...
func (o VacancyPublication) MarshalJSON() ([]byte, error) {
...
func (o VacancyPublication) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["areas_url"] = o.AreasUrl
	toSerialize["count"] = o.Count
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *VacancyPublication) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyPublication := _VacancyPublication{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyPublication)

	if err != nil {
		return err
	}

	*o = VacancyPublication(varVacancyPublication)

	return err
}

type NullableVacancyPublication struct {
	value *VacancyPublication
	isSet bool
}

func (v NullableVacancyPublication) Get() *VacancyPublication {
	return v.value
}

func (v *NullableVacancyPublication) Set(val *VacancyPublication) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyPublication) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyPublication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyPublication(val *VacancyPublication) *NullableVacancyPublication {
	return &NullableVacancyPublication{value: val, isSet: true}
}

func (v NullableVacancyPublication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyPublication) UnmarshalJSON(src []byte) error {
	v.isSet = true
