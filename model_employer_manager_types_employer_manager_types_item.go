...
// checks if the EmployerManagerTypesEmployerManagerTypesItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagerTypesEmployerManagerTypesItem{}

// EmployerManagerTypesEmployerManagerTypesItem struct for EmployerManagerTypesEmployerManagerTypesItem
type EmployerManagerTypesEmployerManagerTypesItem struct {
	// Список прав, которые можно дать данному типу менеджера
	AvailablePermissions []EmployerManagerTypesAvailablePermissions `json:"available_permissions"`
...
type _EmployerManagerTypesEmployerManagerTypesItem EmployerManagerTypesEmployerManagerTypesItem
...
func NewEmployerManagerTypesEmployerManagerTypesItem(availablePermissions []EmployerManagerTypesAvailablePermissions, id string, name string) *EmployerManagerTypesEmployerManagerTypesItem {
	this := EmployerManagerTypesEmployerManagerTypesItem{}
...
// GetAvailablePermissions returns the AvailablePermissions field value
func (o *EmployerManagerTypesEmployerManagerTypesItem) GetAvailablePermissions() []EmployerManagerTypesAvailablePermissions {
	...
	return o.AvailablePermissions
}

// GetAvailablePermissionsOk returns a tuple with the AvailablePermissions field value
...
func (o EmployerManagerTypesEmployerManagerTypesItem) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagerTypesEmployerManagerTypesItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["available_permissions"] = o.AvailablePermissions
	toSerialize["id"] = o.Id
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *EmployerManagerTypesEmployerManagerTypesItem) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagerTypesEmployerManagerTypesItem := _EmployerManagerTypesEmployerManagerTypesItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagerTypesEmployerManagerTypesItem)

	if err != nil {
		return err
	}

	*o = EmployerManagerTypesEmployerManagerTypesItem(varEmployerManagerTypesEmployerManagerTypesItem)

	return err
}

type NullableEmployerManagerTypesEmployerManagerTypesItem struct {
	value *EmployerManagerTypesEmployerManagerTypesItem
	isSet bool
}

func (v NullableEmployerManagerTypesEmployerManagerTypesItem) Get() *EmployerManagerTypesEmployerManagerTypesItem {
	return v.value
}

func (v *NullableEmployerManagerTypesEmployerManagerTypesItem) Set(val *EmployerManagerTypesEmployerManagerTypesItem) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagerTypesEmployerManagerTypesItem) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagerTypesEmployerManagerTypesItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagerTypesEmployerManagerTypesItem(val *EmployerManagerTypesEmployerManagerTypesItem) *NullableEmployerManagerTypesEmployerManagerTypesItem {
	return &NullableEmployerManagerTypesEmployerManagerTypesItem{value: val, isSet: true}
}

func (v NullableEmployerManagerTypesEmployerManagerTypesItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagerTypesEmployerManagerTypesItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
