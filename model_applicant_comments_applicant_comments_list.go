...
// checks if the ApplicantCommentsApplicantCommentsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicantCommentsApplicantCommentsList{}

// ApplicantCommentsApplicantCommentsList struct for ApplicantCommentsApplicantCommentsList
type ApplicantCommentsApplicantCommentsList struct {
	// Список комментариев
	Items []ApplicantCommentsApplicantCommentItem `json:"items"`
	// Найдено результатов
...
type _ApplicantCommentsApplicantCommentsList ApplicantCommentsApplicantCommentsList
...
func NewApplicantCommentsApplicantCommentsList(items []ApplicantCommentsApplicantCommentItem, found float32, page float32, pages float32, perPage float32) *ApplicantCommentsApplicantCommentsList {
	this := ApplicantCommentsApplicantCommentsList{}
	this.Items = items
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *ApplicantCommentsApplicantCommentsList) GetItems() []ApplicantCommentsApplicantCommentItem {
	if o == nil {
		var ret []ApplicantCommentsApplicantCommentItem
		return ret
	}
...
func (o ApplicantCommentsApplicantCommentsList) MarshalJSON() ([]byte, error) {
...
func (o ApplicantCommentsApplicantCommentsList) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicantCommentsApplicantCommentsList) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicantCommentsApplicantCommentsList := _ApplicantCommentsApplicantCommentsList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicantCommentsApplicantCommentsList)

	if err != nil {
		return err
	}

	*o = ApplicantCommentsApplicantCommentsList(varApplicantCommentsApplicantCommentsList)

	return err
}

type NullableApplicantCommentsApplicantCommentsList struct {
	value *ApplicantCommentsApplicantCommentsList
	isSet bool
}

func (v NullableApplicantCommentsApplicantCommentsList) Get() *ApplicantCommentsApplicantCommentsList {
	return v.value
}

func (v *NullableApplicantCommentsApplicantCommentsList) Set(val *ApplicantCommentsApplicantCommentsList) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicantCommentsApplicantCommentsList) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicantCommentsApplicantCommentsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicantCommentsApplicantCommentsList(val *ApplicantCommentsApplicantCommentsList) *NullableApplicantCommentsApplicantCommentsList {
	return &NullableApplicantCommentsApplicantCommentsList{value: val, isSet: true}
}

func (v NullableApplicantCommentsApplicantCommentsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicantCommentsApplicantCommentsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
