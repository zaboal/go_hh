...
// checks if the ApplicantCommentsApplicantCommentItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicantCommentsApplicantCommentItems{}

// ApplicantCommentsApplicantCommentItems struct for ApplicantCommentsApplicantCommentItems
type ApplicantCommentsApplicantCommentItems struct {
	// Список комментариев
	Items []ApplicantCommentsApplicantCommentItem `json:"items"`
}

type _ApplicantCommentsApplicantCommentItems ApplicantCommentsApplicantCommentItems
...
func NewApplicantCommentsApplicantCommentItems(items []ApplicantCommentsApplicantCommentItem) *ApplicantCommentsApplicantCommentItems {
	this := ApplicantCommentsApplicantCommentItems{}
	this.Items = items
	return &this
}
...
func (o ApplicantCommentsApplicantCommentItems) MarshalJSON() ([]byte, error) {
...
func (o ApplicantCommentsApplicantCommentItems) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ApplicantCommentsApplicantCommentItems) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicantCommentsApplicantCommentItems := _ApplicantCommentsApplicantCommentItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicantCommentsApplicantCommentItems)

	if err != nil {
		return err
	}

	*o = ApplicantCommentsApplicantCommentItems(varApplicantCommentsApplicantCommentItems)

	return err
}

type NullableApplicantCommentsApplicantCommentItems struct {
	value *ApplicantCommentsApplicantCommentItems
	isSet bool
}

func (v NullableApplicantCommentsApplicantCommentItems) Get() *ApplicantCommentsApplicantCommentItems {
	return v.value
}

func (v *NullableApplicantCommentsApplicantCommentItems) Set(val *ApplicantCommentsApplicantCommentItems) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicantCommentsApplicantCommentItems) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicantCommentsApplicantCommentItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicantCommentsApplicantCommentItems(val *ApplicantCommentsApplicantCommentItems) *NullableApplicantCommentsApplicantCommentItems {
	return &NullableApplicantCommentsApplicantCommentItems{value: val, isSet: true}
}

func (v NullableApplicantCommentsApplicantCommentItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicantCommentsApplicantCommentItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
