...
// checks if the ResumesResumeVisibilityListSearchPropertiesItemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeVisibilityListSearchPropertiesItemsInner{}

// ResumesResumeVisibilityListSearchPropertiesItemsInner struct for ResumesResumeVisibilityListSearchPropertiesItemsInner
type ResumesResumeVisibilityListSearchPropertiesItemsInner struct {
	// Ссылка на описание работодателя на сайте
	AlternateUrl string `json:"alternate_url"`
	// Идентификатор работодателя
	Id string `json:"id"`
	LogoUrls IncludesLogoUrls90 `json:"logo_urls"`
...
type _ResumesResumeVisibilityListSearchPropertiesItemsInner ResumesResumeVisibilityListSearchPropertiesItemsInner
...
func NewResumesResumeVisibilityListSearchPropertiesItemsInner(alternateUrl string, id string, logoUrls IncludesLogoUrls90, name string, url string, selected bool) *ResumesResumeVisibilityListSearchPropertiesItemsInner {
	this := ResumesResumeVisibilityListSearchPropertiesItemsInner{}
...
// GetLogoUrlsOk returns a tuple with the LogoUrls field value
// and a boolean to check if the value has been set.
...
func (o ResumesResumeVisibilityListSearchPropertiesItemsInner) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeVisibilityListSearchPropertiesItemsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesResumeVisibilityListSearchPropertiesItemsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeVisibilityListSearchPropertiesItemsInner := _ResumesResumeVisibilityListSearchPropertiesItemsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeVisibilityListSearchPropertiesItemsInner)

	if err != nil {
		return err
	}

	*o = ResumesResumeVisibilityListSearchPropertiesItemsInner(varResumesResumeVisibilityListSearchPropertiesItemsInner)

	return err
}

type NullableResumesResumeVisibilityListSearchPropertiesItemsInner struct {
	value *ResumesResumeVisibilityListSearchPropertiesItemsInner
	isSet bool
}

func (v NullableResumesResumeVisibilityListSearchPropertiesItemsInner) Get() *ResumesResumeVisibilityListSearchPropertiesItemsInner {
	return v.value
}

func (v *NullableResumesResumeVisibilityListSearchPropertiesItemsInner) Set(val *ResumesResumeVisibilityListSearchPropertiesItemsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeVisibilityListSearchPropertiesItemsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeVisibilityListSearchPropertiesItemsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeVisibilityListSearchPropertiesItemsInner(val *ResumesResumeVisibilityListSearchPropertiesItemsInner) *NullableResumesResumeVisibilityListSearchPropertiesItemsInner {
	return &NullableResumesResumeVisibilityListSearchPropertiesItemsInner{value: val, isSet: true}
}

func (v NullableResumesResumeVisibilityListSearchPropertiesItemsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeVisibilityListSearchPropertiesItemsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
