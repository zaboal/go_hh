...
// checks if the MeAnyProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeAnyProfile{}
...
func NewMeAnyProfile(authType NullableString, isAdmin bool, isApplicant bool, isApplication bool, isEmployer bool, isEmployerIntegration bool) *MeAnyProfile {
	this := MeAnyProfile{}
...
func (o MeAnyProfile) MarshalJSON() ([]byte, error) {
...
func (o MeAnyProfile) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	return toSerialize, nil
}

func (o *MeAnyProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varMeAnyProfile := _MeAnyProfile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMeAnyProfile)

	if err != nil {
		return err
	}

	*o = MeAnyProfile(varMeAnyProfile)

	return err
}

type NullableMeAnyProfile struct {
	value *MeAnyProfile
	isSet bool
}

func (v NullableMeAnyProfile) Get() *MeAnyProfile {
	return v.value
}

func (v *NullableMeAnyProfile) Set(val *MeAnyProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableMeAnyProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableMeAnyProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeAnyProfile(val *MeAnyProfile) *NullableMeAnyProfile {
	return &NullableMeAnyProfile{value: val, isSet: true}
}

func (v NullableMeAnyProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeAnyProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
