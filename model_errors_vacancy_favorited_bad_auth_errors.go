...
// checks if the ErrorsVacancyFavoritedBadAuthErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyFavoritedBadAuthErrors{}

// ErrorsVacancyFavoritedBadAuthErrors Информация о возникших ошибках
type ErrorsVacancyFavoritedBadAuthErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Описание ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsVacancyFavoritedBadAuthError `json:"errors"`
}

type _ErrorsVacancyFavoritedBadAuthErrors ErrorsVacancyFavoritedBadAuthErrors
...
func NewErrorsVacancyFavoritedBadAuthErrors(requestId string, errors []ErrorsVacancyFavoritedBadAuthError) *ErrorsVacancyFavoritedBadAuthErrors {
	this := ErrorsVacancyFavoritedBadAuthErrors{}
...
func (o *ErrorsVacancyFavoritedBadAuthErrors) GetErrors() []ErrorsVacancyFavoritedBadAuthError {
	if o == nil {
		var ret []ErrorsVacancyFavoritedBadAuthError
		return ret
	}
...
func (o ErrorsVacancyFavoritedBadAuthErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyFavoritedBadAuthErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyFavoritedBadAuthErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyFavoritedBadAuthErrors := _ErrorsVacancyFavoritedBadAuthErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyFavoritedBadAuthErrors)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyFavoritedBadAuthErrors(varErrorsVacancyFavoritedBadAuthErrors)

	return err
}

type NullableErrorsVacancyFavoritedBadAuthErrors struct {
	value *ErrorsVacancyFavoritedBadAuthErrors
	isSet bool
}

func (v NullableErrorsVacancyFavoritedBadAuthErrors) Get() *ErrorsVacancyFavoritedBadAuthErrors {
	return v.value
}

func (v *NullableErrorsVacancyFavoritedBadAuthErrors) Set(val *ErrorsVacancyFavoritedBadAuthErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyFavoritedBadAuthErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyFavoritedBadAuthErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyFavoritedBadAuthErrors(val *ErrorsVacancyFavoritedBadAuthErrors) *NullableErrorsVacancyFavoritedBadAuthErrors {
	return &NullableErrorsVacancyFavoritedBadAuthErrors{value: val, isSet: true}
}

func (v NullableErrorsVacancyFavoritedBadAuthErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyFavoritedBadAuthErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
