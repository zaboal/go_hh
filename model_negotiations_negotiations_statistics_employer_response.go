...
// checks if the NegotiationsNegotiationsStatisticsEmployerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationsStatisticsEmployerResponse{}

// NegotiationsNegotiationsStatisticsEmployerResponse struct for NegotiationsNegotiationsStatisticsEmployerResponse
type NegotiationsNegotiationsStatisticsEmployerResponse struct {
	EmployerStatistics NegotiationsNegotiationsStatistics `json:"employer_statistics"`
}

type _NegotiationsNegotiationsStatisticsEmployerResponse NegotiationsNegotiationsStatisticsEmployerResponse
...
func NewNegotiationsNegotiationsStatisticsEmployerResponse(employerStatistics NegotiationsNegotiationsStatistics) *NegotiationsNegotiationsStatisticsEmployerResponse {
	this := NegotiationsNegotiationsStatisticsEmployerResponse{}
...
// GetEmployerStatistics returns the EmployerStatistics field value
func (o *NegotiationsNegotiationsStatisticsEmployerResponse) GetEmployerStatistics() NegotiationsNegotiationsStatistics {
	if o == nil {
		var ret NegotiationsNegotiationsStatistics
		return ret
	}

	return o.EmployerStatistics
}

// GetEmployerStatisticsOk returns a tuple with the EmployerStatistics field value
...
func (o *NegotiationsNegotiationsStatisticsEmployerResponse) GetEmployerStatisticsOk() (*NegotiationsNegotiationsStatistics, bool) {
	...
	return &o.EmployerStatistics, true
}

// SetEmployerStatistics sets field value
func (o *NegotiationsNegotiationsStatisticsEmployerResponse) SetEmployerStatistics(v NegotiationsNegotiationsStatistics) {
	o.EmployerStatistics = v
}

func (o NegotiationsNegotiationsStatisticsEmployerResponse) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationsStatisticsEmployerResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["employer_statistics"] = o.EmployerStatistics
	return toSerialize, nil
}

func (o *NegotiationsNegotiationsStatisticsEmployerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationsStatisticsEmployerResponse := _NegotiationsNegotiationsStatisticsEmployerResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationsStatisticsEmployerResponse)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationsStatisticsEmployerResponse(varNegotiationsNegotiationsStatisticsEmployerResponse)

	return err
}

type NullableNegotiationsNegotiationsStatisticsEmployerResponse struct {
	value *NegotiationsNegotiationsStatisticsEmployerResponse
	isSet bool
}

func (v NullableNegotiationsNegotiationsStatisticsEmployerResponse) Get() *NegotiationsNegotiationsStatisticsEmployerResponse {
	return v.value
}

func (v *NullableNegotiationsNegotiationsStatisticsEmployerResponse) Set(val *NegotiationsNegotiationsStatisticsEmployerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationsStatisticsEmployerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationsStatisticsEmployerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationsStatisticsEmployerResponse(val *NegotiationsNegotiationsStatisticsEmployerResponse) *NullableNegotiationsNegotiationsStatisticsEmployerResponse {
	return &NullableNegotiationsNegotiationsStatisticsEmployerResponse{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationsStatisticsEmployerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationsStatisticsEmployerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
