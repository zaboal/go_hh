...
// checks if the ResumeObjectsExperienceLogoUrl90 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsExperienceLogoUrl90{}
...
type _ResumeObjectsExperienceLogoUrl90 ResumeObjectsExperienceLogoUrl90
...
func NewResumeObjectsExperienceLogoUrl90(industries []IncludesIdName, position string, start string) *ResumeObjectsExperienceLogoUrl90 {
	this := ResumeObjectsExperienceLogoUrl90{}
...
func (o *ResumeObjectsExperienceLogoUrl90) SetCompanyNil() {
	o.Company.Set(nil)
}
...
func (o *ResumeObjectsExperienceLogoUrl90) SetCompanyIdNil() {
	o.CompanyId.Set(nil)
}
...
func (o *ResumeObjectsExperienceLogoUrl90) SetCompanyUrlNil() {
...
func (o *ResumeObjectsExperienceLogoUrl90) SetDescriptionNil() {
...
func (o *ResumeObjectsExperienceLogoUrl90) SetEndNil() {
	o.End.Set(nil)
}
...
func (o ResumeObjectsExperienceLogoUrl90) MarshalJSON() ([]byte, error) {
...
func (o *ResumeObjectsExperienceLogoUrl90) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsExperienceLogoUrl90 := _ResumeObjectsExperienceLogoUrl90{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsExperienceLogoUrl90)

	if err != nil {
		return err
	}

	*o = ResumeObjectsExperienceLogoUrl90(varResumeObjectsExperienceLogoUrl90)

	return err
}

type NullableResumeObjectsExperienceLogoUrl90 struct {
	value *ResumeObjectsExperienceLogoUrl90
	isSet bool
}

func (v NullableResumeObjectsExperienceLogoUrl90) Get() *ResumeObjectsExperienceLogoUrl90 {
	return v.value
}

func (v *NullableResumeObjectsExperienceLogoUrl90) Set(val *ResumeObjectsExperienceLogoUrl90) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsExperienceLogoUrl90) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsExperienceLogoUrl90) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsExperienceLogoUrl90(val *ResumeObjectsExperienceLogoUrl90) *NullableResumeObjectsExperienceLogoUrl90 {
	return &NullableResumeObjectsExperienceLogoUrl90{value: val, isSet: true}
}

func (v NullableResumeObjectsExperienceLogoUrl90) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsExperienceLogoUrl90) UnmarshalJSON(src []byte) error {
	v.isSet = true
