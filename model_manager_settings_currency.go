...
// checks if the ManagerSettingsCurrency type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagerSettingsCurrency{}

// ManagerSettingsCurrency Предпочитаемая валюта при [публикации вакансии](#tag/Upravlenie-vakansiyami/operation/publish-vacancy) 
type ManagerSettingsCurrency struct {
...
type _ManagerSettingsCurrency ManagerSettingsCurrency
...
func (o ManagerSettingsCurrency) MarshalJSON() ([]byte, error) {
...
func (o ManagerSettingsCurrency) ToMap() (map[string]interface{}, error) {
...
func (o *ManagerSettingsCurrency) UnmarshalJSON(data []byte) (err error) {
	...
	varManagerSettingsCurrency := _ManagerSettingsCurrency{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagerSettingsCurrency)

	if err != nil {
		return err
	}

	*o = ManagerSettingsCurrency(varManagerSettingsCurrency)

	return err
}

type NullableManagerSettingsCurrency struct {
	value *ManagerSettingsCurrency
	isSet bool
}

func (v NullableManagerSettingsCurrency) Get() *ManagerSettingsCurrency {
	return v.value
}

func (v *NullableManagerSettingsCurrency) Set(val *ManagerSettingsCurrency) {
	v.value = val
	v.isSet = true
}

func (v NullableManagerSettingsCurrency) IsSet() bool {
	return v.isSet
}

func (v *NullableManagerSettingsCurrency) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagerSettingsCurrency(val *ManagerSettingsCurrency) *NullableManagerSettingsCurrency {
	return &NullableManagerSettingsCurrency{value: val, isSet: true}
}

func (v NullableManagerSettingsCurrency) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagerSettingsCurrency) UnmarshalJSON(src []byte) error {
	v.isSet = true
