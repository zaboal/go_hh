...
// checks if the ResumeObjectsEducation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsEducation{}

// ResumeObjectsEducation struct for ResumeObjectsEducation
type ResumeObjectsEducation struct {
...
func (o ResumeObjectsEducation) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsEducation) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsEducation) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsEducation := _ResumeObjectsEducation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsEducation)

	if err != nil {
		return err
	}

	*o = ResumeObjectsEducation(varResumeObjectsEducation)

	return err
}

type NullableResumeObjectsEducation struct {
	value *ResumeObjectsEducation
	isSet bool
}

func (v NullableResumeObjectsEducation) Get() *ResumeObjectsEducation {
	return v.value
}

func (v *NullableResumeObjectsEducation) Set(val *ResumeObjectsEducation) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsEducation) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsEducation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsEducation(val *ResumeObjectsEducation) *NullableResumeObjectsEducation {
	return &NullableResumeObjectsEducation{value: val, isSet: true}
}

func (v NullableResumeObjectsEducation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsEducation) UnmarshalJSON(src []byte) error {
	v.isSet = true
