...
// checks if the SkillVerificationsTestResultTasks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkillVerificationsTestResultTasks{}

// SkillVerificationsTestResultTasks struct for SkillVerificationsTestResultTasks
type SkillVerificationsTestResultTasks struct {
	// Варианты ответов на закрытые вопросы
	ClosedAnswers []SkillVerificationsTestResultTasksClosedAnswersInner `json:"closed_answers"`
	OpenedAnswer NullableSkillVerificationsOpenedAnswer `json:"opened_answer,omitempty"`
	// Текст вопроса
	Question string `json:"question"`
}

type _SkillVerificationsTestResultTasks SkillVerificationsTestResultTasks
...
func NewSkillVerificationsTestResultTasks(closedAnswers []SkillVerificationsTestResultTasksClosedAnswersInner, question string) *SkillVerificationsTestResultTasks {
	this := SkillVerificationsTestResultTasks{}
...
// GetClosedAnswers returns the ClosedAnswers field value
func (o *SkillVerificationsTestResultTasks) GetClosedAnswers() []SkillVerificationsTestResultTasksClosedAnswersInner {
	if o == nil {
		var ret []SkillVerificationsTestResultTasksClosedAnswersInner
		return ret
	}

	return o.ClosedAnswers
}

// GetClosedAnswersOk returns a tuple with the ClosedAnswers field value
...
func (o *SkillVerificationsTestResultTasks) GetClosedAnswersOk() ([]SkillVerificationsTestResultTasksClosedAnswersInner, bool) {
	...
	return o.ClosedAnswers, true
}

// SetClosedAnswers sets field value
func (o *SkillVerificationsTestResultTasks) SetClosedAnswers(v []SkillVerificationsTestResultTasksClosedAnswersInner) {
	o.ClosedAnswers = v
}

// GetOpenedAnswer returns the OpenedAnswer field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SkillVerificationsTestResultTasks) GetOpenedAnswer() SkillVerificationsOpenedAnswer {
	if o == nil || IsNil(o.OpenedAnswer.Get()) {
		var ret SkillVerificationsOpenedAnswer
		return ret
	}
	return *o.OpenedAnswer.Get()
}

// GetOpenedAnswerOk returns a tuple with the OpenedAnswer field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetOpenedAnswer gets a reference to the given NullableSkillVerificationsOpenedAnswer and assigns it to the OpenedAnswer field.
func (o *SkillVerificationsTestResultTasks) SetOpenedAnswer(v SkillVerificationsOpenedAnswer) {
	o.OpenedAnswer.Set(&v)
}
// SetOpenedAnswerNil sets the value for OpenedAnswer to be an explicit nil
func (o *SkillVerificationsTestResultTasks) SetOpenedAnswerNil() {
	o.OpenedAnswer.Set(nil)
}
...
func (o SkillVerificationsTestResultTasks) MarshalJSON() ([]byte, error) {
...
func (o SkillVerificationsTestResultTasks) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["closed_answers"] = o.ClosedAnswers
	if o.OpenedAnswer.IsSet() {
		toSerialize["opened_answer"] = o.OpenedAnswer.Get()
	}
	toSerialize["question"] = o.Question
	return toSerialize, nil
}

func (o *SkillVerificationsTestResultTasks) UnmarshalJSON(data []byte) (err error) {
	...
	varSkillVerificationsTestResultTasks := _SkillVerificationsTestResultTasks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSkillVerificationsTestResultTasks)

	if err != nil {
		return err
	}

	*o = SkillVerificationsTestResultTasks(varSkillVerificationsTestResultTasks)

	return err
}

type NullableSkillVerificationsTestResultTasks struct {
	value *SkillVerificationsTestResultTasks
	isSet bool
}

func (v NullableSkillVerificationsTestResultTasks) Get() *SkillVerificationsTestResultTasks {
	return v.value
}

func (v *NullableSkillVerificationsTestResultTasks) Set(val *SkillVerificationsTestResultTasks) {
	v.value = val
	v.isSet = true
}

func (v NullableSkillVerificationsTestResultTasks) IsSet() bool {
	return v.isSet
}

func (v *NullableSkillVerificationsTestResultTasks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkillVerificationsTestResultTasks(val *SkillVerificationsTestResultTasks) *NullableSkillVerificationsTestResultTasks {
	return &NullableSkillVerificationsTestResultTasks{value: val, isSet: true}
}

func (v NullableSkillVerificationsTestResultTasks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkillVerificationsTestResultTasks) UnmarshalJSON(src []byte) error {
	v.isSet = true
