...
// checks if the VacancyEmploymentOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyEmploymentOutput{}

// VacancyEmploymentOutput struct for VacancyEmploymentOutput
type VacancyEmploymentOutput struct {
...
func (o *VacancyEmploymentOutput) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o VacancyEmploymentOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyEmploymentOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyEmploymentOutput struct {
	value *VacancyEmploymentOutput
	isSet bool
}

func (v NullableVacancyEmploymentOutput) Get() *VacancyEmploymentOutput {
	return v.value
}

func (v *NullableVacancyEmploymentOutput) Set(val *VacancyEmploymentOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyEmploymentOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyEmploymentOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyEmploymentOutput(val *VacancyEmploymentOutput) *NullableVacancyEmploymentOutput {
	return &NullableVacancyEmploymentOutput{value: val, isSet: true}
}

func (v NullableVacancyEmploymentOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyEmploymentOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
