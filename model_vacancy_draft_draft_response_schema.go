...
// checks if the VacancyDraftDraftResponseSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftDraftResponseSchema{}

// VacancyDraftDraftResponseSchema struct for VacancyDraftDraftResponseSchema
type VacancyDraftDraftResponseSchema struct {
	...
	ValidationErrors []VacancyDraftDraftVacancyError `json:"validation_errors,omitempty"`
}

type _VacancyDraftDraftResponseSchema VacancyDraftDraftResponseSchema
...
func NewVacancyDraftDraftResponseSchema(id string, name string, publicationReady bool) *VacancyDraftDraftResponseSchema {
	this := VacancyDraftDraftResponseSchema{}
	this.Id = id
	this.Name = name
...
// GetIgnoredFields returns the IgnoredFields field value if set, zero value otherwise.
func (o *VacancyDraftDraftResponseSchema) GetIgnoredFields() []string {
	if o == nil || IsNil(o.IgnoredFields) {
		var ret []string
		return ret
	}
	return o.IgnoredFields
}

// GetIgnoredFieldsOk returns a tuple with the IgnoredFields field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VacancyDraftDraftResponseSchema) GetIgnoredFieldsOk() ([]string, bool) {
	if o == nil || IsNil(o.IgnoredFields) {
		return nil, false
	}
	return o.IgnoredFields, true
}
...
// SetIgnoredFields gets a reference to the given []string and assigns it to the IgnoredFields field.
...
func (o *VacancyDraftDraftResponseSchema) GetValidationErrors() []VacancyDraftDraftVacancyError {
	if o == nil || IsNil(o.ValidationErrors) {
		var ret []VacancyDraftDraftVacancyError
		return ret
	}
...
// SetValidationErrors gets a reference to the given []VacancyDraftDraftVacancyError and assigns it to the ValidationErrors field.
func (o *VacancyDraftDraftResponseSchema) SetValidationErrors(v []VacancyDraftDraftVacancyError) {
	o.ValidationErrors = v
}

func (o VacancyDraftDraftResponseSchema) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftDraftResponseSchema) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	if !IsNil(o.IgnoredFields) {
		toSerialize["ignored_fields"] = o.IgnoredFields
	}
...
func (o *VacancyDraftDraftResponseSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDraftDraftResponseSchema := _VacancyDraftDraftResponseSchema{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDraftDraftResponseSchema)

	if err != nil {
		return err
	}

	*o = VacancyDraftDraftResponseSchema(varVacancyDraftDraftResponseSchema)

	return err
}

type NullableVacancyDraftDraftResponseSchema struct {
	value *VacancyDraftDraftResponseSchema
	isSet bool
}

func (v NullableVacancyDraftDraftResponseSchema) Get() *VacancyDraftDraftResponseSchema {
	return v.value
}

func (v *NullableVacancyDraftDraftResponseSchema) Set(val *VacancyDraftDraftResponseSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftDraftResponseSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftDraftResponseSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftDraftResponseSchema(val *VacancyDraftDraftResponseSchema) *NullableVacancyDraftDraftResponseSchema {
	return &NullableVacancyDraftDraftResponseSchema{value: val, isSet: true}
}

func (v NullableVacancyDraftDraftResponseSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftDraftResponseSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
