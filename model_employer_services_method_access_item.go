...
// checks if the EmployerServicesMethodAccessItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerServicesMethodAccessItem{}

// EmployerServicesMethodAccessItem struct for EmployerServicesMethodAccessItem
type EmployerServicesMethodAccessItem struct {
	Access EmployerServicesMethodAccessItemAccess `json:"access"`
...
type _EmployerServicesMethodAccessItem EmployerServicesMethodAccessItem
...
func NewEmployerServicesMethodAccessItem(access EmployerServicesMethodAccessItemAccess, description string, id string) *EmployerServicesMethodAccessItem {
	this := EmployerServicesMethodAccessItem{}
	this.Access = access
...
func (o *EmployerServicesMethodAccessItem) GetAccess() EmployerServicesMethodAccessItemAccess {
	if o == nil {
		var ret EmployerServicesMethodAccessItemAccess
		return ret
	}
...
func (o EmployerServicesMethodAccessItem) MarshalJSON() ([]byte, error) {
...
func (o EmployerServicesMethodAccessItem) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerServicesMethodAccessItem) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerServicesMethodAccessItem := _EmployerServicesMethodAccessItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerServicesMethodAccessItem)

	if err != nil {
		return err
	}

	*o = EmployerServicesMethodAccessItem(varEmployerServicesMethodAccessItem)

	return err
}

type NullableEmployerServicesMethodAccessItem struct {
	value *EmployerServicesMethodAccessItem
	isSet bool
}

func (v NullableEmployerServicesMethodAccessItem) Get() *EmployerServicesMethodAccessItem {
	return v.value
}

func (v *NullableEmployerServicesMethodAccessItem) Set(val *EmployerServicesMethodAccessItem) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerServicesMethodAccessItem) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerServicesMethodAccessItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerServicesMethodAccessItem(val *EmployerServicesMethodAccessItem) *NullableEmployerServicesMethodAccessItem {
	return &NullableEmployerServicesMethodAccessItem{value: val, isSet: true}
}

func (v NullableEmployerServicesMethodAccessItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerServicesMethodAccessItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
