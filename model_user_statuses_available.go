...
// checks if the UserStatusesAvailable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserStatusesAvailable{}

// UserStatusesAvailable struct for UserStatusesAvailable
type UserStatusesAvailable struct {
	JobSearchStatuses []UserStatusesJobSearchStatusDictionary `json:"job_search_statuses,omitempty"`
	...
	WhenCanStartWorkStatuses []UserStatusesWhenCanStartWorkStatus `json:"when_can_start_work_statuses,omitempty"`
}

type _UserStatusesAvailable UserStatusesAvailable
...
// GetJobSearchStatuses returns the JobSearchStatuses field value if set, zero value otherwise.
func (o *UserStatusesAvailable) GetJobSearchStatuses() []UserStatusesJobSearchStatusDictionary {
	if o == nil || IsNil(o.JobSearchStatuses) {
		var ret []UserStatusesJobSearchStatusDictionary
		return ret
	}
	return o.JobSearchStatuses
}

// GetJobSearchStatusesOk returns a tuple with the JobSearchStatuses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusesAvailable) GetJobSearchStatusesOk() ([]UserStatusesJobSearchStatusDictionary, bool) {
	if o == nil || IsNil(o.JobSearchStatuses) {
		return nil, false
	}
	return o.JobSearchStatuses, true
}
...
// SetJobSearchStatuses gets a reference to the given []UserStatusesJobSearchStatusDictionary and assigns it to the JobSearchStatuses field.
func (o *UserStatusesAvailable) SetJobSearchStatuses(v []UserStatusesJobSearchStatusDictionary) {
	o.JobSearchStatuses = v
}
...
// GetWhenCanStartWorkStatuses returns the WhenCanStartWorkStatuses field value if set, zero value otherwise.
func (o *UserStatusesAvailable) GetWhenCanStartWorkStatuses() []UserStatusesWhenCanStartWorkStatus {
	if o == nil || IsNil(o.WhenCanStartWorkStatuses) {
		var ret []UserStatusesWhenCanStartWorkStatus
		return ret
	}
	return o.WhenCanStartWorkStatuses
}

// GetWhenCanStartWorkStatusesOk returns a tuple with the WhenCanStartWorkStatuses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserStatusesAvailable) GetWhenCanStartWorkStatusesOk() ([]UserStatusesWhenCanStartWorkStatus, bool) {
	if o == nil || IsNil(o.WhenCanStartWorkStatuses) {
		return nil, false
	}
	return o.WhenCanStartWorkStatuses, true
}
...
// SetWhenCanStartWorkStatuses gets a reference to the given []UserStatusesWhenCanStartWorkStatus and assigns it to the WhenCanStartWorkStatuses field.
func (o *UserStatusesAvailable) SetWhenCanStartWorkStatuses(v []UserStatusesWhenCanStartWorkStatus) {
	o.WhenCanStartWorkStatuses = v
}

func (o UserStatusesAvailable) MarshalJSON() ([]byte, error) {
...
func (o UserStatusesAvailable) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.JobSearchStatuses) {
		toSerialize["job_search_statuses"] = o.JobSearchStatuses
	}
	...
	if !IsNil(o.WhenCanStartWorkStatuses) {
		toSerialize["when_can_start_work_statuses"] = o.WhenCanStartWorkStatuses
	}
	return toSerialize, nil
}

func (o *UserStatusesAvailable) UnmarshalJSON(data []byte) (err error) {
	...
	varUserStatusesAvailable := _UserStatusesAvailable{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserStatusesAvailable)

	if err != nil {
		return err
	}

	*o = UserStatusesAvailable(varUserStatusesAvailable)

	return err
}

type NullableUserStatusesAvailable struct {
	value *UserStatusesAvailable
	isSet bool
}

func (v NullableUserStatusesAvailable) Get() *UserStatusesAvailable {
	return v.value
}

func (v *NullableUserStatusesAvailable) Set(val *UserStatusesAvailable) {
	v.value = val
	v.isSet = true
}

func (v NullableUserStatusesAvailable) IsSet() bool {
	return v.isSet
}

func (v *NullableUserStatusesAvailable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserStatusesAvailable(val *UserStatusesAvailable) *NullableUserStatusesAvailable {
	return &NullableUserStatusesAvailable{value: val, isSet: true}
}

func (v NullableUserStatusesAvailable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserStatusesAvailable) UnmarshalJSON(src []byte) error {
	v.isSet = true
