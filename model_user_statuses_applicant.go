...
// checks if the UserStatusesApplicant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserStatusesApplicant{}
...
func (o *UserStatusesApplicant) GetJobSearchStatus() UserStatusesJobSearchStatus {
	if o == nil || IsNil(o.JobSearchStatus) {
		var ret UserStatusesJobSearchStatus
		return ret
	}
...
// SetJobSearchStatus gets a reference to the given UserStatusesJobSearchStatus and assigns it to the JobSearchStatus field.
...
func (o UserStatusesApplicant) ToMap() (map[string]interface{}, error) {
...
type NullableUserStatusesApplicant struct {
	value *UserStatusesApplicant
	isSet bool
}

func (v NullableUserStatusesApplicant) Get() *UserStatusesApplicant {
	return v.value
}

func (v *NullableUserStatusesApplicant) Set(val *UserStatusesApplicant) {
	v.value = val
	v.isSet = true
}

func (v NullableUserStatusesApplicant) IsSet() bool {
	return v.isSet
}

func (v *NullableUserStatusesApplicant) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserStatusesApplicant(val *UserStatusesApplicant) *NullableUserStatusesApplicant {
	return &NullableUserStatusesApplicant{value: val, isSet: true}
}

func (v NullableUserStatusesApplicant) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserStatusesApplicant) UnmarshalJSON(src []byte) error {
	v.isSet = true
