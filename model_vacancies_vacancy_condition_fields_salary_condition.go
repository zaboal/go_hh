...
// checks if the VacanciesVacancyConditionFieldsSalaryCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsSalaryCondition{}

// VacanciesVacancyConditionFieldsSalaryCondition struct for VacanciesVacancyConditionFieldsSalaryCondition
type VacanciesVacancyConditionFieldsSalaryCondition struct {
	// Является ли поле необходимым?
	Required NullableBool `json:"required,omitempty"`
	Fields NullableVacanciesVacancyConditionFieldsSalaryFields `json:"fields,omitempty"`
}
...
func NewVacanciesVacancyConditionFieldsSalaryCondition() *VacanciesVacancyConditionFieldsSalaryCondition {
	this := VacanciesVacancyConditionFieldsSalaryCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsSalaryCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsSalaryCondition) GetFields() VacanciesVacancyConditionFieldsSalaryFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret VacanciesVacancyConditionFieldsSalaryFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableVacanciesVacancyConditionFieldsSalaryFields and assigns it to the Fields field.
...
func (o *VacanciesVacancyConditionFieldsSalaryCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsSalaryCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsSalaryCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsSalaryCondition struct {
	value *VacanciesVacancyConditionFieldsSalaryCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsSalaryCondition) Get() *VacanciesVacancyConditionFieldsSalaryCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsSalaryCondition) Set(val *VacanciesVacancyConditionFieldsSalaryCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsSalaryCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsSalaryCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsSalaryCondition(val *VacanciesVacancyConditionFieldsSalaryCondition) *NullableVacanciesVacancyConditionFieldsSalaryCondition {
	return &NullableVacanciesVacancyConditionFieldsSalaryCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsSalaryCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsSalaryCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
