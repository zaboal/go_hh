...
// checks if the NegotiationsNegotiationGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationGetResponse{}
...
type _NegotiationsNegotiationGetResponse NegotiationsNegotiationGetResponse
...
func NewNegotiationsNegotiationGetResponse(createdAt string, declineAllowed bool, hasUpdates bool, hidden bool, id string, messagingStatus string, source string, state IncludesIdName, updatedAt string, url string, viewedByOpponent bool) *NegotiationsNegotiationGetResponse {
	this := NegotiationsNegotiationGetResponse{}
...
func (o *NegotiationsNegotiationGetResponse) SetResumeNil() {
	o.Resume.Set(nil)
}
...
func (o NegotiationsNegotiationGetResponse) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsNegotiationGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationGetResponse := _NegotiationsNegotiationGetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationGetResponse)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationGetResponse(varNegotiationsNegotiationGetResponse)
