...
// NegotiationsNegotiationGetResponse struct for NegotiationsNegotiationGetResponse
type NegotiationsNegotiationGetResponse struct {
	NegotiationsApplicantNegotiation *NegotiationsApplicantNegotiation
	NegotiationsEmployerNegotiation *NegotiationsEmployerNegotiation
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *NegotiationsNegotiationGetResponse) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into NegotiationsApplicantNegotiation
	err = json.Unmarshal(data, &dst.NegotiationsApplicantNegotiation);
	if err == nil {
		jsonNegotiationsApplicantNegotiation, _ := json.Marshal(dst.NegotiationsApplicantNegotiation)
		if string(jsonNegotiationsApplicantNegotiation) == "{}" { // empty struct
			dst.NegotiationsApplicantNegotiation = nil
		} else {
			return nil // data stored in dst.NegotiationsApplicantNegotiation, return on the first match
		}
	} else {
		dst.NegotiationsApplicantNegotiation = nil
	}

	// try to unmarshal JSON data into NegotiationsEmployerNegotiation
	err = json.Unmarshal(data, &dst.NegotiationsEmployerNegotiation);
	if err == nil {
		jsonNegotiationsEmployerNegotiation, _ := json.Marshal(dst.NegotiationsEmployerNegotiation)
		if string(jsonNegotiationsEmployerNegotiation) == "{}" { // empty struct
			dst.NegotiationsEmployerNegotiation = nil
		} else {
			return nil // data stored in dst.NegotiationsEmployerNegotiation, return on the first match
		}
	} else {
		dst.NegotiationsEmployerNegotiation = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(NegotiationsNegotiationGetResponse)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *NegotiationsNegotiationGetResponse) MarshalJSON() ([]byte, error) {
	if src.NegotiationsApplicantNegotiation != nil {
		return json.Marshal(&src.NegotiationsApplicantNegotiation)
	}

	if src.NegotiationsEmployerNegotiation != nil {
		return json.Marshal(&src.NegotiationsEmployerNegotiation)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableNegotiationsNegotiationGetResponse struct {
	value *NegotiationsNegotiationGetResponse
	isSet bool
}

func (v NullableNegotiationsNegotiationGetResponse) Get() *NegotiationsNegotiationGetResponse {
	return v.value
}

func (v *NullableNegotiationsNegotiationGetResponse) Set(val *NegotiationsNegotiationGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationGetResponse(val *NegotiationsNegotiationGetResponse) *NullableNegotiationsNegotiationGetResponse {
	return &NullableNegotiationsNegotiationGetResponse{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
