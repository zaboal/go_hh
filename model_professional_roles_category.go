...
// checks if the ProfessionalRolesCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfessionalRolesCategory{}

// ProfessionalRolesCategory struct for ProfessionalRolesCategory
...
type _ProfessionalRolesCategory ProfessionalRolesCategory
...
func NewProfessionalRolesCategory(id string, name NullableString, roles []ProfessionalRolesRole) *ProfessionalRolesCategory {
	this := ProfessionalRolesCategory{}
	this.Id = id
	this.Name = name
	this.Roles = roles
	return &this
...
func (o ProfessionalRolesCategory) MarshalJSON() ([]byte, error) {
...
func (o ProfessionalRolesCategory) ToMap() (map[string]interface{}, error) {
...
func (o *ProfessionalRolesCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varProfessionalRolesCategory := _ProfessionalRolesCategory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProfessionalRolesCategory)

	if err != nil {
		return err
	}

	*o = ProfessionalRolesCategory(varProfessionalRolesCategory)

	return err
}

type NullableProfessionalRolesCategory struct {
	value *ProfessionalRolesCategory
	isSet bool
}

func (v NullableProfessionalRolesCategory) Get() *ProfessionalRolesCategory {
	return v.value
}

func (v *NullableProfessionalRolesCategory) Set(val *ProfessionalRolesCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableProfessionalRolesCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableProfessionalRolesCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfessionalRolesCategory(val *ProfessionalRolesCategory) *NullableProfessionalRolesCategory {
	return &NullableProfessionalRolesCategory{value: val, isSet: true}
}

func (v NullableProfessionalRolesCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfessionalRolesCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
