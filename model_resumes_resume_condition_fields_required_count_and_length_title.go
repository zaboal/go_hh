...
// checks if the ResumesResumeConditionFieldsRequiredCountAndLengthTitle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsRequiredCountAndLengthTitle{}

// ResumesResumeConditionFieldsRequiredCountAndLengthTitle struct for ResumesResumeConditionFieldsRequiredCountAndLengthTitle
type ResumesResumeConditionFieldsRequiredCountAndLengthTitle struct {
	...
	MinLength NullableFloat32 `json:"min_length,omitempty"`
}
...
func NewResumesResumeConditionFieldsRequiredCountAndLengthTitle() *ResumesResumeConditionFieldsRequiredCountAndLengthTitle {
	this := ResumesResumeConditionFieldsRequiredCountAndLengthTitle{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
// SetMinLength gets a reference to the given NullableFloat32 and assigns it to the MinLength field.
func (o *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) SetMinLength(v float32) {
	o.MinLength.Set(&v)
}
// SetMinLengthNil sets the value for MinLength to be an explicit nil
func (o *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o ResumesResumeConditionFieldsRequiredCountAndLengthTitle) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsRequiredCountAndLengthTitle) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle struct {
	value *ResumesResumeConditionFieldsRequiredCountAndLengthTitle
	isSet bool
}

func (v NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle) Get() *ResumesResumeConditionFieldsRequiredCountAndLengthTitle {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle) Set(val *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsRequiredCountAndLengthTitle(val *ResumesResumeConditionFieldsRequiredCountAndLengthTitle) *NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle {
	return &NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsRequiredCountAndLengthTitle) UnmarshalJSON(src []byte) error {
	v.isSet = true
