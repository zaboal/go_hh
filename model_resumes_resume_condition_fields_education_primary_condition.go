...
// checks if the ResumesResumeConditionFieldsEducationPrimaryCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsEducationPrimaryCondition{}

// ResumesResumeConditionFieldsEducationPrimaryCondition struct for ResumesResumeConditionFieldsEducationPrimaryCondition
type ResumesResumeConditionFieldsEducationPrimaryCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsPrimaryEducationFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsEducationPrimaryCondition() *ResumesResumeConditionFieldsEducationPrimaryCondition {
	this := ResumesResumeConditionFieldsEducationPrimaryCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsEducationPrimaryCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationPrimaryCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationPrimaryCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationPrimaryCondition) GetFields() ResumesResumeConditionFieldsPrimaryEducationFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsPrimaryEducationFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsPrimaryEducationFields and assigns it to the Fields field.
...
func (o *ResumesResumeConditionFieldsEducationPrimaryCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsEducationPrimaryCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsEducationPrimaryCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsEducationPrimaryCondition struct {
	value *ResumesResumeConditionFieldsEducationPrimaryCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsEducationPrimaryCondition) Get() *ResumesResumeConditionFieldsEducationPrimaryCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsEducationPrimaryCondition) Set(val *ResumesResumeConditionFieldsEducationPrimaryCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsEducationPrimaryCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsEducationPrimaryCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsEducationPrimaryCondition(val *ResumesResumeConditionFieldsEducationPrimaryCondition) *NullableResumesResumeConditionFieldsEducationPrimaryCondition {
	return &NullableResumesResumeConditionFieldsEducationPrimaryCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsEducationPrimaryCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsEducationPrimaryCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
