...
// checks if the ResumesGetResumeVisibilityListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesGetResumeVisibilityListItem{}

// ResumesGetResumeVisibilityListItem struct for ResumesGetResumeVisibilityListItem
type ResumesGetResumeVisibilityListItem struct {
...
type _ResumesGetResumeVisibilityListItem ResumesGetResumeVisibilityListItem
...
func NewResumesGetResumeVisibilityListItem(alternateUrl string, id string, logoUrls IncludesLogoUrls90, name string, url string) *ResumesGetResumeVisibilityListItem {
	this := ResumesGetResumeVisibilityListItem{}
...
func (o ResumesGetResumeVisibilityListItem) MarshalJSON() ([]byte, error) {
...
func (o ResumesGetResumeVisibilityListItem) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesGetResumeVisibilityListItem) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesGetResumeVisibilityListItem := _ResumesGetResumeVisibilityListItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesGetResumeVisibilityListItem)

	if err != nil {
		return err
	}

	*o = ResumesGetResumeVisibilityListItem(varResumesGetResumeVisibilityListItem)

	return err
}

type NullableResumesGetResumeVisibilityListItem struct {
	value *ResumesGetResumeVisibilityListItem
	isSet bool
}

func (v NullableResumesGetResumeVisibilityListItem) Get() *ResumesGetResumeVisibilityListItem {
	return v.value
}

func (v *NullableResumesGetResumeVisibilityListItem) Set(val *ResumesGetResumeVisibilityListItem) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesGetResumeVisibilityListItem) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesGetResumeVisibilityListItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesGetResumeVisibilityListItem(val *ResumesGetResumeVisibilityListItem) *NullableResumesGetResumeVisibilityListItem {
	return &NullableResumesGetResumeVisibilityListItem{value: val, isSet: true}
}

func (v NullableResumesGetResumeVisibilityListItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesGetResumeVisibilityListItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
