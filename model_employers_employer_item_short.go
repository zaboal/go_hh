...
// checks if the EmployersEmployerItemShort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployerItemShort{}

// EmployersEmployerItemShort struct for EmployersEmployerItemShort
type EmployersEmployerItemShort struct {
...
type _EmployersEmployerItemShort EmployersEmployerItemShort
...
func NewEmployersEmployerItemShort(alternateUrl string, id string, name string, url string, vacanciesUrl string) *EmployersEmployerItemShort {
	this := EmployersEmployerItemShort{}
...
func (o *EmployersEmployerItemShort) SetLogoUrlsNil() {
	o.LogoUrls.Set(nil)
}
...
func (o EmployersEmployerItemShort) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployerItemShort) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersEmployerItemShort) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersEmployerItemShort := _EmployersEmployerItemShort{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersEmployerItemShort)

	if err != nil {
		return err
	}

	*o = EmployersEmployerItemShort(varEmployersEmployerItemShort)

	return err
}

type NullableEmployersEmployerItemShort struct {
	value *EmployersEmployerItemShort
	isSet bool
}

func (v NullableEmployersEmployerItemShort) Get() *EmployersEmployerItemShort {
	return v.value
}

func (v *NullableEmployersEmployerItemShort) Set(val *EmployersEmployerItemShort) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployerItemShort) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployerItemShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployerItemShort(val *EmployersEmployerItemShort) *NullableEmployersEmployerItemShort {
	return &NullableEmployersEmployerItemShort{value: val, isSet: true}
}

func (v NullableEmployersEmployerItemShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployerItemShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
