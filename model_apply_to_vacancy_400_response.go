...
type NullableApplyToVacancy400Response struct {
	value *ApplyToVacancy400Response
	isSet bool
}

func (v NullableApplyToVacancy400Response) Get() *ApplyToVacancy400Response {
	return v.value
}

func (v *NullableApplyToVacancy400Response) Set(val *ApplyToVacancy400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyToVacancy400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyToVacancy400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyToVacancy400Response(val *ApplyToVacancy400Response) *NullableApplyToVacancy400Response {
	return &NullableApplyToVacancy400Response{value: val, isSet: true}
}

func (v NullableApplyToVacancy400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyToVacancy400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
