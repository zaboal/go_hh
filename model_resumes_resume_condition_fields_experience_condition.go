...
// checks if the ResumesResumeConditionFieldsExperienceCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsExperienceCondition{}

// ResumesResumeConditionFieldsExperienceCondition struct for ResumesResumeConditionFieldsExperienceCondition
type ResumesResumeConditionFieldsExperienceCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsExperienceFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsExperienceCondition() *ResumesResumeConditionFieldsExperienceCondition {
	this := ResumesResumeConditionFieldsExperienceCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsExperienceCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsExperienceCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsExperienceCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsExperienceCondition) GetFields() ResumesResumeConditionFieldsExperienceFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsExperienceFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsExperienceFields and assigns it to the Fields field.
...
func (o *ResumesResumeConditionFieldsExperienceCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsExperienceCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsExperienceCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsExperienceCondition struct {
	value *ResumesResumeConditionFieldsExperienceCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsExperienceCondition) Get() *ResumesResumeConditionFieldsExperienceCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsExperienceCondition) Set(val *ResumesResumeConditionFieldsExperienceCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsExperienceCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsExperienceCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsExperienceCondition(val *ResumesResumeConditionFieldsExperienceCondition) *NullableResumesResumeConditionFieldsExperienceCondition {
	return &NullableResumesResumeConditionFieldsExperienceCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsExperienceCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsExperienceCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
