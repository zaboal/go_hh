...
// checks if the SalaryStatisticsMarketSalary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalaryStatisticsMarketSalary{}

// SalaryStatisticsMarketSalary struct for SalaryStatisticsMarketSalary
type SalaryStatisticsMarketSalary struct {
...
type _SalaryStatisticsMarketSalary SalaryStatisticsMarketSalary
...
func NewSalaryStatisticsMarketSalary(average float32, bottom float32, maximum float32, median float32, minimum float32, upper float32) *SalaryStatisticsMarketSalary {
	this := SalaryStatisticsMarketSalary{}
...
func (o SalaryStatisticsMarketSalary) MarshalJSON() ([]byte, error) {
...
func (o SalaryStatisticsMarketSalary) ToMap() (map[string]interface{}, error) {
...
func (o *SalaryStatisticsMarketSalary) UnmarshalJSON(data []byte) (err error) {
	...
	varSalaryStatisticsMarketSalary := _SalaryStatisticsMarketSalary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSalaryStatisticsMarketSalary)

	if err != nil {
		return err
	}

	*o = SalaryStatisticsMarketSalary(varSalaryStatisticsMarketSalary)

	return err
}

type NullableSalaryStatisticsMarketSalary struct {
	value *SalaryStatisticsMarketSalary
	isSet bool
}

func (v NullableSalaryStatisticsMarketSalary) Get() *SalaryStatisticsMarketSalary {
	return v.value
}

func (v *NullableSalaryStatisticsMarketSalary) Set(val *SalaryStatisticsMarketSalary) {
	v.value = val
	v.isSet = true
}

func (v NullableSalaryStatisticsMarketSalary) IsSet() bool {
	return v.isSet
}

func (v *NullableSalaryStatisticsMarketSalary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalaryStatisticsMarketSalary(val *SalaryStatisticsMarketSalary) *NullableSalaryStatisticsMarketSalary {
	return &NullableSalaryStatisticsMarketSalary{value: val, isSet: true}
}

func (v NullableSalaryStatisticsMarketSalary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalaryStatisticsMarketSalary) UnmarshalJSON(src []byte) error {
	v.isSet = true
