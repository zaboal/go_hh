...
// checks if the EmployersEmployersBlacklisted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployersBlacklisted{}

// EmployersEmployersBlacklisted struct for EmployersEmployersBlacklisted
type EmployersEmployersBlacklisted struct {
...
func NewEmployersEmployersBlacklisted() *EmployersEmployersBlacklisted {
	this := EmployersEmployersBlacklisted{}
	return &this
}
...
func (o EmployersEmployersBlacklisted) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployersBlacklisted) ToMap() (map[string]interface{}, error) {
...
type NullableEmployersEmployersBlacklisted struct {
	value *EmployersEmployersBlacklisted
	isSet bool
}

func (v NullableEmployersEmployersBlacklisted) Get() *EmployersEmployersBlacklisted {
	return v.value
}

func (v *NullableEmployersEmployersBlacklisted) Set(val *EmployersEmployersBlacklisted) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployersBlacklisted) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployersBlacklisted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployersBlacklisted(val *EmployersEmployersBlacklisted) *NullableEmployersEmployersBlacklisted {
	return &NullableEmployersEmployersBlacklisted{value: val, isSet: true}
}

func (v NullableEmployersEmployersBlacklisted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployersBlacklisted) UnmarshalJSON(src []byte) error {
	v.isSet = true
