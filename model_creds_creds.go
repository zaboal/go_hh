...
// checks if the CredsCreds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CredsCreds{}

// CredsCreds Документы, подтверждающие наличие у соискателя опыта или квалификации для выполнения определенного вида деятельности.  Зависят от профессиональных ролей резюме 
type CredsCreds struct {
	Answers *map[string]CredsAnswers `json:"answers,omitempty"`
	QuestionToAnswerMap *map[string][]string `json:"question_to_answer_map,omitempty"`
	Questions *map[string]CredsQuestions `json:"questions,omitempty"`
}
...
func (o *CredsCreds) GetAnswers() map[string]CredsAnswers {
	if o == nil || IsNil(o.Answers) {
		var ret map[string]CredsAnswers
		return ret
	}
	return *o.Answers
}
...
// SetAnswers gets a reference to the given map[string]CredsAnswers and assigns it to the Answers field.
func (o *CredsCreds) SetAnswers(v map[string]CredsAnswers) {
	o.Answers = &v
}

// GetQuestionToAnswerMap returns the QuestionToAnswerMap field value if set, zero value otherwise.
func (o *CredsCreds) GetQuestionToAnswerMap() map[string][]string {
	if o == nil || IsNil(o.QuestionToAnswerMap) {
		var ret map[string][]string
		return ret
	}
	return *o.QuestionToAnswerMap
}

// GetQuestionToAnswerMapOk returns a tuple with the QuestionToAnswerMap field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CredsCreds) GetQuestionToAnswerMapOk() (*map[string][]string, bool) {
	if o == nil || IsNil(o.QuestionToAnswerMap) {
		return nil, false
	}
	return o.QuestionToAnswerMap, true
}
...
// SetQuestionToAnswerMap gets a reference to the given map[string][]string and assigns it to the QuestionToAnswerMap field.
func (o *CredsCreds) SetQuestionToAnswerMap(v map[string][]string) {
	o.QuestionToAnswerMap = &v
}
...
func (o *CredsCreds) GetQuestions() map[string]CredsQuestions {
	if o == nil || IsNil(o.Questions) {
		var ret map[string]CredsQuestions
		return ret
	}
	return *o.Questions
}
...
// SetQuestions gets a reference to the given map[string]CredsQuestions and assigns it to the Questions field.
func (o *CredsCreds) SetQuestions(v map[string]CredsQuestions) {
	o.Questions = &v
}

func (o CredsCreds) MarshalJSON() ([]byte, error) {
...
func (o CredsCreds) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Answers) {
		toSerialize["answers"] = o.Answers
	}
	if !IsNil(o.QuestionToAnswerMap) {
		toSerialize["question_to_answer_map"] = o.QuestionToAnswerMap
	}
...
type NullableCredsCreds struct {
	value *CredsCreds
	isSet bool
}

func (v NullableCredsCreds) Get() *CredsCreds {
	return v.value
}

func (v *NullableCredsCreds) Set(val *CredsCreds) {
	v.value = val
	v.isSet = true
}

func (v NullableCredsCreds) IsSet() bool {
	return v.isSet
}

func (v *NullableCredsCreds) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCredsCreds(val *CredsCreds) *NullableCredsCreds {
	return &NullableCredsCreds{value: val, isSet: true}
}

func (v NullableCredsCreds) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCredsCreds) UnmarshalJSON(src []byte) error {
	v.isSet = true
