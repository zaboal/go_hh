...
// checks if the NegotiationsAuthor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsAuthor{}

// NegotiationsAuthor Автор сообщения
type NegotiationsAuthor struct {
	// Тип собеседника: `applicant` или `employer`
	ParticipantType string `json:"participant_type"`
}

type _NegotiationsAuthor NegotiationsAuthor
...
func (o NegotiationsAuthor) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsAuthor) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["participant_type"] = o.ParticipantType
	return toSerialize, nil
}

func (o *NegotiationsAuthor) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsAuthor := _NegotiationsAuthor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsAuthor)

	if err != nil {
		return err
	}

	*o = NegotiationsAuthor(varNegotiationsAuthor)

	return err
}

type NullableNegotiationsAuthor struct {
	value *NegotiationsAuthor
	isSet bool
}

func (v NullableNegotiationsAuthor) Get() *NegotiationsAuthor {
	return v.value
}

func (v *NullableNegotiationsAuthor) Set(val *NegotiationsAuthor) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsAuthor) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsAuthor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsAuthor(val *NegotiationsAuthor) *NullableNegotiationsAuthor {
	return &NullableNegotiationsAuthor{value: val, isSet: true}
}

func (v NullableNegotiationsAuthor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsAuthor) UnmarshalJSON(src []byte) error {
	v.isSet = true
