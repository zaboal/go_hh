...
// ErrorsNegotiationNegotiationsBadAuthorizationErrors - Информация о возникших ошибках
type ErrorsNegotiationNegotiationsBadAuthorizationErrors struct {
...
// ErrorsCommonBadAuthorizationErrorsAsErrorsNegotiationNegotiationsBadAuthorizationErrors is a convenience function that returns ErrorsCommonBadAuthorizationErrors wrapped in ErrorsNegotiationNegotiationsBadAuthorizationErrors
func ErrorsCommonBadAuthorizationErrorsAsErrorsNegotiationNegotiationsBadAuthorizationErrors(v *ErrorsCommonBadAuthorizationErrors) ErrorsNegotiationNegotiationsBadAuthorizationErrors {
	return ErrorsNegotiationNegotiationsBadAuthorizationErrors{
		ErrorsCommonBadAuthorizationErrors: v,
	}
}

// ErrorsVacancyApplyForbiddenErrorsAsErrorsNegotiationNegotiationsBadAuthorizationErrors is a convenience function that returns ErrorsVacancyApplyForbiddenErrors wrapped in ErrorsNegotiationNegotiationsBadAuthorizationErrors
func ErrorsVacancyApplyForbiddenErrorsAsErrorsNegotiationNegotiationsBadAuthorizationErrors(v *ErrorsVacancyApplyForbiddenErrors) ErrorsNegotiationNegotiationsBadAuthorizationErrors {
	return ErrorsNegotiationNegotiationsBadAuthorizationErrors{
...
func (dst *ErrorsNegotiationNegotiationsBadAuthorizationErrors) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if err == nil {
		...
		if string(jsonErrorsVacancyApplyForbiddenErrors) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ErrorsVacancyApplyForbiddenErrors); err != nil {
				dst.ErrorsVacancyApplyForbiddenErrors = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ErrorsNegotiationNegotiationsBadAuthorizationErrors)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ErrorsNegotiationNegotiationsBadAuthorizationErrors)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ErrorsNegotiationNegotiationsBadAuthorizationErrors) MarshalJSON() ([]byte, error) {
...
func (obj *ErrorsNegotiationNegotiationsBadAuthorizationErrors) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableErrorsNegotiationNegotiationsBadAuthorizationErrors struct {
	value *ErrorsNegotiationNegotiationsBadAuthorizationErrors
	isSet bool
}

func (v NullableErrorsNegotiationNegotiationsBadAuthorizationErrors) Get() *ErrorsNegotiationNegotiationsBadAuthorizationErrors {
	return v.value
}

func (v *NullableErrorsNegotiationNegotiationsBadAuthorizationErrors) Set(val *ErrorsNegotiationNegotiationsBadAuthorizationErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationNegotiationsBadAuthorizationErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationNegotiationsBadAuthorizationErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationNegotiationsBadAuthorizationErrors(val *ErrorsNegotiationNegotiationsBadAuthorizationErrors) *NullableErrorsNegotiationNegotiationsBadAuthorizationErrors {
	return &NullableErrorsNegotiationNegotiationsBadAuthorizationErrors{value: val, isSet: true}
}

func (v NullableErrorsNegotiationNegotiationsBadAuthorizationErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationNegotiationsBadAuthorizationErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
