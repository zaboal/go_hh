...
// checks if the VacancyArea type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyArea{}
...
func (o VacancyArea) MarshalJSON() ([]byte, error) {
...
func (o VacancyArea) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *VacancyArea) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyArea := _VacancyArea{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyArea)

	if err != nil {
		return err
	}

	*o = VacancyArea(varVacancyArea)

	return err
}

type NullableVacancyArea struct {
	value *VacancyArea
	isSet bool
}

func (v NullableVacancyArea) Get() *VacancyArea {
	return v.value
}

func (v *NullableVacancyArea) Set(val *VacancyArea) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyArea) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyArea) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyArea(val *VacancyArea) *NullableVacancyArea {
	return &NullableVacancyArea{value: val, isSet: true}
}

func (v NullableVacancyArea) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyArea) UnmarshalJSON(src []byte) error {
	v.isSet = true
