...
// checks if the EmployerServicesBalance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerServicesBalance{}

// EmployerServicesBalance struct for EmployerServicesBalance
type EmployerServicesBalance struct {
...
type _EmployerServicesBalance EmployerServicesBalance
...
func (o EmployerServicesBalance) MarshalJSON() ([]byte, error) {
...
func (o EmployerServicesBalance) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerServicesBalance) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerServicesBalance := _EmployerServicesBalance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerServicesBalance)

	if err != nil {
		return err
	}

	*o = EmployerServicesBalance(varEmployerServicesBalance)

	return err
}

type NullableEmployerServicesBalance struct {
	value *EmployerServicesBalance
	isSet bool
}

func (v NullableEmployerServicesBalance) Get() *EmployerServicesBalance {
	return v.value
}

func (v *NullableEmployerServicesBalance) Set(val *EmployerServicesBalance) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerServicesBalance) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerServicesBalance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerServicesBalance(val *EmployerServicesBalance) *NullableEmployerServicesBalance {
	return &NullableEmployerServicesBalance{value: val, isSet: true}
}

func (v NullableEmployerServicesBalance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerServicesBalance) UnmarshalJSON(src []byte) error {
	v.isSet = true
