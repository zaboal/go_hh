...
// checks if the ErrorsCommonBadArgumentErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonBadArgumentErrors{}

// ErrorsCommonBadArgumentErrors Информация о возникших ошибках
type ErrorsCommonBadArgumentErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsCommonBadArgumentError `json:"errors"`
}

type _ErrorsCommonBadArgumentErrors ErrorsCommonBadArgumentErrors
...
func NewErrorsCommonBadArgumentErrors(requestId string, errors []ErrorsCommonBadArgumentError) *ErrorsCommonBadArgumentErrors {
	this := ErrorsCommonBadArgumentErrors{}
...
func (o *ErrorsCommonBadArgumentErrors) GetErrors() []ErrorsCommonBadArgumentError {
	if o == nil {
		var ret []ErrorsCommonBadArgumentError
		return ret
	}
...
func (o ErrorsCommonBadArgumentErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonBadArgumentErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonBadArgumentErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonBadArgumentErrors := _ErrorsCommonBadArgumentErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonBadArgumentErrors)

	if err != nil {
		return err
	}

	*o = ErrorsCommonBadArgumentErrors(varErrorsCommonBadArgumentErrors)

	return err
}

type NullableErrorsCommonBadArgumentErrors struct {
	value *ErrorsCommonBadArgumentErrors
	isSet bool
}

func (v NullableErrorsCommonBadArgumentErrors) Get() *ErrorsCommonBadArgumentErrors {
	return v.value
}

func (v *NullableErrorsCommonBadArgumentErrors) Set(val *ErrorsCommonBadArgumentErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadArgumentErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadArgumentErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadArgumentErrors(val *ErrorsCommonBadArgumentErrors) *NullableErrorsCommonBadArgumentErrors {
	return &NullableErrorsCommonBadArgumentErrors{value: val, isSet: true}
}

func (v NullableErrorsCommonBadArgumentErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadArgumentErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
