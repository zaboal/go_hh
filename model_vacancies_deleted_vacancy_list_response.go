...
// checks if the VacanciesDeletedVacancyListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesDeletedVacancyListResponse{}

// VacanciesDeletedVacancyListResponse struct for VacanciesDeletedVacancyListResponse
type VacanciesDeletedVacancyListResponse struct {
	// Найдено результатов
...
type _VacanciesDeletedVacancyListResponse VacanciesDeletedVacancyListResponse
...
func NewVacanciesDeletedVacancyListResponse(found float32, page float32, pages float32, perPage float32, items []VacanciesVacancyArchived) *VacanciesDeletedVacancyListResponse {
	this := VacanciesDeletedVacancyListResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o VacanciesDeletedVacancyListResponse) MarshalJSON() ([]byte, error) {
...
func (o VacanciesDeletedVacancyListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesDeletedVacancyListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesDeletedVacancyListResponse := _VacanciesDeletedVacancyListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesDeletedVacancyListResponse)

	if err != nil {
		return err
	}

	*o = VacanciesDeletedVacancyListResponse(varVacanciesDeletedVacancyListResponse)

	return err
}

type NullableVacanciesDeletedVacancyListResponse struct {
	value *VacanciesDeletedVacancyListResponse
	isSet bool
}

func (v NullableVacanciesDeletedVacancyListResponse) Get() *VacanciesDeletedVacancyListResponse {
	return v.value
}

func (v *NullableVacanciesDeletedVacancyListResponse) Set(val *VacanciesDeletedVacancyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesDeletedVacancyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesDeletedVacancyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesDeletedVacancyListResponse(val *VacanciesDeletedVacancyListResponse) *NullableVacanciesDeletedVacancyListResponse {
	return &NullableVacanciesDeletedVacancyListResponse{value: val, isSet: true}
}

func (v NullableVacanciesDeletedVacancyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesDeletedVacancyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
