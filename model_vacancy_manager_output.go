...
// checks if the VacancyManagerOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyManagerOutput{}

// VacancyManagerOutput struct for VacancyManagerOutput
type VacancyManagerOutput struct {
	// Имя менеджера
...
type _VacancyManagerOutput VacancyManagerOutput
...
func (o VacancyManagerOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyManagerOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyManagerOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyManagerOutput := _VacancyManagerOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyManagerOutput)

	if err != nil {
		return err
	}

	*o = VacancyManagerOutput(varVacancyManagerOutput)

	return err
}

type NullableVacancyManagerOutput struct {
	value *VacancyManagerOutput
	isSet bool
}

func (v NullableVacancyManagerOutput) Get() *VacancyManagerOutput {
	return v.value
}

func (v *NullableVacancyManagerOutput) Set(val *VacancyManagerOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyManagerOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyManagerOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyManagerOutput(val *VacancyManagerOutput) *NullableVacancyManagerOutput {
	return &NullableVacancyManagerOutput{value: val, isSet: true}
}

func (v NullableVacancyManagerOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyManagerOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
