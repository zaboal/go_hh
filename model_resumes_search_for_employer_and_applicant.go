...
// checks if the ResumesSearchForEmployerAndApplicant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesSearchForEmployerAndApplicant{}

// ResumesSearchForEmployerAndApplicant struct for ResumesSearchForEmployerAndApplicant
type ResumesSearchForEmployerAndApplicant struct {
	// URL резюме на сайте
...
type _ResumesSearchForEmployerAndApplicant ResumesSearchForEmployerAndApplicant
...
func (o *ResumesSearchForEmployerAndApplicant) SetAgeNil() {
	o.Age.Set(nil)
}
...
func (o *ResumesSearchForEmployerAndApplicant) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumesSearchForEmployerAndApplicant) SetCanViewFullInfoNil() {
...
func (o *ResumesSearchForEmployerAndApplicant) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ResumesSearchForEmployerAndApplicant) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ResumesSearchForEmployerAndApplicant) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ResumesSearchForEmployerAndApplicant) SetMiddleNameNil() {
...
func (o *ResumesSearchForEmployerAndApplicant) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *ResumesSearchForEmployerAndApplicant) SetTotalExperienceNil() {
...
func (o *ResumesSearchForEmployerAndApplicant) SetPhotoNil() {
	o.Photo.Set(nil)
}
...
func (o ResumesSearchForEmployerAndApplicant) MarshalJSON() ([]byte, error) {
...
func (o ResumesSearchForEmployerAndApplicant) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesSearchForEmployerAndApplicant) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesSearchForEmployerAndApplicant := _ResumesSearchForEmployerAndApplicant{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesSearchForEmployerAndApplicant)

	if err != nil {
		return err
	}

	*o = ResumesSearchForEmployerAndApplicant(varResumesSearchForEmployerAndApplicant)

	return err
}

type NullableResumesSearchForEmployerAndApplicant struct {
	value *ResumesSearchForEmployerAndApplicant
	isSet bool
}

func (v NullableResumesSearchForEmployerAndApplicant) Get() *ResumesSearchForEmployerAndApplicant {
	return v.value
}

func (v *NullableResumesSearchForEmployerAndApplicant) Set(val *ResumesSearchForEmployerAndApplicant) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesSearchForEmployerAndApplicant) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesSearchForEmployerAndApplicant) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesSearchForEmployerAndApplicant(val *ResumesSearchForEmployerAndApplicant) *NullableResumesSearchForEmployerAndApplicant {
	return &NullableResumesSearchForEmployerAndApplicant{value: val, isSet: true}
}

func (v NullableResumesSearchForEmployerAndApplicant) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesSearchForEmployerAndApplicant) UnmarshalJSON(src []byte) error {
	v.isSet = true
