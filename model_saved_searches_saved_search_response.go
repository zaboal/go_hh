...
// checks if the SavedSearchesSavedSearchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SavedSearchesSavedSearchResponse{}

// SavedSearchesSavedSearchResponse struct for SavedSearchesSavedSearchResponse
type SavedSearchesSavedSearchResponse struct {
	// Список сохраненных поисков вакансий/резюме
	Items []SavedSearchesSavedSearchItem `json:"items"`
	// Найдено результатов
...
type _SavedSearchesSavedSearchResponse SavedSearchesSavedSearchResponse
...
func NewSavedSearchesSavedSearchResponse(items []SavedSearchesSavedSearchItem, found float32, page float32, pages float32, perPage float32) *SavedSearchesSavedSearchResponse {
	this := SavedSearchesSavedSearchResponse{}
	this.Items = items
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *SavedSearchesSavedSearchResponse) GetItems() []SavedSearchesSavedSearchItem {
	if o == nil {
		var ret []SavedSearchesSavedSearchItem
		return ret
	}
...
func (o SavedSearchesSavedSearchResponse) MarshalJSON() ([]byte, error) {
...
func (o SavedSearchesSavedSearchResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SavedSearchesSavedSearchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSavedSearchesSavedSearchResponse := _SavedSearchesSavedSearchResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSavedSearchesSavedSearchResponse)

	if err != nil {
		return err
	}

	*o = SavedSearchesSavedSearchResponse(varSavedSearchesSavedSearchResponse)

	return err
}

type NullableSavedSearchesSavedSearchResponse struct {
	value *SavedSearchesSavedSearchResponse
	isSet bool
}

func (v NullableSavedSearchesSavedSearchResponse) Get() *SavedSearchesSavedSearchResponse {
	return v.value
}

func (v *NullableSavedSearchesSavedSearchResponse) Set(val *SavedSearchesSavedSearchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSavedSearchesSavedSearchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSavedSearchesSavedSearchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSavedSearchesSavedSearchResponse(val *SavedSearchesSavedSearchResponse) *NullableSavedSearchesSavedSearchResponse {
	return &NullableSavedSearchesSavedSearchResponse{value: val, isSet: true}
}

func (v NullableSavedSearchesSavedSearchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSavedSearchesSavedSearchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
