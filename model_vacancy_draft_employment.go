...
// checks if the VacancyDraftEmployment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftEmployment{}

// VacancyDraftEmployment struct for VacancyDraftEmployment
type VacancyDraftEmployment struct {
...
func (o *VacancyDraftEmployment) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o VacancyDraftEmployment) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftEmployment) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftEmployment struct {
	value *VacancyDraftEmployment
	isSet bool
}

func (v NullableVacancyDraftEmployment) Get() *VacancyDraftEmployment {
	return v.value
}

func (v *NullableVacancyDraftEmployment) Set(val *VacancyDraftEmployment) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftEmployment) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftEmployment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftEmployment(val *VacancyDraftEmployment) *NullableVacancyDraftEmployment {
	return &NullableVacancyDraftEmployment{value: val, isSet: true}
}

func (v NullableVacancyDraftEmployment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftEmployment) UnmarshalJSON(src []byte) error {
	v.isSet = true
