...
// checks if the ResumesResumeConditionFieldsLanguageCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsLanguageCondition{}

// ResumesResumeConditionFieldsLanguageCondition struct for ResumesResumeConditionFieldsLanguageCondition
type ResumesResumeConditionFieldsLanguageCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsLanguageFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsLanguageCondition() *ResumesResumeConditionFieldsLanguageCondition {
	this := ResumesResumeConditionFieldsLanguageCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsLanguageCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsLanguageCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsLanguageCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsLanguageCondition) GetFields() ResumesResumeConditionFieldsLanguageFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsLanguageFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsLanguageFields and assigns it to the Fields field.
func (o *ResumesResumeConditionFieldsLanguageCondition) SetFields(v ResumesResumeConditionFieldsLanguageFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *ResumesResumeConditionFieldsLanguageCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsLanguageCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsLanguageCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsLanguageCondition struct {
	value *ResumesResumeConditionFieldsLanguageCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsLanguageCondition) Get() *ResumesResumeConditionFieldsLanguageCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsLanguageCondition) Set(val *ResumesResumeConditionFieldsLanguageCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsLanguageCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsLanguageCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsLanguageCondition(val *ResumesResumeConditionFieldsLanguageCondition) *NullableResumesResumeConditionFieldsLanguageCondition {
	return &NullableResumesResumeConditionFieldsLanguageCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsLanguageCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsLanguageCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
