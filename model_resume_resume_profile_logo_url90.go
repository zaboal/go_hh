...
// checks if the ResumeResumeProfileLogoUrl90 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeProfileLogoUrl90{}

// ResumeResumeProfileLogoUrl90 struct for ResumeResumeProfileLogoUrl90
type ResumeResumeProfileLogoUrl90 struct {
	// URL резюме на сайте
	...
	// Опыт работы
	Experience []ResumeObjectsExperienceLogoUrl90 `json:"experience"`
	// Имя
...
type _ResumeResumeProfileLogoUrl90 ResumeResumeProfileLogoUrl90
...
func NewResumeResumeProfileLogoUrl90(alternateUrl string, id string, title NullableString, url string, certificate []ResumeObjectsCertificate, createdAt string, download map[string]interface{}, education map[string]interface{}, experience []ResumeObjectsExperienceLogoUrl90, hiddenFields []IncludesIdName, updatedAt string) *ResumeResumeProfileLogoUrl90 {
	this := ResumeResumeProfileLogoUrl90{}
...
func (o *ResumeResumeProfileLogoUrl90) SetAgeNil() {
	o.Age.Set(nil)
}
...
func (o *ResumeResumeProfileLogoUrl90) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumeResumeProfileLogoUrl90) SetCanViewFullInfoNil() {
...
func (o *ResumeResumeProfileLogoUrl90) GetExperience() []ResumeObjectsExperienceLogoUrl90 {
	if o == nil {
		var ret []ResumeObjectsExperienceLogoUrl90
		return ret
	}
...
func (o *ResumeResumeProfileLogoUrl90) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ResumeResumeProfileLogoUrl90) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ResumeResumeProfileLogoUrl90) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ResumeResumeProfileLogoUrl90) SetMiddleNameNil() {
...
func (o *ResumeResumeProfileLogoUrl90) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *ResumeResumeProfileLogoUrl90) SetTotalExperienceNil() {
...
func (o ResumeResumeProfileLogoUrl90) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeProfileLogoUrl90) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeProfileLogoUrl90) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeProfileLogoUrl90 := _ResumeResumeProfileLogoUrl90{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeProfileLogoUrl90)

	if err != nil {
		return err
	}

	*o = ResumeResumeProfileLogoUrl90(varResumeResumeProfileLogoUrl90)

	return err
}

type NullableResumeResumeProfileLogoUrl90 struct {
	value *ResumeResumeProfileLogoUrl90
	isSet bool
}

func (v NullableResumeResumeProfileLogoUrl90) Get() *ResumeResumeProfileLogoUrl90 {
	return v.value
}

func (v *NullableResumeResumeProfileLogoUrl90) Set(val *ResumeResumeProfileLogoUrl90) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeProfileLogoUrl90) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeProfileLogoUrl90) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeProfileLogoUrl90(val *ResumeResumeProfileLogoUrl90) *NullableResumeResumeProfileLogoUrl90 {
	return &NullableResumeResumeProfileLogoUrl90{value: val, isSet: true}
}

func (v NullableResumeResumeProfileLogoUrl90) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeProfileLogoUrl90) UnmarshalJSON(src []byte) error {
	v.isSet = true
