...
// checks if the ErrorsResumeAddEditError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsResumeAddEditError{}

// ErrorsResumeAddEditError struct for ErrorsResumeAddEditError
type ErrorsResumeAddEditError struct {
...
type _ErrorsResumeAddEditError ErrorsResumeAddEditError
...
func (o ErrorsResumeAddEditError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsResumeAddEditError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsResumeAddEditError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsResumeAddEditError := _ErrorsResumeAddEditError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsResumeAddEditError)

	if err != nil {
		return err
	}

	*o = ErrorsResumeAddEditError(varErrorsResumeAddEditError)

	return err
}

type NullableErrorsResumeAddEditError struct {
	value *ErrorsResumeAddEditError
	isSet bool
}

func (v NullableErrorsResumeAddEditError) Get() *ErrorsResumeAddEditError {
	return v.value
}

func (v *NullableErrorsResumeAddEditError) Set(val *ErrorsResumeAddEditError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsResumeAddEditError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsResumeAddEditError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsResumeAddEditError(val *ErrorsResumeAddEditError) *NullableErrorsResumeAddEditError {
	return &NullableErrorsResumeAddEditError{value: val, isSet: true}
}

func (v NullableErrorsResumeAddEditError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsResumeAddEditError) UnmarshalJSON(src []byte) error {
	v.isSet = true
