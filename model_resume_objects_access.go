...
// checks if the ResumeObjectsAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsAccess{}

// ResumeObjectsAccess Тип видимости резюме
type ResumeObjectsAccess struct {
...
type _ResumeObjectsAccess ResumeObjectsAccess
...
func (o ResumeObjectsAccess) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsAccess) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["type"] = o.Type
	return toSerialize, nil
}

func (o *ResumeObjectsAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsAccess := _ResumeObjectsAccess{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsAccess)

	if err != nil {
		return err
	}

	*o = ResumeObjectsAccess(varResumeObjectsAccess)

	return err
}

type NullableResumeObjectsAccess struct {
	value *ResumeObjectsAccess
	isSet bool
}

func (v NullableResumeObjectsAccess) Get() *ResumeObjectsAccess {
	return v.value
}

func (v *NullableResumeObjectsAccess) Set(val *ResumeObjectsAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsAccess(val *ResumeObjectsAccess) *NullableResumeObjectsAccess {
	return &NullableResumeObjectsAccess{value: val, isSet: true}
}

func (v NullableResumeObjectsAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
