...
// checks if the ResumesGetResumeVisibilityListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesGetResumeVisibilityListResponse{}

// ResumesGetResumeVisibilityListResponse struct for ResumesGetResumeVisibilityListResponse
type ResumesGetResumeVisibilityListResponse struct {
	// Найдено результатов
...
type _ResumesGetResumeVisibilityListResponse ResumesGetResumeVisibilityListResponse
...
func NewResumesGetResumeVisibilityListResponse(found float32, page float32, pages float32, perPage float32, items []ResumesGetResumeVisibilityListItem, limit float32) *ResumesGetResumeVisibilityListResponse {
	this := ResumesGetResumeVisibilityListResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o ResumesGetResumeVisibilityListResponse) MarshalJSON() ([]byte, error) {
...
func (o ResumesGetResumeVisibilityListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesGetResumeVisibilityListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesGetResumeVisibilityListResponse := _ResumesGetResumeVisibilityListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesGetResumeVisibilityListResponse)

	if err != nil {
		return err
	}

	*o = ResumesGetResumeVisibilityListResponse(varResumesGetResumeVisibilityListResponse)

	return err
}

type NullableResumesGetResumeVisibilityListResponse struct {
	value *ResumesGetResumeVisibilityListResponse
	isSet bool
}

func (v NullableResumesGetResumeVisibilityListResponse) Get() *ResumesGetResumeVisibilityListResponse {
	return v.value
}

func (v *NullableResumesGetResumeVisibilityListResponse) Set(val *ResumesGetResumeVisibilityListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesGetResumeVisibilityListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesGetResumeVisibilityListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesGetResumeVisibilityListResponse(val *ResumesGetResumeVisibilityListResponse) *NullableResumesGetResumeVisibilityListResponse {
	return &NullableResumesGetResumeVisibilityListResponse{value: val, isSet: true}
}

func (v NullableResumesGetResumeVisibilityListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesGetResumeVisibilityListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
