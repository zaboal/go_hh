...
// checks if the DictionariesSkillsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DictionariesSkillsResponse{}

// DictionariesSkillsResponse Список ключевых навыков
type DictionariesSkillsResponse struct {
	// Массив ключевых навыков
	Items []IncludesSkillSetItem `json:"items"`
}

type _DictionariesSkillsResponse DictionariesSkillsResponse

// NewDictionariesSkillsResponse instantiates a new DictionariesSkillsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDictionariesSkillsResponse(items []IncludesSkillSetItem) *DictionariesSkillsResponse {
	this := DictionariesSkillsResponse{}
	this.Items = items
	return &this
}

// NewDictionariesSkillsResponseWithDefaults instantiates a new DictionariesSkillsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDictionariesSkillsResponseWithDefaults() *DictionariesSkillsResponse {
	this := DictionariesSkillsResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *DictionariesSkillsResponse) GetItems() []IncludesSkillSetItem {
	if o == nil {
		var ret []IncludesSkillSetItem
		return ret
	}
...
func (o *DictionariesSkillsResponse) GetItemsOk() ([]IncludesSkillSetItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *DictionariesSkillsResponse) SetItems(v []IncludesSkillSetItem) {
	o.Items = v
}

func (o DictionariesSkillsResponse) MarshalJSON() ([]byte, error) {
...
func (o DictionariesSkillsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *DictionariesSkillsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDictionariesSkillsResponse := _DictionariesSkillsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDictionariesSkillsResponse)

	if err != nil {
		return err
	}

	*o = DictionariesSkillsResponse(varDictionariesSkillsResponse)

	return err
}

type NullableDictionariesSkillsResponse struct {
	value *DictionariesSkillsResponse
	isSet bool
}

func (v NullableDictionariesSkillsResponse) Get() *DictionariesSkillsResponse {
	return v.value
}

func (v *NullableDictionariesSkillsResponse) Set(val *DictionariesSkillsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDictionariesSkillsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDictionariesSkillsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDictionariesSkillsResponse(val *DictionariesSkillsResponse) *NullableDictionariesSkillsResponse {
	return &NullableDictionariesSkillsResponse{value: val, isSet: true}
}

func (v NullableDictionariesSkillsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDictionariesSkillsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
