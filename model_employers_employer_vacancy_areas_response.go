...
// checks if the EmployersEmployerVacancyAreasResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployerVacancyAreasResponse{}

// EmployersEmployerVacancyAreasResponse struct for EmployersEmployerVacancyAreasResponse
type EmployersEmployerVacancyAreasResponse struct {
	// Список регионов
	Items []IncludesArea `json:"items"`
	// Найдено результатов
...
type _EmployersEmployerVacancyAreasResponse EmployersEmployerVacancyAreasResponse
...
func NewEmployersEmployerVacancyAreasResponse(items []IncludesArea, found float32, page float32, pages float32, perPage float32) *EmployersEmployerVacancyAreasResponse {
	this := EmployersEmployerVacancyAreasResponse{}
	this.Items = items
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o EmployersEmployerVacancyAreasResponse) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployerVacancyAreasResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersEmployerVacancyAreasResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersEmployerVacancyAreasResponse := _EmployersEmployerVacancyAreasResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersEmployerVacancyAreasResponse)

	if err != nil {
		return err
	}

	*o = EmployersEmployerVacancyAreasResponse(varEmployersEmployerVacancyAreasResponse)

	return err
}

type NullableEmployersEmployerVacancyAreasResponse struct {
	value *EmployersEmployerVacancyAreasResponse
	isSet bool
}

func (v NullableEmployersEmployerVacancyAreasResponse) Get() *EmployersEmployerVacancyAreasResponse {
	return v.value
}

func (v *NullableEmployersEmployerVacancyAreasResponse) Set(val *EmployersEmployerVacancyAreasResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployerVacancyAreasResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployerVacancyAreasResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployerVacancyAreasResponse(val *EmployersEmployerVacancyAreasResponse) *NullableEmployersEmployerVacancyAreasResponse {
	return &NullableEmployersEmployerVacancyAreasResponse{value: val, isSet: true}
}

func (v NullableEmployersEmployerVacancyAreasResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployerVacancyAreasResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
