...
// checks if the ResumesResumeConditionFieldsEducationElementaryCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsEducationElementaryCondition{}

// ResumesResumeConditionFieldsEducationElementaryCondition struct for ResumesResumeConditionFieldsEducationElementaryCondition
type ResumesResumeConditionFieldsEducationElementaryCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsElementaryEducationFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsEducationElementaryCondition() *ResumesResumeConditionFieldsEducationElementaryCondition {
	this := ResumesResumeConditionFieldsEducationElementaryCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsEducationElementaryCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationElementaryCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationElementaryCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationElementaryCondition) GetFields() ResumesResumeConditionFieldsElementaryEducationFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsElementaryEducationFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsElementaryEducationFields and assigns it to the Fields field.
func (o *ResumesResumeConditionFieldsEducationElementaryCondition) SetFields(v ResumesResumeConditionFieldsElementaryEducationFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *ResumesResumeConditionFieldsEducationElementaryCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsEducationElementaryCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsEducationElementaryCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsEducationElementaryCondition struct {
	value *ResumesResumeConditionFieldsEducationElementaryCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsEducationElementaryCondition) Get() *ResumesResumeConditionFieldsEducationElementaryCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsEducationElementaryCondition) Set(val *ResumesResumeConditionFieldsEducationElementaryCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsEducationElementaryCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsEducationElementaryCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsEducationElementaryCondition(val *ResumesResumeConditionFieldsEducationElementaryCondition) *NullableResumesResumeConditionFieldsEducationElementaryCondition {
	return &NullableResumesResumeConditionFieldsEducationElementaryCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsEducationElementaryCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsEducationElementaryCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
