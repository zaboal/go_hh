...
// EmployersBrandingConstructorConstructorWidgetsInner - struct for EmployersBrandingConstructorConstructorWidgetsInner
type EmployersBrandingConstructorConstructorWidgetsInner struct {
	EmployersBrandingConstructorGalleryWidget *EmployersBrandingConstructorGalleryWidget
}

// EmployersBrandingConstructorGalleryWidgetAsEmployersBrandingConstructorConstructorWidgetsInner is a convenience function that returns EmployersBrandingConstructorGalleryWidget wrapped in EmployersBrandingConstructorConstructorWidgetsInner
func EmployersBrandingConstructorGalleryWidgetAsEmployersBrandingConstructorConstructorWidgetsInner(v *EmployersBrandingConstructorGalleryWidget) EmployersBrandingConstructorConstructorWidgetsInner {
	return EmployersBrandingConstructorConstructorWidgetsInner{
		EmployersBrandingConstructorGalleryWidget: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *EmployersBrandingConstructorConstructorWidgetsInner) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into EmployersBrandingConstructorGalleryWidget
	err = newStrictDecoder(data).Decode(&dst.EmployersBrandingConstructorGalleryWidget)
	if err == nil {
		jsonEmployersBrandingConstructorGalleryWidget, _ := json.Marshal(dst.EmployersBrandingConstructorGalleryWidget)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(EmployersBrandingConstructorConstructorWidgetsInner)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(EmployersBrandingConstructorConstructorWidgetsInner)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src EmployersBrandingConstructorConstructorWidgetsInner) MarshalJSON() ([]byte, error) {
	if src.EmployersBrandingConstructorGalleryWidget != nil {
		return json.Marshal(&src.EmployersBrandingConstructorGalleryWidget)
	}
...
func (obj *EmployersBrandingConstructorConstructorWidgetsInner) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.EmployersBrandingConstructorGalleryWidget != nil {
		return obj.EmployersBrandingConstructorGalleryWidget
	}
...
type NullableEmployersBrandingConstructorConstructorWidgetsInner struct {
	value *EmployersBrandingConstructorConstructorWidgetsInner
	isSet bool
}

func (v NullableEmployersBrandingConstructorConstructorWidgetsInner) Get() *EmployersBrandingConstructorConstructorWidgetsInner {
	return v.value
}

func (v *NullableEmployersBrandingConstructorConstructorWidgetsInner) Set(val *EmployersBrandingConstructorConstructorWidgetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersBrandingConstructorConstructorWidgetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersBrandingConstructorConstructorWidgetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersBrandingConstructorConstructorWidgetsInner(val *EmployersBrandingConstructorConstructorWidgetsInner) *NullableEmployersBrandingConstructorConstructorWidgetsInner {
	return &NullableEmployersBrandingConstructorConstructorWidgetsInner{value: val, isSet: true}
}

func (v NullableEmployersBrandingConstructorConstructorWidgetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersBrandingConstructorConstructorWidgetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
