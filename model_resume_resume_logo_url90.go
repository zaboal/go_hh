...
// checks if the ResumeResumeLogoUrl90 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeLogoUrl90{}

// ResumeResumeLogoUrl90 struct for ResumeResumeLogoUrl90
type ResumeResumeLogoUrl90 struct {
	// URL резюме на сайте
...
type _ResumeResumeLogoUrl90 ResumeResumeLogoUrl90
...
func (o *ResumeResumeLogoUrl90) SetAgeNil() {
	o.Age.Set(nil)
}
...
func (o *ResumeResumeLogoUrl90) SetAreaNil() {
	o.Area.Set(nil)
}
...
func (o *ResumeResumeLogoUrl90) SetCanViewFullInfoNil() {
...
func (o *ResumeResumeLogoUrl90) SetFirstNameNil() {
	o.FirstName.Set(nil)
}
...
func (o *ResumeResumeLogoUrl90) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ResumeResumeLogoUrl90) SetLastNameNil() {
	o.LastName.Set(nil)
}
...
func (o *ResumeResumeLogoUrl90) SetMiddleNameNil() {
...
func (o *ResumeResumeLogoUrl90) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *ResumeResumeLogoUrl90) SetTotalExperienceNil() {
...
func (o ResumeResumeLogoUrl90) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeLogoUrl90) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeLogoUrl90) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeLogoUrl90 := _ResumeResumeLogoUrl90{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeLogoUrl90)

	if err != nil {
		return err
	}

	*o = ResumeResumeLogoUrl90(varResumeResumeLogoUrl90)

	return err
}

type NullableResumeResumeLogoUrl90 struct {
	value *ResumeResumeLogoUrl90
	isSet bool
}

func (v NullableResumeResumeLogoUrl90) Get() *ResumeResumeLogoUrl90 {
	return v.value
}

func (v *NullableResumeResumeLogoUrl90) Set(val *ResumeResumeLogoUrl90) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeLogoUrl90) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeLogoUrl90) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeLogoUrl90(val *ResumeResumeLogoUrl90) *NullableResumeResumeLogoUrl90 {
	return &NullableResumeResumeLogoUrl90{value: val, isSet: true}
}

func (v NullableResumeResumeLogoUrl90) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeLogoUrl90) UnmarshalJSON(src []byte) error {
	v.isSet = true
