...
// checks if the DictionariesDistrictItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DictionariesDistrictItem{}

// DictionariesDistrictItem struct for DictionariesDistrictItem
...
type _DictionariesDistrictItem DictionariesDistrictItem
...
func (o DictionariesDistrictItem) MarshalJSON() ([]byte, error) {
...
func (o DictionariesDistrictItem) ToMap() (map[string]interface{}, error) {
...
func (o *DictionariesDistrictItem) UnmarshalJSON(data []byte) (err error) {
	...
	varDictionariesDistrictItem := _DictionariesDistrictItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDictionariesDistrictItem)

	if err != nil {
		return err
	}

	*o = DictionariesDistrictItem(varDictionariesDistrictItem)

	return err
}

type NullableDictionariesDistrictItem struct {
	value *DictionariesDistrictItem
	isSet bool
}

func (v NullableDictionariesDistrictItem) Get() *DictionariesDistrictItem {
	return v.value
}

func (v *NullableDictionariesDistrictItem) Set(val *DictionariesDistrictItem) {
	v.value = val
	v.isSet = true
}

func (v NullableDictionariesDistrictItem) IsSet() bool {
	return v.isSet
}

func (v *NullableDictionariesDistrictItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDictionariesDistrictItem(val *DictionariesDistrictItem) *NullableDictionariesDistrictItem {
	return &NullableDictionariesDistrictItem{value: val, isSet: true}
}

func (v NullableDictionariesDistrictItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDictionariesDistrictItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
