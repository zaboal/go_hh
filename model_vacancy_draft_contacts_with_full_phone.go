...
// checks if the VacancyDraftContactsWithFullPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftContactsWithFullPhone{}

// VacancyDraftContactsWithFullPhone Контактная информация
type VacancyDraftContactsWithFullPhone struct {
	// Email
	Email NullableString `json:"email"`
	// Имя менеджера
	Name NullableString `json:"name"`
	// Список телефонов для связи
	Phones []VacancyDraftPhoneItemWithFullPhone `json:"phones"`
}

type _VacancyDraftContactsWithFullPhone VacancyDraftContactsWithFullPhone
...
func NewVacancyDraftContactsWithFullPhone(email NullableString, name NullableString, phones []VacancyDraftPhoneItemWithFullPhone) *VacancyDraftContactsWithFullPhone {
	this := VacancyDraftContactsWithFullPhone{}
	this.Email = email
	this.Name = name
	this.Phones = phones
	return &this
...
// If the value is explicit nil, the zero value for []VacancyDraftPhoneItemWithFullPhone will be returned
func (o *VacancyDraftContactsWithFullPhone) GetPhones() []VacancyDraftPhoneItemWithFullPhone {
	if o == nil {
		var ret []VacancyDraftPhoneItemWithFullPhone
		return ret
	}
...
func (o VacancyDraftContactsWithFullPhone) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftContactsWithFullPhone) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyDraftContactsWithFullPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDraftContactsWithFullPhone := _VacancyDraftContactsWithFullPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDraftContactsWithFullPhone)

	if err != nil {
		return err
	}

	*o = VacancyDraftContactsWithFullPhone(varVacancyDraftContactsWithFullPhone)

	return err
}

type NullableVacancyDraftContactsWithFullPhone struct {
	value *VacancyDraftContactsWithFullPhone
	isSet bool
}

func (v NullableVacancyDraftContactsWithFullPhone) Get() *VacancyDraftContactsWithFullPhone {
	return v.value
}

func (v *NullableVacancyDraftContactsWithFullPhone) Set(val *VacancyDraftContactsWithFullPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftContactsWithFullPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftContactsWithFullPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftContactsWithFullPhone(val *VacancyDraftContactsWithFullPhone) *NullableVacancyDraftContactsWithFullPhone {
	return &NullableVacancyDraftContactsWithFullPhone{value: val, isSet: true}
}

func (v NullableVacancyDraftContactsWithFullPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftContactsWithFullPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
