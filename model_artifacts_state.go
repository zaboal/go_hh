...
// checks if the ArtifactsState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsState{}

// ArtifactsState struct for ArtifactsState
...
type _ArtifactsState ArtifactsState
...
func (o ArtifactsState) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsState) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsState) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsState := _ArtifactsState{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsState)

	if err != nil {
		return err
	}

	*o = ArtifactsState(varArtifactsState)

	return err
}

type NullableArtifactsState struct {
	value *ArtifactsState
	isSet bool
}

func (v NullableArtifactsState) Get() *ArtifactsState {
	return v.value
}

func (v *NullableArtifactsState) Set(val *ArtifactsState) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsState) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsState(val *ArtifactsState) *NullableArtifactsState {
	return &NullableArtifactsState{value: val, isSet: true}
}

func (v NullableArtifactsState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsState) UnmarshalJSON(src []byte) error {
	v.isSet = true
