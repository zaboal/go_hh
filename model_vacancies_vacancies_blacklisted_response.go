...
// checks if the VacanciesVacanciesBlacklistedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacanciesBlacklistedResponse{}

// VacanciesVacanciesBlacklistedResponse struct for VacanciesVacanciesBlacklistedResponse
type VacanciesVacanciesBlacklistedResponse struct {
	// Найдено результатов
	...
	Items []VacanciesVacanciesBlacklistedItem `json:"items,omitempty"`
	// Превышено ли максимальное количество элементов в списке
	LimitReached *bool `json:"limit_reached,omitempty"`
}

type _VacanciesVacanciesBlacklistedResponse VacanciesVacanciesBlacklistedResponse
...
func NewVacanciesVacanciesBlacklistedResponse(found float32, page float32, pages float32, perPage float32) *VacanciesVacanciesBlacklistedResponse {
	this := VacanciesVacanciesBlacklistedResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *VacanciesVacanciesBlacklistedResponse) GetItems() []VacanciesVacanciesBlacklistedItem {
	if o == nil || IsNil(o.Items) {
		var ret []VacanciesVacanciesBlacklistedItem
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []VacanciesVacanciesBlacklistedItem and assigns it to the Items field.
...
func (o VacanciesVacanciesBlacklistedResponse) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacanciesBlacklistedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesVacanciesBlacklistedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacanciesBlacklistedResponse := _VacanciesVacanciesBlacklistedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacanciesBlacklistedResponse)

	if err != nil {
		return err
	}

	*o = VacanciesVacanciesBlacklistedResponse(varVacanciesVacanciesBlacklistedResponse)

	return err
}

type NullableVacanciesVacanciesBlacklistedResponse struct {
	value *VacanciesVacanciesBlacklistedResponse
	isSet bool
}

func (v NullableVacanciesVacanciesBlacklistedResponse) Get() *VacanciesVacanciesBlacklistedResponse {
	return v.value
}

func (v *NullableVacanciesVacanciesBlacklistedResponse) Set(val *VacanciesVacanciesBlacklistedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacanciesBlacklistedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacanciesBlacklistedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacanciesBlacklistedResponse(val *VacanciesVacanciesBlacklistedResponse) *NullableVacanciesVacanciesBlacklistedResponse {
	return &NullableVacanciesVacanciesBlacklistedResponse{value: val, isSet: true}
}

func (v NullableVacanciesVacanciesBlacklistedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacanciesBlacklistedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
