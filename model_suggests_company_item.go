...
// checks if the SuggestsCompanyItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsCompanyItem{}

// SuggestsCompanyItem struct for SuggestsCompanyItem
...
type _SuggestsCompanyItem SuggestsCompanyItem
...
func (o SuggestsCompanyItem) MarshalJSON() ([]byte, error) {
...
func (o SuggestsCompanyItem) ToMap() (map[string]interface{}, error) {
...
func (o *SuggestsCompanyItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsCompanyItem := _SuggestsCompanyItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsCompanyItem)

	if err != nil {
		return err
	}

	*o = SuggestsCompanyItem(varSuggestsCompanyItem)

	return err
}

type NullableSuggestsCompanyItem struct {
	value *SuggestsCompanyItem
	isSet bool
}

func (v NullableSuggestsCompanyItem) Get() *SuggestsCompanyItem {
	return v.value
}

func (v *NullableSuggestsCompanyItem) Set(val *SuggestsCompanyItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsCompanyItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsCompanyItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsCompanyItem(val *SuggestsCompanyItem) *NullableSuggestsCompanyItem {
	return &NullableSuggestsCompanyItem{value: val, isSet: true}
}

func (v NullableSuggestsCompanyItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsCompanyItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
