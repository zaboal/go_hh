...
// checks if the VacancyWorkingTimeModeItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyWorkingTimeModeItem{}

// VacancyWorkingTimeModeItem struct for VacancyWorkingTimeModeItem
type VacancyWorkingTimeModeItem struct {
...
func NewVacancyWorkingTimeModeItem() *VacancyWorkingTimeModeItem {
	this := VacancyWorkingTimeModeItem{}
	return &this
}
...
func (o VacancyWorkingTimeModeItem) MarshalJSON() ([]byte, error) {
...
func (o VacancyWorkingTimeModeItem) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyWorkingTimeModeItem struct {
	value *VacancyWorkingTimeModeItem
	isSet bool
}

func (v NullableVacancyWorkingTimeModeItem) Get() *VacancyWorkingTimeModeItem {
	return v.value
}

func (v *NullableVacancyWorkingTimeModeItem) Set(val *VacancyWorkingTimeModeItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyWorkingTimeModeItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyWorkingTimeModeItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyWorkingTimeModeItem(val *VacancyWorkingTimeModeItem) *NullableVacancyWorkingTimeModeItem {
	return &NullableVacancyWorkingTimeModeItem{value: val, isSet: true}
}

func (v NullableVacancyWorkingTimeModeItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyWorkingTimeModeItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
