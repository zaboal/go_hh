...
type VacanciesVacancyConditionFieldsContactFields struct {
	...
	Phones NullableVacanciesVacancyConditionFieldsPhoneCondition `json:"phones,omitempty"`
}
...
func (o *VacanciesVacancyConditionFieldsContactFields) GetPhones() VacanciesVacancyConditionFieldsPhoneCondition {
	if o == nil || IsNil(o.Phones.Get()) {
		var ret VacanciesVacancyConditionFieldsPhoneCondition
		return ret
	}
	return *o.Phones.Get()
}
...
// SetPhones gets a reference to the given NullableVacanciesVacancyConditionFieldsPhoneCondition and assigns it to the Phones field.
...
func (o *VacanciesVacancyConditionFieldsContactFields) SetPhonesNil() {
	o.Phones.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsContactFields) ToMap() (map[string]interface{}, error) {
	...
	if o.Phones.IsSet() {
		toSerialize["phones"] = o.Phones.Get()
	}
