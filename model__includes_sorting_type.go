...
// checks if the IncludesSortingType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesSortingType{}

// IncludesSortingType struct for IncludesSortingType
type IncludesSortingType struct {
	// Применяемый тип сортировки
	OrderedBy IncludesIdName `json:"ordered_by"`
}

type _IncludesSortingType IncludesSortingType
...
func (o IncludesSortingType) MarshalJSON() ([]byte, error) {
...
func (o IncludesSortingType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ordered_by"] = o.OrderedBy
	return toSerialize, nil
}

func (o *IncludesSortingType) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesSortingType := _IncludesSortingType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesSortingType)

	if err != nil {
		return err
	}

	*o = IncludesSortingType(varIncludesSortingType)

	return err
}

type NullableIncludesSortingType struct {
	value *IncludesSortingType
	isSet bool
}

func (v NullableIncludesSortingType) Get() *IncludesSortingType {
	return v.value
}

func (v *NullableIncludesSortingType) Set(val *IncludesSortingType) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesSortingType) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesSortingType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesSortingType(val *IncludesSortingType) *NullableIncludesSortingType {
	return &NullableIncludesSortingType{value: val, isSet: true}
}

func (v NullableIncludesSortingType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesSortingType) UnmarshalJSON(src []byte) error {
	v.isSet = true
