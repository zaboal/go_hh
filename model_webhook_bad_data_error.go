...
// WebhookBadDataError - Ошибка параметров запроса
type WebhookBadDataError struct {
	ErrorsCommonBadJsonDataErrors *ErrorsCommonBadJsonDataErrors
	WebhookErrors *WebhookErrors
}

// ErrorsCommonBadJsonDataErrorsAsWebhookBadDataError is a convenience function that returns ErrorsCommonBadJsonDataErrors wrapped in WebhookBadDataError
func ErrorsCommonBadJsonDataErrorsAsWebhookBadDataError(v *ErrorsCommonBadJsonDataErrors) WebhookBadDataError {
	return WebhookBadDataError{
		ErrorsCommonBadJsonDataErrors: v,
	}
}

// WebhookErrorsAsWebhookBadDataError is a convenience function that returns WebhookErrors wrapped in WebhookBadDataError
func WebhookErrorsAsWebhookBadDataError(v *WebhookErrors) WebhookBadDataError {
	return WebhookBadDataError{
		WebhookErrors: v,
	}
}
...
func (dst *WebhookBadDataError) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ErrorsCommonBadJsonDataErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsCommonBadJsonDataErrors)
	if err == nil {
	...
	// try to unmarshal data into WebhookErrors
	err = newStrictDecoder(data).Decode(&dst.WebhookErrors)
	if err == nil {
		jsonWebhookErrors, _ := json.Marshal(dst.WebhookErrors)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(WebhookBadDataError)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(WebhookBadDataError)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src WebhookBadDataError) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadJsonDataErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadJsonDataErrors)
	}

	if src.WebhookErrors != nil {
		return json.Marshal(&src.WebhookErrors)
	}
...
func (obj *WebhookBadDataError) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.ErrorsCommonBadJsonDataErrors != nil {
		return obj.ErrorsCommonBadJsonDataErrors
	}

	if obj.WebhookErrors != nil {
		return obj.WebhookErrors
	}
...
type NullableWebhookBadDataError struct {
	value *WebhookBadDataError
	isSet bool
}

func (v NullableWebhookBadDataError) Get() *WebhookBadDataError {
	return v.value
}

func (v *NullableWebhookBadDataError) Set(val *WebhookBadDataError) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookBadDataError) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookBadDataError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookBadDataError(val *WebhookBadDataError) *NullableWebhookBadDataError {
	return &NullableWebhookBadDataError{value: val, isSet: true}
}

func (v NullableWebhookBadDataError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookBadDataError) UnmarshalJSON(src []byte) error {
	v.isSet = true
