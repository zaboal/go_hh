...
// checks if the ErrorsSavedSearchForbiddenErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsSavedSearchForbiddenErrors{}

// ErrorsSavedSearchForbiddenErrors Информация о возникших ошибках
type ErrorsSavedSearchForbiddenErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Описание ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsSavedSearchForbiddenError `json:"errors"`
}

type _ErrorsSavedSearchForbiddenErrors ErrorsSavedSearchForbiddenErrors
...
func NewErrorsSavedSearchForbiddenErrors(requestId string, errors []ErrorsSavedSearchForbiddenError) *ErrorsSavedSearchForbiddenErrors {
	this := ErrorsSavedSearchForbiddenErrors{}
...
func (o *ErrorsSavedSearchForbiddenErrors) GetErrors() []ErrorsSavedSearchForbiddenError {
	if o == nil {
		var ret []ErrorsSavedSearchForbiddenError
		return ret
	}
...
func (o ErrorsSavedSearchForbiddenErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsSavedSearchForbiddenErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsSavedSearchForbiddenErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsSavedSearchForbiddenErrors := _ErrorsSavedSearchForbiddenErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsSavedSearchForbiddenErrors)

	if err != nil {
		return err
	}

	*o = ErrorsSavedSearchForbiddenErrors(varErrorsSavedSearchForbiddenErrors)

	return err
}

type NullableErrorsSavedSearchForbiddenErrors struct {
	value *ErrorsSavedSearchForbiddenErrors
	isSet bool
}

func (v NullableErrorsSavedSearchForbiddenErrors) Get() *ErrorsSavedSearchForbiddenErrors {
	return v.value
}

func (v *NullableErrorsSavedSearchForbiddenErrors) Set(val *ErrorsSavedSearchForbiddenErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsSavedSearchForbiddenErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsSavedSearchForbiddenErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsSavedSearchForbiddenErrors(val *ErrorsSavedSearchForbiddenErrors) *NullableErrorsSavedSearchForbiddenErrors {
	return &NullableErrorsSavedSearchForbiddenErrors{value: val, isSet: true}
}

func (v NullableErrorsSavedSearchForbiddenErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsSavedSearchForbiddenErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
