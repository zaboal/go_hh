...
// ErrorsArtifactUploadBadJsonData struct for ErrorsArtifactUploadBadJsonData
type ErrorsArtifactUploadBadJsonData struct {
	ErrorsArtifactUploadErrors *ErrorsArtifactUploadErrors
	ErrorsCommonBadJsonDataErrors *ErrorsCommonBadJsonDataErrors
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ErrorsArtifactUploadBadJsonData) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into ErrorsArtifactUploadErrors
	err = json.Unmarshal(data, &dst.ErrorsArtifactUploadErrors);
	if err == nil {
		jsonErrorsArtifactUploadErrors, _ := json.Marshal(dst.ErrorsArtifactUploadErrors)
		if string(jsonErrorsArtifactUploadErrors) == "{}" { // empty struct
			dst.ErrorsArtifactUploadErrors = nil
		} else {
			return nil // data stored in dst.ErrorsArtifactUploadErrors, return on the first match
		}
	} else {
		dst.ErrorsArtifactUploadErrors = nil
	}
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ErrorsArtifactUploadBadJsonData)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ErrorsArtifactUploadBadJsonData) MarshalJSON() ([]byte, error) {
	if src.ErrorsArtifactUploadErrors != nil {
		return json.Marshal(&src.ErrorsArtifactUploadErrors)
	}
...
type NullableErrorsArtifactUploadBadJsonData struct {
	value *ErrorsArtifactUploadBadJsonData
	isSet bool
}

func (v NullableErrorsArtifactUploadBadJsonData) Get() *ErrorsArtifactUploadBadJsonData {
	return v.value
}

func (v *NullableErrorsArtifactUploadBadJsonData) Set(val *ErrorsArtifactUploadBadJsonData) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsArtifactUploadBadJsonData) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsArtifactUploadBadJsonData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsArtifactUploadBadJsonData(val *ErrorsArtifactUploadBadJsonData) *NullableErrorsArtifactUploadBadJsonData {
	return &NullableErrorsArtifactUploadBadJsonData{value: val, isSet: true}
}

func (v NullableErrorsArtifactUploadBadJsonData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsArtifactUploadBadJsonData) UnmarshalJSON(src []byte) error {
	v.isSet = true
