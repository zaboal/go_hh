...
// checks if the ApplicantCommentsAuthor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicantCommentsAuthor{}

// ApplicantCommentsAuthor struct for ApplicantCommentsAuthor
type ApplicantCommentsAuthor struct {
	// ФИО автора комментария
	FullName string `json:"full_name"`
}

type _ApplicantCommentsAuthor ApplicantCommentsAuthor
...
func (o ApplicantCommentsAuthor) MarshalJSON() ([]byte, error) {
...
func (o ApplicantCommentsAuthor) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["full_name"] = o.FullName
	return toSerialize, nil
}

func (o *ApplicantCommentsAuthor) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicantCommentsAuthor := _ApplicantCommentsAuthor{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApplicantCommentsAuthor)

	if err != nil {
		return err
	}

	*o = ApplicantCommentsAuthor(varApplicantCommentsAuthor)

	return err
}

type NullableApplicantCommentsAuthor struct {
	value *ApplicantCommentsAuthor
	isSet bool
}

func (v NullableApplicantCommentsAuthor) Get() *ApplicantCommentsAuthor {
	return v.value
}

func (v *NullableApplicantCommentsAuthor) Set(val *ApplicantCommentsAuthor) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicantCommentsAuthor) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicantCommentsAuthor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicantCommentsAuthor(val *ApplicantCommentsAuthor) *NullableApplicantCommentsAuthor {
	return &NullableApplicantCommentsAuthor{value: val, isSet: true}
}

func (v NullableApplicantCommentsAuthor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicantCommentsAuthor) UnmarshalJSON(src []byte) error {
	v.isSet = true
