...
// checks if the ErrorsEmployerBlacklistedNotFoundError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsEmployerBlacklistedNotFoundError{}

// ErrorsEmployerBlacklistedNotFoundError struct for ErrorsEmployerBlacklistedNotFoundError
type ErrorsEmployerBlacklistedNotFoundError struct {
...
type _ErrorsEmployerBlacklistedNotFoundError ErrorsEmployerBlacklistedNotFoundError
...
func NewErrorsEmployerBlacklistedNotFoundError(type_ string, value string) *ErrorsEmployerBlacklistedNotFoundError {
	this := ErrorsEmployerBlacklistedNotFoundError{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o ErrorsEmployerBlacklistedNotFoundError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsEmployerBlacklistedNotFoundError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsEmployerBlacklistedNotFoundError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsEmployerBlacklistedNotFoundError := _ErrorsEmployerBlacklistedNotFoundError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsEmployerBlacklistedNotFoundError)

	if err != nil {
		return err
	}

	*o = ErrorsEmployerBlacklistedNotFoundError(varErrorsEmployerBlacklistedNotFoundError)

	return err
}

type NullableErrorsEmployerBlacklistedNotFoundError struct {
	value *ErrorsEmployerBlacklistedNotFoundError
	isSet bool
}

func (v NullableErrorsEmployerBlacklistedNotFoundError) Get() *ErrorsEmployerBlacklistedNotFoundError {
	return v.value
}

func (v *NullableErrorsEmployerBlacklistedNotFoundError) Set(val *ErrorsEmployerBlacklistedNotFoundError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsEmployerBlacklistedNotFoundError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsEmployerBlacklistedNotFoundError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsEmployerBlacklistedNotFoundError(val *ErrorsEmployerBlacklistedNotFoundError) *NullableErrorsEmployerBlacklistedNotFoundError {
	return &NullableErrorsEmployerBlacklistedNotFoundError{value: val, isSet: true}
}

func (v NullableErrorsEmployerBlacklistedNotFoundError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsEmployerBlacklistedNotFoundError) UnmarshalJSON(src []byte) error {
	v.isSet = true
