...
// checks if the VacancyCountersForArchivedOrHidden type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyCountersForArchivedOrHidden{}

// VacancyCountersForArchivedOrHidden struct for VacancyCountersForArchivedOrHidden
type VacancyCountersForArchivedOrHidden struct {
	// Количество откликов на вакансию с момента публикации
	Responses *float32 `json:"responses,omitempty"`
	// Количество откликов на вакансию с момента создания
	TotalResponses *float32 `json:"total_responses,omitempty"`
...
func NewVacancyCountersForArchivedOrHidden() *VacancyCountersForArchivedOrHidden {
	this := VacancyCountersForArchivedOrHidden{}
	return &this
}
...
// SetResponses gets a reference to the given float32 and assigns it to the Responses field.
...
// SetTotalResponses gets a reference to the given float32 and assigns it to the TotalResponses field.
...
func (o VacancyCountersForArchivedOrHidden) MarshalJSON() ([]byte, error) {
...
func (o VacancyCountersForArchivedOrHidden) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyCountersForArchivedOrHidden struct {
	value *VacancyCountersForArchivedOrHidden
	isSet bool
}

func (v NullableVacancyCountersForArchivedOrHidden) Get() *VacancyCountersForArchivedOrHidden {
	return v.value
}

func (v *NullableVacancyCountersForArchivedOrHidden) Set(val *VacancyCountersForArchivedOrHidden) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyCountersForArchivedOrHidden) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyCountersForArchivedOrHidden) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyCountersForArchivedOrHidden(val *VacancyCountersForArchivedOrHidden) *NullableVacancyCountersForArchivedOrHidden {
	return &NullableVacancyCountersForArchivedOrHidden{value: val, isSet: true}
}

func (v NullableVacancyCountersForArchivedOrHidden) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyCountersForArchivedOrHidden) UnmarshalJSON(src []byte) error {
	v.isSet = true
