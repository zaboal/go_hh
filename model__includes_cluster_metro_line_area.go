...
// checks if the IncludesClusterMetroLineArea type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesClusterMetroLineArea{}

// IncludesClusterMetroLineArea struct for IncludesClusterMetroLineArea
type IncludesClusterMetroLineArea struct {
...
type _IncludesClusterMetroLineArea IncludesClusterMetroLineArea
...
func NewIncludesClusterMetroLineArea(id string, name string, url string) *IncludesClusterMetroLineArea {
	this := IncludesClusterMetroLineArea{}
	this.Id = id
	this.Name = name
	this.Url = url
	return &this
...
func (o IncludesClusterMetroLineArea) MarshalJSON() ([]byte, error) {
...
func (o IncludesClusterMetroLineArea) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesClusterMetroLineArea) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesClusterMetroLineArea := _IncludesClusterMetroLineArea{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesClusterMetroLineArea)

	if err != nil {
		return err
	}

	*o = IncludesClusterMetroLineArea(varIncludesClusterMetroLineArea)

	return err
}

type NullableIncludesClusterMetroLineArea struct {
	value *IncludesClusterMetroLineArea
	isSet bool
}

func (v NullableIncludesClusterMetroLineArea) Get() *IncludesClusterMetroLineArea {
	return v.value
}

func (v *NullableIncludesClusterMetroLineArea) Set(val *IncludesClusterMetroLineArea) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesClusterMetroLineArea) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesClusterMetroLineArea) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesClusterMetroLineArea(val *IncludesClusterMetroLineArea) *NullableIncludesClusterMetroLineArea {
	return &NullableIncludesClusterMetroLineArea{value: val, isSet: true}
}

func (v NullableIncludesClusterMetroLineArea) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesClusterMetroLineArea) UnmarshalJSON(src []byte) error {
	v.isSet = true
