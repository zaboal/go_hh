...
// checks if the ResumesResumeConditionFieldsSiteCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsSiteCondition{}

// ResumesResumeConditionFieldsSiteCondition struct for ResumesResumeConditionFieldsSiteCondition
type ResumesResumeConditionFieldsSiteCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsSiteFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsSiteCondition() *ResumesResumeConditionFieldsSiteCondition {
	this := ResumesResumeConditionFieldsSiteCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsSiteCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsSiteCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsSiteCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsSiteCondition) GetFields() ResumesResumeConditionFieldsSiteFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsSiteFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsSiteFields and assigns it to the Fields field.
func (o *ResumesResumeConditionFieldsSiteCondition) SetFields(v ResumesResumeConditionFieldsSiteFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *ResumesResumeConditionFieldsSiteCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsSiteCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsSiteCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsSiteCondition struct {
	value *ResumesResumeConditionFieldsSiteCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsSiteCondition) Get() *ResumesResumeConditionFieldsSiteCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsSiteCondition) Set(val *ResumesResumeConditionFieldsSiteCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsSiteCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsSiteCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsSiteCondition(val *ResumesResumeConditionFieldsSiteCondition) *NullableResumesResumeConditionFieldsSiteCondition {
	return &NullableResumesResumeConditionFieldsSiteCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsSiteCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsSiteCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
