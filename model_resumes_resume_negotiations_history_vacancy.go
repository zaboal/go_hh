...
// checks if the ResumesResumeNegotiationsHistoryVacancy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeNegotiationsHistoryVacancy{}

// ResumesResumeNegotiationsHistoryVacancy struct for ResumesResumeNegotiationsHistoryVacancy
type ResumesResumeNegotiationsHistoryVacancy struct {
	...
	Items []ResumesResumeNegotiationsHistoryVacancyItem `json:"items"`
...
type _ResumesResumeNegotiationsHistoryVacancy ResumesResumeNegotiationsHistoryVacancy
...
func NewResumesResumeNegotiationsHistoryVacancy(archived bool, canEdit bool, id string, items []ResumesResumeNegotiationsHistoryVacancyItem, messagesUrl string, name string, negotiationsUrl string, url string) *ResumesResumeNegotiationsHistoryVacancy {
	this := ResumesResumeNegotiationsHistoryVacancy{}
...
func (o *ResumesResumeNegotiationsHistoryVacancy) GetItems() []ResumesResumeNegotiationsHistoryVacancyItem {
	if o == nil {
		var ret []ResumesResumeNegotiationsHistoryVacancyItem
		return ret
	}
...
// GetMessagesUrl returns the MessagesUrl field value
...
// GetMessagesUrlOk returns a tuple with the MessagesUrl field value
// and a boolean to check if the value has been set.
...
// SetMessagesUrl sets field value
...
func (o ResumesResumeNegotiationsHistoryVacancy) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeNegotiationsHistoryVacancy) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesResumeNegotiationsHistoryVacancy) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeNegotiationsHistoryVacancy := _ResumesResumeNegotiationsHistoryVacancy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeNegotiationsHistoryVacancy)

	if err != nil {
		return err
	}

	*o = ResumesResumeNegotiationsHistoryVacancy(varResumesResumeNegotiationsHistoryVacancy)

	return err
}

type NullableResumesResumeNegotiationsHistoryVacancy struct {
	value *ResumesResumeNegotiationsHistoryVacancy
	isSet bool
}

func (v NullableResumesResumeNegotiationsHistoryVacancy) Get() *ResumesResumeNegotiationsHistoryVacancy {
	return v.value
}

func (v *NullableResumesResumeNegotiationsHistoryVacancy) Set(val *ResumesResumeNegotiationsHistoryVacancy) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeNegotiationsHistoryVacancy) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeNegotiationsHistoryVacancy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeNegotiationsHistoryVacancy(val *ResumesResumeNegotiationsHistoryVacancy) *NullableResumesResumeNegotiationsHistoryVacancy {
	return &NullableResumesResumeNegotiationsHistoryVacancy{value: val, isSet: true}
}

func (v NullableResumesResumeNegotiationsHistoryVacancy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeNegotiationsHistoryVacancy) UnmarshalJSON(src []byte) error {
	v.isSet = true
