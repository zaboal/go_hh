...
// checks if the ErrorsDictionariesBadArgumentError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsDictionariesBadArgumentError{}

// ErrorsDictionariesBadArgumentError struct for ErrorsDictionariesBadArgumentError
type ErrorsDictionariesBadArgumentError struct {
...
type _ErrorsDictionariesBadArgumentError ErrorsDictionariesBadArgumentError
...
func NewErrorsDictionariesBadArgumentError(type_ string, value string) *ErrorsDictionariesBadArgumentError {
	this := ErrorsDictionariesBadArgumentError{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o ErrorsDictionariesBadArgumentError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsDictionariesBadArgumentError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsDictionariesBadArgumentError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsDictionariesBadArgumentError := _ErrorsDictionariesBadArgumentError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsDictionariesBadArgumentError)

	if err != nil {
		return err
	}

	*o = ErrorsDictionariesBadArgumentError(varErrorsDictionariesBadArgumentError)

	return err
}

type NullableErrorsDictionariesBadArgumentError struct {
	value *ErrorsDictionariesBadArgumentError
	isSet bool
}

func (v NullableErrorsDictionariesBadArgumentError) Get() *ErrorsDictionariesBadArgumentError {
	return v.value
}

func (v *NullableErrorsDictionariesBadArgumentError) Set(val *ErrorsDictionariesBadArgumentError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsDictionariesBadArgumentError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsDictionariesBadArgumentError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsDictionariesBadArgumentError(val *ErrorsDictionariesBadArgumentError) *NullableErrorsDictionariesBadArgumentError {
	return &NullableErrorsDictionariesBadArgumentError{value: val, isSet: true}
}

func (v NullableErrorsDictionariesBadArgumentError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsDictionariesBadArgumentError) UnmarshalJSON(src []byte) error {
	v.isSet = true
