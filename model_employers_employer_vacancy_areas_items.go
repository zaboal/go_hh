...
// checks if the EmployersEmployerVacancyAreasItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployerVacancyAreasItems{}

// EmployersEmployerVacancyAreasItems struct for EmployersEmployerVacancyAreasItems
type EmployersEmployerVacancyAreasItems struct {
	// Список регионов
	Items []IncludesArea `json:"items"`
}

type _EmployersEmployerVacancyAreasItems EmployersEmployerVacancyAreasItems
...
func NewEmployersEmployerVacancyAreasItems(items []IncludesArea) *EmployersEmployerVacancyAreasItems {
	this := EmployersEmployerVacancyAreasItems{}
	this.Items = items
	return &this
}
...
func (o EmployersEmployerVacancyAreasItems) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployerVacancyAreasItems) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *EmployersEmployerVacancyAreasItems) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersEmployerVacancyAreasItems := _EmployersEmployerVacancyAreasItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersEmployerVacancyAreasItems)

	if err != nil {
		return err
	}

	*o = EmployersEmployerVacancyAreasItems(varEmployersEmployerVacancyAreasItems)

	return err
}

type NullableEmployersEmployerVacancyAreasItems struct {
	value *EmployersEmployerVacancyAreasItems
	isSet bool
}

func (v NullableEmployersEmployerVacancyAreasItems) Get() *EmployersEmployerVacancyAreasItems {
	return v.value
}

func (v *NullableEmployersEmployerVacancyAreasItems) Set(val *EmployersEmployerVacancyAreasItems) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployerVacancyAreasItems) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployerVacancyAreasItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployerVacancyAreasItems(val *EmployersEmployerVacancyAreasItems) *NullableEmployersEmployerVacancyAreasItems {
	return &NullableEmployersEmployerVacancyAreasItems{value: val, isSet: true}
}

func (v NullableEmployersEmployerVacancyAreasItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployerVacancyAreasItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
