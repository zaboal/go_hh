...
// checks if the VacancyNegotiationActions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyNegotiationActions{}

// VacancyNegotiationActions struct for VacancyNegotiationActions
type VacancyNegotiationActions struct {
	// Обязательные и дополнительные аргументы для запроса
	Arguments []VacancyArguments `json:"arguments"`
	...
	ResultingEmployerState NullableIncludesIdName `json:"resulting_employer_state,omitempty"`
	// Шаблоны писем
...
type _VacancyNegotiationActions VacancyNegotiationActions
...
func NewVacancyNegotiationActions(arguments []VacancyArguments, enabled bool, id string, method string, name string, templates []VacancyTemplates, url string) *VacancyNegotiationActions {
	this := VacancyNegotiationActions{}
...
// GetResultingEmployerState returns the ResultingEmployerState field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *VacancyNegotiationActions) GetResultingEmployerState() IncludesIdName {
	if o == nil || IsNil(o.ResultingEmployerState.Get()) {
		var ret IncludesIdName
		return ret
	}
	return *o.ResultingEmployerState.Get()
}

// GetResultingEmployerStateOk returns a tuple with the ResultingEmployerState field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *VacancyNegotiationActions) GetResultingEmployerStateOk() (*IncludesIdName, bool) {
	...
	return o.ResultingEmployerState.Get(), o.ResultingEmployerState.IsSet()
}
...
func (o *VacancyNegotiationActions) HasResultingEmployerState() bool {
	if o != nil && o.ResultingEmployerState.IsSet() {
		return true
	}
...
// SetResultingEmployerState gets a reference to the given NullableIncludesIdName and assigns it to the ResultingEmployerState field.
func (o *VacancyNegotiationActions) SetResultingEmployerState(v IncludesIdName) {
	o.ResultingEmployerState.Set(&v)
}
// SetResultingEmployerStateNil sets the value for ResultingEmployerState to be an explicit nil
func (o *VacancyNegotiationActions) SetResultingEmployerStateNil() {
	o.ResultingEmployerState.Set(nil)
}
...
func (o *VacancyNegotiationActions) UnsetResultingEmployerState() {
	o.ResultingEmployerState.Unset()
}
...
func (o VacancyNegotiationActions) MarshalJSON() ([]byte, error) {
...
func (o VacancyNegotiationActions) ToMap() (map[string]interface{}, error) {
	...
	if o.ResultingEmployerState.IsSet() {
		toSerialize["resulting_employer_state"] = o.ResultingEmployerState.Get()
	}
...
func (o *VacancyNegotiationActions) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyNegotiationActions := _VacancyNegotiationActions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyNegotiationActions)

	if err != nil {
		return err
	}

	*o = VacancyNegotiationActions(varVacancyNegotiationActions)

	return err
}

type NullableVacancyNegotiationActions struct {
	value *VacancyNegotiationActions
	isSet bool
}

func (v NullableVacancyNegotiationActions) Get() *VacancyNegotiationActions {
	return v.value
}

func (v *NullableVacancyNegotiationActions) Set(val *VacancyNegotiationActions) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyNegotiationActions) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyNegotiationActions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyNegotiationActions(val *VacancyNegotiationActions) *NullableVacancyNegotiationActions {
	return &NullableVacancyNegotiationActions{value: val, isSet: true}
}

func (v NullableVacancyNegotiationActions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyNegotiationActions) UnmarshalJSON(src []byte) error {
	v.isSet = true
