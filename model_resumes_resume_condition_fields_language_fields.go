...
// checks if the ResumesResumeConditionFieldsLanguageFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsLanguageFields{}

// ResumesResumeConditionFieldsLanguageFields struct for ResumesResumeConditionFieldsLanguageFields
type ResumesResumeConditionFieldsLanguageFields struct {
	Id NullableResumesResumeConditionFieldsRequiredWithTitle `json:"id,omitempty"`
...
func NewResumesResumeConditionFieldsLanguageFields() *ResumesResumeConditionFieldsLanguageFields {
	this := ResumesResumeConditionFieldsLanguageFields{}
	return &this
}
...
// SetId gets a reference to the given NullableResumesResumeConditionFieldsRequiredWithTitle and assigns it to the Id field.
func (o *ResumesResumeConditionFieldsLanguageFields) SetId(v ResumesResumeConditionFieldsRequiredWithTitle) {
	o.Id.Set(&v)
}
// SetIdNil sets the value for Id to be an explicit nil
func (o *ResumesResumeConditionFieldsLanguageFields) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsLanguageFields) SetLevelNil() {
	o.Level.Set(nil)
}
...
func (o ResumesResumeConditionFieldsLanguageFields) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsLanguageFields) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsLanguageFields struct {
	value *ResumesResumeConditionFieldsLanguageFields
	isSet bool
}

func (v NullableResumesResumeConditionFieldsLanguageFields) Get() *ResumesResumeConditionFieldsLanguageFields {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsLanguageFields) Set(val *ResumesResumeConditionFieldsLanguageFields) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsLanguageFields) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsLanguageFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsLanguageFields(val *ResumesResumeConditionFieldsLanguageFields) *NullableResumesResumeConditionFieldsLanguageFields {
	return &NullableResumesResumeConditionFieldsLanguageFields{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsLanguageFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsLanguageFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
