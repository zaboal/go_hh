...
// checks if the MetroMetroItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetroMetroItem{}

// MetroMetroItem struct for MetroMetroItem
...
type _MetroMetroItem MetroMetroItem
...
func (o MetroMetroItem) MarshalJSON() ([]byte, error) {
...
func (o MetroMetroItem) ToMap() (map[string]interface{}, error) {
...
func (o *MetroMetroItem) UnmarshalJSON(data []byte) (err error) {
	...
	varMetroMetroItem := _MetroMetroItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetroMetroItem)

	if err != nil {
		return err
	}

	*o = MetroMetroItem(varMetroMetroItem)

	return err
}

type NullableMetroMetroItem struct {
	value *MetroMetroItem
	isSet bool
}

func (v NullableMetroMetroItem) Get() *MetroMetroItem {
	return v.value
}

func (v *NullableMetroMetroItem) Set(val *MetroMetroItem) {
	v.value = val
	v.isSet = true
}

func (v NullableMetroMetroItem) IsSet() bool {
	return v.isSet
}

func (v *NullableMetroMetroItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetroMetroItem(val *MetroMetroItem) *NullableMetroMetroItem {
	return &NullableMetroMetroItem{value: val, isSet: true}
}

func (v NullableMetroMetroItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetroMetroItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
