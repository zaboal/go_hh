...
// checks if the SuggestsProfessionalRoles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsProfessionalRoles{}
...
type _SuggestsProfessionalRoles SuggestsProfessionalRoles
...
func NewSuggestsProfessionalRoles(items []SuggestsProfessionalRoleItem) *SuggestsProfessionalRoles {
	this := SuggestsProfessionalRoles{}
	this.Items = items
	return &this
}
...
func (o *SuggestsProfessionalRoles) GetItems() []SuggestsProfessionalRoleItem {
	if o == nil {
		var ret []SuggestsProfessionalRoleItem
		return ret
	}
...
func (o SuggestsProfessionalRoles) MarshalJSON() ([]byte, error) {
...
func (o SuggestsProfessionalRoles) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *SuggestsProfessionalRoles) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsProfessionalRoles := _SuggestsProfessionalRoles{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsProfessionalRoles)

	if err != nil {
		return err
	}

	*o = SuggestsProfessionalRoles(varSuggestsProfessionalRoles)

	return err
}

type NullableSuggestsProfessionalRoles struct {
	value *SuggestsProfessionalRoles
	isSet bool
}

func (v NullableSuggestsProfessionalRoles) Get() *SuggestsProfessionalRoles {
	return v.value
}

func (v *NullableSuggestsProfessionalRoles) Set(val *SuggestsProfessionalRoles) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsProfessionalRoles) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsProfessionalRoles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsProfessionalRoles(val *SuggestsProfessionalRoles) *NullableSuggestsProfessionalRoles {
	return &NullableSuggestsProfessionalRoles{value: val, isSet: true}
}

func (v NullableSuggestsProfessionalRoles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsProfessionalRoles) UnmarshalJSON(src []byte) error {
	v.isSet = true
