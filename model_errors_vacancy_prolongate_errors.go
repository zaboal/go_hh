...
// checks if the ErrorsVacancyProlongateErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyProlongateErrors{}

// ErrorsVacancyProlongateErrors Информация о возникших ошибках
type ErrorsVacancyProlongateErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsVacancyProlongateError `json:"errors"`
}

type _ErrorsVacancyProlongateErrors ErrorsVacancyProlongateErrors
...
func NewErrorsVacancyProlongateErrors(requestId string, errors []ErrorsVacancyProlongateError) *ErrorsVacancyProlongateErrors {
	this := ErrorsVacancyProlongateErrors{}
...
func (o *ErrorsVacancyProlongateErrors) GetErrors() []ErrorsVacancyProlongateError {
	if o == nil {
		var ret []ErrorsVacancyProlongateError
		return ret
	}
...
func (o ErrorsVacancyProlongateErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyProlongateErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyProlongateErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyProlongateErrors := _ErrorsVacancyProlongateErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyProlongateErrors)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyProlongateErrors(varErrorsVacancyProlongateErrors)

	return err
}

type NullableErrorsVacancyProlongateErrors struct {
	value *ErrorsVacancyProlongateErrors
	isSet bool
}

func (v NullableErrorsVacancyProlongateErrors) Get() *ErrorsVacancyProlongateErrors {
	return v.value
}

func (v *NullableErrorsVacancyProlongateErrors) Set(val *ErrorsVacancyProlongateErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyProlongateErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyProlongateErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyProlongateErrors(val *ErrorsVacancyProlongateErrors) *NullableErrorsVacancyProlongateErrors {
	return &NullableErrorsVacancyProlongateErrors{value: val, isSet: true}
}

func (v NullableErrorsVacancyProlongateErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyProlongateErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
