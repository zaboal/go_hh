...
// checks if the ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments{}

// ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments struct for ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments
type ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments struct {
...
func NewErrorsVacancyApplyBadRequestErrorsAllOfBadArguments() *ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments {
	this := ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments{}
	return &this
}
...
func (o ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) ToMap() (map[string]interface{}, error) {
...
type NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments struct {
	value *ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments
	isSet bool
}

func (v NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) Get() *ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments {
	return v.value
}

func (v *NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) Set(val *ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments(val *ErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) *NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments {
	return &NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments{value: val, isSet: true}
}

func (v NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyApplyBadRequestErrorsAllOfBadArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
