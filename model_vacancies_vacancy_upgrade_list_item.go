...
// checks if the VacanciesVacancyUpgradeListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyUpgradeListItem{}

// VacanciesVacancyUpgradeListItem struct for VacanciesVacancyUpgradeListItem
type VacanciesVacancyUpgradeListItem struct {
	// Список возможных действий
	Actions []VacanciesUpgradeFieldsAction `json:"actions"`
	VacancyBillingType VacanciesUpgradeFieldsBillingTypeFull `json:"vacancy_billing_type"`
	// Объект с описанием причины, по которой невозможно улучшить вакансию до данного типа. `Null`, если массив `actions` не пустой
	WithoutAction []VacanciesVacancyUpgradeListItemWithoutActionInner `json:"without_action,omitempty"`
}

type _VacanciesVacancyUpgradeListItem VacanciesVacancyUpgradeListItem
...
func NewVacanciesVacancyUpgradeListItem(actions []VacanciesUpgradeFieldsAction, vacancyBillingType VacanciesUpgradeFieldsBillingTypeFull) *VacanciesVacancyUpgradeListItem {
	this := VacanciesVacancyUpgradeListItem{}
...
func (o *VacanciesVacancyUpgradeListItem) GetActions() []VacanciesUpgradeFieldsAction {
	if o == nil {
		var ret []VacanciesUpgradeFieldsAction
		return ret
	}
...
func (o *VacanciesVacancyUpgradeListItem) GetVacancyBillingType() VacanciesUpgradeFieldsBillingTypeFull {
	if o == nil {
		var ret VacanciesUpgradeFieldsBillingTypeFull
		return ret
	}
...
// GetWithoutAction returns the WithoutAction field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *VacanciesVacancyUpgradeListItem) GetWithoutAction() []VacanciesVacancyUpgradeListItemWithoutActionInner {
	if o == nil {
		var ret []VacanciesVacancyUpgradeListItemWithoutActionInner
		return ret
	}
	return o.WithoutAction
}

// GetWithoutActionOk returns a tuple with the WithoutAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetWithoutAction gets a reference to the given []VacanciesVacancyUpgradeListItemWithoutActionInner and assigns it to the WithoutAction field.
func (o *VacanciesVacancyUpgradeListItem) SetWithoutAction(v []VacanciesVacancyUpgradeListItemWithoutActionInner) {
	o.WithoutAction = v
}

func (o VacanciesVacancyUpgradeListItem) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyUpgradeListItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["actions"] = o.Actions
	toSerialize["vacancy_billing_type"] = o.VacancyBillingType
	if o.WithoutAction != nil {
		toSerialize["without_action"] = o.WithoutAction
	}
	return toSerialize, nil
}

func (o *VacanciesVacancyUpgradeListItem) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacancyUpgradeListItem := _VacanciesVacancyUpgradeListItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacancyUpgradeListItem)

	if err != nil {
		return err
	}

	*o = VacanciesVacancyUpgradeListItem(varVacanciesVacancyUpgradeListItem)

	return err
}

type NullableVacanciesVacancyUpgradeListItem struct {
	value *VacanciesVacancyUpgradeListItem
	isSet bool
}

func (v NullableVacanciesVacancyUpgradeListItem) Get() *VacanciesVacancyUpgradeListItem {
	return v.value
}

func (v *NullableVacanciesVacancyUpgradeListItem) Set(val *VacanciesVacancyUpgradeListItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyUpgradeListItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyUpgradeListItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyUpgradeListItem(val *VacanciesVacancyUpgradeListItem) *NullableVacanciesVacancyUpgradeListItem {
	return &NullableVacanciesVacancyUpgradeListItem{value: val, isSet: true}
}

func (v NullableVacanciesVacancyUpgradeListItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyUpgradeListItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
