...
// checks if the ErrorsEmployerManagerBadAuthorizationErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsEmployerManagerBadAuthorizationErrors{}

// ErrorsEmployerManagerBadAuthorizationErrors Информация о возникших ошибках
type ErrorsEmployerManagerBadAuthorizationErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Описание ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsEmployerManagerBadAuthorizationError `json:"errors"`
}

type _ErrorsEmployerManagerBadAuthorizationErrors ErrorsEmployerManagerBadAuthorizationErrors
...
func NewErrorsEmployerManagerBadAuthorizationErrors(requestId string, errors []ErrorsEmployerManagerBadAuthorizationError) *ErrorsEmployerManagerBadAuthorizationErrors {
	this := ErrorsEmployerManagerBadAuthorizationErrors{}
...
func (o *ErrorsEmployerManagerBadAuthorizationErrors) GetErrors() []ErrorsEmployerManagerBadAuthorizationError {
	if o == nil {
		var ret []ErrorsEmployerManagerBadAuthorizationError
		return ret
	}
...
func (o ErrorsEmployerManagerBadAuthorizationErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsEmployerManagerBadAuthorizationErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsEmployerManagerBadAuthorizationErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsEmployerManagerBadAuthorizationErrors := _ErrorsEmployerManagerBadAuthorizationErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsEmployerManagerBadAuthorizationErrors)

	if err != nil {
		return err
	}

	*o = ErrorsEmployerManagerBadAuthorizationErrors(varErrorsEmployerManagerBadAuthorizationErrors)

	return err
}

type NullableErrorsEmployerManagerBadAuthorizationErrors struct {
	value *ErrorsEmployerManagerBadAuthorizationErrors
	isSet bool
}

func (v NullableErrorsEmployerManagerBadAuthorizationErrors) Get() *ErrorsEmployerManagerBadAuthorizationErrors {
	return v.value
}

func (v *NullableErrorsEmployerManagerBadAuthorizationErrors) Set(val *ErrorsEmployerManagerBadAuthorizationErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsEmployerManagerBadAuthorizationErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsEmployerManagerBadAuthorizationErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsEmployerManagerBadAuthorizationErrors(val *ErrorsEmployerManagerBadAuthorizationErrors) *NullableErrorsEmployerManagerBadAuthorizationErrors {
	return &NullableErrorsEmployerManagerBadAuthorizationErrors{value: val, isSet: true}
}

func (v NullableErrorsEmployerManagerBadAuthorizationErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsEmployerManagerBadAuthorizationErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
