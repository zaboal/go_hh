...
// checks if the IncludesLanguageProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesLanguageProperties{}

// IncludesLanguageProperties struct for IncludesLanguageProperties
type IncludesLanguageProperties struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
func NewIncludesLanguageProperties(id string, name string) *IncludesLanguageProperties {
	this := IncludesLanguageProperties{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o IncludesLanguageProperties) MarshalJSON() ([]byte, error) {
...
func (o IncludesLanguageProperties) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesLanguageProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesLanguageProperties := _IncludesLanguageProperties{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesLanguageProperties)

	if err != nil {
		return err
	}

	*o = IncludesLanguageProperties(varIncludesLanguageProperties)

	return err
}

type NullableIncludesLanguageProperties struct {
	value *IncludesLanguageProperties
	isSet bool
}

func (v NullableIncludesLanguageProperties) Get() *IncludesLanguageProperties {
	return v.value
}

func (v *NullableIncludesLanguageProperties) Set(val *IncludesLanguageProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesLanguageProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesLanguageProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesLanguageProperties(val *IncludesLanguageProperties) *NullableIncludesLanguageProperties {
	return &NullableIncludesLanguageProperties{value: val, isSet: true}
}

func (v NullableIncludesLanguageProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesLanguageProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
