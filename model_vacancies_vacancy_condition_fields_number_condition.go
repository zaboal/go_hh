...
// checks if the VacanciesVacancyConditionFieldsNumberCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsNumberCondition{}

// VacanciesVacancyConditionFieldsNumberCondition struct for VacanciesVacancyConditionFieldsNumberCondition
type VacanciesVacancyConditionFieldsNumberCondition struct {
...
func NewVacanciesVacancyConditionFieldsNumberCondition() *VacanciesVacancyConditionFieldsNumberCondition {
	this := VacanciesVacancyConditionFieldsNumberCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsNumberCondition) SetMaxLength(v float32) {
	o.MaxLength.Set(&v)
}
// SetMaxLengthNil sets the value for MaxLength to be an explicit nil
func (o *VacanciesVacancyConditionFieldsNumberCondition) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsNumberCondition) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsNumberCondition) GetRequired() bool {
...
func (o *VacanciesVacancyConditionFieldsNumberCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsNumberCondition) SetRegexpNil() {
	o.Regexp.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsNumberCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsNumberCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsNumberCondition struct {
	value *VacanciesVacancyConditionFieldsNumberCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsNumberCondition) Get() *VacanciesVacancyConditionFieldsNumberCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsNumberCondition) Set(val *VacanciesVacancyConditionFieldsNumberCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsNumberCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsNumberCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsNumberCondition(val *VacanciesVacancyConditionFieldsNumberCondition) *NullableVacanciesVacancyConditionFieldsNumberCondition {
	return &NullableVacanciesVacancyConditionFieldsNumberCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsNumberCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsNumberCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
