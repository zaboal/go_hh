...
// checks if the ResumeResumeFullAllOfResumeLocale type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeFullAllOfResumeLocale{}

// ResumeResumeFullAllOfResumeLocale Язык, на котором составлено резюме (локаль). Элемент справочника [локали резюме](#tag/Obshie-spravochniki/operation/get-locales)
type ResumeResumeFullAllOfResumeLocale struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _ResumeResumeFullAllOfResumeLocale ResumeResumeFullAllOfResumeLocale
...
func NewResumeResumeFullAllOfResumeLocale(id string, name string) *ResumeResumeFullAllOfResumeLocale {
	this := ResumeResumeFullAllOfResumeLocale{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ResumeResumeFullAllOfResumeLocale) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeFullAllOfResumeLocale) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeFullAllOfResumeLocale) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeFullAllOfResumeLocale := _ResumeResumeFullAllOfResumeLocale{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeFullAllOfResumeLocale)

	if err != nil {
		return err
	}

	*o = ResumeResumeFullAllOfResumeLocale(varResumeResumeFullAllOfResumeLocale)

	return err
}

type NullableResumeResumeFullAllOfResumeLocale struct {
	value *ResumeResumeFullAllOfResumeLocale
	isSet bool
}

func (v NullableResumeResumeFullAllOfResumeLocale) Get() *ResumeResumeFullAllOfResumeLocale {
	return v.value
}

func (v *NullableResumeResumeFullAllOfResumeLocale) Set(val *ResumeResumeFullAllOfResumeLocale) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeFullAllOfResumeLocale) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeFullAllOfResumeLocale) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeFullAllOfResumeLocale(val *ResumeResumeFullAllOfResumeLocale) *NullableResumeResumeFullAllOfResumeLocale {
	return &NullableResumeResumeFullAllOfResumeLocale{value: val, isSet: true}
}

func (v NullableResumeResumeFullAllOfResumeLocale) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeFullAllOfResumeLocale) UnmarshalJSON(src []byte) error {
	v.isSet = true
