...
// checks if the VacancyDraftAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftAddress{}
...
func (o *VacancyDraftAddress) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *VacancyDraftAddress) SetShowMetroOnlyNil() {
...
func (o VacancyDraftAddress) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftAddress) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftAddress struct {
	value *VacancyDraftAddress
	isSet bool
}

func (v NullableVacancyDraftAddress) Get() *VacancyDraftAddress {
	return v.value
}

func (v *NullableVacancyDraftAddress) Set(val *VacancyDraftAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftAddress(val *VacancyDraftAddress) *NullableVacancyDraftAddress {
	return &NullableVacancyDraftAddress{value: val, isSet: true}
}

func (v NullableVacancyDraftAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
