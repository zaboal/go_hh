...
// checks if the ResumesResumeConditionFieldsAccessCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsAccessCondition{}

// ResumesResumeConditionFieldsAccessCondition struct for ResumesResumeConditionFieldsAccessCondition
type ResumesResumeConditionFieldsAccessCondition struct {
	...
	Fields NullableResumesResumeConditionFieldsAccessFields `json:"fields,omitempty"`
}
...
func NewResumesResumeConditionFieldsAccessCondition() *ResumesResumeConditionFieldsAccessCondition {
	this := ResumesResumeConditionFieldsAccessCondition{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsAccessCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsAccessCondition) GetFields() ResumesResumeConditionFieldsAccessFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret ResumesResumeConditionFieldsAccessFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableResumesResumeConditionFieldsAccessFields and assigns it to the Fields field.
func (o *ResumesResumeConditionFieldsAccessCondition) SetFields(v ResumesResumeConditionFieldsAccessFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *ResumesResumeConditionFieldsAccessCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o ResumesResumeConditionFieldsAccessCondition) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsAccessCondition) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsAccessCondition struct {
	value *ResumesResumeConditionFieldsAccessCondition
	isSet bool
}

func (v NullableResumesResumeConditionFieldsAccessCondition) Get() *ResumesResumeConditionFieldsAccessCondition {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsAccessCondition) Set(val *ResumesResumeConditionFieldsAccessCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsAccessCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsAccessCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsAccessCondition(val *ResumesResumeConditionFieldsAccessCondition) *NullableResumesResumeConditionFieldsAccessCondition {
	return &NullableResumesResumeConditionFieldsAccessCondition{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsAccessCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsAccessCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
