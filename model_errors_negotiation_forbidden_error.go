...
// ErrorsNegotiationForbiddenError struct for ErrorsNegotiationForbiddenError
type ErrorsNegotiationForbiddenError struct {
	ErrorsCommonBadAuthorizationEmployerError *ErrorsCommonBadAuthorizationEmployerError
	ErrorsCommonBadAuthorizationError *ErrorsCommonBadAuthorizationError
	ErrorsCommonCaptchaError *ErrorsCommonCaptchaError
	ErrorsNegotiationTopicsStateChangeDeniedError *ErrorsNegotiationTopicsStateChangeDeniedError
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ErrorsNegotiationForbiddenError) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into ErrorsCommonBadAuthorizationEmployerError
	err = json.Unmarshal(data, &dst.ErrorsCommonBadAuthorizationEmployerError);
	if err == nil {
		jsonErrorsCommonBadAuthorizationEmployerError, _ := json.Marshal(dst.ErrorsCommonBadAuthorizationEmployerError)
		if string(jsonErrorsCommonBadAuthorizationEmployerError) == "{}" { // empty struct
			dst.ErrorsCommonBadAuthorizationEmployerError = nil
		} else {
			return nil // data stored in dst.ErrorsCommonBadAuthorizationEmployerError, return on the first match
		}
	} else {
		dst.ErrorsCommonBadAuthorizationEmployerError = nil
	}

	// try to unmarshal JSON data into ErrorsCommonBadAuthorizationError
	err = json.Unmarshal(data, &dst.ErrorsCommonBadAuthorizationError);
	if err == nil {
		jsonErrorsCommonBadAuthorizationError, _ := json.Marshal(dst.ErrorsCommonBadAuthorizationError)
		if string(jsonErrorsCommonBadAuthorizationError) == "{}" { // empty struct
			dst.ErrorsCommonBadAuthorizationError = nil
		} else {
			return nil // data stored in dst.ErrorsCommonBadAuthorizationError, return on the first match
		}
	} else {
		dst.ErrorsCommonBadAuthorizationError = nil
	}

	// try to unmarshal JSON data into ErrorsCommonCaptchaError
	err = json.Unmarshal(data, &dst.ErrorsCommonCaptchaError);
	if err == nil {
		jsonErrorsCommonCaptchaError, _ := json.Marshal(dst.ErrorsCommonCaptchaError)
		if string(jsonErrorsCommonCaptchaError) == "{}" { // empty struct
			dst.ErrorsCommonCaptchaError = nil
		} else {
			return nil // data stored in dst.ErrorsCommonCaptchaError, return on the first match
		}
	} else {
		dst.ErrorsCommonCaptchaError = nil
	}

	// try to unmarshal JSON data into ErrorsNegotiationTopicsStateChangeDeniedError
	err = json.Unmarshal(data, &dst.ErrorsNegotiationTopicsStateChangeDeniedError);
	if err == nil {
		jsonErrorsNegotiationTopicsStateChangeDeniedError, _ := json.Marshal(dst.ErrorsNegotiationTopicsStateChangeDeniedError)
		if string(jsonErrorsNegotiationTopicsStateChangeDeniedError) == "{}" { // empty struct
			dst.ErrorsNegotiationTopicsStateChangeDeniedError = nil
		} else {
			return nil // data stored in dst.ErrorsNegotiationTopicsStateChangeDeniedError, return on the first match
		}
	} else {
		dst.ErrorsNegotiationTopicsStateChangeDeniedError = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ErrorsNegotiationForbiddenError)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ErrorsNegotiationForbiddenError) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadAuthorizationEmployerError != nil {
		return json.Marshal(&src.ErrorsCommonBadAuthorizationEmployerError)
	}

	if src.ErrorsCommonBadAuthorizationError != nil {
		return json.Marshal(&src.ErrorsCommonBadAuthorizationError)
	}

	if src.ErrorsCommonCaptchaError != nil {
		return json.Marshal(&src.ErrorsCommonCaptchaError)
	}

	if src.ErrorsNegotiationTopicsStateChangeDeniedError != nil {
		return json.Marshal(&src.ErrorsNegotiationTopicsStateChangeDeniedError)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableErrorsNegotiationForbiddenError struct {
	value *ErrorsNegotiationForbiddenError
	isSet bool
}

func (v NullableErrorsNegotiationForbiddenError) Get() *ErrorsNegotiationForbiddenError {
	return v.value
}

func (v *NullableErrorsNegotiationForbiddenError) Set(val *ErrorsNegotiationForbiddenError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationForbiddenError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationForbiddenError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationForbiddenError(val *ErrorsNegotiationForbiddenError) *NullableErrorsNegotiationForbiddenError {
	return &NullableErrorsNegotiationForbiddenError{value: val, isSet: true}
}

func (v NullableErrorsNegotiationForbiddenError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationForbiddenError) UnmarshalJSON(src []byte) error {
	v.isSet = true
