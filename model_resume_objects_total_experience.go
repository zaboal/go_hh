...
// checks if the ResumeObjectsTotalExperience type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsTotalExperience{}

// ResumeObjectsTotalExperience struct for ResumeObjectsTotalExperience
type ResumeObjectsTotalExperience struct {
	// Общий опыт работы в месяцах, с округлением до месяца
	Months NullableFloat32 `json:"months,omitempty"`
}
...
func NewResumeObjectsTotalExperience() *ResumeObjectsTotalExperience {
	this := ResumeObjectsTotalExperience{}
	return &this
}
...
// SetMonths gets a reference to the given NullableFloat32 and assigns it to the Months field.
func (o *ResumeObjectsTotalExperience) SetMonths(v float32) {
	o.Months.Set(&v)
}
// SetMonthsNil sets the value for Months to be an explicit nil
func (o *ResumeObjectsTotalExperience) SetMonthsNil() {
	o.Months.Set(nil)
}
...
func (o ResumeObjectsTotalExperience) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsTotalExperience) ToMap() (map[string]interface{}, error) {
...
type NullableResumeObjectsTotalExperience struct {
	value *ResumeObjectsTotalExperience
	isSet bool
}

func (v NullableResumeObjectsTotalExperience) Get() *ResumeObjectsTotalExperience {
	return v.value
}

func (v *NullableResumeObjectsTotalExperience) Set(val *ResumeObjectsTotalExperience) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsTotalExperience) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsTotalExperience) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsTotalExperience(val *ResumeObjectsTotalExperience) *NullableResumeObjectsTotalExperience {
	return &NullableResumeObjectsTotalExperience{value: val, isSet: true}
}

func (v NullableResumeObjectsTotalExperience) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsTotalExperience) UnmarshalJSON(src []byte) error {
	v.isSet = true
