...
// checks if the VacanciesVacancyProlongate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyProlongate{}

// VacanciesVacancyProlongate struct for VacanciesVacancyProlongate
type VacanciesVacancyProlongate struct {
	// Список действий, которые можно предпринять для продления вакансии
	Actions []VacanciesVacancyProlongateActionsInner `json:"actions"`
...
type _VacanciesVacancyProlongate VacanciesVacancyProlongate
...
func NewVacanciesVacancyProlongate(actions []VacanciesVacancyProlongateActionsInner, expiresAt string, id string) *VacanciesVacancyProlongate {
	this := VacanciesVacancyProlongate{}
...
func (o *VacanciesVacancyProlongate) GetActions() []VacanciesVacancyProlongateActionsInner {
	if o == nil {
		var ret []VacanciesVacancyProlongateActionsInner
		return ret
	}
...
func (o VacanciesVacancyProlongate) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyProlongate) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesVacancyProlongate) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacancyProlongate := _VacanciesVacancyProlongate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacancyProlongate)

	if err != nil {
		return err
	}

	*o = VacanciesVacancyProlongate(varVacanciesVacancyProlongate)

	return err
}

type NullableVacanciesVacancyProlongate struct {
	value *VacanciesVacancyProlongate
	isSet bool
}

func (v NullableVacanciesVacancyProlongate) Get() *VacanciesVacancyProlongate {
	return v.value
}

func (v *NullableVacanciesVacancyProlongate) Set(val *VacanciesVacancyProlongate) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyProlongate) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyProlongate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyProlongate(val *VacanciesVacancyProlongate) *NullableVacanciesVacancyProlongate {
	return &NullableVacanciesVacancyProlongate{value: val, isSet: true}
}

func (v NullableVacanciesVacancyProlongate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyProlongate) UnmarshalJSON(src []byte) error {
	v.isSet = true
