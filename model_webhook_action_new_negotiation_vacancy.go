...
// checks if the WebhookActionNewNegotiationVacancy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookActionNewNegotiationVacancy{}

// WebhookActionNewNegotiationVacancy struct for WebhookActionNewNegotiationVacancy
type WebhookActionNewNegotiationVacancy struct {
...
type _WebhookActionNewNegotiationVacancy WebhookActionNewNegotiationVacancy
...
func NewWebhookActionNewNegotiationVacancy(type_ string) *WebhookActionNewNegotiationVacancy {
	this := WebhookActionNewNegotiationVacancy{}
	this.Type = type_
	return &this
}
...
func (o *WebhookActionNewNegotiationVacancy) SetSettingsNil() {
	o.Settings.Set(nil)
}
...
func (o WebhookActionNewNegotiationVacancy) MarshalJSON() ([]byte, error) {
...
func (o WebhookActionNewNegotiationVacancy) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookActionNewNegotiationVacancy) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookActionNewNegotiationVacancy := _WebhookActionNewNegotiationVacancy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookActionNewNegotiationVacancy)

	if err != nil {
		return err
	}

	*o = WebhookActionNewNegotiationVacancy(varWebhookActionNewNegotiationVacancy)

	return err
}

type NullableWebhookActionNewNegotiationVacancy struct {
	value *WebhookActionNewNegotiationVacancy
	isSet bool
}

func (v NullableWebhookActionNewNegotiationVacancy) Get() *WebhookActionNewNegotiationVacancy {
	return v.value
}

func (v *NullableWebhookActionNewNegotiationVacancy) Set(val *WebhookActionNewNegotiationVacancy) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookActionNewNegotiationVacancy) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookActionNewNegotiationVacancy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookActionNewNegotiationVacancy(val *WebhookActionNewNegotiationVacancy) *NullableWebhookActionNewNegotiationVacancy {
	return &NullableWebhookActionNewNegotiationVacancy{value: val, isSet: true}
}

func (v NullableWebhookActionNewNegotiationVacancy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookActionNewNegotiationVacancy) UnmarshalJSON(src []byte) error {
	v.isSet = true
