...
// checks if the ArtifactsArtifactPhotoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsArtifactPhotoResponse{}

// ArtifactsArtifactPhotoResponse struct for ArtifactsArtifactPhotoResponse
type ArtifactsArtifactPhotoResponse struct {
	// Список изображений
	Items []ArtifactsArtifactItem `json:"items"`
	// Найдено результатов
...
type _ArtifactsArtifactPhotoResponse ArtifactsArtifactPhotoResponse
...
func NewArtifactsArtifactPhotoResponse(items []ArtifactsArtifactItem, found float32, page float32, pages float32, perPage float32) *ArtifactsArtifactPhotoResponse {
	this := ArtifactsArtifactPhotoResponse{}
	this.Items = items
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o ArtifactsArtifactPhotoResponse) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsArtifactPhotoResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsArtifactPhotoResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsArtifactPhotoResponse := _ArtifactsArtifactPhotoResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsArtifactPhotoResponse)

	if err != nil {
		return err
	}

	*o = ArtifactsArtifactPhotoResponse(varArtifactsArtifactPhotoResponse)

	return err
}

type NullableArtifactsArtifactPhotoResponse struct {
	value *ArtifactsArtifactPhotoResponse
	isSet bool
}

func (v NullableArtifactsArtifactPhotoResponse) Get() *ArtifactsArtifactPhotoResponse {
	return v.value
}

func (v *NullableArtifactsArtifactPhotoResponse) Set(val *ArtifactsArtifactPhotoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsArtifactPhotoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsArtifactPhotoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsArtifactPhotoResponse(val *ArtifactsArtifactPhotoResponse) *NullableArtifactsArtifactPhotoResponse {
	return &NullableArtifactsArtifactPhotoResponse{value: val, isSet: true}
}

func (v NullableArtifactsArtifactPhotoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsArtifactPhotoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
