...
// checks if the EmployerServicesMethodAccessItemAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerServicesMethodAccessItemAccess{}

// EmployerServicesMethodAccessItemAccess Информация о доступе к платному методу
type EmployerServicesMethodAccessItemAccess struct {
	// Признак наличия доступа к группе методов
	HasAccess bool `json:"has_access"`
}

type _EmployerServicesMethodAccessItemAccess EmployerServicesMethodAccessItemAccess
...
func NewEmployerServicesMethodAccessItemAccess(hasAccess bool) *EmployerServicesMethodAccessItemAccess {
	this := EmployerServicesMethodAccessItemAccess{}
...
func (o EmployerServicesMethodAccessItemAccess) MarshalJSON() ([]byte, error) {
...
func (o EmployerServicesMethodAccessItemAccess) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["has_access"] = o.HasAccess
	return toSerialize, nil
}

func (o *EmployerServicesMethodAccessItemAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerServicesMethodAccessItemAccess := _EmployerServicesMethodAccessItemAccess{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerServicesMethodAccessItemAccess)

	if err != nil {
		return err
	}

	*o = EmployerServicesMethodAccessItemAccess(varEmployerServicesMethodAccessItemAccess)

	return err
}

type NullableEmployerServicesMethodAccessItemAccess struct {
	value *EmployerServicesMethodAccessItemAccess
	isSet bool
}

func (v NullableEmployerServicesMethodAccessItemAccess) Get() *EmployerServicesMethodAccessItemAccess {
	return v.value
}

func (v *NullableEmployerServicesMethodAccessItemAccess) Set(val *EmployerServicesMethodAccessItemAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerServicesMethodAccessItemAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerServicesMethodAccessItemAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerServicesMethodAccessItemAccess(val *EmployerServicesMethodAccessItemAccess) *NullableEmployerServicesMethodAccessItemAccess {
	return &NullableEmployerServicesMethodAccessItemAccess{value: val, isSet: true}
}

func (v NullableEmployerServicesMethodAccessItemAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerServicesMethodAccessItemAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
