...
// checks if the MeEmployerProfileCompanyDeprecated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeEmployerProfileCompanyDeprecated{}

// MeEmployerProfileCompanyDeprecated Информация о компании работодателя
type MeEmployerProfileCompanyDeprecated struct {
...
type _MeEmployerProfileCompanyDeprecated MeEmployerProfileCompanyDeprecated
...
func NewMeEmployerProfileCompanyDeprecated(id string, name string, managerId string) *MeEmployerProfileCompanyDeprecated {
	this := MeEmployerProfileCompanyDeprecated{}
	this.Id = id
	this.Name = name
...
func (o MeEmployerProfileCompanyDeprecated) MarshalJSON() ([]byte, error) {
...
func (o MeEmployerProfileCompanyDeprecated) ToMap() (map[string]interface{}, error) {
...
func (o *MeEmployerProfileCompanyDeprecated) UnmarshalJSON(data []byte) (err error) {
	...
	varMeEmployerProfileCompanyDeprecated := _MeEmployerProfileCompanyDeprecated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMeEmployerProfileCompanyDeprecated)

	if err != nil {
		return err
	}

	*o = MeEmployerProfileCompanyDeprecated(varMeEmployerProfileCompanyDeprecated)

	return err
}

type NullableMeEmployerProfileCompanyDeprecated struct {
	value *MeEmployerProfileCompanyDeprecated
	isSet bool
}

func (v NullableMeEmployerProfileCompanyDeprecated) Get() *MeEmployerProfileCompanyDeprecated {
	return v.value
}

func (v *NullableMeEmployerProfileCompanyDeprecated) Set(val *MeEmployerProfileCompanyDeprecated) {
	v.value = val
	v.isSet = true
}

func (v NullableMeEmployerProfileCompanyDeprecated) IsSet() bool {
	return v.isSet
}

func (v *NullableMeEmployerProfileCompanyDeprecated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeEmployerProfileCompanyDeprecated(val *MeEmployerProfileCompanyDeprecated) *NullableMeEmployerProfileCompanyDeprecated {
	return &NullableMeEmployerProfileCompanyDeprecated{value: val, isSet: true}
}

func (v NullableMeEmployerProfileCompanyDeprecated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeEmployerProfileCompanyDeprecated) UnmarshalJSON(src []byte) error {
	v.isSet = true
