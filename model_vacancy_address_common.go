...
// checks if the VacancyAddressCommon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyAddressCommon{}

// VacancyAddressCommon Адрес
type VacancyAddressCommon struct {
...
func (o *VacancyAddressCommon) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o VacancyAddressCommon) MarshalJSON() ([]byte, error) {
...
func (o VacancyAddressCommon) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyAddressCommon struct {
	value *VacancyAddressCommon
	isSet bool
}

func (v NullableVacancyAddressCommon) Get() *VacancyAddressCommon {
	return v.value
}

func (v *NullableVacancyAddressCommon) Set(val *VacancyAddressCommon) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyAddressCommon) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyAddressCommon) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyAddressCommon(val *VacancyAddressCommon) *NullableVacancyAddressCommon {
	return &NullableVacancyAddressCommon{value: val, isSet: true}
}

func (v NullableVacancyAddressCommon) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyAddressCommon) UnmarshalJSON(src []byte) error {
	v.isSet = true
