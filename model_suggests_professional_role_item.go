...
// checks if the SuggestsProfessionalRoleItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsProfessionalRoleItem{}

// SuggestsProfessionalRoleItem struct for SuggestsProfessionalRoleItem
...
type _SuggestsProfessionalRoleItem SuggestsProfessionalRoleItem
...
func NewSuggestsProfessionalRoleItem(acceptIncompleteResumes bool, id string, text string) *SuggestsProfessionalRoleItem {
	this := SuggestsProfessionalRoleItem{}
...
func (o SuggestsProfessionalRoleItem) MarshalJSON() ([]byte, error) {
...
func (o SuggestsProfessionalRoleItem) ToMap() (map[string]interface{}, error) {
...
func (o *SuggestsProfessionalRoleItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsProfessionalRoleItem := _SuggestsProfessionalRoleItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsProfessionalRoleItem)

	if err != nil {
		return err
	}

	*o = SuggestsProfessionalRoleItem(varSuggestsProfessionalRoleItem)

	return err
}

type NullableSuggestsProfessionalRoleItem struct {
	value *SuggestsProfessionalRoleItem
	isSet bool
}

func (v NullableSuggestsProfessionalRoleItem) Get() *SuggestsProfessionalRoleItem {
	return v.value
}

func (v *NullableSuggestsProfessionalRoleItem) Set(val *SuggestsProfessionalRoleItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsProfessionalRoleItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsProfessionalRoleItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsProfessionalRoleItem(val *SuggestsProfessionalRoleItem) *NullableSuggestsProfessionalRoleItem {
	return &NullableSuggestsProfessionalRoleItem{value: val, isSet: true}
}

func (v NullableSuggestsProfessionalRoleItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsProfessionalRoleItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
