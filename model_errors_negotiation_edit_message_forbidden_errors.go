...
// ErrorsNegotiationEditMessageForbiddenErrors struct for ErrorsNegotiationEditMessageForbiddenErrors
type ErrorsNegotiationEditMessageForbiddenErrors struct {
	ErrorsCommonBadAuthorizationErrors *ErrorsCommonBadAuthorizationErrors
	ErrorsNegotiationEditMessageErrors *ErrorsNegotiationEditMessageErrors
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ErrorsNegotiationEditMessageForbiddenErrors) UnmarshalJSON(data []byte) error {
	var err error
	...
	// try to unmarshal JSON data into ErrorsNegotiationEditMessageErrors
	err = json.Unmarshal(data, &dst.ErrorsNegotiationEditMessageErrors);
	if err == nil {
		jsonErrorsNegotiationEditMessageErrors, _ := json.Marshal(dst.ErrorsNegotiationEditMessageErrors)
		if string(jsonErrorsNegotiationEditMessageErrors) == "{}" { // empty struct
			dst.ErrorsNegotiationEditMessageErrors = nil
		} else {
			return nil // data stored in dst.ErrorsNegotiationEditMessageErrors, return on the first match
		}
	} else {
		dst.ErrorsNegotiationEditMessageErrors = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ErrorsNegotiationEditMessageForbiddenErrors)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ErrorsNegotiationEditMessageForbiddenErrors) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadAuthorizationErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadAuthorizationErrors)
	}

	if src.ErrorsNegotiationEditMessageErrors != nil {
		return json.Marshal(&src.ErrorsNegotiationEditMessageErrors)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableErrorsNegotiationEditMessageForbiddenErrors struct {
	value *ErrorsNegotiationEditMessageForbiddenErrors
	isSet bool
}

func (v NullableErrorsNegotiationEditMessageForbiddenErrors) Get() *ErrorsNegotiationEditMessageForbiddenErrors {
	return v.value
}

func (v *NullableErrorsNegotiationEditMessageForbiddenErrors) Set(val *ErrorsNegotiationEditMessageForbiddenErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationEditMessageForbiddenErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationEditMessageForbiddenErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationEditMessageForbiddenErrors(val *ErrorsNegotiationEditMessageForbiddenErrors) *NullableErrorsNegotiationEditMessageForbiddenErrors {
	return &NullableErrorsNegotiationEditMessageForbiddenErrors{value: val, isSet: true}
}

func (v NullableErrorsNegotiationEditMessageForbiddenErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationEditMessageForbiddenErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
