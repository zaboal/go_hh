...
// checks if the VacanciesVisitorsHiddenOnPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVisitorsHiddenOnPage{}

// VacanciesVisitorsHiddenOnPage struct for VacanciesVisitorsHiddenOnPage
type VacanciesVisitorsHiddenOnPage struct {
	// Количество удаленных или скрытых соискателями резюме на странице
	HiddenOnPage float32 `json:"hidden_on_page"`
}

type _VacanciesVisitorsHiddenOnPage VacanciesVisitorsHiddenOnPage
...
func NewVacanciesVisitorsHiddenOnPage(hiddenOnPage float32) *VacanciesVisitorsHiddenOnPage {
	this := VacanciesVisitorsHiddenOnPage{}
...
func (o VacanciesVisitorsHiddenOnPage) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVisitorsHiddenOnPage) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["hidden_on_page"] = o.HiddenOnPage
	return toSerialize, nil
}

func (o *VacanciesVisitorsHiddenOnPage) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVisitorsHiddenOnPage := _VacanciesVisitorsHiddenOnPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVisitorsHiddenOnPage)

	if err != nil {
		return err
	}

	*o = VacanciesVisitorsHiddenOnPage(varVacanciesVisitorsHiddenOnPage)

	return err
}

type NullableVacanciesVisitorsHiddenOnPage struct {
	value *VacanciesVisitorsHiddenOnPage
	isSet bool
}

func (v NullableVacanciesVisitorsHiddenOnPage) Get() *VacanciesVisitorsHiddenOnPage {
	return v.value
}

func (v *NullableVacanciesVisitorsHiddenOnPage) Set(val *VacanciesVisitorsHiddenOnPage) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVisitorsHiddenOnPage) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVisitorsHiddenOnPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVisitorsHiddenOnPage(val *VacanciesVisitorsHiddenOnPage) *NullableVacanciesVisitorsHiddenOnPage {
	return &NullableVacanciesVisitorsHiddenOnPage{value: val, isSet: true}
}

func (v NullableVacanciesVisitorsHiddenOnPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVisitorsHiddenOnPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
