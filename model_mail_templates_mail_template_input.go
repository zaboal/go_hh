...
// checks if the MailTemplatesMailTemplateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailTemplatesMailTemplateInput{}

// MailTemplatesMailTemplateInput struct for MailTemplatesMailTemplateInput
type MailTemplatesMailTemplateInput struct {
	// Текст шаблона
	Text string `json:"text"`
}

type _MailTemplatesMailTemplateInput MailTemplatesMailTemplateInput
...
func NewMailTemplatesMailTemplateInput(text string) *MailTemplatesMailTemplateInput {
	this := MailTemplatesMailTemplateInput{}
	this.Text = text
	return &this
}
...
func (o MailTemplatesMailTemplateInput) MarshalJSON() ([]byte, error) {
...
func (o MailTemplatesMailTemplateInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["text"] = o.Text
	return toSerialize, nil
}

func (o *MailTemplatesMailTemplateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMailTemplatesMailTemplateInput := _MailTemplatesMailTemplateInput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMailTemplatesMailTemplateInput)

	if err != nil {
		return err
	}

	*o = MailTemplatesMailTemplateInput(varMailTemplatesMailTemplateInput)

	return err
}

type NullableMailTemplatesMailTemplateInput struct {
	value *MailTemplatesMailTemplateInput
	isSet bool
}

func (v NullableMailTemplatesMailTemplateInput) Get() *MailTemplatesMailTemplateInput {
	return v.value
}

func (v *NullableMailTemplatesMailTemplateInput) Set(val *MailTemplatesMailTemplateInput) {
	v.value = val
	v.isSet = true
}

func (v NullableMailTemplatesMailTemplateInput) IsSet() bool {
	return v.isSet
}

func (v *NullableMailTemplatesMailTemplateInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailTemplatesMailTemplateInput(val *MailTemplatesMailTemplateInput) *NullableMailTemplatesMailTemplateInput {
	return &NullableMailTemplatesMailTemplateInput{value: val, isSet: true}
}

func (v NullableMailTemplatesMailTemplateInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailTemplatesMailTemplateInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
