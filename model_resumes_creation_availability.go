...
// checks if the ResumesCreationAvailability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesCreationAvailability{}

// ResumesCreationAvailability struct for ResumesCreationAvailability
type ResumesCreationAvailability struct {
	// Количество созданных резюме
	Created float32 `json:"created"`
	// Доступно ли создание новых резюме для данного пользователя
	IsCreationAvailable bool `json:"is_creation_available"`
...
type _ResumesCreationAvailability ResumesCreationAvailability
...
func NewResumesCreationAvailability(created float32, isCreationAvailable bool, max float32, remaining float32) *ResumesCreationAvailability {
	this := ResumesCreationAvailability{}
...
// GetIsCreationAvailable returns the IsCreationAvailable field value
func (o *ResumesCreationAvailability) GetIsCreationAvailable() bool {
	...
	return o.IsCreationAvailable
}

// GetIsCreationAvailableOk returns a tuple with the IsCreationAvailable field value
// and a boolean to check if the value has been set.
func (o *ResumesCreationAvailability) GetIsCreationAvailableOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsCreationAvailable, true
}

// SetIsCreationAvailable sets field value
func (o *ResumesCreationAvailability) SetIsCreationAvailable(v bool) {
	o.IsCreationAvailable = v
}
...
func (o ResumesCreationAvailability) MarshalJSON() ([]byte, error) {
...
func (o ResumesCreationAvailability) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["created"] = o.Created
	toSerialize["is_creation_available"] = o.IsCreationAvailable
	toSerialize["max"] = o.Max
	toSerialize["remaining"] = o.Remaining
	return toSerialize, nil
}

func (o *ResumesCreationAvailability) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesCreationAvailability := _ResumesCreationAvailability{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesCreationAvailability)

	if err != nil {
		return err
	}

	*o = ResumesCreationAvailability(varResumesCreationAvailability)

	return err
}

type NullableResumesCreationAvailability struct {
	value *ResumesCreationAvailability
	isSet bool
}

func (v NullableResumesCreationAvailability) Get() *ResumesCreationAvailability {
	return v.value
}

func (v *NullableResumesCreationAvailability) Set(val *ResumesCreationAvailability) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesCreationAvailability) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesCreationAvailability) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesCreationAvailability(val *ResumesCreationAvailability) *NullableResumesCreationAvailability {
	return &NullableResumesCreationAvailability{value: val, isSet: true}
}

func (v NullableResumesCreationAvailability) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesCreationAvailability) UnmarshalJSON(src []byte) error {
	v.isSet = true
