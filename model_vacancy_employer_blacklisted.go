...
// checks if the VacancyEmployerBlacklisted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyEmployerBlacklisted{}

// VacancyEmployerBlacklisted struct for VacancyEmployerBlacklisted
type VacancyEmployerBlacklisted struct {
...
func NewVacancyEmployerBlacklisted() *VacancyEmployerBlacklisted {
	this := VacancyEmployerBlacklisted{}
	return &this
}
...
func (o VacancyEmployerBlacklisted) MarshalJSON() ([]byte, error) {
...
func (o VacancyEmployerBlacklisted) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyEmployerBlacklisted struct {
	value *VacancyEmployerBlacklisted
	isSet bool
}

func (v NullableVacancyEmployerBlacklisted) Get() *VacancyEmployerBlacklisted {
	return v.value
}

func (v *NullableVacancyEmployerBlacklisted) Set(val *VacancyEmployerBlacklisted) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyEmployerBlacklisted) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyEmployerBlacklisted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyEmployerBlacklisted(val *VacancyEmployerBlacklisted) *NullableVacancyEmployerBlacklisted {
	return &NullableVacancyEmployerBlacklisted{value: val, isSet: true}
}

func (v NullableVacancyEmployerBlacklisted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyEmployerBlacklisted) UnmarshalJSON(src []byte) error {
	v.isSet = true
