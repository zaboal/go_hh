...
// checks if the ResumeObjectsSalaryProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsSalaryProperties{}

// ResumeObjectsSalaryProperties struct for ResumeObjectsSalaryProperties
type ResumeObjectsSalaryProperties struct {
	// Сумма
...
func NewResumeObjectsSalaryProperties() *ResumeObjectsSalaryProperties {
	this := ResumeObjectsSalaryProperties{}
	return &this
}
...
func (o *ResumeObjectsSalaryProperties) SetAmountNil() {
	o.Amount.Set(nil)
}
...
func (o *ResumeObjectsSalaryProperties) SetCurrencyNil() {
	o.Currency.Set(nil)
}
...
func (o ResumeObjectsSalaryProperties) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsSalaryProperties) ToMap() (map[string]interface{}, error) {
...
type NullableResumeObjectsSalaryProperties struct {
	value *ResumeObjectsSalaryProperties
	isSet bool
}

func (v NullableResumeObjectsSalaryProperties) Get() *ResumeObjectsSalaryProperties {
	return v.value
}

func (v *NullableResumeObjectsSalaryProperties) Set(val *ResumeObjectsSalaryProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsSalaryProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsSalaryProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsSalaryProperties(val *ResumeObjectsSalaryProperties) *NullableResumeObjectsSalaryProperties {
	return &NullableResumeObjectsSalaryProperties{value: val, isSet: true}
}

func (v NullableResumeObjectsSalaryProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsSalaryProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
