...
// checks if the IncludesEmployerApplicantServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesEmployerApplicantServices{}

// IncludesEmployerApplicantServices Информация о подключенных услугах соискателя, относящихся к данному работодателю
type IncludesEmployerApplicantServices struct {
	TargetEmployer *IncludesEmployerApplicantServicesTargetEmployer `json:"target_employer,omitempty"`
}
...
func NewIncludesEmployerApplicantServices() *IncludesEmployerApplicantServices {
	this := IncludesEmployerApplicantServices{}
	return &this
}
...
// GetTargetEmployer returns the TargetEmployer field value if set, zero value otherwise.
func (o *IncludesEmployerApplicantServices) GetTargetEmployer() IncludesEmployerApplicantServicesTargetEmployer {
	if o == nil || IsNil(o.TargetEmployer) {
		var ret IncludesEmployerApplicantServicesTargetEmployer
		return ret
	}
	return *o.TargetEmployer
}

// GetTargetEmployerOk returns a tuple with the TargetEmployer field value if set, nil otherwise
...
// SetTargetEmployer gets a reference to the given IncludesEmployerApplicantServicesTargetEmployer and assigns it to the TargetEmployer field.
func (o *IncludesEmployerApplicantServices) SetTargetEmployer(v IncludesEmployerApplicantServicesTargetEmployer) {
	o.TargetEmployer = &v
}

func (o IncludesEmployerApplicantServices) MarshalJSON() ([]byte, error) {
...
func (o IncludesEmployerApplicantServices) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TargetEmployer) {
		toSerialize["target_employer"] = o.TargetEmployer
	}
	return toSerialize, nil
}

type NullableIncludesEmployerApplicantServices struct {
	value *IncludesEmployerApplicantServices
	isSet bool
}

func (v NullableIncludesEmployerApplicantServices) Get() *IncludesEmployerApplicantServices {
	return v.value
}

func (v *NullableIncludesEmployerApplicantServices) Set(val *IncludesEmployerApplicantServices) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesEmployerApplicantServices) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesEmployerApplicantServices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesEmployerApplicantServices(val *IncludesEmployerApplicantServices) *NullableIncludesEmployerApplicantServices {
	return &NullableIncludesEmployerApplicantServices{value: val, isSet: true}
}

func (v NullableIncludesEmployerApplicantServices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesEmployerApplicantServices) UnmarshalJSON(src []byte) error {
	v.isSet = true
