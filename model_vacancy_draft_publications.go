...
// checks if the VacancyDraftPublications type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftPublications{}

// VacancyDraftPublications struct for VacancyDraftPublications
type VacancyDraftPublications struct {
	BillingType VacancyBillingTypeOutput `json:"billing_type"`
...
type _VacancyDraftPublications VacancyDraftPublications
...
func (o *VacancyDraftPublications) GetBillingTypeOk() (VacancyBillingTypeOutput, bool) {
	if o == nil || IsNil(o.BillingType) {
		return VacancyBillingTypeOutput{}, false
	}
...
func (o VacancyDraftPublications) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftPublications) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyDraftPublications) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDraftPublications := _VacancyDraftPublications{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDraftPublications)

	if err != nil {
		return err
	}

	*o = VacancyDraftPublications(varVacancyDraftPublications)

	return err
}

type NullableVacancyDraftPublications struct {
	value *VacancyDraftPublications
	isSet bool
}

func (v NullableVacancyDraftPublications) Get() *VacancyDraftPublications {
	return v.value
}

func (v *NullableVacancyDraftPublications) Set(val *VacancyDraftPublications) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftPublications) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftPublications) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftPublications(val *VacancyDraftPublications) *NullableVacancyDraftPublications {
	return &NullableVacancyDraftPublications{value: val, isSet: true}
}

func (v NullableVacancyDraftPublications) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftPublications) UnmarshalJSON(src []byte) error {
	v.isSet = true
