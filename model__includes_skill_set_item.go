...
// checks if the IncludesSkillSetItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesSkillSetItem{}

// IncludesSkillSetItem struct for IncludesSkillSetItem
type IncludesSkillSetItem struct {
...
type _IncludesSkillSetItem IncludesSkillSetItem
...
func (o IncludesSkillSetItem) MarshalJSON() ([]byte, error) {
...
func (o IncludesSkillSetItem) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesSkillSetItem) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesSkillSetItem := _IncludesSkillSetItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesSkillSetItem)

	if err != nil {
		return err
	}

	*o = IncludesSkillSetItem(varIncludesSkillSetItem)

	return err
}

type NullableIncludesSkillSetItem struct {
	value *IncludesSkillSetItem
	isSet bool
}

func (v NullableIncludesSkillSetItem) Get() *IncludesSkillSetItem {
	return v.value
}

func (v *NullableIncludesSkillSetItem) Set(val *IncludesSkillSetItem) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesSkillSetItem) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesSkillSetItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesSkillSetItem(val *IncludesSkillSetItem) *NullableIncludesSkillSetItem {
	return &NullableIncludesSkillSetItem{value: val, isSet: true}
}

func (v NullableIncludesSkillSetItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesSkillSetItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
