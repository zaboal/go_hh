...
// checks if the NegotiationsMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsMessage{}
...
type _NegotiationsMessage NegotiationsMessage
...
func (o NegotiationsMessage) MarshalJSON() ([]byte, error) {
...
func (o *NegotiationsMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsMessage := _NegotiationsMessage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsMessage)

	if err != nil {
		return err
	}

	*o = NegotiationsMessage(varNegotiationsMessage)

	return err
}

type NullableNegotiationsMessage struct {
	value *NegotiationsMessage
	isSet bool
}

func (v NullableNegotiationsMessage) Get() *NegotiationsMessage {
	return v.value
}

func (v *NullableNegotiationsMessage) Set(val *NegotiationsMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsMessage(val *NegotiationsMessage) *NullableNegotiationsMessage {
	return &NullableNegotiationsMessage{value: val, isSet: true}
}

func (v NullableNegotiationsMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
