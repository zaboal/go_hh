...
// checks if the NegotiationsMessagesGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsMessagesGet{}

// NegotiationsMessagesGet Сообщение в отклике
type NegotiationsMessagesGet struct {
	...
	Assessments []NegotiationsAssessment `json:"assessments,omitempty"`
}

type _NegotiationsMessagesGet NegotiationsMessagesGet

// NewNegotiationsMessagesGet instantiates a new NegotiationsMessagesGet object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewNegotiationsMessagesGet(address NullableVacancyAddressOutput, author NegotiationsAuthor, createdAt string, editable bool, id string, state IncludesIdName, text string, viewedByMe bool, viewedByOpponent bool) *NegotiationsMessagesGet {
...
func (o *NegotiationsMessagesGet) GetAddress() VacancyAddressOutput {
...
func (o *NegotiationsMessagesGet) GetAddressOk() (*VacancyAddressOutput, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NegotiationsMessagesGet) SetAddress(v VacancyAddressOutput) {
	o.Address.Set(&v)
}
...
func (o *NegotiationsMessagesGet) GetAssessments() []NegotiationsAssessment {
	if o == nil || IsNil(o.Assessments) {
		var ret []NegotiationsAssessment
		return ret
	}
...
// SetAssessments gets a reference to the given []NegotiationsAssessment and assigns it to the Assessments field.
func (o *NegotiationsMessagesGet) SetAssessments(v []NegotiationsAssessment) {
	o.Assessments = v
}

func (o NegotiationsMessagesGet) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsMessagesGet) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsMessagesGet) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsMessagesGet := _NegotiationsMessagesGet{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsMessagesGet)

	if err != nil {
		return err
	}

	*o = NegotiationsMessagesGet(varNegotiationsMessagesGet)

	return err
}

type NullableNegotiationsMessagesGet struct {
	value *NegotiationsMessagesGet
	isSet bool
}

func (v NullableNegotiationsMessagesGet) Get() *NegotiationsMessagesGet {
	return v.value
}

func (v *NullableNegotiationsMessagesGet) Set(val *NegotiationsMessagesGet) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsMessagesGet) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsMessagesGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsMessagesGet(val *NegotiationsMessagesGet) *NullableNegotiationsMessagesGet {
	return &NullableNegotiationsMessagesGet{value: val, isSet: true}
}

func (v NullableNegotiationsMessagesGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsMessagesGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
