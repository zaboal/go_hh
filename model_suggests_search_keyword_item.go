...
// checks if the SuggestsSearchKeywordItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsSearchKeywordItem{}

// SuggestsSearchKeywordItem struct for SuggestsSearchKeywordItem
type SuggestsSearchKeywordItem struct {
	// Ключевое слово
	Text string `json:"text"`
}

type _SuggestsSearchKeywordItem SuggestsSearchKeywordItem
...
func NewSuggestsSearchKeywordItem(text string) *SuggestsSearchKeywordItem {
	this := SuggestsSearchKeywordItem{}
	this.Text = text
	return &this
}
...
func (o SuggestsSearchKeywordItem) MarshalJSON() ([]byte, error) {
...
func (o SuggestsSearchKeywordItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["text"] = o.Text
	return toSerialize, nil
}

func (o *SuggestsSearchKeywordItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsSearchKeywordItem := _SuggestsSearchKeywordItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsSearchKeywordItem)

	if err != nil {
		return err
	}

	*o = SuggestsSearchKeywordItem(varSuggestsSearchKeywordItem)

	return err
}

type NullableSuggestsSearchKeywordItem struct {
	value *SuggestsSearchKeywordItem
	isSet bool
}

func (v NullableSuggestsSearchKeywordItem) Get() *SuggestsSearchKeywordItem {
	return v.value
}

func (v *NullableSuggestsSearchKeywordItem) Set(val *SuggestsSearchKeywordItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsSearchKeywordItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsSearchKeywordItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsSearchKeywordItem(val *SuggestsSearchKeywordItem) *NullableSuggestsSearchKeywordItem {
	return &NullableSuggestsSearchKeywordItem{value: val, isSet: true}
}

func (v NullableSuggestsSearchKeywordItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsSearchKeywordItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
