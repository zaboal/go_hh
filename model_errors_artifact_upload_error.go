...
// checks if the ErrorsArtifactUploadError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsArtifactUploadError{}

// ErrorsArtifactUploadError struct for ErrorsArtifactUploadError
type ErrorsArtifactUploadError struct {
...
type _ErrorsArtifactUploadError ErrorsArtifactUploadError
...
func NewErrorsArtifactUploadError(type_ string, value string) *ErrorsArtifactUploadError {
	this := ErrorsArtifactUploadError{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o ErrorsArtifactUploadError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsArtifactUploadError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsArtifactUploadError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsArtifactUploadError := _ErrorsArtifactUploadError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsArtifactUploadError)

	if err != nil {
		return err
	}

	*o = ErrorsArtifactUploadError(varErrorsArtifactUploadError)

	return err
}

type NullableErrorsArtifactUploadError struct {
	value *ErrorsArtifactUploadError
	isSet bool
}

func (v NullableErrorsArtifactUploadError) Get() *ErrorsArtifactUploadError {
	return v.value
}

func (v *NullableErrorsArtifactUploadError) Set(val *ErrorsArtifactUploadError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsArtifactUploadError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsArtifactUploadError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsArtifactUploadError(val *ErrorsArtifactUploadError) *NullableErrorsArtifactUploadError {
	return &NullableErrorsArtifactUploadError{value: val, isSet: true}
}

func (v NullableErrorsArtifactUploadError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsArtifactUploadError) UnmarshalJSON(src []byte) error {
	v.isSet = true
