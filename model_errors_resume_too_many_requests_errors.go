...
// checks if the ErrorsResumeTooManyRequestsErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsResumeTooManyRequestsErrors{}

// ErrorsResumeTooManyRequestsErrors Информация о возникших ошибках
type ErrorsResumeTooManyRequestsErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsResumeTooManyRequestsError `json:"errors"`
}

type _ErrorsResumeTooManyRequestsErrors ErrorsResumeTooManyRequestsErrors
...
func NewErrorsResumeTooManyRequestsErrors(requestId string, errors []ErrorsResumeTooManyRequestsError) *ErrorsResumeTooManyRequestsErrors {
	this := ErrorsResumeTooManyRequestsErrors{}
...
func (o *ErrorsResumeTooManyRequestsErrors) GetErrors() []ErrorsResumeTooManyRequestsError {
	if o == nil {
		var ret []ErrorsResumeTooManyRequestsError
		return ret
	}
...
func (o ErrorsResumeTooManyRequestsErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsResumeTooManyRequestsErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsResumeTooManyRequestsErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsResumeTooManyRequestsErrors := _ErrorsResumeTooManyRequestsErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsResumeTooManyRequestsErrors)

	if err != nil {
		return err
	}

	*o = ErrorsResumeTooManyRequestsErrors(varErrorsResumeTooManyRequestsErrors)

	return err
}

type NullableErrorsResumeTooManyRequestsErrors struct {
	value *ErrorsResumeTooManyRequestsErrors
	isSet bool
}

func (v NullableErrorsResumeTooManyRequestsErrors) Get() *ErrorsResumeTooManyRequestsErrors {
	return v.value
}

func (v *NullableErrorsResumeTooManyRequestsErrors) Set(val *ErrorsResumeTooManyRequestsErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsResumeTooManyRequestsErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsResumeTooManyRequestsErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsResumeTooManyRequestsErrors(val *ErrorsResumeTooManyRequestsErrors) *NullableErrorsResumeTooManyRequestsErrors {
	return &NullableErrorsResumeTooManyRequestsErrors{value: val, isSet: true}
}

func (v NullableErrorsResumeTooManyRequestsErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsResumeTooManyRequestsErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
