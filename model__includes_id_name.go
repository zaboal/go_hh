...
// checks if the IncludesIdName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesIdName{}

// IncludesIdName struct for IncludesIdName
type IncludesIdName struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _IncludesIdName IncludesIdName
...
func (o IncludesIdName) MarshalJSON() ([]byte, error) {
...
func (o IncludesIdName) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesIdName) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesIdName := _IncludesIdName{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesIdName)

	if err != nil {
		return err
	}

	*o = IncludesIdName(varIncludesIdName)

	return err
}

type NullableIncludesIdName struct {
	value *IncludesIdName
	isSet bool
}

func (v NullableIncludesIdName) Get() *IncludesIdName {
	return v.value
}

func (v *NullableIncludesIdName) Set(val *IncludesIdName) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesIdName) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesIdName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesIdName(val *IncludesIdName) *NullableIncludesIdName {
	return &NullableIncludesIdName{value: val, isSet: true}
}

func (v NullableIncludesIdName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesIdName) UnmarshalJSON(src []byte) error {
	v.isSet = true
