...
// checks if the ResumePhotoPortfolio type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumePhotoPortfolio{}

// ResumePhotoPortfolio struct for ResumePhotoPortfolio
type ResumePhotoPortfolio struct {
...
type _ResumePhotoPortfolio ResumePhotoPortfolio
...
func (o *ResumePhotoPortfolio) SetPhotoNil() {
	o.Photo.Set(nil)
}
...
func (o ResumePhotoPortfolio) MarshalJSON() ([]byte, error) {
...
func (o ResumePhotoPortfolio) ToMap() (map[string]interface{}, error) {
...
func (o *ResumePhotoPortfolio) UnmarshalJSON(data []byte) (err error) {
	...
	varResumePhotoPortfolio := _ResumePhotoPortfolio{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumePhotoPortfolio)

	if err != nil {
		return err
	}

	*o = ResumePhotoPortfolio(varResumePhotoPortfolio)

	return err
}

type NullableResumePhotoPortfolio struct {
	value *ResumePhotoPortfolio
	isSet bool
}

func (v NullableResumePhotoPortfolio) Get() *ResumePhotoPortfolio {
	return v.value
}

func (v *NullableResumePhotoPortfolio) Set(val *ResumePhotoPortfolio) {
	v.value = val
	v.isSet = true
}

func (v NullableResumePhotoPortfolio) IsSet() bool {
	return v.isSet
}

func (v *NullableResumePhotoPortfolio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumePhotoPortfolio(val *ResumePhotoPortfolio) *NullableResumePhotoPortfolio {
	return &NullableResumePhotoPortfolio{value: val, isSet: true}
}

func (v NullableResumePhotoPortfolio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumePhotoPortfolio) UnmarshalJSON(src []byte) error {
	v.isSet = true
