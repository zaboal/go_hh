...
// ErrorsNegotiationHideResponseForbiddenErrors struct for ErrorsNegotiationHideResponseForbiddenErrors
type ErrorsNegotiationHideResponseForbiddenErrors struct {
	ErrorsCommonBadAuthorizationErrors *ErrorsCommonBadAuthorizationErrors
	ErrorsNegotiationHideResponseErrors *ErrorsNegotiationHideResponseErrors
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ErrorsNegotiationHideResponseForbiddenErrors) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into ErrorsCommonBadAuthorizationErrors
	err = json.Unmarshal(data, &dst.ErrorsCommonBadAuthorizationErrors);
	if err == nil {
		...
		if string(jsonErrorsCommonBadAuthorizationErrors) == "{}" { // empty struct
			...
			return nil // data stored in dst.ErrorsCommonBadAuthorizationErrors, return on the first match
		}
	} else {
		dst.ErrorsCommonBadAuthorizationErrors = nil
	}

	// try to unmarshal JSON data into ErrorsNegotiationHideResponseErrors
	err = json.Unmarshal(data, &dst.ErrorsNegotiationHideResponseErrors);
	if err == nil {
		jsonErrorsNegotiationHideResponseErrors, _ := json.Marshal(dst.ErrorsNegotiationHideResponseErrors)
		if string(jsonErrorsNegotiationHideResponseErrors) == "{}" { // empty struct
			dst.ErrorsNegotiationHideResponseErrors = nil
		} else {
			return nil // data stored in dst.ErrorsNegotiationHideResponseErrors, return on the first match
		}
	} else {
		dst.ErrorsNegotiationHideResponseErrors = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ErrorsNegotiationHideResponseForbiddenErrors)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ErrorsNegotiationHideResponseForbiddenErrors) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonBadAuthorizationErrors != nil {
		return json.Marshal(&src.ErrorsCommonBadAuthorizationErrors)
	}

	if src.ErrorsNegotiationHideResponseErrors != nil {
		return json.Marshal(&src.ErrorsNegotiationHideResponseErrors)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableErrorsNegotiationHideResponseForbiddenErrors struct {
	value *ErrorsNegotiationHideResponseForbiddenErrors
	isSet bool
}

func (v NullableErrorsNegotiationHideResponseForbiddenErrors) Get() *ErrorsNegotiationHideResponseForbiddenErrors {
	return v.value
}

func (v *NullableErrorsNegotiationHideResponseForbiddenErrors) Set(val *ErrorsNegotiationHideResponseForbiddenErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationHideResponseForbiddenErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationHideResponseForbiddenErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationHideResponseForbiddenErrors(val *ErrorsNegotiationHideResponseForbiddenErrors) *NullableErrorsNegotiationHideResponseForbiddenErrors {
	return &NullableErrorsNegotiationHideResponseForbiddenErrors{value: val, isSet: true}
}

func (v NullableErrorsNegotiationHideResponseForbiddenErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationHideResponseForbiddenErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
