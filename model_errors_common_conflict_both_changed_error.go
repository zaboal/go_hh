...
// checks if the ErrorsCommonConflictBothChangedError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonConflictBothChangedError{}

// ErrorsCommonConflictBothChangedError struct for ErrorsCommonConflictBothChangedError
type ErrorsCommonConflictBothChangedError struct {
...
type _ErrorsCommonConflictBothChangedError ErrorsCommonConflictBothChangedError
...
func NewErrorsCommonConflictBothChangedError(type_ string, value string) *ErrorsCommonConflictBothChangedError {
	this := ErrorsCommonConflictBothChangedError{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o ErrorsCommonConflictBothChangedError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonConflictBothChangedError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonConflictBothChangedError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonConflictBothChangedError := _ErrorsCommonConflictBothChangedError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonConflictBothChangedError)

	if err != nil {
		return err
	}

	*o = ErrorsCommonConflictBothChangedError(varErrorsCommonConflictBothChangedError)

	return err
}

type NullableErrorsCommonConflictBothChangedError struct {
	value *ErrorsCommonConflictBothChangedError
	isSet bool
}

func (v NullableErrorsCommonConflictBothChangedError) Get() *ErrorsCommonConflictBothChangedError {
	return v.value
}

func (v *NullableErrorsCommonConflictBothChangedError) Set(val *ErrorsCommonConflictBothChangedError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonConflictBothChangedError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonConflictBothChangedError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonConflictBothChangedError(val *ErrorsCommonConflictBothChangedError) *NullableErrorsCommonConflictBothChangedError {
	return &NullableErrorsCommonConflictBothChangedError{value: val, isSet: true}
}

func (v NullableErrorsCommonConflictBothChangedError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonConflictBothChangedError) UnmarshalJSON(src []byte) error {
	v.isSet = true
