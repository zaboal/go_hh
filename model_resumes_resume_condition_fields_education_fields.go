...
// checks if the ResumesResumeConditionFieldsEducationFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsEducationFields{}

// ResumesResumeConditionFieldsEducationFields struct for ResumesResumeConditionFieldsEducationFields
type ResumesResumeConditionFieldsEducationFields struct {
	Additional NullableResumesResumeConditionFieldsEducationPrimaryCondition `json:"additional,omitempty"`
	Attestation NullableResumesResumeConditionFieldsEducationPrimaryCondition `json:"attestation,omitempty"`
	Elementary NullableResumesResumeConditionFieldsEducationElementaryCondition `json:"elementary,omitempty"`
	Level NullableResumesResumeConditionFieldsRequiredWithTitle `json:"level,omitempty"`
	Primary NullableResumesResumeConditionFieldsEducationPrimaryCondition `json:"primary,omitempty"`
}
...
func NewResumesResumeConditionFieldsEducationFields() *ResumesResumeConditionFieldsEducationFields {
	this := ResumesResumeConditionFieldsEducationFields{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsEducationFields) GetAdditional() ResumesResumeConditionFieldsEducationPrimaryCondition {
	if o == nil || IsNil(o.Additional.Get()) {
		var ret ResumesResumeConditionFieldsEducationPrimaryCondition
		return ret
	}
	return *o.Additional.Get()
}
...
func (o *ResumesResumeConditionFieldsEducationFields) GetAdditionalOk() (*ResumesResumeConditionFieldsEducationPrimaryCondition, bool) {
	...
	return o.Additional.Get(), o.Additional.IsSet()
}
...
// SetAdditional gets a reference to the given NullableResumesResumeConditionFieldsEducationPrimaryCondition and assigns it to the Additional field.
...
func (o *ResumesResumeConditionFieldsEducationFields) SetAdditionalNil() {
	o.Additional.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationFields) GetAttestation() ResumesResumeConditionFieldsEducationPrimaryCondition {
	if o == nil || IsNil(o.Attestation.Get()) {
		var ret ResumesResumeConditionFieldsEducationPrimaryCondition
		return ret
	}
	return *o.Attestation.Get()
}
...
func (o *ResumesResumeConditionFieldsEducationFields) GetAttestationOk() (*ResumesResumeConditionFieldsEducationPrimaryCondition, bool) {
	...
	return o.Attestation.Get(), o.Attestation.IsSet()
}
...
// SetAttestation gets a reference to the given NullableResumesResumeConditionFieldsEducationPrimaryCondition and assigns it to the Attestation field.
...
func (o *ResumesResumeConditionFieldsEducationFields) SetAttestationNil() {
	o.Attestation.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsEducationFields) GetElementary() ResumesResumeConditionFieldsEducationElementaryCondition {
	if o == nil || IsNil(o.Elementary.Get()) {
		var ret ResumesResumeConditionFieldsEducationElementaryCondition
		return ret
	}
	return *o.Elementary.Get()
}
...
func (o *ResumesResumeConditionFieldsEducationFields) GetElementaryOk() (*ResumesResumeConditionFieldsEducationElementaryCondition, bool) {
	...
	return o.Elementary.Get(), o.Elementary.IsSet()
}
...
// SetElementary gets a reference to the given NullableResumesResumeConditionFieldsEducationElementaryCondition and assigns it to the Elementary field.
...
func (o *ResumesResumeConditionFieldsEducationFields) SetElementaryNil() {
	o.Elementary.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ResumesResumeConditionFieldsEducationFields) GetLevelOk() (*ResumesResumeConditionFieldsRequiredWithTitle, bool) {
	if o == nil {
		return nil, false
	}
...
// SetLevel gets a reference to the given NullableResumesResumeConditionFieldsRequiredWithTitle and assigns it to the Level field.
func (o *ResumesResumeConditionFieldsEducationFields) SetLevel(v ResumesResumeConditionFieldsRequiredWithTitle) {
	o.Level.Set(&v)
}
// SetLevelNil sets the value for Level to be an explicit nil
func (o *ResumesResumeConditionFieldsEducationFields) SetLevelNil() {
	o.Level.Set(nil)
}
...
// SetPrimary gets a reference to the given NullableResumesResumeConditionFieldsEducationPrimaryCondition and assigns it to the Primary field.
...
func (o *ResumesResumeConditionFieldsEducationFields) SetPrimaryNil() {
	o.Primary.Set(nil)
}
...
func (o ResumesResumeConditionFieldsEducationFields) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsEducationFields) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.Additional.IsSet() {
		toSerialize["additional"] = o.Additional.Get()
	}
	if o.Attestation.IsSet() {
		toSerialize["attestation"] = o.Attestation.Get()
	}
	if o.Elementary.IsSet() {
		toSerialize["elementary"] = o.Elementary.Get()
	}
	if o.Level.IsSet() {
...
type NullableResumesResumeConditionFieldsEducationFields struct {
	value *ResumesResumeConditionFieldsEducationFields
	isSet bool
}

func (v NullableResumesResumeConditionFieldsEducationFields) Get() *ResumesResumeConditionFieldsEducationFields {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsEducationFields) Set(val *ResumesResumeConditionFieldsEducationFields) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsEducationFields) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsEducationFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsEducationFields(val *ResumesResumeConditionFieldsEducationFields) *NullableResumesResumeConditionFieldsEducationFields {
	return &NullableResumesResumeConditionFieldsEducationFields{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsEducationFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsEducationFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
