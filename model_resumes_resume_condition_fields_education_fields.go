...
type ResumesResumeConditionFieldsEducationFields struct {
	Additional OneOf `json:"additional,omitempty"`
	Attestation OneOf `json:"attestation,omitempty"`
	Elementary OneOf `json:"elementary,omitempty"`
	Level NullableResumesResumeConditionFieldsRequiredWithTitle `json:"level,omitempty"`
	Primary OneOf `json:"primary,omitempty"`
}
...
// SetAdditional gets a reference to the given OneOf and assigns it to the Additional field.
...
// SetAttestation gets a reference to the given OneOf and assigns it to the Attestation field.
...
// SetElementary gets a reference to the given OneOf and assigns it to the Elementary field.
...
// SetPrimary gets a reference to the given OneOf and assigns it to the Primary field.
