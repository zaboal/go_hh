...
// checks if the EmployerManagersPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersPhone{}

// EmployerManagersPhone struct for EmployerManagersPhone
type EmployerManagersPhone struct {
	// Код города
...
type _EmployerManagersPhone EmployerManagersPhone
...
func (o *EmployerManagersPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersPhone := _EmployerManagersPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersPhone(varEmployerManagersPhone)

	return err
}

type NullableEmployerManagersPhone struct {
	value *EmployerManagersPhone
	isSet bool
}

func (v NullableEmployerManagersPhone) Get() *EmployerManagersPhone {
	return v.value
}

func (v *NullableEmployerManagersPhone) Set(val *EmployerManagersPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersPhone(val *EmployerManagersPhone) *NullableEmployerManagersPhone {
	return &NullableEmployerManagersPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
