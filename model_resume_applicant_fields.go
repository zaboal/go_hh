...
// checks if the ResumeApplicantFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeApplicantFields{}

// ResumeApplicantFields struct for ResumeApplicantFields
type ResumeApplicantFields struct {
...
type _ResumeApplicantFields ResumeApplicantFields
...
func (o *ResumeApplicantFields) SetNextPublishAtNil() {
...
func (o ResumeApplicantFields) MarshalJSON() ([]byte, error) {
...
func (o ResumeApplicantFields) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeApplicantFields) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeApplicantFields := _ResumeApplicantFields{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeApplicantFields)

	if err != nil {
		return err
	}

	*o = ResumeApplicantFields(varResumeApplicantFields)

	return err
}

type NullableResumeApplicantFields struct {
	value *ResumeApplicantFields
	isSet bool
}

func (v NullableResumeApplicantFields) Get() *ResumeApplicantFields {
	return v.value
}

func (v *NullableResumeApplicantFields) Set(val *ResumeApplicantFields) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeApplicantFields) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeApplicantFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeApplicantFields(val *ResumeApplicantFields) *NullableResumeApplicantFields {
	return &NullableResumeApplicantFields{value: val, isSet: true}
}

func (v NullableResumeApplicantFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeApplicantFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
