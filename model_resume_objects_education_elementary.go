...
// checks if the ResumeObjectsEducationElementary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsEducationElementary{}

// ResumeObjectsEducationElementary struct for ResumeObjectsEducationElementary
type ResumeObjectsEducationElementary struct {
	// Идентификатор
...
type _ResumeObjectsEducationElementary ResumeObjectsEducationElementary
...
func NewResumeObjectsEducationElementary(name string, year float32) *ResumeObjectsEducationElementary {
	this := ResumeObjectsEducationElementary{}
	this.Name = name
	this.Year = year
	return &this
}
...
func (o *ResumeObjectsEducationElementary) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o ResumeObjectsEducationElementary) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsEducationElementary) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsEducationElementary) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsEducationElementary := _ResumeObjectsEducationElementary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsEducationElementary)

	if err != nil {
		return err
	}

	*o = ResumeObjectsEducationElementary(varResumeObjectsEducationElementary)

	return err
}

type NullableResumeObjectsEducationElementary struct {
	value *ResumeObjectsEducationElementary
	isSet bool
}

func (v NullableResumeObjectsEducationElementary) Get() *ResumeObjectsEducationElementary {
	return v.value
}

func (v *NullableResumeObjectsEducationElementary) Set(val *ResumeObjectsEducationElementary) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsEducationElementary) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsEducationElementary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsEducationElementary(val *ResumeObjectsEducationElementary) *NullableResumeObjectsEducationElementary {
	return &NullableResumeObjectsEducationElementary{value: val, isSet: true}
}

func (v NullableResumeObjectsEducationElementary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsEducationElementary) UnmarshalJSON(src []byte) error {
	v.isSet = true
