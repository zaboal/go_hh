...
// checks if the VacancyArguments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyArguments{}

// VacancyArguments struct for VacancyArguments
type VacancyArguments struct {
	...
	RequiredArguments []IncludesId `json:"required_arguments"`
}

type _VacancyArguments VacancyArguments
...
// GetRequiredArguments returns the RequiredArguments field value
func (o *VacancyArguments) GetRequiredArguments() []IncludesId {
	...
	return o.RequiredArguments
}

// GetRequiredArgumentsOk returns a tuple with the RequiredArguments field value
// and a boolean to check if the value has been set.
func (o *VacancyArguments) GetRequiredArgumentsOk() ([]IncludesId, bool) {
	if o == nil {
		return nil, false
	}
	return o.RequiredArguments, true
}

// SetRequiredArguments sets field value
func (o *VacancyArguments) SetRequiredArguments(v []IncludesId) {
	o.RequiredArguments = v
}

func (o VacancyArguments) MarshalJSON() ([]byte, error) {
...
func (o VacancyArguments) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["required"] = o.Required
	toSerialize["required_arguments"] = o.RequiredArguments
	return toSerialize, nil
}

func (o *VacancyArguments) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyArguments := _VacancyArguments{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyArguments)

	if err != nil {
		return err
	}

	*o = VacancyArguments(varVacancyArguments)

	return err
}

type NullableVacancyArguments struct {
	value *VacancyArguments
	isSet bool
}

func (v NullableVacancyArguments) Get() *VacancyArguments {
	return v.value
}

func (v *NullableVacancyArguments) Set(val *VacancyArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyArguments(val *VacancyArguments) *NullableVacancyArguments {
	return &NullableVacancyArguments{value: val, isSet: true}
}

func (v NullableVacancyArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
