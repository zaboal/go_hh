...
// checks if the VacanciesVacanciesItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacanciesItems{}

// VacanciesVacanciesItems struct for VacanciesVacanciesItems
type VacanciesVacanciesItems struct {
	// Список вакансий
	Items []VacanciesVacanciesItem `json:"items"`
}

type _VacanciesVacanciesItems VacanciesVacanciesItems
...
func (o VacanciesVacanciesItems) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacanciesItems) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *VacanciesVacanciesItems) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacanciesItems := _VacanciesVacanciesItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacanciesItems)

	if err != nil {
		return err
	}

	*o = VacanciesVacanciesItems(varVacanciesVacanciesItems)

	return err
}

type NullableVacanciesVacanciesItems struct {
	value *VacanciesVacanciesItems
	isSet bool
}

func (v NullableVacanciesVacanciesItems) Get() *VacanciesVacanciesItems {
	return v.value
}

func (v *NullableVacanciesVacanciesItems) Set(val *VacanciesVacanciesItems) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacanciesItems) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacanciesItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacanciesItems(val *VacanciesVacanciesItems) *NullableVacanciesVacanciesItems {
	return &NullableVacanciesVacanciesItems{value: val, isSet: true}
}

func (v NullableVacanciesVacanciesItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacanciesItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
