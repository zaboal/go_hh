...
// checks if the VacancyDraftTest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftTest{}
...
func (o *VacancyDraftTest) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *VacancyDraftTest) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o VacancyDraftTest) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftTest) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftTest struct {
	value *VacancyDraftTest
	isSet bool
}

func (v NullableVacancyDraftTest) Get() *VacancyDraftTest {
	return v.value
}

func (v *NullableVacancyDraftTest) Set(val *VacancyDraftTest) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftTest) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftTest(val *VacancyDraftTest) *NullableVacancyDraftTest {
	return &NullableVacancyDraftTest{value: val, isSet: true}
}

func (v NullableVacancyDraftTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
