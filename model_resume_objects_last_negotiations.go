...
// checks if the ResumeObjectsLastNegotiations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsLastNegotiations{}

// ResumeObjectsLastNegotiations struct for ResumeObjectsLastNegotiations
type ResumeObjectsLastNegotiations struct {
...
func NewResumeObjectsLastNegotiations() *ResumeObjectsLastNegotiations {
	this := ResumeObjectsLastNegotiations{}
	return &this
}
...
func (o *ResumeObjectsLastNegotiations) SetLastNegotiationNil() {
...
func (o ResumeObjectsLastNegotiations) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsLastNegotiations) ToMap() (map[string]interface{}, error) {
...
type NullableResumeObjectsLastNegotiations struct {
	value *ResumeObjectsLastNegotiations
	isSet bool
}

func (v NullableResumeObjectsLastNegotiations) Get() *ResumeObjectsLastNegotiations {
	return v.value
}

func (v *NullableResumeObjectsLastNegotiations) Set(val *ResumeObjectsLastNegotiations) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsLastNegotiations) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsLastNegotiations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsLastNegotiations(val *ResumeObjectsLastNegotiations) *NullableResumeObjectsLastNegotiations {
	return &NullableResumeObjectsLastNegotiations{value: val, isSet: true}
}

func (v NullableResumeObjectsLastNegotiations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsLastNegotiations) UnmarshalJSON(src []byte) error {
	v.isSet = true
