...
// checks if the VacanciesSuggests type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesSuggests{}

// VacanciesSuggests struct for VacanciesSuggests
type VacanciesSuggests struct {
...
// SetFound gets a reference to the given int32 and assigns it to the Found field.
...
func (o VacanciesSuggests) MarshalJSON() ([]byte, error) {
...
func (o VacanciesSuggests) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesSuggests struct {
	value *VacanciesSuggests
	isSet bool
}

func (v NullableVacanciesSuggests) Get() *VacanciesSuggests {
	return v.value
}

func (v *NullableVacanciesSuggests) Set(val *VacanciesSuggests) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesSuggests) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesSuggests) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesSuggests(val *VacanciesSuggests) *NullableVacanciesSuggests {
	return &NullableVacanciesSuggests{value: val, isSet: true}
}

func (v NullableVacanciesSuggests) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesSuggests) UnmarshalJSON(src []byte) error {
	v.isSet = true
