...
// checks if the VacancyAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyAddress{}
...
func (o *VacancyAddress) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *VacancyAddress) SetShowMetroOnlyNil() {
...
func (o VacancyAddress) MarshalJSON() ([]byte, error) {
...
func (o VacancyAddress) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyAddress struct {
	value *VacancyAddress
	isSet bool
}

func (v NullableVacancyAddress) Get() *VacancyAddress {
	return v.value
}

func (v *NullableVacancyAddress) Set(val *VacancyAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyAddress(val *VacancyAddress) *NullableVacancyAddress {
	return &NullableVacancyAddress{value: val, isSet: true}
}

func (v NullableVacancyAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
