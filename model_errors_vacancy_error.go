...
// checks if the ErrorsVacancyError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyError{}

// ErrorsVacancyError struct for ErrorsVacancyError
type ErrorsVacancyError struct {
	// Количество найденных дублей вакансии
	Found *float32 `json:"found,omitempty"`
	// Массив идентификаторов вакансий-дублей
	Items []ErrorsVacancyErrorItemsInner `json:"items,omitempty"`
	// Причина ошибки
...
type _ErrorsVacancyError ErrorsVacancyError
...
// SetFound gets a reference to the given float32 and assigns it to the Found field.
...
func (o *ErrorsVacancyError) GetItems() []ErrorsVacancyErrorItemsInner {
	if o == nil || IsNil(o.Items) {
		var ret []ErrorsVacancyErrorItemsInner
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ErrorsVacancyErrorItemsInner and assigns it to the Items field.
...
func (o ErrorsVacancyError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyError := _ErrorsVacancyError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyError)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyError(varErrorsVacancyError)

	return err
}

type NullableErrorsVacancyError struct {
	value *ErrorsVacancyError
	isSet bool
}

func (v NullableErrorsVacancyError) Get() *ErrorsVacancyError {
	return v.value
}

func (v *NullableErrorsVacancyError) Set(val *ErrorsVacancyError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyError(val *ErrorsVacancyError) *NullableErrorsVacancyError {
	return &NullableErrorsVacancyError{value: val, isSet: true}
}

func (v NullableErrorsVacancyError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyError) UnmarshalJSON(src []byte) error {
	v.isSet = true
