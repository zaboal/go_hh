...
type NullableNegotiationsListResponse struct {
	value *NegotiationsListResponse
	isSet bool
}

func (v NullableNegotiationsListResponse) Get() *NegotiationsListResponse {
	return v.value
}

func (v *NullableNegotiationsListResponse) Set(val *NegotiationsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsListResponse(val *NegotiationsListResponse) *NullableNegotiationsListResponse {
	return &NullableNegotiationsListResponse{value: val, isSet: true}
}

func (v NullableNegotiationsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
