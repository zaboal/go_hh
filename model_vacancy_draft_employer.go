...
// checks if the VacancyDraftEmployer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftEmployer{}

// VacancyDraftEmployer struct for VacancyDraftEmployer
type VacancyDraftEmployer struct {
	// Url для просмотра работодателя на сайте
	AlternateUrl string `json:"alternate_url"`
	// Идентификатор работодателя
	Id string `json:"id"`
	LogoUrls VacancyDraftEmployerLogoUrls `json:"logo_urls"`
...
type _VacancyDraftEmployer VacancyDraftEmployer
...
func (o *VacancyDraftEmployer) GetLogoUrls() VacancyDraftEmployerLogoUrls {
	if o == nil {
		var ret VacancyDraftEmployerLogoUrls
		return ret
	}
...
func (o VacancyDraftEmployer) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftEmployer) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyDraftEmployer) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyDraftEmployer := _VacancyDraftEmployer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyDraftEmployer)

	if err != nil {
		return err
	}

	*o = VacancyDraftEmployer(varVacancyDraftEmployer)

	return err
}

type NullableVacancyDraftEmployer struct {
	value *VacancyDraftEmployer
	isSet bool
}

func (v NullableVacancyDraftEmployer) Get() *VacancyDraftEmployer {
	return v.value
}

func (v *NullableVacancyDraftEmployer) Set(val *VacancyDraftEmployer) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftEmployer) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftEmployer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftEmployer(val *VacancyDraftEmployer) *NullableVacancyDraftEmployer {
	return &NullableVacancyDraftEmployer{value: val, isSet: true}
}

func (v NullableVacancyDraftEmployer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftEmployer) UnmarshalJSON(src []byte) error {
	v.isSet = true
