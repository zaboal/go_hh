...
// checks if the VacancyBillingTypeOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyBillingTypeOutput{}

// VacancyBillingTypeOutput Биллинговый тип [из справочника vacancy_billing_type](#tag/Obshie-spravochniki/operation/get-dictionaries)
type VacancyBillingTypeOutput struct {
...
type _VacancyBillingTypeOutput VacancyBillingTypeOutput
...
func (o VacancyBillingTypeOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyBillingTypeOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyBillingTypeOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyBillingTypeOutput := _VacancyBillingTypeOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyBillingTypeOutput)

	if err != nil {
		return err
	}

	*o = VacancyBillingTypeOutput(varVacancyBillingTypeOutput)

	return err
}

type NullableVacancyBillingTypeOutput struct {
	value *VacancyBillingTypeOutput
	isSet bool
}

func (v NullableVacancyBillingTypeOutput) Get() *VacancyBillingTypeOutput {
	return v.value
}

func (v *NullableVacancyBillingTypeOutput) Set(val *VacancyBillingTypeOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyBillingTypeOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyBillingTypeOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyBillingTypeOutput(val *VacancyBillingTypeOutput) *NullableVacancyBillingTypeOutput {
	return &NullableVacancyBillingTypeOutput{value: val, isSet: true}
}

func (v NullableVacancyBillingTypeOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyBillingTypeOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
