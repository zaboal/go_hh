...
// checks if the ResumesResumeConditionFieldsElementaryEducationFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsElementaryEducationFields{}

// ResumesResumeConditionFieldsElementaryEducationFields struct for ResumesResumeConditionFieldsElementaryEducationFields
type ResumesResumeConditionFieldsElementaryEducationFields struct {
...
func NewResumesResumeConditionFieldsElementaryEducationFields() *ResumesResumeConditionFieldsElementaryEducationFields {
	this := ResumesResumeConditionFieldsElementaryEducationFields{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsElementaryEducationFields) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsElementaryEducationFields) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o ResumesResumeConditionFieldsElementaryEducationFields) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsElementaryEducationFields) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsElementaryEducationFields struct {
	value *ResumesResumeConditionFieldsElementaryEducationFields
	isSet bool
}

func (v NullableResumesResumeConditionFieldsElementaryEducationFields) Get() *ResumesResumeConditionFieldsElementaryEducationFields {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsElementaryEducationFields) Set(val *ResumesResumeConditionFieldsElementaryEducationFields) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsElementaryEducationFields) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsElementaryEducationFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsElementaryEducationFields(val *ResumesResumeConditionFieldsElementaryEducationFields) *NullableResumesResumeConditionFieldsElementaryEducationFields {
	return &NullableResumesResumeConditionFieldsElementaryEducationFields{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsElementaryEducationFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsElementaryEducationFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
