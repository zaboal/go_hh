...
// checks if the ErrorsVacancyFavoritedBadAuthError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyFavoritedBadAuthError{}

// ErrorsVacancyFavoritedBadAuthError struct for ErrorsVacancyFavoritedBadAuthError
type ErrorsVacancyFavoritedBadAuthError struct {
...
type _ErrorsVacancyFavoritedBadAuthError ErrorsVacancyFavoritedBadAuthError
...
func NewErrorsVacancyFavoritedBadAuthError(type_ string, value string) *ErrorsVacancyFavoritedBadAuthError {
	this := ErrorsVacancyFavoritedBadAuthError{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o ErrorsVacancyFavoritedBadAuthError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyFavoritedBadAuthError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyFavoritedBadAuthError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyFavoritedBadAuthError := _ErrorsVacancyFavoritedBadAuthError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyFavoritedBadAuthError)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyFavoritedBadAuthError(varErrorsVacancyFavoritedBadAuthError)

	return err
}

type NullableErrorsVacancyFavoritedBadAuthError struct {
	value *ErrorsVacancyFavoritedBadAuthError
	isSet bool
}

func (v NullableErrorsVacancyFavoritedBadAuthError) Get() *ErrorsVacancyFavoritedBadAuthError {
	return v.value
}

func (v *NullableErrorsVacancyFavoritedBadAuthError) Set(val *ErrorsVacancyFavoritedBadAuthError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyFavoritedBadAuthError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyFavoritedBadAuthError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyFavoritedBadAuthError(val *ErrorsVacancyFavoritedBadAuthError) *NullableErrorsVacancyFavoritedBadAuthError {
	return &NullableErrorsVacancyFavoritedBadAuthError{value: val, isSet: true}
}

func (v NullableErrorsVacancyFavoritedBadAuthError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyFavoritedBadAuthError) UnmarshalJSON(src []byte) error {
	v.isSet = true
