...
// VacanciesVacancyProlongateActionsInner - struct for VacanciesVacancyProlongateActionsInner
type VacanciesVacancyProlongateActionsInner struct {
	VacanciesVacancyProlongateAvailableActions *VacanciesVacancyProlongateAvailableActions
	VacanciesVacancyProlongateUnavailableActions *VacanciesVacancyProlongateUnavailableActions
}

// VacanciesVacancyProlongateAvailableActionsAsVacanciesVacancyProlongateActionsInner is a convenience function that returns VacanciesVacancyProlongateAvailableActions wrapped in VacanciesVacancyProlongateActionsInner
func VacanciesVacancyProlongateAvailableActionsAsVacanciesVacancyProlongateActionsInner(v *VacanciesVacancyProlongateAvailableActions) VacanciesVacancyProlongateActionsInner {
	return VacanciesVacancyProlongateActionsInner{
		VacanciesVacancyProlongateAvailableActions: v,
	}
}

// VacanciesVacancyProlongateUnavailableActionsAsVacanciesVacancyProlongateActionsInner is a convenience function that returns VacanciesVacancyProlongateUnavailableActions wrapped in VacanciesVacancyProlongateActionsInner
func VacanciesVacancyProlongateUnavailableActionsAsVacanciesVacancyProlongateActionsInner(v *VacanciesVacancyProlongateUnavailableActions) VacanciesVacancyProlongateActionsInner {
	return VacanciesVacancyProlongateActionsInner{
		VacanciesVacancyProlongateUnavailableActions: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *VacanciesVacancyProlongateActionsInner) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into VacanciesVacancyProlongateAvailableActions
	err = newStrictDecoder(data).Decode(&dst.VacanciesVacancyProlongateAvailableActions)
	if err == nil {
		jsonVacanciesVacancyProlongateAvailableActions, _ := json.Marshal(dst.VacanciesVacancyProlongateAvailableActions)
	...
	// try to unmarshal data into VacanciesVacancyProlongateUnavailableActions
	err = newStrictDecoder(data).Decode(&dst.VacanciesVacancyProlongateUnavailableActions)
	if err == nil {
		jsonVacanciesVacancyProlongateUnavailableActions, _ := json.Marshal(dst.VacanciesVacancyProlongateUnavailableActions)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(VacanciesVacancyProlongateActionsInner)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(VacanciesVacancyProlongateActionsInner)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src VacanciesVacancyProlongateActionsInner) MarshalJSON() ([]byte, error) {
	if src.VacanciesVacancyProlongateAvailableActions != nil {
		return json.Marshal(&src.VacanciesVacancyProlongateAvailableActions)
	}

	if src.VacanciesVacancyProlongateUnavailableActions != nil {
		return json.Marshal(&src.VacanciesVacancyProlongateUnavailableActions)
	}
...
func (obj *VacanciesVacancyProlongateActionsInner) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.VacanciesVacancyProlongateAvailableActions != nil {
		return obj.VacanciesVacancyProlongateAvailableActions
	}

	if obj.VacanciesVacancyProlongateUnavailableActions != nil {
		return obj.VacanciesVacancyProlongateUnavailableActions
	}
...
type NullableVacanciesVacancyProlongateActionsInner struct {
	value *VacanciesVacancyProlongateActionsInner
	isSet bool
}

func (v NullableVacanciesVacancyProlongateActionsInner) Get() *VacanciesVacancyProlongateActionsInner {
	return v.value
}

func (v *NullableVacanciesVacancyProlongateActionsInner) Set(val *VacanciesVacancyProlongateActionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyProlongateActionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyProlongateActionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyProlongateActionsInner(val *VacanciesVacancyProlongateActionsInner) *NullableVacanciesVacancyProlongateActionsInner {
	return &NullableVacanciesVacancyProlongateActionsInner{value: val, isSet: true}
}

func (v NullableVacanciesVacancyProlongateActionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyProlongateActionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
