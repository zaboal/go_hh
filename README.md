# Go API client for github.com/zaboal/hh-go
...
For more information, please visit [https://feedback.hh.ru/](https://feedback.hh.ru/)
...
```go
import github.com/zaboal/hh-go "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
For using other server than the one defined on index 0 set context value `github.com/zaboal/hh-go.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), github.com/zaboal/hh-go.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `github.com/zaboal/hh-go.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), github.com/zaboal/hh-go.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `github.com/zaboal/hh-go.ContextOperationServerIndices` and `github.com/zaboal/hh-go.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), github.com/zaboal/hh-go.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), github.com/zaboal/hh-go.ContextOperationServerVariables, map[string]map[string]string{
...
*DefaultApi* | [**GetAvailableUserStatuses**](docs/DefaultApi.md#getavailableuserstatuses) | **Get** /user_statuses/available | Справочник доступных пользовательских статусов
*DefaultApi* | [**GetAvailableUserStatuses_0**](docs/DefaultApi.md#getavailableuserstatuses_0) | **Get** /user_statuses/available | Справочник доступных пользовательских статусов
...
## Documentation For Models
 ...
 - [IncludesLanguagePropertiesAllOfLevel](docs/IncludesLanguagePropertiesAllOfLevel.md)
 ...
 - [ResumeAddResumeRequestAllOfArea](docs/ResumeAddResumeRequestAllOfArea.md)
 - [ResumeAddResumeRequestAllOfEducation](docs/ResumeAddResumeRequestAllOfEducation.md)
 - [ResumeAddResumeRequestAllOfGender](docs/ResumeAddResumeRequestAllOfGender.md)
 ...
 - [ResumeResumeFullAllOfBusinessTripReadiness](docs/ResumeResumeFullAllOfBusinessTripReadiness.md)
 - [ResumeResumeFullAllOfEmployment](docs/ResumeResumeFullAllOfEmployment.md)
 - [ResumeResumeFullAllOfRelocation](docs/ResumeResumeFullAllOfRelocation.md)
 - [ResumeResumeFullAllOfResumeLocale](docs/ResumeResumeFullAllOfResumeLocale.md)
 ...
 - [ResumeResumeProfileAllOfPlatform](docs/ResumeResumeProfileAllOfPlatform.md)
 - [ResumeResumeShort](docs/ResumeResumeShort.md)
 - [ResumeResumeShortAllOfActions](docs/ResumeResumeShortAllOfActions.md)
 - [ResumeResumeShortAllOfNegotiationsHistory](docs/ResumeResumeShortAllOfNegotiationsHistory.md)
 - [ResumeResumeShortAllOfOwner](docs/ResumeResumeShortAllOfOwner.md)
 - [ResumeResumeShortAllOfPhoto](docs/ResumeResumeShortAllOfPhoto.md)
 ...
 - [UserStatusesAvailable](docs/UserStatusesAvailable.md)
 - [UserStatusesJobSearchStatus](docs/UserStatusesJobSearchStatus.md)
 - [UserStatusesJobSearchStatusDictionary](docs/UserStatusesJobSearchStatusDictionary.md)
 - [UserStatusesWhenCanStartWorkStatus](docs/UserStatusesWhenCanStartWorkStatus.md)
...
```go
auth := context.WithValue(context.Background(), github.com/zaboal/hh-go.ContextAccessToken, "BEARER_TOKEN_STRING")
