...
// checks if the ErrorsArtifactUploadErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsArtifactUploadErrors{}

// ErrorsArtifactUploadErrors Информация о возникших ошибках
type ErrorsArtifactUploadErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsArtifactUploadError `json:"errors"`
}

type _ErrorsArtifactUploadErrors ErrorsArtifactUploadErrors
...
func NewErrorsArtifactUploadErrors(requestId string, errors []ErrorsArtifactUploadError) *ErrorsArtifactUploadErrors {
	this := ErrorsArtifactUploadErrors{}
...
func (o *ErrorsArtifactUploadErrors) GetErrors() []ErrorsArtifactUploadError {
	if o == nil {
		var ret []ErrorsArtifactUploadError
		return ret
	}
...
func (o ErrorsArtifactUploadErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsArtifactUploadErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsArtifactUploadErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsArtifactUploadErrors := _ErrorsArtifactUploadErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsArtifactUploadErrors)

	if err != nil {
		return err
	}

	*o = ErrorsArtifactUploadErrors(varErrorsArtifactUploadErrors)

	return err
}

type NullableErrorsArtifactUploadErrors struct {
	value *ErrorsArtifactUploadErrors
	isSet bool
}

func (v NullableErrorsArtifactUploadErrors) Get() *ErrorsArtifactUploadErrors {
	return v.value
}

func (v *NullableErrorsArtifactUploadErrors) Set(val *ErrorsArtifactUploadErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsArtifactUploadErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsArtifactUploadErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsArtifactUploadErrors(val *ErrorsArtifactUploadErrors) *NullableErrorsArtifactUploadErrors {
	return &NullableErrorsArtifactUploadErrors{value: val, isSet: true}
}

func (v NullableErrorsArtifactUploadErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsArtifactUploadErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
