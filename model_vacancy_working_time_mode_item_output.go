...
// checks if the VacancyWorkingTimeModeItemOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyWorkingTimeModeItemOutput{}

// VacancyWorkingTimeModeItemOutput struct for VacancyWorkingTimeModeItemOutput
type VacancyWorkingTimeModeItemOutput struct {
...
func NewVacancyWorkingTimeModeItemOutput() *VacancyWorkingTimeModeItemOutput {
	this := VacancyWorkingTimeModeItemOutput{}
	return &this
}
...
func (o VacancyWorkingTimeModeItemOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyWorkingTimeModeItemOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyWorkingTimeModeItemOutput struct {
	value *VacancyWorkingTimeModeItemOutput
	isSet bool
}

func (v NullableVacancyWorkingTimeModeItemOutput) Get() *VacancyWorkingTimeModeItemOutput {
	return v.value
}

func (v *NullableVacancyWorkingTimeModeItemOutput) Set(val *VacancyWorkingTimeModeItemOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyWorkingTimeModeItemOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyWorkingTimeModeItemOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyWorkingTimeModeItemOutput(val *VacancyWorkingTimeModeItemOutput) *NullableVacancyWorkingTimeModeItemOutput {
	return &NullableVacancyWorkingTimeModeItemOutput{value: val, isSet: true}
}

func (v NullableVacancyWorkingTimeModeItemOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyWorkingTimeModeItemOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
