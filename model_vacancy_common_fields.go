...
// checks if the VacancyCommonFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyCommonFields{}

// VacancyCommonFields Поля, передаваемые в запросах на создание и редактирование вакансии
type VacancyCommonFields struct {
...
func (o *VacancyCommonFields) SetAcceptTemporaryNil() {
...
func (o *VacancyCommonFields) SetAddressNil() {
	o.Address.Set(nil)
}
...
func (o *VacancyCommonFields) SetBrandedTemplateNil() {
...
func (o *VacancyCommonFields) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *VacancyCommonFields) SetContactsNil() {
	o.Contacts.Set(nil)
}
...
func (o *VacancyCommonFields) SetCustomEmployerNameNil() {
...
func (o *VacancyCommonFields) SetDepartmentNil() {
...
func (o *VacancyCommonFields) GetDriverLicenseTypes() []VacancyDriverLicenceTypeItem {
...
// and a boolean to check if the value has been set.
func (o *VacancyCommonFields) GetDriverLicenseTypesOk() ([]VacancyDriverLicenceTypeItem, bool) {
	if o == nil || IsNil(o.DriverLicenseTypes) {
		return nil, false
	}
...
func (o *VacancyCommonFields) SetDriverLicenseTypes(v []VacancyDriverLicenceTypeItem) {
...
func (o *VacancyCommonFields) SetEmploymentNil() {
...
func (o *VacancyCommonFields) SetExperienceNil() {
...
func (o *VacancyCommonFields) GetKeySkills() []VacancyKeySkillItem {
...
// and a boolean to check if the value has been set.
func (o *VacancyCommonFields) GetKeySkillsOk() ([]VacancyKeySkillItem, bool) {
	if o == nil || IsNil(o.KeySkills) {
		return nil, false
	}
...
func (o *VacancyCommonFields) SetKeySkills(v []VacancyKeySkillItem) {
	o.KeySkills = v
}

// GetLanguages returns the Languages field value if set, zero value otherwise.
func (o *VacancyCommonFields) GetLanguages() []VacancyLanguage {
...
// and a boolean to check if the value has been set.
func (o *VacancyCommonFields) GetLanguagesOk() ([]VacancyLanguage, bool) {
	if o == nil || IsNil(o.Languages) {
		return nil, false
	}
...
func (o *VacancyCommonFields) SetLanguages(v []VacancyLanguage) {
	o.Languages = v
}
...
func (o *VacancyCommonFields) SetResponseUrlNil() {
...
func (o *VacancyCommonFields) SetSalaryNil() {
	o.Salary.Set(nil)
}
...
func (o *VacancyCommonFields) SetScheduleNil() {
	o.Schedule.Set(nil)
}
...
func (o *VacancyCommonFields) SetTestNil() {
	o.Test.Set(nil)
}
...
func (o VacancyCommonFields) MarshalJSON() ([]byte, error) {
...
func (o VacancyCommonFields) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyCommonFields struct {
	value *VacancyCommonFields
	isSet bool
}

func (v NullableVacancyCommonFields) Get() *VacancyCommonFields {
	return v.value
}

func (v *NullableVacancyCommonFields) Set(val *VacancyCommonFields) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyCommonFields) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyCommonFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyCommonFields(val *VacancyCommonFields) *NullableVacancyCommonFields {
	return &NullableVacancyCommonFields{value: val, isSet: true}
}

func (v NullableVacancyCommonFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyCommonFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
