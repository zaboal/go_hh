...
// checks if the VacancyDraftAddressOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftAddressOutput{}

// VacancyDraftAddressOutput struct for VacancyDraftAddressOutput
type VacancyDraftAddressOutput struct {
	// Дом
...
func NewVacancyDraftAddressOutput() *VacancyDraftAddressOutput {
	this := VacancyDraftAddressOutput{}
	return &this
}
...
func (o *VacancyDraftAddressOutput) SetBuildingNil() {
	o.Building.Set(nil)
}
...
func (o *VacancyDraftAddressOutput) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *VacancyDraftAddressOutput) SetLatNil() {
	o.Lat.Set(nil)
}
...
func (o *VacancyDraftAddressOutput) SetLngNil() {
	o.Lng.Set(nil)
}
...
func (o *VacancyDraftAddressOutput) SetStreetNil() {
	o.Street.Set(nil)
}
...
func (o *VacancyDraftAddressOutput) SetDescriptionNil() {
...
func (o *VacancyDraftAddressOutput) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *VacancyDraftAddressOutput) SetShowMetroOnlyNil() {
...
func (o VacancyDraftAddressOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftAddressOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftAddressOutput struct {
	value *VacancyDraftAddressOutput
	isSet bool
}

func (v NullableVacancyDraftAddressOutput) Get() *VacancyDraftAddressOutput {
	return v.value
}

func (v *NullableVacancyDraftAddressOutput) Set(val *VacancyDraftAddressOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftAddressOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftAddressOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftAddressOutput(val *VacancyDraftAddressOutput) *NullableVacancyDraftAddressOutput {
	return &NullableVacancyDraftAddressOutput{value: val, isSet: true}
}

func (v NullableVacancyDraftAddressOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftAddressOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
