...
// checks if the ResumeShouldSendSmsContainer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeShouldSendSmsContainer{}

// ResumeShouldSendSmsContainer struct for ResumeShouldSendSmsContainer
type ResumeShouldSendSmsContainer struct {
	Phone ResumeShouldSendSmsPhone `json:"phone"`
}

type _ResumeShouldSendSmsContainer ResumeShouldSendSmsContainer
...
func NewResumeShouldSendSmsContainer(phone ResumeShouldSendSmsPhone) *ResumeShouldSendSmsContainer {
	this := ResumeShouldSendSmsContainer{}
	this.Phone = phone
	return &this
}
...
func (o *ResumeShouldSendSmsContainer) GetPhone() ResumeShouldSendSmsPhone {
	if o == nil {
		var ret ResumeShouldSendSmsPhone
		return ret
	}
...
func (o ResumeShouldSendSmsContainer) MarshalJSON() ([]byte, error) {
...
func (o ResumeShouldSendSmsContainer) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["phone"] = o.Phone
	return toSerialize, nil
}

func (o *ResumeShouldSendSmsContainer) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeShouldSendSmsContainer := _ResumeShouldSendSmsContainer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeShouldSendSmsContainer)

	if err != nil {
		return err
	}

	*o = ResumeShouldSendSmsContainer(varResumeShouldSendSmsContainer)

	return err
}

type NullableResumeShouldSendSmsContainer struct {
	value *ResumeShouldSendSmsContainer
	isSet bool
}

func (v NullableResumeShouldSendSmsContainer) Get() *ResumeShouldSendSmsContainer {
	return v.value
}

func (v *NullableResumeShouldSendSmsContainer) Set(val *ResumeShouldSendSmsContainer) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeShouldSendSmsContainer) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeShouldSendSmsContainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeShouldSendSmsContainer(val *ResumeShouldSendSmsContainer) *NullableResumeShouldSendSmsContainer {
	return &NullableResumeShouldSendSmsContainer{value: val, isSet: true}
}

func (v NullableResumeShouldSendSmsContainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeShouldSendSmsContainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
