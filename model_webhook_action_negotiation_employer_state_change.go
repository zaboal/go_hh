...
// checks if the WebhookActionNegotiationEmployerStateChange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookActionNegotiationEmployerStateChange{}

// WebhookActionNegotiationEmployerStateChange struct for WebhookActionNegotiationEmployerStateChange
type WebhookActionNegotiationEmployerStateChange struct {
...
type _WebhookActionNegotiationEmployerStateChange WebhookActionNegotiationEmployerStateChange
...
func NewWebhookActionNegotiationEmployerStateChange(type_ string) *WebhookActionNegotiationEmployerStateChange {
	this := WebhookActionNegotiationEmployerStateChange{}
	this.Type = type_
	return &this
}
...
func (o *WebhookActionNegotiationEmployerStateChange) SetSettingsNil() {
	o.Settings.Set(nil)
}
...
func (o WebhookActionNegotiationEmployerStateChange) MarshalJSON() ([]byte, error) {
...
func (o WebhookActionNegotiationEmployerStateChange) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookActionNegotiationEmployerStateChange) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookActionNegotiationEmployerStateChange := _WebhookActionNegotiationEmployerStateChange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookActionNegotiationEmployerStateChange)

	if err != nil {
		return err
	}

	*o = WebhookActionNegotiationEmployerStateChange(varWebhookActionNegotiationEmployerStateChange)

	return err
}

type NullableWebhookActionNegotiationEmployerStateChange struct {
	value *WebhookActionNegotiationEmployerStateChange
	isSet bool
}

func (v NullableWebhookActionNegotiationEmployerStateChange) Get() *WebhookActionNegotiationEmployerStateChange {
	return v.value
}

func (v *NullableWebhookActionNegotiationEmployerStateChange) Set(val *WebhookActionNegotiationEmployerStateChange) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookActionNegotiationEmployerStateChange) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookActionNegotiationEmployerStateChange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookActionNegotiationEmployerStateChange(val *WebhookActionNegotiationEmployerStateChange) *NullableWebhookActionNegotiationEmployerStateChange {
	return &NullableWebhookActionNegotiationEmployerStateChange{value: val, isSet: true}
}

func (v NullableWebhookActionNegotiationEmployerStateChange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookActionNegotiationEmployerStateChange) UnmarshalJSON(src []byte) error {
	v.isSet = true
