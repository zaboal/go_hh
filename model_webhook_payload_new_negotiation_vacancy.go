...
// checks if the WebhookPayloadNewNegotiationVacancy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookPayloadNewNegotiationVacancy{}

// WebhookPayloadNewNegotiationVacancy Новый отклик на вакансию
type WebhookPayloadNewNegotiationVacancy struct {
	...
	NegotiationDate interface{} `json:"negotiation_date"`
...
type _WebhookPayloadNewNegotiationVacancy WebhookPayloadNewNegotiationVacancy
...
func NewWebhookPayloadNewNegotiationVacancy(employerId string, negotiationDate interface{}, resumeId NullableString, topicId string, vacancyId NullableString) *WebhookPayloadNewNegotiationVacancy {
	this := WebhookPayloadNewNegotiationVacancy{}
...
// GetNegotiationDate returns the NegotiationDate field value
...
func (o *WebhookPayloadNewNegotiationVacancy) GetNegotiationDate() interface{} {
	...
	return o.NegotiationDate
}

// GetNegotiationDateOk returns a tuple with the NegotiationDate field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebhookPayloadNewNegotiationVacancy) GetNegotiationDateOk() (*interface{}, bool) {
	if o == nil || IsNil(o.NegotiationDate) {
		return nil, false
	}
	return &o.NegotiationDate, true
}

// SetNegotiationDate sets field value
...
func (o WebhookPayloadNewNegotiationVacancy) MarshalJSON() ([]byte, error) {
...
func (o WebhookPayloadNewNegotiationVacancy) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["employer_id"] = o.EmployerId
	if o.NegotiationDate != nil {
		toSerialize["negotiation_date"] = o.NegotiationDate
	}
...
func (o *WebhookPayloadNewNegotiationVacancy) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookPayloadNewNegotiationVacancy := _WebhookPayloadNewNegotiationVacancy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookPayloadNewNegotiationVacancy)

	if err != nil {
		return err
	}

	*o = WebhookPayloadNewNegotiationVacancy(varWebhookPayloadNewNegotiationVacancy)

	return err
}

type NullableWebhookPayloadNewNegotiationVacancy struct {
	value *WebhookPayloadNewNegotiationVacancy
	isSet bool
}

func (v NullableWebhookPayloadNewNegotiationVacancy) Get() *WebhookPayloadNewNegotiationVacancy {
	return v.value
}

func (v *NullableWebhookPayloadNewNegotiationVacancy) Set(val *WebhookPayloadNewNegotiationVacancy) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookPayloadNewNegotiationVacancy) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookPayloadNewNegotiationVacancy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookPayloadNewNegotiationVacancy(val *WebhookPayloadNewNegotiationVacancy) *NullableWebhookPayloadNewNegotiationVacancy {
	return &NullableWebhookPayloadNewNegotiationVacancy{value: val, isSet: true}
}

func (v NullableWebhookPayloadNewNegotiationVacancy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookPayloadNewNegotiationVacancy) UnmarshalJSON(src []byte) error {
	v.isSet = true
