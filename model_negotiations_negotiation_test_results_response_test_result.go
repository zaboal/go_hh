...
// checks if the NegotiationsNegotiationTestResultsResponseTestResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationTestResultsResponseTestResult{}

// NegotiationsNegotiationTestResultsResponseTestResult Пройденные тесты кандидата
type NegotiationsNegotiationTestResultsResponseTestResult struct {
	...
	Tasks []SkillVerificationsTestResultTasks `json:"tasks"`
}

type _NegotiationsNegotiationTestResultsResponseTestResult NegotiationsNegotiationTestResultsResponseTestResult
...
func NewNegotiationsNegotiationTestResultsResponseTestResult(duration float32, mark string, name string, score float32, tasks []SkillVerificationsTestResultTasks) *NegotiationsNegotiationTestResultsResponseTestResult {
	this := NegotiationsNegotiationTestResultsResponseTestResult{}
...
func (o *NegotiationsNegotiationTestResultsResponseTestResult) GetTasks() []SkillVerificationsTestResultTasks {
	if o == nil {
		var ret []SkillVerificationsTestResultTasks
		return ret
	}
...
func (o NegotiationsNegotiationTestResultsResponseTestResult) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationTestResultsResponseTestResult) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsNegotiationTestResultsResponseTestResult) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationTestResultsResponseTestResult := _NegotiationsNegotiationTestResultsResponseTestResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationTestResultsResponseTestResult)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationTestResultsResponseTestResult(varNegotiationsNegotiationTestResultsResponseTestResult)

	return err
}

type NullableNegotiationsNegotiationTestResultsResponseTestResult struct {
	value *NegotiationsNegotiationTestResultsResponseTestResult
	isSet bool
}

func (v NullableNegotiationsNegotiationTestResultsResponseTestResult) Get() *NegotiationsNegotiationTestResultsResponseTestResult {
	return v.value
}

func (v *NullableNegotiationsNegotiationTestResultsResponseTestResult) Set(val *NegotiationsNegotiationTestResultsResponseTestResult) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationTestResultsResponseTestResult) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationTestResultsResponseTestResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationTestResultsResponseTestResult(val *NegotiationsNegotiationTestResultsResponseTestResult) *NullableNegotiationsNegotiationTestResultsResponseTestResult {
	return &NullableNegotiationsNegotiationTestResultsResponseTestResult{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationTestResultsResponseTestResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationTestResultsResponseTestResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
