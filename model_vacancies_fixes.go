...
// checks if the VacanciesFixes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesFixes{}

// VacanciesFixes struct for VacanciesFixes
type VacanciesFixes struct {
...
func (o VacanciesFixes) MarshalJSON() ([]byte, error) {
...
func (o VacanciesFixes) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesFixes struct {
	value *VacanciesFixes
	isSet bool
}

func (v NullableVacanciesFixes) Get() *VacanciesFixes {
	return v.value
}

func (v *NullableVacanciesFixes) Set(val *VacanciesFixes) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesFixes) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesFixes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesFixes(val *VacanciesFixes) *NullableVacanciesFixes {
	return &NullableVacanciesFixes{value: val, isSet: true}
}

func (v NullableVacanciesFixes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesFixes) UnmarshalJSON(src []byte) error {
	v.isSet = true
