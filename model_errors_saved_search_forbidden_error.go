...
// checks if the ErrorsSavedSearchForbiddenError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsSavedSearchForbiddenError{}

// ErrorsSavedSearchForbiddenError struct for ErrorsSavedSearchForbiddenError
type ErrorsSavedSearchForbiddenError struct {
...
type _ErrorsSavedSearchForbiddenError ErrorsSavedSearchForbiddenError
...
func NewErrorsSavedSearchForbiddenError(type_ string) *ErrorsSavedSearchForbiddenError {
	this := ErrorsSavedSearchForbiddenError{}
	this.Type = type_
	return &this
}
...
func (o ErrorsSavedSearchForbiddenError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsSavedSearchForbiddenError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsSavedSearchForbiddenError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsSavedSearchForbiddenError := _ErrorsSavedSearchForbiddenError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsSavedSearchForbiddenError)

	if err != nil {
		return err
	}

	*o = ErrorsSavedSearchForbiddenError(varErrorsSavedSearchForbiddenError)

	return err
}

type NullableErrorsSavedSearchForbiddenError struct {
	value *ErrorsSavedSearchForbiddenError
	isSet bool
}

func (v NullableErrorsSavedSearchForbiddenError) Get() *ErrorsSavedSearchForbiddenError {
	return v.value
}

func (v *NullableErrorsSavedSearchForbiddenError) Set(val *ErrorsSavedSearchForbiddenError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsSavedSearchForbiddenError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsSavedSearchForbiddenError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsSavedSearchForbiddenError(val *ErrorsSavedSearchForbiddenError) *NullableErrorsSavedSearchForbiddenError {
	return &NullableErrorsSavedSearchForbiddenError{value: val, isSet: true}
}

func (v NullableErrorsSavedSearchForbiddenError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsSavedSearchForbiddenError) UnmarshalJSON(src []byte) error {
	v.isSet = true
