...
// checks if the ErrorsEmployerBlacklistedErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsEmployerBlacklistedErrors{}

// ErrorsEmployerBlacklistedErrors Информация о возникших ошибках
type ErrorsEmployerBlacklistedErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Описание ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsEmployerBlacklistedError `json:"errors"`
}

type _ErrorsEmployerBlacklistedErrors ErrorsEmployerBlacklistedErrors
...
func NewErrorsEmployerBlacklistedErrors(requestId string, errors []ErrorsEmployerBlacklistedError) *ErrorsEmployerBlacklistedErrors {
	this := ErrorsEmployerBlacklistedErrors{}
...
func (o *ErrorsEmployerBlacklistedErrors) GetErrors() []ErrorsEmployerBlacklistedError {
	if o == nil {
		var ret []ErrorsEmployerBlacklistedError
		return ret
	}
...
func (o ErrorsEmployerBlacklistedErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsEmployerBlacklistedErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsEmployerBlacklistedErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsEmployerBlacklistedErrors := _ErrorsEmployerBlacklistedErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsEmployerBlacklistedErrors)

	if err != nil {
		return err
	}

	*o = ErrorsEmployerBlacklistedErrors(varErrorsEmployerBlacklistedErrors)

	return err
}

type NullableErrorsEmployerBlacklistedErrors struct {
	value *ErrorsEmployerBlacklistedErrors
	isSet bool
}

func (v NullableErrorsEmployerBlacklistedErrors) Get() *ErrorsEmployerBlacklistedErrors {
	return v.value
}

func (v *NullableErrorsEmployerBlacklistedErrors) Set(val *ErrorsEmployerBlacklistedErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsEmployerBlacklistedErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsEmployerBlacklistedErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsEmployerBlacklistedErrors(val *ErrorsEmployerBlacklistedErrors) *NullableErrorsEmployerBlacklistedErrors {
	return &NullableErrorsEmployerBlacklistedErrors{value: val, isSet: true}
}

func (v NullableErrorsEmployerBlacklistedErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsEmployerBlacklistedErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
