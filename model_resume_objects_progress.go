...
// checks if the ResumeObjectsProgress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsProgress{}

// ResumeObjectsProgress Информация о заполненности резюме
type ResumeObjectsProgress struct {
	// Список полей, которые обязательны, но еще не заполнены
	Mandatory []IncludesIdName `json:"mandatory"`
	// Процент заполненности резюме
	Percentage float32 `json:"percentage"`
	// Список полей, которые рекомендованы к заполнению, но ещё не заполнены
	Recommended []IncludesIdName `json:"recommended"`
}

type _ResumeObjectsProgress ResumeObjectsProgress
...
func (o ResumeObjectsProgress) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsProgress) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsProgress) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsProgress := _ResumeObjectsProgress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsProgress)

	if err != nil {
		return err
	}

	*o = ResumeObjectsProgress(varResumeObjectsProgress)

	return err
}

type NullableResumeObjectsProgress struct {
	value *ResumeObjectsProgress
	isSet bool
}

func (v NullableResumeObjectsProgress) Get() *ResumeObjectsProgress {
	return v.value
}

func (v *NullableResumeObjectsProgress) Set(val *ResumeObjectsProgress) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsProgress) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsProgress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsProgress(val *ResumeObjectsProgress) *NullableResumeObjectsProgress {
	return &NullableResumeObjectsProgress{value: val, isSet: true}
}

func (v NullableResumeObjectsProgress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsProgress) UnmarshalJSON(src []byte) error {
	v.isSet = true
