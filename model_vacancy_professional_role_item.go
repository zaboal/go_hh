...
// checks if the VacancyProfessionalRoleItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyProfessionalRoleItem{}

// VacancyProfessionalRoleItem struct for VacancyProfessionalRoleItem
type VacancyProfessionalRoleItem struct {
...
func NewVacancyProfessionalRoleItem() *VacancyProfessionalRoleItem {
	this := VacancyProfessionalRoleItem{}
	return &this
}
...
func (o VacancyProfessionalRoleItem) MarshalJSON() ([]byte, error) {
...
func (o VacancyProfessionalRoleItem) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyProfessionalRoleItem struct {
	value *VacancyProfessionalRoleItem
	isSet bool
}

func (v NullableVacancyProfessionalRoleItem) Get() *VacancyProfessionalRoleItem {
	return v.value
}

func (v *NullableVacancyProfessionalRoleItem) Set(val *VacancyProfessionalRoleItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyProfessionalRoleItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyProfessionalRoleItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyProfessionalRoleItem(val *VacancyProfessionalRoleItem) *NullableVacancyProfessionalRoleItem {
	return &NullableVacancyProfessionalRoleItem{value: val, isSet: true}
}

func (v NullableVacancyProfessionalRoleItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyProfessionalRoleItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
