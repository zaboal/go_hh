...
// checks if the ErrorsResumeAddEditErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsResumeAddEditErrors{}

// ErrorsResumeAddEditErrors Информация о возникших ошибках
type ErrorsResumeAddEditErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsResumeAddEditError `json:"errors"`
}

type _ErrorsResumeAddEditErrors ErrorsResumeAddEditErrors
...
func NewErrorsResumeAddEditErrors(requestId string, errors []ErrorsResumeAddEditError) *ErrorsResumeAddEditErrors {
	this := ErrorsResumeAddEditErrors{}
...
func (o *ErrorsResumeAddEditErrors) GetErrors() []ErrorsResumeAddEditError {
	if o == nil {
		var ret []ErrorsResumeAddEditError
		return ret
	}
...
func (o ErrorsResumeAddEditErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsResumeAddEditErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsResumeAddEditErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsResumeAddEditErrors := _ErrorsResumeAddEditErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsResumeAddEditErrors)

	if err != nil {
		return err
	}

	*o = ErrorsResumeAddEditErrors(varErrorsResumeAddEditErrors)

	return err
}

type NullableErrorsResumeAddEditErrors struct {
	value *ErrorsResumeAddEditErrors
	isSet bool
}

func (v NullableErrorsResumeAddEditErrors) Get() *ErrorsResumeAddEditErrors {
	return v.value
}

func (v *NullableErrorsResumeAddEditErrors) Set(val *ErrorsResumeAddEditErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsResumeAddEditErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsResumeAddEditErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsResumeAddEditErrors(val *ErrorsResumeAddEditErrors) *NullableErrorsResumeAddEditErrors {
	return &NullableErrorsResumeAddEditErrors{value: val, isSet: true}
}

func (v NullableErrorsResumeAddEditErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsResumeAddEditErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
