...
// checks if the ErrorsResumeTooManyResumesErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsResumeTooManyResumesErrors{}

// ErrorsResumeTooManyResumesErrors Информация о возникших ошибках
type ErrorsResumeTooManyResumesErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsResumeTooManyResumesError `json:"errors"`
}

type _ErrorsResumeTooManyResumesErrors ErrorsResumeTooManyResumesErrors
...
func NewErrorsResumeTooManyResumesErrors(requestId string, errors []ErrorsResumeTooManyResumesError) *ErrorsResumeTooManyResumesErrors {
	this := ErrorsResumeTooManyResumesErrors{}
...
func (o *ErrorsResumeTooManyResumesErrors) GetErrors() []ErrorsResumeTooManyResumesError {
	if o == nil {
		var ret []ErrorsResumeTooManyResumesError
		return ret
	}
...
func (o ErrorsResumeTooManyResumesErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsResumeTooManyResumesErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsResumeTooManyResumesErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsResumeTooManyResumesErrors := _ErrorsResumeTooManyResumesErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsResumeTooManyResumesErrors)

	if err != nil {
		return err
	}

	*o = ErrorsResumeTooManyResumesErrors(varErrorsResumeTooManyResumesErrors)

	return err
}

type NullableErrorsResumeTooManyResumesErrors struct {
	value *ErrorsResumeTooManyResumesErrors
	isSet bool
}

func (v NullableErrorsResumeTooManyResumesErrors) Get() *ErrorsResumeTooManyResumesErrors {
	return v.value
}

func (v *NullableErrorsResumeTooManyResumesErrors) Set(val *ErrorsResumeTooManyResumesErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsResumeTooManyResumesErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsResumeTooManyResumesErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsResumeTooManyResumesErrors(val *ErrorsResumeTooManyResumesErrors) *NullableErrorsResumeTooManyResumesErrors {
	return &NullableErrorsResumeTooManyResumesErrors{value: val, isSet: true}
}

func (v NullableErrorsResumeTooManyResumesErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsResumeTooManyResumesErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
