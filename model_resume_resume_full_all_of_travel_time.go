...
// checks if the ResumeResumeFullAllOfTravelTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeFullAllOfTravelTime{}

// ResumeResumeFullAllOfTravelTime Желательное время в пути до работы. Элемент справочника [travel_time](#tag/Obshie-spravochniki/operation/get-dictionaries)
type ResumeResumeFullAllOfTravelTime struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _ResumeResumeFullAllOfTravelTime ResumeResumeFullAllOfTravelTime
...
func NewResumeResumeFullAllOfTravelTime(id string, name string) *ResumeResumeFullAllOfTravelTime {
	this := ResumeResumeFullAllOfTravelTime{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ResumeResumeFullAllOfTravelTime) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeFullAllOfTravelTime) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeFullAllOfTravelTime) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeFullAllOfTravelTime := _ResumeResumeFullAllOfTravelTime{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeFullAllOfTravelTime)

	if err != nil {
		return err
	}

	*o = ResumeResumeFullAllOfTravelTime(varResumeResumeFullAllOfTravelTime)

	return err
}

type NullableResumeResumeFullAllOfTravelTime struct {
	value *ResumeResumeFullAllOfTravelTime
	isSet bool
}

func (v NullableResumeResumeFullAllOfTravelTime) Get() *ResumeResumeFullAllOfTravelTime {
	return v.value
}

func (v *NullableResumeResumeFullAllOfTravelTime) Set(val *ResumeResumeFullAllOfTravelTime) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeFullAllOfTravelTime) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeFullAllOfTravelTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeFullAllOfTravelTime(val *ResumeResumeFullAllOfTravelTime) *NullableResumeResumeFullAllOfTravelTime {
	return &NullableResumeResumeFullAllOfTravelTime{value: val, isSet: true}
}

func (v NullableResumeResumeFullAllOfTravelTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeFullAllOfTravelTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
