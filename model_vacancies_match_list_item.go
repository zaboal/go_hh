...
// checks if the VacanciesMatchListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesMatchListItem{}
...
type _VacanciesMatchListItem VacanciesMatchListItem

// NewVacanciesMatchListItem instantiates a new VacanciesMatchListItem object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewVacanciesMatchListItem(alternateUrl string, applyAlternateUrl string, archived bool, area IncludesArea, department NullableVacancyDepartmentOutput, employer NullableVacanciesEmployerPublic, hasTest bool, id string, name string, premium bool, publishedAt string, relations []VacancyRelationItem, responseLetterRequired bool, salary NullableVacancySalary, type_ VacancyTypeOutput, url string, canInvite bool, createdAt string, employerNegotiationsState IncludesIdName, manager VacancyManagerOutput, negotiationsActions []VacancyNegotiationActions, negotiationsState IncludesIdName) *VacanciesMatchListItem {
...
func (o *VacanciesMatchListItem) SetResponseUrlNil() {
...
func (o *VacanciesMatchListItem) SetShowLogoInSearchNil() {
...
func (o *VacanciesMatchListItem) SetSortPointDistanceNil() {
...
func (o VacanciesMatchListItem) MarshalJSON() ([]byte, error) {
...
func (o *VacanciesMatchListItem) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesMatchListItem := _VacanciesMatchListItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesMatchListItem)

	if err != nil {
		return err
	}

	*o = VacanciesMatchListItem(varVacanciesMatchListItem)

	return err
}

type NullableVacanciesMatchListItem struct {
	value *VacanciesMatchListItem
	isSet bool
}

func (v NullableVacanciesMatchListItem) Get() *VacanciesMatchListItem {
	return v.value
}

func (v *NullableVacanciesMatchListItem) Set(val *VacanciesMatchListItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesMatchListItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesMatchListItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesMatchListItem(val *VacanciesMatchListItem) *NullableVacanciesMatchListItem {
	return &NullableVacanciesMatchListItem{value: val, isSet: true}
}

func (v NullableVacanciesMatchListItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesMatchListItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
