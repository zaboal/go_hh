...
// checks if the SuggestsEmployerItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsEmployerItem{}

// SuggestsEmployerItem struct for SuggestsEmployerItem
type SuggestsEmployerItem struct {
...
type _SuggestsEmployerItem SuggestsEmployerItem
...
func (o SuggestsEmployerItem) MarshalJSON() ([]byte, error) {
...
func (o SuggestsEmployerItem) ToMap() (map[string]interface{}, error) {
...
func (o *SuggestsEmployerItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsEmployerItem := _SuggestsEmployerItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsEmployerItem)

	if err != nil {
		return err
	}

	*o = SuggestsEmployerItem(varSuggestsEmployerItem)

	return err
}

type NullableSuggestsEmployerItem struct {
	value *SuggestsEmployerItem
	isSet bool
}

func (v NullableSuggestsEmployerItem) Get() *SuggestsEmployerItem {
	return v.value
}

func (v *NullableSuggestsEmployerItem) Set(val *SuggestsEmployerItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsEmployerItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsEmployerItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsEmployerItem(val *SuggestsEmployerItem) *NullableSuggestsEmployerItem {
	return &NullableSuggestsEmployerItem{value: val, isSet: true}
}

func (v NullableSuggestsEmployerItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsEmployerItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
