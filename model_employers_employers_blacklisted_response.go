...
// checks if the EmployersEmployersBlacklistedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployersBlacklistedResponse{}

// EmployersEmployersBlacklistedResponse struct for EmployersEmployersBlacklistedResponse
type EmployersEmployersBlacklistedResponse struct {
	// Найдено результатов
	...
	Items []EmployersEmployersBlacklistedItem `json:"items,omitempty"`
	// Превышено ли максимальное количество элементов в списке
	LimitReached *bool `json:"limit_reached,omitempty"`
}

type _EmployersEmployersBlacklistedResponse EmployersEmployersBlacklistedResponse
...
func NewEmployersEmployersBlacklistedResponse(found float32, page float32, pages float32, perPage float32) *EmployersEmployersBlacklistedResponse {
	this := EmployersEmployersBlacklistedResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *EmployersEmployersBlacklistedResponse) GetItems() []EmployersEmployersBlacklistedItem {
	if o == nil || IsNil(o.Items) {
		var ret []EmployersEmployersBlacklistedItem
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []EmployersEmployersBlacklistedItem and assigns it to the Items field.
...
func (o EmployersEmployersBlacklistedResponse) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployersBlacklistedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersEmployersBlacklistedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersEmployersBlacklistedResponse := _EmployersEmployersBlacklistedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersEmployersBlacklistedResponse)

	if err != nil {
		return err
	}

	*o = EmployersEmployersBlacklistedResponse(varEmployersEmployersBlacklistedResponse)

	return err
}

type NullableEmployersEmployersBlacklistedResponse struct {
	value *EmployersEmployersBlacklistedResponse
	isSet bool
}

func (v NullableEmployersEmployersBlacklistedResponse) Get() *EmployersEmployersBlacklistedResponse {
	return v.value
}

func (v *NullableEmployersEmployersBlacklistedResponse) Set(val *EmployersEmployersBlacklistedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployersBlacklistedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployersBlacklistedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployersBlacklistedResponse(val *EmployersEmployersBlacklistedResponse) *NullableEmployersEmployersBlacklistedResponse {
	return &NullableEmployersEmployersBlacklistedResponse{value: val, isSet: true}
}

func (v NullableEmployersEmployersBlacklistedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployersBlacklistedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
