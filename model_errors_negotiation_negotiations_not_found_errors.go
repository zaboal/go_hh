...
// ErrorsNegotiationNegotiationsNotFoundErrors - Информация о возникших ошибках
type ErrorsNegotiationNegotiationsNotFoundErrors struct {
	ErrorsCommonNotFoundErrors *ErrorsCommonNotFoundErrors
	ErrorsNegotiationNotFoundErrors *ErrorsNegotiationNotFoundErrors
}

// ErrorsCommonNotFoundErrorsAsErrorsNegotiationNegotiationsNotFoundErrors is a convenience function that returns ErrorsCommonNotFoundErrors wrapped in ErrorsNegotiationNegotiationsNotFoundErrors
func ErrorsCommonNotFoundErrorsAsErrorsNegotiationNegotiationsNotFoundErrors(v *ErrorsCommonNotFoundErrors) ErrorsNegotiationNegotiationsNotFoundErrors {
	return ErrorsNegotiationNegotiationsNotFoundErrors{
		ErrorsCommonNotFoundErrors: v,
	}
}

// ErrorsNegotiationNotFoundErrorsAsErrorsNegotiationNegotiationsNotFoundErrors is a convenience function that returns ErrorsNegotiationNotFoundErrors wrapped in ErrorsNegotiationNegotiationsNotFoundErrors
func ErrorsNegotiationNotFoundErrorsAsErrorsNegotiationNegotiationsNotFoundErrors(v *ErrorsNegotiationNotFoundErrors) ErrorsNegotiationNegotiationsNotFoundErrors {
	return ErrorsNegotiationNegotiationsNotFoundErrors{
		ErrorsNegotiationNotFoundErrors: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *ErrorsNegotiationNegotiationsNotFoundErrors) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into ErrorsCommonNotFoundErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsCommonNotFoundErrors)
	if err == nil {
		jsonErrorsCommonNotFoundErrors, _ := json.Marshal(dst.ErrorsCommonNotFoundErrors)
	...
	// try to unmarshal data into ErrorsNegotiationNotFoundErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsNegotiationNotFoundErrors)
	if err == nil {
		jsonErrorsNegotiationNotFoundErrors, _ := json.Marshal(dst.ErrorsNegotiationNotFoundErrors)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ErrorsNegotiationNegotiationsNotFoundErrors)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ErrorsNegotiationNegotiationsNotFoundErrors)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ErrorsNegotiationNegotiationsNotFoundErrors) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonNotFoundErrors != nil {
		return json.Marshal(&src.ErrorsCommonNotFoundErrors)
	}

	if src.ErrorsNegotiationNotFoundErrors != nil {
		return json.Marshal(&src.ErrorsNegotiationNotFoundErrors)
	}
...
func (obj *ErrorsNegotiationNegotiationsNotFoundErrors) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.ErrorsCommonNotFoundErrors != nil {
		return obj.ErrorsCommonNotFoundErrors
	}

	if obj.ErrorsNegotiationNotFoundErrors != nil {
		return obj.ErrorsNegotiationNotFoundErrors
	}
...
type NullableErrorsNegotiationNegotiationsNotFoundErrors struct {
	value *ErrorsNegotiationNegotiationsNotFoundErrors
	isSet bool
}

func (v NullableErrorsNegotiationNegotiationsNotFoundErrors) Get() *ErrorsNegotiationNegotiationsNotFoundErrors {
	return v.value
}

func (v *NullableErrorsNegotiationNegotiationsNotFoundErrors) Set(val *ErrorsNegotiationNegotiationsNotFoundErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsNegotiationNegotiationsNotFoundErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsNegotiationNegotiationsNotFoundErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsNegotiationNegotiationsNotFoundErrors(val *ErrorsNegotiationNegotiationsNotFoundErrors) *NullableErrorsNegotiationNegotiationsNotFoundErrors {
	return &NullableErrorsNegotiationNegotiationsNotFoundErrors{value: val, isSet: true}
}

func (v NullableErrorsNegotiationNegotiationsNotFoundErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsNegotiationNegotiationsNotFoundErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
