...
// checks if the VacancyEmployment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyEmployment{}

// VacancyEmployment struct for VacancyEmployment
...
func (o *VacancyEmployment) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o VacancyEmployment) MarshalJSON() ([]byte, error) {
...
func (o VacancyEmployment) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyEmployment struct {
	value *VacancyEmployment
	isSet bool
}

func (v NullableVacancyEmployment) Get() *VacancyEmployment {
	return v.value
}

func (v *NullableVacancyEmployment) Set(val *VacancyEmployment) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyEmployment) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyEmployment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyEmployment(val *VacancyEmployment) *NullableVacancyEmployment {
	return &NullableVacancyEmployment{value: val, isSet: true}
}

func (v NullableVacancyEmployment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyEmployment) UnmarshalJSON(src []byte) error {
	v.isSet = true
