...
// checks if the EmployersBrandingMakeupMakeup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersBrandingMakeupMakeup{}

// EmployersBrandingMakeupMakeup struct for EmployersBrandingMakeupMakeup
type EmployersBrandingMakeupMakeup struct {
	// Ссылка на webview версию бренд страницы
	Url string `json:"url"`
}

type _EmployersBrandingMakeupMakeup EmployersBrandingMakeupMakeup
...
func NewEmployersBrandingMakeupMakeup(url string) *EmployersBrandingMakeupMakeup {
	this := EmployersBrandingMakeupMakeup{}
	this.Url = url
	return &this
}
...
func (o EmployersBrandingMakeupMakeup) MarshalJSON() ([]byte, error) {
...
func (o EmployersBrandingMakeupMakeup) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["url"] = o.Url
	return toSerialize, nil
}

func (o *EmployersBrandingMakeupMakeup) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersBrandingMakeupMakeup := _EmployersBrandingMakeupMakeup{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersBrandingMakeupMakeup)

	if err != nil {
		return err
	}

	*o = EmployersBrandingMakeupMakeup(varEmployersBrandingMakeupMakeup)

	return err
}

type NullableEmployersBrandingMakeupMakeup struct {
	value *EmployersBrandingMakeupMakeup
	isSet bool
}

func (v NullableEmployersBrandingMakeupMakeup) Get() *EmployersBrandingMakeupMakeup {
	return v.value
}

func (v *NullableEmployersBrandingMakeupMakeup) Set(val *EmployersBrandingMakeupMakeup) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersBrandingMakeupMakeup) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersBrandingMakeupMakeup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersBrandingMakeupMakeup(val *EmployersBrandingMakeupMakeup) *NullableEmployersBrandingMakeupMakeup {
	return &NullableEmployersBrandingMakeupMakeup{value: val, isSet: true}
}

func (v NullableEmployersBrandingMakeupMakeup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersBrandingMakeupMakeup) UnmarshalJSON(src []byte) error {
	v.isSet = true
