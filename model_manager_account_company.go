...
// checks if the ManagerAccountCompany type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagerAccountCompany{}

// ManagerAccountCompany Информация о компании, к которой прикреплен рабочий аккаунт менеджера
type ManagerAccountCompany struct {
...
type _ManagerAccountCompany ManagerAccountCompany
...
func (o ManagerAccountCompany) MarshalJSON() ([]byte, error) {
...
func (o ManagerAccountCompany) ToMap() (map[string]interface{}, error) {
...
func (o *ManagerAccountCompany) UnmarshalJSON(data []byte) (err error) {
	...
	varManagerAccountCompany := _ManagerAccountCompany{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varManagerAccountCompany)

	if err != nil {
		return err
	}

	*o = ManagerAccountCompany(varManagerAccountCompany)

	return err
}

type NullableManagerAccountCompany struct {
	value *ManagerAccountCompany
	isSet bool
}

func (v NullableManagerAccountCompany) Get() *ManagerAccountCompany {
	return v.value
}

func (v *NullableManagerAccountCompany) Set(val *ManagerAccountCompany) {
	v.value = val
	v.isSet = true
}

func (v NullableManagerAccountCompany) IsSet() bool {
	return v.isSet
}

func (v *NullableManagerAccountCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagerAccountCompany(val *ManagerAccountCompany) *NullableManagerAccountCompany {
	return &NullableManagerAccountCompany{value: val, isSet: true}
}

func (v NullableManagerAccountCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagerAccountCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
