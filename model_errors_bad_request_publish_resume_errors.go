...
// checks if the ErrorsBadRequestPublishResumeErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsBadRequestPublishResumeErrors{}

// ErrorsBadRequestPublishResumeErrors Информация о возникших ошибках
type ErrorsBadRequestPublishResumeErrors struct {
	...
	Errors []ErrorsBadRequestPublishResumeError `json:"errors"`
}

type _ErrorsBadRequestPublishResumeErrors ErrorsBadRequestPublishResumeErrors
...
func NewErrorsBadRequestPublishResumeErrors(requestId string, errors []ErrorsBadRequestPublishResumeError) *ErrorsBadRequestPublishResumeErrors {
	this := ErrorsBadRequestPublishResumeErrors{}
...
func (o *ErrorsBadRequestPublishResumeErrors) GetErrors() []ErrorsBadRequestPublishResumeError {
	if o == nil {
		var ret []ErrorsBadRequestPublishResumeError
		return ret
	}
...
func (o ErrorsBadRequestPublishResumeErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsBadRequestPublishResumeErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsBadRequestPublishResumeErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsBadRequestPublishResumeErrors := _ErrorsBadRequestPublishResumeErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsBadRequestPublishResumeErrors)

	if err != nil {
		return err
	}

	*o = ErrorsBadRequestPublishResumeErrors(varErrorsBadRequestPublishResumeErrors)

	return err
}

type NullableErrorsBadRequestPublishResumeErrors struct {
	value *ErrorsBadRequestPublishResumeErrors
	isSet bool
}

func (v NullableErrorsBadRequestPublishResumeErrors) Get() *ErrorsBadRequestPublishResumeErrors {
	return v.value
}

func (v *NullableErrorsBadRequestPublishResumeErrors) Set(val *ErrorsBadRequestPublishResumeErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsBadRequestPublishResumeErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsBadRequestPublishResumeErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsBadRequestPublishResumeErrors(val *ErrorsBadRequestPublishResumeErrors) *NullableErrorsBadRequestPublishResumeErrors {
	return &NullableErrorsBadRequestPublishResumeErrors{value: val, isSet: true}
}

func (v NullableErrorsBadRequestPublishResumeErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsBadRequestPublishResumeErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
