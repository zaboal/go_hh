...
// checks if the ErrorsVacancyAddEditForbiddenErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyAddEditForbiddenErrors{}

// ErrorsVacancyAddEditForbiddenErrors Информация о возникших ошибках
type ErrorsVacancyAddEditForbiddenErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Описание ошибки
	Description *string `json:"description,omitempty"`
	// Массив с данными ошибок
	Errors []ErrorsVacancyAddEditForbiddenError `json:"errors"`
}

type _ErrorsVacancyAddEditForbiddenErrors ErrorsVacancyAddEditForbiddenErrors
...
func NewErrorsVacancyAddEditForbiddenErrors(requestId string, errors []ErrorsVacancyAddEditForbiddenError) *ErrorsVacancyAddEditForbiddenErrors {
	this := ErrorsVacancyAddEditForbiddenErrors{}
...
func (o *ErrorsVacancyAddEditForbiddenErrors) GetErrors() []ErrorsVacancyAddEditForbiddenError {
	if o == nil {
		var ret []ErrorsVacancyAddEditForbiddenError
		return ret
	}
...
func (o ErrorsVacancyAddEditForbiddenErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyAddEditForbiddenErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyAddEditForbiddenErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyAddEditForbiddenErrors := _ErrorsVacancyAddEditForbiddenErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyAddEditForbiddenErrors)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyAddEditForbiddenErrors(varErrorsVacancyAddEditForbiddenErrors)

	return err
}

type NullableErrorsVacancyAddEditForbiddenErrors struct {
	value *ErrorsVacancyAddEditForbiddenErrors
	isSet bool
}

func (v NullableErrorsVacancyAddEditForbiddenErrors) Get() *ErrorsVacancyAddEditForbiddenErrors {
	return v.value
}

func (v *NullableErrorsVacancyAddEditForbiddenErrors) Set(val *ErrorsVacancyAddEditForbiddenErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyAddEditForbiddenErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyAddEditForbiddenErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyAddEditForbiddenErrors(val *ErrorsVacancyAddEditForbiddenErrors) *NullableErrorsVacancyAddEditForbiddenErrors {
	return &NullableErrorsVacancyAddEditForbiddenErrors{value: val, isSet: true}
}

func (v NullableErrorsVacancyAddEditForbiddenErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyAddEditForbiddenErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
