...
// checks if the ErrorsVacancyErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsVacancyErrors{}

// ErrorsVacancyErrors Информация о возникших ошибках
type ErrorsVacancyErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsVacancyError `json:"errors"`
}

type _ErrorsVacancyErrors ErrorsVacancyErrors
...
func (o ErrorsVacancyErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsVacancyErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsVacancyErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsVacancyErrors := _ErrorsVacancyErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsVacancyErrors)

	if err != nil {
		return err
	}

	*o = ErrorsVacancyErrors(varErrorsVacancyErrors)

	return err
}

type NullableErrorsVacancyErrors struct {
	value *ErrorsVacancyErrors
	isSet bool
}

func (v NullableErrorsVacancyErrors) Get() *ErrorsVacancyErrors {
	return v.value
}

func (v *NullableErrorsVacancyErrors) Set(val *ErrorsVacancyErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsVacancyErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsVacancyErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsVacancyErrors(val *ErrorsVacancyErrors) *NullableErrorsVacancyErrors {
	return &NullableErrorsVacancyErrors{value: val, isSet: true}
}

func (v NullableErrorsVacancyErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsVacancyErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
