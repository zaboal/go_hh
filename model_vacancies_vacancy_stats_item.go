...
// checks if the VacanciesVacancyStatsItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyStatsItem{}

// VacanciesVacancyStatsItem struct for VacanciesVacancyStatsItem
type VacanciesVacancyStatsItem struct {
	// Дата в формате `YYYY-MM-DD`
	Date string `json:"date"`
	// Количество откликов на вакансию. `null` если дата в будущем или данных на эту дату нет
	Responses NullableFloat32 `json:"responses,omitempty"`
	// Количество просмотров вакансии. `null` если дата в будущем или данных на эту дату нет
	Views NullableFloat32 `json:"views,omitempty"`
}

type _VacanciesVacancyStatsItem VacanciesVacancyStatsItem
...
func NewVacanciesVacancyStatsItem(date string) *VacanciesVacancyStatsItem {
	this := VacanciesVacancyStatsItem{}
	this.Date = date
	return &this
}
...
func (o *VacanciesVacancyStatsItem) GetResponses() float32 {
	if o == nil || IsNil(o.Responses.Get()) {
		var ret float32
		return ret
	}
	return *o.Responses.Get()
}
...
func (o *VacanciesVacancyStatsItem) GetResponsesOk() (*float32, bool) {
	...
	return o.Responses.Get(), o.Responses.IsSet()
}

// HasResponses returns a boolean if a field has been set.
func (o *VacanciesVacancyStatsItem) HasResponses() bool {
	if o != nil && o.Responses.IsSet() {
		return true
	}
...
// SetResponses gets a reference to the given NullableFloat32 and assigns it to the Responses field.
...
func (o *VacanciesVacancyStatsItem) SetResponsesNil() {
	o.Responses.Set(nil)
}
...
// SetViews gets a reference to the given NullableFloat32 and assigns it to the Views field.
func (o *VacanciesVacancyStatsItem) SetViews(v float32) {
	o.Views.Set(&v)
}
// SetViewsNil sets the value for Views to be an explicit nil
func (o *VacanciesVacancyStatsItem) SetViewsNil() {
	o.Views.Set(nil)
}
...
func (o VacanciesVacancyStatsItem) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyStatsItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["date"] = o.Date
	if o.Responses.IsSet() {
		toSerialize["responses"] = o.Responses.Get()
	}
	if o.Views.IsSet() {
...
func (o *VacanciesVacancyStatsItem) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacancyStatsItem := _VacanciesVacancyStatsItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacancyStatsItem)

	if err != nil {
		return err
	}

	*o = VacanciesVacancyStatsItem(varVacanciesVacancyStatsItem)

	return err
}

type NullableVacanciesVacancyStatsItem struct {
	value *VacanciesVacancyStatsItem
	isSet bool
}

func (v NullableVacanciesVacancyStatsItem) Get() *VacanciesVacancyStatsItem {
	return v.value
}

func (v *NullableVacanciesVacancyStatsItem) Set(val *VacanciesVacancyStatsItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyStatsItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyStatsItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyStatsItem(val *VacanciesVacancyStatsItem) *NullableVacanciesVacancyStatsItem {
	return &NullableVacanciesVacancyStatsItem{value: val, isSet: true}
}

func (v NullableVacanciesVacancyStatsItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyStatsItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
