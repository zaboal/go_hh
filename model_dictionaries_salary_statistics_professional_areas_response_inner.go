...
// checks if the DictionariesSalaryStatisticsProfessionalAreasResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DictionariesSalaryStatisticsProfessionalAreasResponseInner{}

// DictionariesSalaryStatisticsProfessionalAreasResponseInner Профобласть и специализации
type DictionariesSalaryStatisticsProfessionalAreasResponseInner struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
	Name string `json:"name"`
	Specializations []IncludesIdNameDesc `json:"specializations"`
}

type _DictionariesSalaryStatisticsProfessionalAreasResponseInner DictionariesSalaryStatisticsProfessionalAreasResponseInner
...
func NewDictionariesSalaryStatisticsProfessionalAreasResponseInner(id string, name string, specializations []IncludesIdNameDesc) *DictionariesSalaryStatisticsProfessionalAreasResponseInner {
	this := DictionariesSalaryStatisticsProfessionalAreasResponseInner{}
	this.Id = id
	this.Name = name
...
// GetSpecializations returns the Specializations field value
func (o *DictionariesSalaryStatisticsProfessionalAreasResponseInner) GetSpecializations() []IncludesIdNameDesc {
	if o == nil {
		var ret []IncludesIdNameDesc
		return ret
	}

	return o.Specializations
}

// GetSpecializationsOk returns a tuple with the Specializations field value
// and a boolean to check if the value has been set.
func (o *DictionariesSalaryStatisticsProfessionalAreasResponseInner) GetSpecializationsOk() ([]IncludesIdNameDesc, bool) {
	if o == nil {
		return nil, false
	}
	return o.Specializations, true
}

// SetSpecializations sets field value
func (o *DictionariesSalaryStatisticsProfessionalAreasResponseInner) SetSpecializations(v []IncludesIdNameDesc) {
	o.Specializations = v
}

func (o DictionariesSalaryStatisticsProfessionalAreasResponseInner) MarshalJSON() ([]byte, error) {
...
func (o DictionariesSalaryStatisticsProfessionalAreasResponseInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["name"] = o.Name
	toSerialize["specializations"] = o.Specializations
	return toSerialize, nil
}

func (o *DictionariesSalaryStatisticsProfessionalAreasResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varDictionariesSalaryStatisticsProfessionalAreasResponseInner := _DictionariesSalaryStatisticsProfessionalAreasResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDictionariesSalaryStatisticsProfessionalAreasResponseInner)

	if err != nil {
		return err
	}

	*o = DictionariesSalaryStatisticsProfessionalAreasResponseInner(varDictionariesSalaryStatisticsProfessionalAreasResponseInner)

	return err
}

type NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner struct {
	value *DictionariesSalaryStatisticsProfessionalAreasResponseInner
	isSet bool
}

func (v NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner) Get() *DictionariesSalaryStatisticsProfessionalAreasResponseInner {
	return v.value
}

func (v *NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner) Set(val *DictionariesSalaryStatisticsProfessionalAreasResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDictionariesSalaryStatisticsProfessionalAreasResponseInner(val *DictionariesSalaryStatisticsProfessionalAreasResponseInner) *NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner {
	return &NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner{value: val, isSet: true}
}

func (v NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDictionariesSalaryStatisticsProfessionalAreasResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
