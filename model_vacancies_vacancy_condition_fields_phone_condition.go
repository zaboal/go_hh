...
// checks if the VacanciesVacancyConditionFieldsPhoneCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsPhoneCondition{}

// VacanciesVacancyConditionFieldsPhoneCondition struct for VacanciesVacancyConditionFieldsPhoneCondition
type VacanciesVacancyConditionFieldsPhoneCondition struct {
	...
	Fields NullableVacanciesVacancyConditionFieldsPhoneFields `json:"fields,omitempty"`
}
...
func NewVacanciesVacancyConditionFieldsPhoneCondition() *VacanciesVacancyConditionFieldsPhoneCondition {
	this := VacanciesVacancyConditionFieldsPhoneCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsPhoneCondition) SetMaxCountNil() {
	o.MaxCount.Set(nil)
}

// UnsetMaxCount ensures that no value is present for MaxCount, not even an explicit nil
func (o *VacanciesVacancyConditionFieldsPhoneCondition) UnsetMaxCount() {
	o.MaxCount.Unset()
}
...
func (o *VacanciesVacancyConditionFieldsPhoneCondition) SetMinCountNil() {
	o.MinCount.Set(nil)
}

// UnsetMinCount ensures that no value is present for MinCount, not even an explicit nil
func (o *VacanciesVacancyConditionFieldsPhoneCondition) UnsetMinCount() {
	o.MinCount.Unset()
}
...
func (o *VacanciesVacancyConditionFieldsPhoneCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsPhoneCondition) GetFields() VacanciesVacancyConditionFieldsPhoneFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret VacanciesVacancyConditionFieldsPhoneFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableVacanciesVacancyConditionFieldsPhoneFields and assigns it to the Fields field.
func (o *VacanciesVacancyConditionFieldsPhoneCondition) SetFields(v VacanciesVacancyConditionFieldsPhoneFields) {
	o.Fields.Set(&v)
}
// SetFieldsNil sets the value for Fields to be an explicit nil
func (o *VacanciesVacancyConditionFieldsPhoneCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsPhoneCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsPhoneCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsPhoneCondition struct {
	value *VacanciesVacancyConditionFieldsPhoneCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsPhoneCondition) Get() *VacanciesVacancyConditionFieldsPhoneCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsPhoneCondition) Set(val *VacanciesVacancyConditionFieldsPhoneCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsPhoneCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsPhoneCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsPhoneCondition(val *VacanciesVacancyConditionFieldsPhoneCondition) *NullableVacanciesVacancyConditionFieldsPhoneCondition {
	return &NullableVacanciesVacancyConditionFieldsPhoneCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsPhoneCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsPhoneCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
