...
// checks if the EmployerManagersEmployerManagerItemPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersEmployerManagerItemPhone{}

// EmployerManagersEmployerManagerItemPhone Основной телефон менеджера
type EmployerManagersEmployerManagerItemPhone struct {
	// Код города
...
type _EmployerManagersEmployerManagerItemPhone EmployerManagersEmployerManagerItemPhone
...
func NewEmployerManagersEmployerManagerItemPhone(city string, country string, number string) *EmployerManagersEmployerManagerItemPhone {
	this := EmployerManagersEmployerManagerItemPhone{}
	this.City = city
...
func (o *EmployerManagersEmployerManagerItemPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersEmployerManagerItemPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersEmployerManagerItemPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersEmployerManagerItemPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersEmployerManagerItemPhone := _EmployerManagersEmployerManagerItemPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersEmployerManagerItemPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersEmployerManagerItemPhone(varEmployerManagersEmployerManagerItemPhone)

	return err
}

type NullableEmployerManagersEmployerManagerItemPhone struct {
	value *EmployerManagersEmployerManagerItemPhone
	isSet bool
}

func (v NullableEmployerManagersEmployerManagerItemPhone) Get() *EmployerManagersEmployerManagerItemPhone {
	return v.value
}

func (v *NullableEmployerManagersEmployerManagerItemPhone) Set(val *EmployerManagersEmployerManagerItemPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersEmployerManagerItemPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersEmployerManagerItemPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersEmployerManagerItemPhone(val *EmployerManagersEmployerManagerItemPhone) *NullableEmployerManagersEmployerManagerItemPhone {
	return &NullableEmployerManagersEmployerManagerItemPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersEmployerManagerItemPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersEmployerManagerItemPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
