...
// checks if the VacancyDraftPhoneItemWithFullPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftPhoneItemWithFullPhone{}

// VacancyDraftPhoneItemWithFullPhone struct for VacancyDraftPhoneItemWithFullPhone
type VacancyDraftPhoneItemWithFullPhone struct {
...
func NewVacancyDraftPhoneItemWithFullPhone() *VacancyDraftPhoneItemWithFullPhone {
	this := VacancyDraftPhoneItemWithFullPhone{}
	return &this
}
...
func (o *VacancyDraftPhoneItemWithFullPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o VacancyDraftPhoneItemWithFullPhone) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftPhoneItemWithFullPhone) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftPhoneItemWithFullPhone struct {
	value *VacancyDraftPhoneItemWithFullPhone
	isSet bool
}

func (v NullableVacancyDraftPhoneItemWithFullPhone) Get() *VacancyDraftPhoneItemWithFullPhone {
	return v.value
}

func (v *NullableVacancyDraftPhoneItemWithFullPhone) Set(val *VacancyDraftPhoneItemWithFullPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftPhoneItemWithFullPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftPhoneItemWithFullPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftPhoneItemWithFullPhone(val *VacancyDraftPhoneItemWithFullPhone) *NullableVacancyDraftPhoneItemWithFullPhone {
	return &NullableVacancyDraftPhoneItemWithFullPhone{value: val, isSet: true}
}

func (v NullableVacancyDraftPhoneItemWithFullPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftPhoneItemWithFullPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
