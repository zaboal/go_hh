...
// checks if the VacancyEditManagerManager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyEditManagerManager{}

// VacancyEditManagerManager Идентификатор менеджера, которому надо передать автопоиск из ([списка менеджеров компании](#tag/Menedzhery-rabotodatelya/operation/get-employer-managers))
type VacancyEditManagerManager struct {
	// Идентификатор
	Id string `json:"id"`
}

type _VacancyEditManagerManager VacancyEditManagerManager
...
func NewVacancyEditManagerManager(id string) *VacancyEditManagerManager {
	this := VacancyEditManagerManager{}
	this.Id = id
	return &this
}
...
func (o VacancyEditManagerManager) MarshalJSON() ([]byte, error) {
...
func (o VacancyEditManagerManager) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	return toSerialize, nil
}

func (o *VacancyEditManagerManager) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyEditManagerManager := _VacancyEditManagerManager{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyEditManagerManager)

	if err != nil {
		return err
	}

	*o = VacancyEditManagerManager(varVacancyEditManagerManager)

	return err
}

type NullableVacancyEditManagerManager struct {
	value *VacancyEditManagerManager
	isSet bool
}

func (v NullableVacancyEditManagerManager) Get() *VacancyEditManagerManager {
	return v.value
}

func (v *NullableVacancyEditManagerManager) Set(val *VacancyEditManagerManager) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyEditManagerManager) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyEditManagerManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyEditManagerManager(val *VacancyEditManagerManager) *NullableVacancyEditManagerManager {
	return &NullableVacancyEditManagerManager{value: val, isSet: true}
}

func (v NullableVacancyEditManagerManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyEditManagerManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
