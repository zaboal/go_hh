...
// checks if the ResumeObjectsEducationAdditional type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsEducationAdditional{}

// ResumeObjectsEducationAdditional struct for ResumeObjectsEducationAdditional
type ResumeObjectsEducationAdditional struct {
	// Идентификатор
...
type _ResumeObjectsEducationAdditional ResumeObjectsEducationAdditional
...
func NewResumeObjectsEducationAdditional(name string, organization string, year float32) *ResumeObjectsEducationAdditional {
	this := ResumeObjectsEducationAdditional{}
	this.Name = name
...
func (o *ResumeObjectsEducationAdditional) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ResumeObjectsEducationAdditional) SetResultNil() {
	o.Result.Set(nil)
}
...
func (o ResumeObjectsEducationAdditional) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsEducationAdditional) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsEducationAdditional) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsEducationAdditional := _ResumeObjectsEducationAdditional{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsEducationAdditional)

	if err != nil {
		return err
	}

	*o = ResumeObjectsEducationAdditional(varResumeObjectsEducationAdditional)

	return err
}

type NullableResumeObjectsEducationAdditional struct {
	value *ResumeObjectsEducationAdditional
	isSet bool
}

func (v NullableResumeObjectsEducationAdditional) Get() *ResumeObjectsEducationAdditional {
	return v.value
}

func (v *NullableResumeObjectsEducationAdditional) Set(val *ResumeObjectsEducationAdditional) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsEducationAdditional) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsEducationAdditional) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsEducationAdditional(val *ResumeObjectsEducationAdditional) *NullableResumeObjectsEducationAdditional {
	return &NullableResumeObjectsEducationAdditional{value: val, isSet: true}
}

func (v NullableResumeObjectsEducationAdditional) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsEducationAdditional) UnmarshalJSON(src []byte) error {
	v.isSet = true
