...
// checks if the VacanciesVacancyConditionFieldsAddressCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsAddressCondition{}

// VacanciesVacancyConditionFieldsAddressCondition struct for VacanciesVacancyConditionFieldsAddressCondition
type VacanciesVacancyConditionFieldsAddressCondition struct {
	// Является ли поле необходимым?
	Required NullableBool `json:"required,omitempty"`
	Fields NullableVacanciesVacancyConditionFieldsAddressFields `json:"fields,omitempty"`
}
...
func NewVacanciesVacancyConditionFieldsAddressCondition() *VacanciesVacancyConditionFieldsAddressCondition {
	this := VacanciesVacancyConditionFieldsAddressCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsAddressCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsAddressCondition) GetFields() VacanciesVacancyConditionFieldsAddressFields {
	if o == nil || IsNil(o.Fields.Get()) {
		var ret VacanciesVacancyConditionFieldsAddressFields
		return ret
	}
	return *o.Fields.Get()
}
...
// SetFields gets a reference to the given NullableVacanciesVacancyConditionFieldsAddressFields and assigns it to the Fields field.
...
func (o *VacanciesVacancyConditionFieldsAddressCondition) SetFieldsNil() {
	o.Fields.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsAddressCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsAddressCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsAddressCondition struct {
	value *VacanciesVacancyConditionFieldsAddressCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsAddressCondition) Get() *VacanciesVacancyConditionFieldsAddressCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsAddressCondition) Set(val *VacanciesVacancyConditionFieldsAddressCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsAddressCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsAddressCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsAddressCondition(val *VacanciesVacancyConditionFieldsAddressCondition) *NullableVacanciesVacancyConditionFieldsAddressCondition {
	return &NullableVacanciesVacancyConditionFieldsAddressCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsAddressCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsAddressCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
