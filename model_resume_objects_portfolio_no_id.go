...
// checks if the ResumeObjectsPortfolioNoId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsPortfolioNoId{}

// ResumeObjectsPortfolioNoId struct for ResumeObjectsPortfolioNoId
type ResumeObjectsPortfolioNoId struct {
...
type _ResumeObjectsPortfolioNoId ResumeObjectsPortfolioNoId
...
func NewResumeObjectsPortfolioNoId(medium string, small string) *ResumeObjectsPortfolioNoId {
	this := ResumeObjectsPortfolioNoId{}
	this.Medium = medium
	this.Small = small
	return &this
}
...
func (o ResumeObjectsPortfolioNoId) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsPortfolioNoId) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeObjectsPortfolioNoId) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsPortfolioNoId := _ResumeObjectsPortfolioNoId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsPortfolioNoId)

	if err != nil {
		return err
	}

	*o = ResumeObjectsPortfolioNoId(varResumeObjectsPortfolioNoId)

	return err
}

type NullableResumeObjectsPortfolioNoId struct {
	value *ResumeObjectsPortfolioNoId
	isSet bool
}

func (v NullableResumeObjectsPortfolioNoId) Get() *ResumeObjectsPortfolioNoId {
	return v.value
}

func (v *NullableResumeObjectsPortfolioNoId) Set(val *ResumeObjectsPortfolioNoId) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsPortfolioNoId) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsPortfolioNoId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsPortfolioNoId(val *ResumeObjectsPortfolioNoId) *NullableResumeObjectsPortfolioNoId {
	return &NullableResumeObjectsPortfolioNoId{value: val, isSet: true}
}

func (v NullableResumeObjectsPortfolioNoId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsPortfolioNoId) UnmarshalJSON(src []byte) error {
	v.isSet = true
