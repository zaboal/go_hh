...
// checks if the NegotiationsAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsAction{}

// NegotiationsAction В зависимости от состояния инструмента оценки, конкретные действия над ним могут быть доступны либо нет 
type NegotiationsAction struct {
...
type _NegotiationsAction NegotiationsAction
...
// GetAlternateUrl returns the AlternateUrl field value if set, zero value otherwise.
func (o *NegotiationsAction) GetAlternateUrl() string {
	if o == nil || IsNil(o.AlternateUrl) {
		var ret string
		return ret
	}
...
// SetAlternateUrl gets a reference to the given string and assigns it to the AlternateUrl field.
...
func (o NegotiationsAction) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsAction) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AlternateUrl) {
...
func (o *NegotiationsAction) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsAction := _NegotiationsAction{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsAction)

	if err != nil {
		return err
	}

	*o = NegotiationsAction(varNegotiationsAction)

	return err
}

type NullableNegotiationsAction struct {
	value *NegotiationsAction
	isSet bool
}

func (v NullableNegotiationsAction) Get() *NegotiationsAction {
	return v.value
}

func (v *NullableNegotiationsAction) Set(val *NegotiationsAction) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsAction) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsAction(val *NegotiationsAction) *NullableNegotiationsAction {
	return &NullableNegotiationsAction{value: val, isSet: true}
}

func (v NullableNegotiationsAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
