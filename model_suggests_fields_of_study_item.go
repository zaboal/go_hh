...
// checks if the SuggestsFieldsOfStudyItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsFieldsOfStudyItem{}

// SuggestsFieldsOfStudyItem struct for SuggestsFieldsOfStudyItem
...
type _SuggestsFieldsOfStudyItem SuggestsFieldsOfStudyItem
...
func NewSuggestsFieldsOfStudyItem(id string, text string) *SuggestsFieldsOfStudyItem {
	this := SuggestsFieldsOfStudyItem{}
	this.Id = id
	this.Text = text
	return &this
}
...
func (o SuggestsFieldsOfStudyItem) MarshalJSON() ([]byte, error) {
...
func (o SuggestsFieldsOfStudyItem) ToMap() (map[string]interface{}, error) {
...
func (o *SuggestsFieldsOfStudyItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsFieldsOfStudyItem := _SuggestsFieldsOfStudyItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsFieldsOfStudyItem)

	if err != nil {
		return err
	}

	*o = SuggestsFieldsOfStudyItem(varSuggestsFieldsOfStudyItem)

	return err
}

type NullableSuggestsFieldsOfStudyItem struct {
	value *SuggestsFieldsOfStudyItem
	isSet bool
}

func (v NullableSuggestsFieldsOfStudyItem) Get() *SuggestsFieldsOfStudyItem {
	return v.value
}

func (v *NullableSuggestsFieldsOfStudyItem) Set(val *SuggestsFieldsOfStudyItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsFieldsOfStudyItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsFieldsOfStudyItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsFieldsOfStudyItem(val *SuggestsFieldsOfStudyItem) *NullableSuggestsFieldsOfStudyItem {
	return &NullableSuggestsFieldsOfStudyItem{value: val, isSet: true}
}

func (v NullableSuggestsFieldsOfStudyItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsFieldsOfStudyItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
