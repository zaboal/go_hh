...
// checks if the ErrorsDictionariesBadArgumentErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsDictionariesBadArgumentErrors{}

// ErrorsDictionariesBadArgumentErrors Информация о возникших ошибках
type ErrorsDictionariesBadArgumentErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsDictionariesBadArgumentError `json:"errors"`
}

type _ErrorsDictionariesBadArgumentErrors ErrorsDictionariesBadArgumentErrors
...
func NewErrorsDictionariesBadArgumentErrors(requestId string, errors []ErrorsDictionariesBadArgumentError) *ErrorsDictionariesBadArgumentErrors {
	this := ErrorsDictionariesBadArgumentErrors{}
...
func (o *ErrorsDictionariesBadArgumentErrors) GetErrors() []ErrorsDictionariesBadArgumentError {
	if o == nil {
		var ret []ErrorsDictionariesBadArgumentError
		return ret
	}
...
func (o ErrorsDictionariesBadArgumentErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsDictionariesBadArgumentErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsDictionariesBadArgumentErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsDictionariesBadArgumentErrors := _ErrorsDictionariesBadArgumentErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsDictionariesBadArgumentErrors)

	if err != nil {
		return err
	}

	*o = ErrorsDictionariesBadArgumentErrors(varErrorsDictionariesBadArgumentErrors)

	return err
}

type NullableErrorsDictionariesBadArgumentErrors struct {
	value *ErrorsDictionariesBadArgumentErrors
	isSet bool
}

func (v NullableErrorsDictionariesBadArgumentErrors) Get() *ErrorsDictionariesBadArgumentErrors {
	return v.value
}

func (v *NullableErrorsDictionariesBadArgumentErrors) Set(val *ErrorsDictionariesBadArgumentErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsDictionariesBadArgumentErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsDictionariesBadArgumentErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsDictionariesBadArgumentErrors(val *ErrorsDictionariesBadArgumentErrors) *NullableErrorsDictionariesBadArgumentErrors {
	return &NullableErrorsDictionariesBadArgumentErrors{value: val, isSet: true}
}

func (v NullableErrorsDictionariesBadArgumentErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsDictionariesBadArgumentErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
