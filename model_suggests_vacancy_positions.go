...
// checks if the SuggestsVacancyPositions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuggestsVacancyPositions{}
...
type _SuggestsVacancyPositions SuggestsVacancyPositions
...
func (o *SuggestsVacancyPositions) GetItems() []SuggestsVacancyPositionItem {
	if o == nil {
		var ret []SuggestsVacancyPositionItem
		return ret
	}
...
func (o SuggestsVacancyPositions) MarshalJSON() ([]byte, error) {
...
func (o SuggestsVacancyPositions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *SuggestsVacancyPositions) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestsVacancyPositions := _SuggestsVacancyPositions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestsVacancyPositions)

	if err != nil {
		return err
	}

	*o = SuggestsVacancyPositions(varSuggestsVacancyPositions)

	return err
}

type NullableSuggestsVacancyPositions struct {
	value *SuggestsVacancyPositions
	isSet bool
}

func (v NullableSuggestsVacancyPositions) Get() *SuggestsVacancyPositions {
	return v.value
}

func (v *NullableSuggestsVacancyPositions) Set(val *SuggestsVacancyPositions) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestsVacancyPositions) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestsVacancyPositions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestsVacancyPositions(val *SuggestsVacancyPositions) *NullableSuggestsVacancyPositions {
	return &NullableSuggestsVacancyPositions{value: val, isSet: true}
}

func (v NullableSuggestsVacancyPositions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestsVacancyPositions) UnmarshalJSON(src []byte) error {
	v.isSet = true
