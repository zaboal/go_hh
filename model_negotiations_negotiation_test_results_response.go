...
// checks if the NegotiationsNegotiationTestResultsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationTestResultsResponse{}

// NegotiationsNegotiationTestResultsResponse struct for NegotiationsNegotiationTestResultsResponse
type NegotiationsNegotiationTestResultsResponse struct {
	TestResult NegotiationsNegotiationTestResultsResponseTestResult `json:"test_result"`
}

type _NegotiationsNegotiationTestResultsResponse NegotiationsNegotiationTestResultsResponse
...
func NewNegotiationsNegotiationTestResultsResponse(testResult NegotiationsNegotiationTestResultsResponseTestResult) *NegotiationsNegotiationTestResultsResponse {
	this := NegotiationsNegotiationTestResultsResponse{}
...
func (o *NegotiationsNegotiationTestResultsResponse) GetTestResult() NegotiationsNegotiationTestResultsResponseTestResult {
	if o == nil {
		var ret NegotiationsNegotiationTestResultsResponseTestResult
		return ret
	}
...
func (o NegotiationsNegotiationTestResultsResponse) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationTestResultsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["test_result"] = o.TestResult
	return toSerialize, nil
}

func (o *NegotiationsNegotiationTestResultsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationTestResultsResponse := _NegotiationsNegotiationTestResultsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationTestResultsResponse)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationTestResultsResponse(varNegotiationsNegotiationTestResultsResponse)

	return err
}

type NullableNegotiationsNegotiationTestResultsResponse struct {
	value *NegotiationsNegotiationTestResultsResponse
	isSet bool
}

func (v NullableNegotiationsNegotiationTestResultsResponse) Get() *NegotiationsNegotiationTestResultsResponse {
	return v.value
}

func (v *NullableNegotiationsNegotiationTestResultsResponse) Set(val *NegotiationsNegotiationTestResultsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationTestResultsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationTestResultsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationTestResultsResponse(val *NegotiationsNegotiationTestResultsResponse) *NullableNegotiationsNegotiationTestResultsResponse {
	return &NullableNegotiationsNegotiationTestResultsResponse{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationTestResultsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationTestResultsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
