...
// checks if the EmployerManagersEmployerManagerItemAdditionalPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersEmployerManagerItemAdditionalPhone{}

// EmployerManagersEmployerManagerItemAdditionalPhone Дополнительный телефон менеджера
type EmployerManagersEmployerManagerItemAdditionalPhone struct {
	// Код города
...
type _EmployerManagersEmployerManagerItemAdditionalPhone EmployerManagersEmployerManagerItemAdditionalPhone
...
func NewEmployerManagersEmployerManagerItemAdditionalPhone(city string, country string, number string) *EmployerManagersEmployerManagerItemAdditionalPhone {
	this := EmployerManagersEmployerManagerItemAdditionalPhone{}
	this.City = city
...
func (o *EmployerManagersEmployerManagerItemAdditionalPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersEmployerManagerItemAdditionalPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersEmployerManagerItemAdditionalPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersEmployerManagerItemAdditionalPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersEmployerManagerItemAdditionalPhone := _EmployerManagersEmployerManagerItemAdditionalPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersEmployerManagerItemAdditionalPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersEmployerManagerItemAdditionalPhone(varEmployerManagersEmployerManagerItemAdditionalPhone)

	return err
}

type NullableEmployerManagersEmployerManagerItemAdditionalPhone struct {
	value *EmployerManagersEmployerManagerItemAdditionalPhone
	isSet bool
}

func (v NullableEmployerManagersEmployerManagerItemAdditionalPhone) Get() *EmployerManagersEmployerManagerItemAdditionalPhone {
	return v.value
}

func (v *NullableEmployerManagersEmployerManagerItemAdditionalPhone) Set(val *EmployerManagersEmployerManagerItemAdditionalPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersEmployerManagerItemAdditionalPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersEmployerManagerItemAdditionalPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersEmployerManagerItemAdditionalPhone(val *EmployerManagersEmployerManagerItemAdditionalPhone) *NullableEmployerManagersEmployerManagerItemAdditionalPhone {
	return &NullableEmployerManagersEmployerManagerItemAdditionalPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersEmployerManagerItemAdditionalPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersEmployerManagerItemAdditionalPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
