...
// checks if the EmployerServicesEmployerServiceItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerServicesEmployerServiceItem{}
...
type _EmployerServicesEmployerServiceItem EmployerServicesEmployerServiceItem
...
func NewEmployerServicesEmployerServiceItem(activatedAt string, expiresAt string, id string, serviceType EmployerServicesServiceType) *EmployerServicesEmployerServiceItem {
	this := EmployerServicesEmployerServiceItem{}
...
func (o *EmployerServicesEmployerServiceItem) GetBalance() EmployerServicesBalance {
	if o == nil || IsNil(o.Balance) {
		var ret EmployerServicesBalance
		return ret
	}
	return o.Balance
}
...
func (o *EmployerServicesEmployerServiceItem) GetBalanceOk() (EmployerServicesBalance, bool) {
	if o == nil || IsNil(o.Balance) {
		return EmployerServicesBalance{}, false
	}
...
// SetBalance gets a reference to the given EmployerServicesBalance and assigns it to the Balance field.
...
func (o *EmployerServicesEmployerServiceItem) GetServiceType() EmployerServicesServiceType {
	if o == nil {
		var ret EmployerServicesServiceType
		return ret
	}
...
func (o EmployerServicesEmployerServiceItem) MarshalJSON() ([]byte, error) {
...
func (o EmployerServicesEmployerServiceItem) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerServicesEmployerServiceItem) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerServicesEmployerServiceItem := _EmployerServicesEmployerServiceItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerServicesEmployerServiceItem)

	if err != nil {
		return err
	}

	*o = EmployerServicesEmployerServiceItem(varEmployerServicesEmployerServiceItem)

	return err
}

type NullableEmployerServicesEmployerServiceItem struct {
	value *EmployerServicesEmployerServiceItem
	isSet bool
}

func (v NullableEmployerServicesEmployerServiceItem) Get() *EmployerServicesEmployerServiceItem {
	return v.value
}

func (v *NullableEmployerServicesEmployerServiceItem) Set(val *EmployerServicesEmployerServiceItem) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerServicesEmployerServiceItem) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerServicesEmployerServiceItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerServicesEmployerServiceItem(val *EmployerServicesEmployerServiceItem) *NullableEmployerServicesEmployerServiceItem {
	return &NullableEmployerServicesEmployerServiceItem{value: val, isSet: true}
}

func (v NullableEmployerServicesEmployerServiceItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerServicesEmployerServiceItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
