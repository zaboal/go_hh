...
// checks if the ArtifactsFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactsFields{}

// ArtifactsFields struct for ArtifactsFields
type ArtifactsFields struct {
...
type _ArtifactsFields ArtifactsFields
...
func (o ArtifactsFields) MarshalJSON() ([]byte, error) {
...
func (o ArtifactsFields) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactsFields) UnmarshalJSON(data []byte) (err error) {
	...
	varArtifactsFields := _ArtifactsFields{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArtifactsFields)

	if err != nil {
		return err
	}

	*o = ArtifactsFields(varArtifactsFields)

	return err
}

type NullableArtifactsFields struct {
	value *ArtifactsFields
	isSet bool
}

func (v NullableArtifactsFields) Get() *ArtifactsFields {
	return v.value
}

func (v *NullableArtifactsFields) Set(val *ArtifactsFields) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactsFields) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactsFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactsFields(val *ArtifactsFields) *NullableArtifactsFields {
	return &NullableArtifactsFields{value: val, isSet: true}
}

func (v NullableArtifactsFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactsFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
