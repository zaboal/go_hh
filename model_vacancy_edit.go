...
// VacancyEdit struct for VacancyEdit
type VacancyEdit struct {
	VacancyEditBillingType *VacancyEditBillingType
	VacancyEditCommon *VacancyEditCommon
	VacancyEditManager *VacancyEditManager
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *VacancyEdit) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into VacancyEditBillingType
	err = json.Unmarshal(data, &dst.VacancyEditBillingType);
	if err == nil {
		jsonVacancyEditBillingType, _ := json.Marshal(dst.VacancyEditBillingType)
		if string(jsonVacancyEditBillingType) == "{}" { // empty struct
			dst.VacancyEditBillingType = nil
		} else {
			return nil // data stored in dst.VacancyEditBillingType, return on the first match
		}
	} else {
		dst.VacancyEditBillingType = nil
	}

	// try to unmarshal JSON data into VacancyEditCommon
	err = json.Unmarshal(data, &dst.VacancyEditCommon);
	if err == nil {
		jsonVacancyEditCommon, _ := json.Marshal(dst.VacancyEditCommon)
		if string(jsonVacancyEditCommon) == "{}" { // empty struct
			dst.VacancyEditCommon = nil
		} else {
			return nil // data stored in dst.VacancyEditCommon, return on the first match
		}
	} else {
		dst.VacancyEditCommon = nil
	}

	// try to unmarshal JSON data into VacancyEditManager
	err = json.Unmarshal(data, &dst.VacancyEditManager);
	if err == nil {
		jsonVacancyEditManager, _ := json.Marshal(dst.VacancyEditManager)
		if string(jsonVacancyEditManager) == "{}" { // empty struct
			dst.VacancyEditManager = nil
		} else {
			return nil // data stored in dst.VacancyEditManager, return on the first match
		}
	} else {
		dst.VacancyEditManager = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(VacancyEdit)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *VacancyEdit) MarshalJSON() ([]byte, error) {
	if src.VacancyEditBillingType != nil {
		return json.Marshal(&src.VacancyEditBillingType)
	}

	if src.VacancyEditCommon != nil {
		return json.Marshal(&src.VacancyEditCommon)
	}

	if src.VacancyEditManager != nil {
		return json.Marshal(&src.VacancyEditManager)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableVacancyEdit struct {
	value *VacancyEdit
	isSet bool
}

func (v NullableVacancyEdit) Get() *VacancyEdit {
	return v.value
}

func (v *NullableVacancyEdit) Set(val *VacancyEdit) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyEdit) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyEdit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyEdit(val *VacancyEdit) *NullableVacancyEdit {
	return &NullableVacancyEdit{value: val, isSet: true}
}

func (v NullableVacancyEdit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyEdit) UnmarshalJSON(src []byte) error {
	v.isSet = true
