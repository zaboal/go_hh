...
// checks if the VacancyDraftContacts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDraftContacts{}

// VacancyDraftContacts Контактная информация
type VacancyDraftContacts struct {
	// Email
	Email NullableString `json:"email,omitempty"`
	// Имя менеджера
	Name NullableString `json:"name,omitempty"`
	// Список телефонов для связи
	Phones []VacancyDraftPhoneItem `json:"phones,omitempty"`
}
...
func (o *VacancyDraftContacts) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *VacancyDraftContacts) SetNameNil() {
	o.Name.Set(nil)
}
...
// SetPhones gets a reference to the given []VacancyDraftPhoneItem and assigns it to the Phones field.
func (o *VacancyDraftContacts) SetPhones(v []VacancyDraftPhoneItem) {
	o.Phones = v
}

func (o VacancyDraftContacts) MarshalJSON() ([]byte, error) {
...
func (o VacancyDraftContacts) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDraftContacts struct {
	value *VacancyDraftContacts
	isSet bool
}

func (v NullableVacancyDraftContacts) Get() *VacancyDraftContacts {
	return v.value
}

func (v *NullableVacancyDraftContacts) Set(val *VacancyDraftContacts) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftContacts) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftContacts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftContacts(val *VacancyDraftContacts) *NullableVacancyDraftContacts {
	return &NullableVacancyDraftContacts{value: val, isSet: true}
}

func (v NullableVacancyDraftContacts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftContacts) UnmarshalJSON(src []byte) error {
	v.isSet = true
