...
// checks if the IncludesContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesContact{}

// IncludesContact struct for IncludesContact
type IncludesContact struct {
...
type _IncludesContact IncludesContact
...
func (o *IncludesContact) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o *IncludesContact) SetNeedVerificationNil() {
...
func (o *IncludesContact) SetVerifiedNil() {
	o.Verified.Set(nil)
}
...
func (o IncludesContact) MarshalJSON() ([]byte, error) {
...
func (o IncludesContact) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesContact) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesContact := _IncludesContact{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesContact)

	if err != nil {
		return err
	}

	*o = IncludesContact(varIncludesContact)

	return err
}

type NullableIncludesContact struct {
	value *IncludesContact
	isSet bool
}

func (v NullableIncludesContact) Get() *IncludesContact {
	return v.value
}

func (v *NullableIncludesContact) Set(val *IncludesContact) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesContact) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesContact(val *IncludesContact) *NullableIncludesContact {
	return &NullableIncludesContact{value: val, isSet: true}
}

func (v NullableIncludesContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
