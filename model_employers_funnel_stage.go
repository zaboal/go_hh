...
// checks if the EmployersFunnelStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersFunnelStage{}

// EmployersFunnelStage struct for EmployersFunnelStage
type EmployersFunnelStage struct {
	// Идентификатор этапа воронки
	Id string `json:"id"`
	State EmployersEmployersState `json:"state"`
	Substate NullableEmployersFunnelSubstate `json:"substate,omitempty"`
}

type _EmployersFunnelStage EmployersFunnelStage
...
func (o *EmployersFunnelStage) GetSubstate() EmployersFunnelSubstate {
	if o == nil || IsNil(o.Substate.Get()) {
		var ret EmployersFunnelSubstate
		return ret
	}
...
// SetSubstate gets a reference to the given NullableEmployersFunnelSubstate and assigns it to the Substate field.
...
func (o *EmployersFunnelStage) SetSubstateNil() {
	o.Substate.Set(nil)
}
...
func (o EmployersFunnelStage) MarshalJSON() ([]byte, error) {
...
func (o EmployersFunnelStage) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersFunnelStage) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersFunnelStage := _EmployersFunnelStage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersFunnelStage)

	if err != nil {
		return err
	}

	*o = EmployersFunnelStage(varEmployersFunnelStage)

	return err
}

type NullableEmployersFunnelStage struct {
	value *EmployersFunnelStage
	isSet bool
}

func (v NullableEmployersFunnelStage) Get() *EmployersFunnelStage {
	return v.value
}

func (v *NullableEmployersFunnelStage) Set(val *EmployersFunnelStage) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersFunnelStage) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersFunnelStage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersFunnelStage(val *EmployersFunnelStage) *NullableEmployersFunnelStage {
	return &NullableEmployersFunnelStage{value: val, isSet: true}
}

func (v NullableEmployersFunnelStage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersFunnelStage) UnmarshalJSON(src []byte) error {
	v.isSet = true
