...
// checks if the NegotiationsNegotiationsStatistics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationsStatistics{}

// NegotiationsNegotiationsStatistics struct for NegotiationsNegotiationsStatistics
type NegotiationsNegotiationsStatistics struct {
	// Среднее время (в днях) между получением отклика и отправкой сообщения
	AverageReplyTime NullableFloat32 `json:"average_reply_time,omitempty"`
	Politeness NullableNegotiationsObjectsPoliteness `json:"politeness,omitempty"`
	...
	RepliedPercent NullableFloat32 `json:"replied_percent,omitempty"`
	// Процент прочитанных откликов за период
	ViewedPercent NullableFloat32 `json:"viewed_percent,omitempty"`
}

type _NegotiationsNegotiationsStatistics NegotiationsNegotiationsStatistics
...
func NewNegotiationsNegotiationsStatistics(received float32) *NegotiationsNegotiationsStatistics {
	this := NegotiationsNegotiationsStatistics{}
...
// GetAverageReplyTime returns the AverageReplyTime field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NegotiationsNegotiationsStatistics) GetAverageReplyTime() float32 {
	if o == nil || IsNil(o.AverageReplyTime.Get()) {
		var ret float32
		return ret
	}
	return *o.AverageReplyTime.Get()
}

// GetAverageReplyTimeOk returns a tuple with the AverageReplyTime field value if set, nil otherwise
...
func (o *NegotiationsNegotiationsStatistics) GetAverageReplyTimeOk() (*float32, bool) {
	...
	return o.AverageReplyTime.Get(), o.AverageReplyTime.IsSet()
}
...
func (o *NegotiationsNegotiationsStatistics) HasAverageReplyTime() bool {
	if o != nil && o.AverageReplyTime.IsSet() {
		return true
	}
...
// SetAverageReplyTime gets a reference to the given NullableFloat32 and assigns it to the AverageReplyTime field.
func (o *NegotiationsNegotiationsStatistics) SetAverageReplyTime(v float32) {
	o.AverageReplyTime.Set(&v)
}
// SetAverageReplyTimeNil sets the value for AverageReplyTime to be an explicit nil
func (o *NegotiationsNegotiationsStatistics) SetAverageReplyTimeNil() {
	o.AverageReplyTime.Set(nil)
}
...
func (o *NegotiationsNegotiationsStatistics) UnsetAverageReplyTime() {
	o.AverageReplyTime.Unset()
}

// GetPoliteness returns the Politeness field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NegotiationsNegotiationsStatistics) GetPoliteness() NegotiationsObjectsPoliteness {
	if o == nil || IsNil(o.Politeness.Get()) {
		var ret NegotiationsObjectsPoliteness
		return ret
	}
	return *o.Politeness.Get()
}

// GetPolitenessOk returns a tuple with the Politeness field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetPoliteness gets a reference to the given NullableNegotiationsObjectsPoliteness and assigns it to the Politeness field.
...
func (o *NegotiationsNegotiationsStatistics) SetPolitenessNil() {
	o.Politeness.Set(nil)
}
...
// GetRepliedPercent returns the RepliedPercent field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NegotiationsNegotiationsStatistics) GetRepliedPercent() float32 {
	if o == nil || IsNil(o.RepliedPercent.Get()) {
		var ret float32
		return ret
	}
	return *o.RepliedPercent.Get()
}

// GetRepliedPercentOk returns a tuple with the RepliedPercent field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NegotiationsNegotiationsStatistics) GetRepliedPercentOk() (*float32, bool) {
	...
	return o.RepliedPercent.Get(), o.RepliedPercent.IsSet()
}
...
func (o *NegotiationsNegotiationsStatistics) HasRepliedPercent() bool {
	if o != nil && o.RepliedPercent.IsSet() {
		return true
	}
...
// SetRepliedPercent gets a reference to the given NullableFloat32 and assigns it to the RepliedPercent field.
func (o *NegotiationsNegotiationsStatistics) SetRepliedPercent(v float32) {
	o.RepliedPercent.Set(&v)
}
// SetRepliedPercentNil sets the value for RepliedPercent to be an explicit nil
func (o *NegotiationsNegotiationsStatistics) SetRepliedPercentNil() {
	o.RepliedPercent.Set(nil)
}
...
func (o *NegotiationsNegotiationsStatistics) UnsetRepliedPercent() {
	o.RepliedPercent.Unset()
}

// GetViewedPercent returns the ViewedPercent field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NegotiationsNegotiationsStatistics) GetViewedPercent() float32 {
	if o == nil || IsNil(o.ViewedPercent.Get()) {
		var ret float32
		return ret
	}
	return *o.ViewedPercent.Get()
}

// GetViewedPercentOk returns a tuple with the ViewedPercent field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NegotiationsNegotiationsStatistics) GetViewedPercentOk() (*float32, bool) {
	...
	return o.ViewedPercent.Get(), o.ViewedPercent.IsSet()
}
...
func (o *NegotiationsNegotiationsStatistics) HasViewedPercent() bool {
	if o != nil && o.ViewedPercent.IsSet() {
		return true
	}
...
// SetViewedPercent gets a reference to the given NullableFloat32 and assigns it to the ViewedPercent field.
func (o *NegotiationsNegotiationsStatistics) SetViewedPercent(v float32) {
	o.ViewedPercent.Set(&v)
}
// SetViewedPercentNil sets the value for ViewedPercent to be an explicit nil
func (o *NegotiationsNegotiationsStatistics) SetViewedPercentNil() {
	o.ViewedPercent.Set(nil)
}
...
func (o *NegotiationsNegotiationsStatistics) UnsetViewedPercent() {
	o.ViewedPercent.Unset()
}

func (o NegotiationsNegotiationsStatistics) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationsStatistics) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.AverageReplyTime.IsSet() {
		toSerialize["average_reply_time"] = o.AverageReplyTime.Get()
	}
	if o.Politeness.IsSet() {
		toSerialize["politeness"] = o.Politeness.Get()
	}
	toSerialize["received"] = o.Received
	if o.RepliedPercent.IsSet() {
		toSerialize["replied_percent"] = o.RepliedPercent.Get()
	}
	if o.ViewedPercent.IsSet() {
		toSerialize["viewed_percent"] = o.ViewedPercent.Get()
	}
	return toSerialize, nil
}

func (o *NegotiationsNegotiationsStatistics) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationsStatistics := _NegotiationsNegotiationsStatistics{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationsStatistics)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationsStatistics(varNegotiationsNegotiationsStatistics)

	return err
}

type NullableNegotiationsNegotiationsStatistics struct {
	value *NegotiationsNegotiationsStatistics
	isSet bool
}

func (v NullableNegotiationsNegotiationsStatistics) Get() *NegotiationsNegotiationsStatistics {
	return v.value
}

func (v *NullableNegotiationsNegotiationsStatistics) Set(val *NegotiationsNegotiationsStatistics) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationsStatistics) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationsStatistics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationsStatistics(val *NegotiationsNegotiationsStatistics) *NullableNegotiationsNegotiationsStatistics {
	return &NullableNegotiationsNegotiationsStatistics{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationsStatistics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationsStatistics) UnmarshalJSON(src []byte) error {
	v.isSet = true
