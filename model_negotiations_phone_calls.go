...
// checks if the NegotiationsPhoneCalls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsPhoneCalls{}

// NegotiationsPhoneCalls struct for NegotiationsPhoneCalls
type NegotiationsPhoneCalls struct {
	// Список звонков
	Items []NegotiationsPhoneCallItem `json:"items"`
	// Ответил ли абонент соискателю хотя бы один раз
	PickedUpPhoneByOpponent bool `json:"picked_up_phone_by_opponent"`
}

type _NegotiationsPhoneCalls NegotiationsPhoneCalls
...
func (o *NegotiationsPhoneCalls) GetItems() []NegotiationsPhoneCallItem {
	if o == nil {
		var ret []NegotiationsPhoneCallItem
		return ret
	}
...
// GetPickedUpPhoneByOpponent returns the PickedUpPhoneByOpponent field value
func (o *NegotiationsPhoneCalls) GetPickedUpPhoneByOpponent() bool {
	...
	return o.PickedUpPhoneByOpponent
}

// GetPickedUpPhoneByOpponentOk returns a tuple with the PickedUpPhoneByOpponent field value
// and a boolean to check if the value has been set.
func (o *NegotiationsPhoneCalls) GetPickedUpPhoneByOpponentOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PickedUpPhoneByOpponent, true
}

// SetPickedUpPhoneByOpponent sets field value
func (o *NegotiationsPhoneCalls) SetPickedUpPhoneByOpponent(v bool) {
	o.PickedUpPhoneByOpponent = v
}

func (o NegotiationsPhoneCalls) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsPhoneCalls) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	toSerialize["picked_up_phone_by_opponent"] = o.PickedUpPhoneByOpponent
	return toSerialize, nil
}

func (o *NegotiationsPhoneCalls) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsPhoneCalls := _NegotiationsPhoneCalls{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsPhoneCalls)

	if err != nil {
		return err
	}

	*o = NegotiationsPhoneCalls(varNegotiationsPhoneCalls)

	return err
}

type NullableNegotiationsPhoneCalls struct {
	value *NegotiationsPhoneCalls
	isSet bool
}

func (v NullableNegotiationsPhoneCalls) Get() *NegotiationsPhoneCalls {
	return v.value
}

func (v *NullableNegotiationsPhoneCalls) Set(val *NegotiationsPhoneCalls) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsPhoneCalls) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsPhoneCalls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsPhoneCalls(val *NegotiationsPhoneCalls) *NullableNegotiationsPhoneCalls {
	return &NullableNegotiationsPhoneCalls{value: val, isSet: true}
}

func (v NullableNegotiationsPhoneCalls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsPhoneCalls) UnmarshalJSON(src []byte) error {
	v.isSet = true
