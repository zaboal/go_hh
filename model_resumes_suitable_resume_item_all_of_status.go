...
// checks if the ResumesSuitableResumeItemAllOfStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesSuitableResumeItemAllOfStatus{}

// ResumesSuitableResumeItemAllOfStatus Статус [резюме](#tag/Rezyume.-Prosmotr-informacii/Status-rezyume) 
type ResumesSuitableResumeItemAllOfStatus struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _ResumesSuitableResumeItemAllOfStatus ResumesSuitableResumeItemAllOfStatus
...
func NewResumesSuitableResumeItemAllOfStatus(id string, name string) *ResumesSuitableResumeItemAllOfStatus {
	this := ResumesSuitableResumeItemAllOfStatus{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ResumesSuitableResumeItemAllOfStatus) MarshalJSON() ([]byte, error) {
...
func (o ResumesSuitableResumeItemAllOfStatus) ToMap() (map[string]interface{}, error) {
...
func (o *ResumesSuitableResumeItemAllOfStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesSuitableResumeItemAllOfStatus := _ResumesSuitableResumeItemAllOfStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesSuitableResumeItemAllOfStatus)

	if err != nil {
		return err
	}

	*o = ResumesSuitableResumeItemAllOfStatus(varResumesSuitableResumeItemAllOfStatus)

	return err
}

type NullableResumesSuitableResumeItemAllOfStatus struct {
	value *ResumesSuitableResumeItemAllOfStatus
	isSet bool
}

func (v NullableResumesSuitableResumeItemAllOfStatus) Get() *ResumesSuitableResumeItemAllOfStatus {
	return v.value
}

func (v *NullableResumesSuitableResumeItemAllOfStatus) Set(val *ResumesSuitableResumeItemAllOfStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesSuitableResumeItemAllOfStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesSuitableResumeItemAllOfStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesSuitableResumeItemAllOfStatus(val *ResumesSuitableResumeItemAllOfStatus) *NullableResumesSuitableResumeItemAllOfStatus {
	return &NullableResumesSuitableResumeItemAllOfStatus{value: val, isSet: true}
}

func (v NullableResumesSuitableResumeItemAllOfStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesSuitableResumeItemAllOfStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
