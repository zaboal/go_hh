...
// checks if the EmployerManagersManagerDataPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersManagerDataPhone{}

// EmployerManagersManagerDataPhone Основной телефон менеджера
type EmployerManagersManagerDataPhone struct {
	// Код города
...
type _EmployerManagersManagerDataPhone EmployerManagersManagerDataPhone
...
func NewEmployerManagersManagerDataPhone(city string, country string, number string) *EmployerManagersManagerDataPhone {
	this := EmployerManagersManagerDataPhone{}
	this.City = city
...
func (o *EmployerManagersManagerDataPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersManagerDataPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersManagerDataPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersManagerDataPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersManagerDataPhone := _EmployerManagersManagerDataPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersManagerDataPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersManagerDataPhone(varEmployerManagersManagerDataPhone)

	return err
}

type NullableEmployerManagersManagerDataPhone struct {
	value *EmployerManagersManagerDataPhone
	isSet bool
}

func (v NullableEmployerManagersManagerDataPhone) Get() *EmployerManagersManagerDataPhone {
	return v.value
}

func (v *NullableEmployerManagersManagerDataPhone) Set(val *EmployerManagersManagerDataPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersManagerDataPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersManagerDataPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersManagerDataPhone(val *EmployerManagersManagerDataPhone) *NullableEmployerManagersManagerDataPhone {
	return &NullableEmployerManagersManagerDataPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersManagerDataPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersManagerDataPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
