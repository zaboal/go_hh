...
// checks if the EmployerManagersAddEmployerManagerPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersAddEmployerManagerPhone{}

// EmployerManagersAddEmployerManagerPhone Основной телефон менеджера
type EmployerManagersAddEmployerManagerPhone struct {
	// Код города
...
type _EmployerManagersAddEmployerManagerPhone EmployerManagersAddEmployerManagerPhone
...
func NewEmployerManagersAddEmployerManagerPhone(city string, country string, number string) *EmployerManagersAddEmployerManagerPhone {
	this := EmployerManagersAddEmployerManagerPhone{}
	this.City = city
...
func (o *EmployerManagersAddEmployerManagerPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersAddEmployerManagerPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersAddEmployerManagerPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersAddEmployerManagerPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersAddEmployerManagerPhone := _EmployerManagersAddEmployerManagerPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersAddEmployerManagerPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersAddEmployerManagerPhone(varEmployerManagersAddEmployerManagerPhone)

	return err
}

type NullableEmployerManagersAddEmployerManagerPhone struct {
	value *EmployerManagersAddEmployerManagerPhone
	isSet bool
}

func (v NullableEmployerManagersAddEmployerManagerPhone) Get() *EmployerManagersAddEmployerManagerPhone {
	return v.value
}

func (v *NullableEmployerManagersAddEmployerManagerPhone) Set(val *EmployerManagersAddEmployerManagerPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersAddEmployerManagerPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersAddEmployerManagerPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersAddEmployerManagerPhone(val *EmployerManagersAddEmployerManagerPhone) *NullableEmployerManagersAddEmployerManagerPhone {
	return &NullableEmployerManagersAddEmployerManagerPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersAddEmployerManagerPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersAddEmployerManagerPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
