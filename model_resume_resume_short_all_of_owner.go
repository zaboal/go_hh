...
// checks if the ResumeResumeShortAllOfOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeResumeShortAllOfOwner{}

// ResumeResumeShortAllOfOwner Информация о владельце резюме
type ResumeResumeShortAllOfOwner struct {
	// Раздел [Комментарии к владельцу резюме](#tag/Kommentarii-k-soiskatelyu/operation/get-applicant-comments-list)
	Comments ResumeObjectsOwnerComments `json:"comments"`
	// Идентификатор владельца резюме
	Id string `json:"id"`
}

type _ResumeResumeShortAllOfOwner ResumeResumeShortAllOfOwner
...
func NewResumeResumeShortAllOfOwner(comments ResumeObjectsOwnerComments, id string) *ResumeResumeShortAllOfOwner {
	this := ResumeResumeShortAllOfOwner{}
...
func (o *ResumeResumeShortAllOfOwner) GetComments() ResumeObjectsOwnerComments {
	if o == nil {
		var ret ResumeObjectsOwnerComments
		return ret
	}
...
func (o ResumeResumeShortAllOfOwner) MarshalJSON() ([]byte, error) {
...
func (o ResumeResumeShortAllOfOwner) ToMap() (map[string]interface{}, error) {
...
func (o *ResumeResumeShortAllOfOwner) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeResumeShortAllOfOwner := _ResumeResumeShortAllOfOwner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeResumeShortAllOfOwner)

	if err != nil {
		return err
	}

	*o = ResumeResumeShortAllOfOwner(varResumeResumeShortAllOfOwner)

	return err
}

type NullableResumeResumeShortAllOfOwner struct {
	value *ResumeResumeShortAllOfOwner
	isSet bool
}

func (v NullableResumeResumeShortAllOfOwner) Get() *ResumeResumeShortAllOfOwner {
	return v.value
}

func (v *NullableResumeResumeShortAllOfOwner) Set(val *ResumeResumeShortAllOfOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeResumeShortAllOfOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeResumeShortAllOfOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeResumeShortAllOfOwner(val *ResumeResumeShortAllOfOwner) *NullableResumeResumeShortAllOfOwner {
	return &NullableResumeResumeShortAllOfOwner{value: val, isSet: true}
}

func (v NullableResumeResumeShortAllOfOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeResumeShortAllOfOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
