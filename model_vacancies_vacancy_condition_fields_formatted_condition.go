...
// checks if the VacanciesVacancyConditionFieldsFormattedCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsFormattedCondition{}

// VacanciesVacancyConditionFieldsFormattedCondition struct for VacanciesVacancyConditionFieldsFormattedCondition
type VacanciesVacancyConditionFieldsFormattedCondition struct {
...
func NewVacanciesVacancyConditionFieldsFormattedCondition() *VacanciesVacancyConditionFieldsFormattedCondition {
	this := VacanciesVacancyConditionFieldsFormattedCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsFormattedCondition) SetMaxLength(v float32) {
	o.MaxLength.Set(&v)
}
// SetMaxLengthNil sets the value for MaxLength to be an explicit nil
func (o *VacanciesVacancyConditionFieldsFormattedCondition) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsFormattedCondition) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsFormattedCondition) GetRequired() bool {
...
func (o *VacanciesVacancyConditionFieldsFormattedCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsFormattedCondition) SetRegexpNil() {
	o.Regexp.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsFormattedCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsFormattedCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsFormattedCondition struct {
	value *VacanciesVacancyConditionFieldsFormattedCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsFormattedCondition) Get() *VacanciesVacancyConditionFieldsFormattedCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsFormattedCondition) Set(val *VacanciesVacancyConditionFieldsFormattedCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsFormattedCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsFormattedCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsFormattedCondition(val *VacanciesVacancyConditionFieldsFormattedCondition) *NullableVacanciesVacancyConditionFieldsFormattedCondition {
	return &NullableVacanciesVacancyConditionFieldsFormattedCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsFormattedCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsFormattedCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
