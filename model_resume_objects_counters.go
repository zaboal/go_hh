...
// checks if the ResumeObjectsCounters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumeObjectsCounters{}

// ResumeObjectsCounters Счетчики похожих вакансий
type ResumeObjectsCounters struct {
	// Количество подходящих вакансий
	Total float32 `json:"total"`
}

type _ResumeObjectsCounters ResumeObjectsCounters
...
func (o ResumeObjectsCounters) MarshalJSON() ([]byte, error) {
...
func (o ResumeObjectsCounters) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["total"] = o.Total
	return toSerialize, nil
}

func (o *ResumeObjectsCounters) UnmarshalJSON(data []byte) (err error) {
	...
	varResumeObjectsCounters := _ResumeObjectsCounters{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumeObjectsCounters)

	if err != nil {
		return err
	}

	*o = ResumeObjectsCounters(varResumeObjectsCounters)

	return err
}

type NullableResumeObjectsCounters struct {
	value *ResumeObjectsCounters
	isSet bool
}

func (v NullableResumeObjectsCounters) Get() *ResumeObjectsCounters {
	return v.value
}

func (v *NullableResumeObjectsCounters) Set(val *ResumeObjectsCounters) {
	v.value = val
	v.isSet = true
}

func (v NullableResumeObjectsCounters) IsSet() bool {
	return v.isSet
}

func (v *NullableResumeObjectsCounters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumeObjectsCounters(val *ResumeObjectsCounters) *NullableResumeObjectsCounters {
	return &NullableResumeObjectsCounters{value: val, isSet: true}
}

func (v NullableResumeObjectsCounters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumeObjectsCounters) UnmarshalJSON(src []byte) error {
	v.isSet = true
