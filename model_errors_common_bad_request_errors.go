...
// checks if the ErrorsCommonBadRequestErrors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonBadRequestErrors{}

// ErrorsCommonBadRequestErrors Информация о возникших ошибках
type ErrorsCommonBadRequestErrors struct {
	// Идентификатор запроса
	RequestId string `json:"request_id"`
	// Массив с данными ошибок
	Errors []ErrorsCommonBadRequestError `json:"errors"`
}

type _ErrorsCommonBadRequestErrors ErrorsCommonBadRequestErrors
...
func NewErrorsCommonBadRequestErrors(requestId string, errors []ErrorsCommonBadRequestError) *ErrorsCommonBadRequestErrors {
	this := ErrorsCommonBadRequestErrors{}
...
func (o *ErrorsCommonBadRequestErrors) GetErrors() []ErrorsCommonBadRequestError {
	if o == nil {
		var ret []ErrorsCommonBadRequestError
		return ret
	}
...
func (o ErrorsCommonBadRequestErrors) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonBadRequestErrors) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonBadRequestErrors) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonBadRequestErrors := _ErrorsCommonBadRequestErrors{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonBadRequestErrors)

	if err != nil {
		return err
	}

	*o = ErrorsCommonBadRequestErrors(varErrorsCommonBadRequestErrors)

	return err
}

type NullableErrorsCommonBadRequestErrors struct {
	value *ErrorsCommonBadRequestErrors
	isSet bool
}

func (v NullableErrorsCommonBadRequestErrors) Get() *ErrorsCommonBadRequestErrors {
	return v.value
}

func (v *NullableErrorsCommonBadRequestErrors) Set(val *ErrorsCommonBadRequestErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadRequestErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadRequestErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadRequestErrors(val *ErrorsCommonBadRequestErrors) *NullableErrorsCommonBadRequestErrors {
	return &NullableErrorsCommonBadRequestErrors{value: val, isSet: true}
}

func (v NullableErrorsCommonBadRequestErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadRequestErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
