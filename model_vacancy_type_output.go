...
// checks if the VacancyTypeOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyTypeOutput{}

// VacancyTypeOutput struct for VacancyTypeOutput
type VacancyTypeOutput struct {
...
type _VacancyTypeOutput VacancyTypeOutput
...
func (o VacancyTypeOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyTypeOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyTypeOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyTypeOutput := _VacancyTypeOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyTypeOutput)

	if err != nil {
		return err
	}

	*o = VacancyTypeOutput(varVacancyTypeOutput)

	return err
}

type NullableVacancyTypeOutput struct {
	value *VacancyTypeOutput
	isSet bool
}

func (v NullableVacancyTypeOutput) Get() *VacancyTypeOutput {
	return v.value
}

func (v *NullableVacancyTypeOutput) Set(val *VacancyTypeOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyTypeOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyTypeOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyTypeOutput(val *VacancyTypeOutput) *NullableVacancyTypeOutput {
	return &NullableVacancyTypeOutput{value: val, isSet: true}
}

func (v NullableVacancyTypeOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyTypeOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
