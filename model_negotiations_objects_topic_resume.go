...
// checks if the NegotiationsObjectsTopicResume type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsObjectsTopicResume{}

// NegotiationsObjectsTopicResume struct for NegotiationsObjectsTopicResume
type NegotiationsObjectsTopicResume struct {
	// URL резюме на сайте
...
type _NegotiationsObjectsTopicResume NegotiationsObjectsTopicResume
...
func NewNegotiationsObjectsTopicResume(alternateUrl string, id string, title NullableString, url string, createdAt string, updatedAt string) *NegotiationsObjectsTopicResume {
	this := NegotiationsObjectsTopicResume{}
...
func (o NegotiationsObjectsTopicResume) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsObjectsTopicResume) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsObjectsTopicResume) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsObjectsTopicResume := _NegotiationsObjectsTopicResume{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsObjectsTopicResume)

	if err != nil {
		return err
	}

	*o = NegotiationsObjectsTopicResume(varNegotiationsObjectsTopicResume)

	return err
}

type NullableNegotiationsObjectsTopicResume struct {
	value *NegotiationsObjectsTopicResume
	isSet bool
}

func (v NullableNegotiationsObjectsTopicResume) Get() *NegotiationsObjectsTopicResume {
	return v.value
}

func (v *NullableNegotiationsObjectsTopicResume) Set(val *NegotiationsObjectsTopicResume) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsObjectsTopicResume) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsObjectsTopicResume) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsObjectsTopicResume(val *NegotiationsObjectsTopicResume) *NullableNegotiationsObjectsTopicResume {
	return &NullableNegotiationsObjectsTopicResume{value: val, isSet: true}
}

func (v NullableNegotiationsObjectsTopicResume) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsObjectsTopicResume) UnmarshalJSON(src []byte) error {
	v.isSet = true
