...
// checks if the VacanciesVacanciesFavoritedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacanciesFavoritedResponse{}

// VacanciesVacanciesFavoritedResponse struct for VacanciesVacanciesFavoritedResponse
type VacanciesVacanciesFavoritedResponse struct {
	// Найдено результатов
	...
	Items []VacanciesVacanciesFavoritedItem `json:"items,omitempty"`
}

type _VacanciesVacanciesFavoritedResponse VacanciesVacanciesFavoritedResponse
...
func NewVacanciesVacanciesFavoritedResponse(found float32, page float32, pages float32, perPage float32) *VacanciesVacanciesFavoritedResponse {
	this := VacanciesVacanciesFavoritedResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *VacanciesVacanciesFavoritedResponse) GetItems() []VacanciesVacanciesFavoritedItem {
	if o == nil || IsNil(o.Items) {
		var ret []VacanciesVacanciesFavoritedItem
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []VacanciesVacanciesFavoritedItem and assigns it to the Items field.
func (o *VacanciesVacanciesFavoritedResponse) SetItems(v []VacanciesVacanciesFavoritedItem) {
	o.Items = v
}

func (o VacanciesVacanciesFavoritedResponse) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacanciesFavoritedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesVacanciesFavoritedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesVacanciesFavoritedResponse := _VacanciesVacanciesFavoritedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesVacanciesFavoritedResponse)

	if err != nil {
		return err
	}

	*o = VacanciesVacanciesFavoritedResponse(varVacanciesVacanciesFavoritedResponse)

	return err
}

type NullableVacanciesVacanciesFavoritedResponse struct {
	value *VacanciesVacanciesFavoritedResponse
	isSet bool
}

func (v NullableVacanciesVacanciesFavoritedResponse) Get() *VacanciesVacanciesFavoritedResponse {
	return v.value
}

func (v *NullableVacanciesVacanciesFavoritedResponse) Set(val *VacanciesVacanciesFavoritedResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacanciesFavoritedResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacanciesFavoritedResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacanciesFavoritedResponse(val *VacanciesVacanciesFavoritedResponse) *NullableVacanciesVacanciesFavoritedResponse {
	return &NullableVacanciesVacanciesFavoritedResponse{value: val, isSet: true}
}

func (v NullableVacanciesVacanciesFavoritedResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacanciesFavoritedResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
