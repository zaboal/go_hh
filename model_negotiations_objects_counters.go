...
// checks if the NegotiationsObjectsCounters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsObjectsCounters{}

// NegotiationsObjectsCounters struct for NegotiationsObjectsCounters
type NegotiationsObjectsCounters struct {
	// Общее количество сообщений
	Messages *float32 `json:"messages,omitempty"`
	// Количество непрочитанных работодателем сообщений
	UnreadMessages *float32 `json:"unread_messages,omitempty"`
}
...
func NewNegotiationsObjectsCounters() *NegotiationsObjectsCounters {
	this := NegotiationsObjectsCounters{}
	return &this
}
...
// SetUnreadMessages gets a reference to the given float32 and assigns it to the UnreadMessages field.
func (o *NegotiationsObjectsCounters) SetUnreadMessages(v float32) {
	o.UnreadMessages = &v
}

func (o NegotiationsObjectsCounters) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsObjectsCounters) ToMap() (map[string]interface{}, error) {
...
type NullableNegotiationsObjectsCounters struct {
	value *NegotiationsObjectsCounters
	isSet bool
}

func (v NullableNegotiationsObjectsCounters) Get() *NegotiationsObjectsCounters {
	return v.value
}

func (v *NullableNegotiationsObjectsCounters) Set(val *NegotiationsObjectsCounters) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsObjectsCounters) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsObjectsCounters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsObjectsCounters(val *NegotiationsObjectsCounters) *NullableNegotiationsObjectsCounters {
	return &NullableNegotiationsObjectsCounters{value: val, isSet: true}
}

func (v NullableNegotiationsObjectsCounters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsObjectsCounters) UnmarshalJSON(src []byte) error {
	v.isSet = true
