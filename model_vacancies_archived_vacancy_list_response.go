...
// checks if the VacanciesArchivedVacancyListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesArchivedVacancyListResponse{}

// VacanciesArchivedVacancyListResponse struct for VacanciesArchivedVacancyListResponse
type VacanciesArchivedVacancyListResponse struct {
	// Найдено результатов
	...
	Items []VacanciesVacancyArchived `json:"items"`
}

type _VacanciesArchivedVacancyListResponse VacanciesArchivedVacancyListResponse
...
func NewVacanciesArchivedVacancyListResponse(found float32, page float32, pages float32, perPage float32, items []VacanciesVacancyArchived) *VacanciesArchivedVacancyListResponse {
	this := VacanciesArchivedVacancyListResponse{}
	this.Found = found
	this.Page = page
	this.Pages = pages
...
func (o *VacanciesArchivedVacancyListResponse) GetItems() []VacanciesVacancyArchived {
	if o == nil {
		var ret []VacanciesVacancyArchived
		return ret
	}
...
func (o VacanciesArchivedVacancyListResponse) MarshalJSON() ([]byte, error) {
...
func (o VacanciesArchivedVacancyListResponse) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesArchivedVacancyListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesArchivedVacancyListResponse := _VacanciesArchivedVacancyListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesArchivedVacancyListResponse)

	if err != nil {
		return err
	}

	*o = VacanciesArchivedVacancyListResponse(varVacanciesArchivedVacancyListResponse)

	return err
}

type NullableVacanciesArchivedVacancyListResponse struct {
	value *VacanciesArchivedVacancyListResponse
	isSet bool
}

func (v NullableVacanciesArchivedVacancyListResponse) Get() *VacanciesArchivedVacancyListResponse {
	return v.value
}

func (v *NullableVacanciesArchivedVacancyListResponse) Set(val *VacanciesArchivedVacancyListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesArchivedVacancyListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesArchivedVacancyListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesArchivedVacancyListResponse(val *VacanciesArchivedVacancyListResponse) *NullableVacanciesArchivedVacancyListResponse {
	return &NullableVacanciesArchivedVacancyListResponse{value: val, isSet: true}
}

func (v NullableVacanciesArchivedVacancyListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesArchivedVacancyListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
