...
// checks if the ResumePhoneGenerateCodeGenerateCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumePhoneGenerateCodeGenerateCode{}

// ResumePhoneGenerateCodeGenerateCode struct for ResumePhoneGenerateCodeGenerateCode
type ResumePhoneGenerateCodeGenerateCode struct {
	// Ближайшая возможная повторная отправка кода в секундах
	CanRequestCodeAgainIn *string `json:"can_request_code_again_in,omitempty"`
...
func NewResumePhoneGenerateCodeGenerateCode() *ResumePhoneGenerateCodeGenerateCode {
	this := ResumePhoneGenerateCodeGenerateCode{}
	return &this
}
...
// GetCanRequestCodeAgainIn returns the CanRequestCodeAgainIn field value if set, zero value otherwise.
func (o *ResumePhoneGenerateCodeGenerateCode) GetCanRequestCodeAgainIn() string {
	if o == nil || IsNil(o.CanRequestCodeAgainIn) {
		var ret string
		return ret
	}
	return *o.CanRequestCodeAgainIn
}

// GetCanRequestCodeAgainInOk returns a tuple with the CanRequestCodeAgainIn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResumePhoneGenerateCodeGenerateCode) GetCanRequestCodeAgainInOk() (*string, bool) {
	if o == nil || IsNil(o.CanRequestCodeAgainIn) {
		return nil, false
	}
	return o.CanRequestCodeAgainIn, true
}
...
// SetCanRequestCodeAgainIn gets a reference to the given string and assigns it to the CanRequestCodeAgainIn field.
func (o *ResumePhoneGenerateCodeGenerateCode) SetCanRequestCodeAgainIn(v string) {
	o.CanRequestCodeAgainIn = &v
}
...
func (o ResumePhoneGenerateCodeGenerateCode) MarshalJSON() ([]byte, error) {
...
func (o ResumePhoneGenerateCodeGenerateCode) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CanRequestCodeAgainIn) {
		toSerialize["can_request_code_again_in"] = o.CanRequestCodeAgainIn
	}
...
type NullableResumePhoneGenerateCodeGenerateCode struct {
	value *ResumePhoneGenerateCodeGenerateCode
	isSet bool
}

func (v NullableResumePhoneGenerateCodeGenerateCode) Get() *ResumePhoneGenerateCodeGenerateCode {
	return v.value
}

func (v *NullableResumePhoneGenerateCodeGenerateCode) Set(val *ResumePhoneGenerateCodeGenerateCode) {
	v.value = val
	v.isSet = true
}

func (v NullableResumePhoneGenerateCodeGenerateCode) IsSet() bool {
	return v.isSet
}

func (v *NullableResumePhoneGenerateCodeGenerateCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumePhoneGenerateCodeGenerateCode(val *ResumePhoneGenerateCodeGenerateCode) *NullableResumePhoneGenerateCodeGenerateCode {
	return &NullableResumePhoneGenerateCodeGenerateCode{value: val, isSet: true}
}

func (v NullableResumePhoneGenerateCodeGenerateCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumePhoneGenerateCodeGenerateCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
