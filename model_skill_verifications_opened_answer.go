...
// checks if the SkillVerificationsOpenedAnswer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkillVerificationsOpenedAnswer{}

// SkillVerificationsOpenedAnswer struct for SkillVerificationsOpenedAnswer
type SkillVerificationsOpenedAnswer struct {
...
type _SkillVerificationsOpenedAnswer SkillVerificationsOpenedAnswer
...
func NewSkillVerificationsOpenedAnswer(mark string, value string) *SkillVerificationsOpenedAnswer {
	this := SkillVerificationsOpenedAnswer{}
	this.Mark = mark
	this.Value = value
	return &this
}
...
func (o SkillVerificationsOpenedAnswer) MarshalJSON() ([]byte, error) {
...
func (o SkillVerificationsOpenedAnswer) ToMap() (map[string]interface{}, error) {
...
func (o *SkillVerificationsOpenedAnswer) UnmarshalJSON(data []byte) (err error) {
	...
	varSkillVerificationsOpenedAnswer := _SkillVerificationsOpenedAnswer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSkillVerificationsOpenedAnswer)

	if err != nil {
		return err
	}

	*o = SkillVerificationsOpenedAnswer(varSkillVerificationsOpenedAnswer)

	return err
}

type NullableSkillVerificationsOpenedAnswer struct {
	value *SkillVerificationsOpenedAnswer
	isSet bool
}

func (v NullableSkillVerificationsOpenedAnswer) Get() *SkillVerificationsOpenedAnswer {
	return v.value
}

func (v *NullableSkillVerificationsOpenedAnswer) Set(val *SkillVerificationsOpenedAnswer) {
	v.value = val
	v.isSet = true
}

func (v NullableSkillVerificationsOpenedAnswer) IsSet() bool {
	return v.isSet
}

func (v *NullableSkillVerificationsOpenedAnswer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSkillVerificationsOpenedAnswer(val *SkillVerificationsOpenedAnswer) *NullableSkillVerificationsOpenedAnswer {
	return &NullableSkillVerificationsOpenedAnswer{value: val, isSet: true}
}

func (v NullableSkillVerificationsOpenedAnswer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSkillVerificationsOpenedAnswer) UnmarshalJSON(src []byte) error {
	v.isSet = true
