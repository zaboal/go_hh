...
// ErrorsResumeBadArgumentResumeErrors struct for ErrorsResumeBadArgumentResumeErrors
type ErrorsResumeBadArgumentResumeErrors struct {
...
func (dst *ErrorsResumeBadArgumentResumeErrors) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ErrorsResumeBadArgumentResumeErrors)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ErrorsResumeBadArgumentResumeErrors) MarshalJSON() ([]byte, error) {
...
type NullableErrorsResumeBadArgumentResumeErrors struct {
	value *ErrorsResumeBadArgumentResumeErrors
	isSet bool
}

func (v NullableErrorsResumeBadArgumentResumeErrors) Get() *ErrorsResumeBadArgumentResumeErrors {
	return v.value
}

func (v *NullableErrorsResumeBadArgumentResumeErrors) Set(val *ErrorsResumeBadArgumentResumeErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsResumeBadArgumentResumeErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsResumeBadArgumentResumeErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsResumeBadArgumentResumeErrors(val *ErrorsResumeBadArgumentResumeErrors) *NullableErrorsResumeBadArgumentResumeErrors {
	return &NullableErrorsResumeBadArgumentResumeErrors{value: val, isSet: true}
}

func (v NullableErrorsResumeBadArgumentResumeErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsResumeBadArgumentResumeErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
