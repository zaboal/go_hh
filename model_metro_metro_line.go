...
// checks if the MetroMetroLine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetroMetroLine{}

// MetroMetroLine struct for MetroMetroLine
...
type _MetroMetroLine MetroMetroLine
...
func (o MetroMetroLine) MarshalJSON() ([]byte, error) {
...
func (o MetroMetroLine) ToMap() (map[string]interface{}, error) {
...
func (o *MetroMetroLine) UnmarshalJSON(data []byte) (err error) {
	...
	varMetroMetroLine := _MetroMetroLine{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetroMetroLine)

	if err != nil {
		return err
	}

	*o = MetroMetroLine(varMetroMetroLine)

	return err
}

type NullableMetroMetroLine struct {
	value *MetroMetroLine
	isSet bool
}

func (v NullableMetroMetroLine) Get() *MetroMetroLine {
	return v.value
}

func (v *NullableMetroMetroLine) Set(val *MetroMetroLine) {
	v.value = val
	v.isSet = true
}

func (v NullableMetroMetroLine) IsSet() bool {
	return v.isSet
}

func (v *NullableMetroMetroLine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetroMetroLine(val *MetroMetroLine) *NullableMetroMetroLine {
	return &NullableMetroMetroLine{value: val, isSet: true}
}

func (v NullableMetroMetroLine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetroMetroLine) UnmarshalJSON(src []byte) error {
	v.isSet = true
