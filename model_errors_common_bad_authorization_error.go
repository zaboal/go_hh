...
// checks if the ErrorsCommonBadAuthorizationError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonBadAuthorizationError{}

// ErrorsCommonBadAuthorizationError struct for ErrorsCommonBadAuthorizationError
type ErrorsCommonBadAuthorizationError struct {
...
type _ErrorsCommonBadAuthorizationError ErrorsCommonBadAuthorizationError
...
func NewErrorsCommonBadAuthorizationError(type_ string) *ErrorsCommonBadAuthorizationError {
	this := ErrorsCommonBadAuthorizationError{}
	this.Type = type_
	return &this
}
...
func (o ErrorsCommonBadAuthorizationError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonBadAuthorizationError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonBadAuthorizationError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonBadAuthorizationError := _ErrorsCommonBadAuthorizationError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonBadAuthorizationError)

	if err != nil {
		return err
	}

	*o = ErrorsCommonBadAuthorizationError(varErrorsCommonBadAuthorizationError)

	return err
}

type NullableErrorsCommonBadAuthorizationError struct {
	value *ErrorsCommonBadAuthorizationError
	isSet bool
}

func (v NullableErrorsCommonBadAuthorizationError) Get() *ErrorsCommonBadAuthorizationError {
	return v.value
}

func (v *NullableErrorsCommonBadAuthorizationError) Set(val *ErrorsCommonBadAuthorizationError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadAuthorizationError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadAuthorizationError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadAuthorizationError(val *ErrorsCommonBadAuthorizationError) *NullableErrorsCommonBadAuthorizationError {
	return &NullableErrorsCommonBadAuthorizationError{value: val, isSet: true}
}

func (v NullableErrorsCommonBadAuthorizationError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadAuthorizationError) UnmarshalJSON(src []byte) error {
	v.isSet = true
