...
// checks if the NegotiationsCollectionNegotiationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsCollectionNegotiationsResponse{}

// NegotiationsCollectionNegotiationsResponse struct for NegotiationsCollectionNegotiationsResponse
type NegotiationsCollectionNegotiationsResponse struct {
	// Применяемый тип сортировки
	OrderedBy IncludesIdName `json:"ordered_by"`
	// Найдено результатов
	...
	Items []NegotiationsCollectionNegotiationsItemsInner `json:"items"`
}

type _NegotiationsCollectionNegotiationsResponse NegotiationsCollectionNegotiationsResponse
...
func NewNegotiationsCollectionNegotiationsResponse(orderedBy IncludesIdName, found float32, page float32, pages float32, perPage float32, items []NegotiationsCollectionNegotiationsItemsInner) *NegotiationsCollectionNegotiationsResponse {
	this := NegotiationsCollectionNegotiationsResponse{}
...
// GetOrderedBy returns the OrderedBy field value
...
// GetOrderedByOk returns a tuple with the OrderedBy field value
...
func (o *NegotiationsCollectionNegotiationsResponse) GetItems() []NegotiationsCollectionNegotiationsItemsInner {
	if o == nil {
		var ret []NegotiationsCollectionNegotiationsItemsInner
		return ret
	}
...
func (o NegotiationsCollectionNegotiationsResponse) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsCollectionNegotiationsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ordered_by"] = o.OrderedBy
...
func (o *NegotiationsCollectionNegotiationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsCollectionNegotiationsResponse := _NegotiationsCollectionNegotiationsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsCollectionNegotiationsResponse)

	if err != nil {
		return err
	}

	*o = NegotiationsCollectionNegotiationsResponse(varNegotiationsCollectionNegotiationsResponse)

	return err
}

type NullableNegotiationsCollectionNegotiationsResponse struct {
	value *NegotiationsCollectionNegotiationsResponse
	isSet bool
}

func (v NullableNegotiationsCollectionNegotiationsResponse) Get() *NegotiationsCollectionNegotiationsResponse {
	return v.value
}

func (v *NullableNegotiationsCollectionNegotiationsResponse) Set(val *NegotiationsCollectionNegotiationsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsCollectionNegotiationsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsCollectionNegotiationsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsCollectionNegotiationsResponse(val *NegotiationsCollectionNegotiationsResponse) *NullableNegotiationsCollectionNegotiationsResponse {
	return &NullableNegotiationsCollectionNegotiationsResponse{value: val, isSet: true}
}

func (v NullableNegotiationsCollectionNegotiationsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsCollectionNegotiationsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
