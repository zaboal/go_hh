...
// checks if the EmployerManagersEmployerManagerInfoPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersEmployerManagerInfoPhone{}

// EmployerManagersEmployerManagerInfoPhone Основной телефон менеджера
type EmployerManagersEmployerManagerInfoPhone struct {
	// Код города
...
type _EmployerManagersEmployerManagerInfoPhone EmployerManagersEmployerManagerInfoPhone
...
func NewEmployerManagersEmployerManagerInfoPhone(city string, country string, number string) *EmployerManagersEmployerManagerInfoPhone {
	this := EmployerManagersEmployerManagerInfoPhone{}
	this.City = city
...
func (o *EmployerManagersEmployerManagerInfoPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersEmployerManagerInfoPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersEmployerManagerInfoPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersEmployerManagerInfoPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersEmployerManagerInfoPhone := _EmployerManagersEmployerManagerInfoPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersEmployerManagerInfoPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersEmployerManagerInfoPhone(varEmployerManagersEmployerManagerInfoPhone)

	return err
}

type NullableEmployerManagersEmployerManagerInfoPhone struct {
	value *EmployerManagersEmployerManagerInfoPhone
	isSet bool
}

func (v NullableEmployerManagersEmployerManagerInfoPhone) Get() *EmployerManagersEmployerManagerInfoPhone {
	return v.value
}

func (v *NullableEmployerManagersEmployerManagerInfoPhone) Set(val *EmployerManagersEmployerManagerInfoPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersEmployerManagerInfoPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersEmployerManagerInfoPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersEmployerManagerInfoPhone(val *EmployerManagersEmployerManagerInfoPhone) *NullableEmployerManagersEmployerManagerInfoPhone {
	return &NullableEmployerManagersEmployerManagerInfoPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersEmployerManagerInfoPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersEmployerManagerInfoPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
