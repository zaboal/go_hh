...
// checks if the VacanciesDeletedVacancyListItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesDeletedVacancyListItems{}

// VacanciesDeletedVacancyListItems struct for VacanciesDeletedVacancyListItems
type VacanciesDeletedVacancyListItems struct {
	// Список удаленных вакансий
	Items []VacanciesVacancyArchived `json:"items"`
}

type _VacanciesDeletedVacancyListItems VacanciesDeletedVacancyListItems
...
func NewVacanciesDeletedVacancyListItems(items []VacanciesVacancyArchived) *VacanciesDeletedVacancyListItems {
	this := VacanciesDeletedVacancyListItems{}
	this.Items = items
	return &this
}
...
func (o VacanciesDeletedVacancyListItems) MarshalJSON() ([]byte, error) {
...
func (o VacanciesDeletedVacancyListItems) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *VacanciesDeletedVacancyListItems) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesDeletedVacancyListItems := _VacanciesDeletedVacancyListItems{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesDeletedVacancyListItems)

	if err != nil {
		return err
	}

	*o = VacanciesDeletedVacancyListItems(varVacanciesDeletedVacancyListItems)

	return err
}

type NullableVacanciesDeletedVacancyListItems struct {
	value *VacanciesDeletedVacancyListItems
	isSet bool
}

func (v NullableVacanciesDeletedVacancyListItems) Get() *VacanciesDeletedVacancyListItems {
	return v.value
}

func (v *NullableVacanciesDeletedVacancyListItems) Set(val *VacanciesDeletedVacancyListItems) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesDeletedVacancyListItems) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesDeletedVacancyListItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesDeletedVacancyListItems(val *VacanciesDeletedVacancyListItems) *NullableVacanciesDeletedVacancyListItems {
	return &NullableVacanciesDeletedVacancyListItems{value: val, isSet: true}
}

func (v NullableVacanciesDeletedVacancyListItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesDeletedVacancyListItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
