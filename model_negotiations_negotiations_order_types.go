...
// checks if the NegotiationsNegotiationsOrderTypes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsNegotiationsOrderTypes{}

// NegotiationsNegotiationsOrderTypes struct for NegotiationsNegotiationsOrderTypes
type NegotiationsNegotiationsOrderTypes struct {
...
type _NegotiationsNegotiationsOrderTypes NegotiationsNegotiationsOrderTypes
...
func NewNegotiationsNegotiationsOrderTypes(id string, name string, url string) *NegotiationsNegotiationsOrderTypes {
	this := NegotiationsNegotiationsOrderTypes{}
	this.Id = id
	this.Name = name
	this.Url = url
	return &this
...
func (o NegotiationsNegotiationsOrderTypes) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsNegotiationsOrderTypes) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsNegotiationsOrderTypes) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsNegotiationsOrderTypes := _NegotiationsNegotiationsOrderTypes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsNegotiationsOrderTypes)

	if err != nil {
		return err
	}

	*o = NegotiationsNegotiationsOrderTypes(varNegotiationsNegotiationsOrderTypes)

	return err
}

type NullableNegotiationsNegotiationsOrderTypes struct {
	value *NegotiationsNegotiationsOrderTypes
	isSet bool
}

func (v NullableNegotiationsNegotiationsOrderTypes) Get() *NegotiationsNegotiationsOrderTypes {
	return v.value
}

func (v *NullableNegotiationsNegotiationsOrderTypes) Set(val *NegotiationsNegotiationsOrderTypes) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsNegotiationsOrderTypes) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsNegotiationsOrderTypes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsNegotiationsOrderTypes(val *NegotiationsNegotiationsOrderTypes) *NullableNegotiationsNegotiationsOrderTypes {
	return &NullableNegotiationsNegotiationsOrderTypes{value: val, isSet: true}
}

func (v NullableNegotiationsNegotiationsOrderTypes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsNegotiationsOrderTypes) UnmarshalJSON(src []byte) error {
	v.isSet = true
