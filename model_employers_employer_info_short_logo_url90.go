...
// checks if the EmployersEmployerInfoShortLogoUrl90 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployersEmployerInfoShortLogoUrl90{}

// EmployersEmployerInfoShortLogoUrl90 struct for EmployersEmployerInfoShortLogoUrl90
type EmployersEmployerInfoShortLogoUrl90 struct {
	// Ссылка на описание работодателя на сайте
	AlternateUrl string `json:"alternate_url"`
	// Идентификатор работодателя
	Id string `json:"id"`
	LogoUrls NullableIncludesLogoUrls90 `json:"logo_urls,omitempty"`
...
type _EmployersEmployerInfoShortLogoUrl90 EmployersEmployerInfoShortLogoUrl90
...
func NewEmployersEmployerInfoShortLogoUrl90(alternateUrl string, id string, name string, url string) *EmployersEmployerInfoShortLogoUrl90 {
	this := EmployersEmployerInfoShortLogoUrl90{}
...
// SetLogoUrls gets a reference to the given NullableIncludesLogoUrls90 and assigns it to the LogoUrls field.
...
func (o *EmployersEmployerInfoShortLogoUrl90) SetLogoUrlsNil() {
	o.LogoUrls.Set(nil)
}
...
func (o EmployersEmployerInfoShortLogoUrl90) MarshalJSON() ([]byte, error) {
...
func (o EmployersEmployerInfoShortLogoUrl90) ToMap() (map[string]interface{}, error) {
...
func (o *EmployersEmployerInfoShortLogoUrl90) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployersEmployerInfoShortLogoUrl90 := _EmployersEmployerInfoShortLogoUrl90{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployersEmployerInfoShortLogoUrl90)

	if err != nil {
		return err
	}

	*o = EmployersEmployerInfoShortLogoUrl90(varEmployersEmployerInfoShortLogoUrl90)

	return err
}

type NullableEmployersEmployerInfoShortLogoUrl90 struct {
	value *EmployersEmployerInfoShortLogoUrl90
	isSet bool
}

func (v NullableEmployersEmployerInfoShortLogoUrl90) Get() *EmployersEmployerInfoShortLogoUrl90 {
	return v.value
}

func (v *NullableEmployersEmployerInfoShortLogoUrl90) Set(val *EmployersEmployerInfoShortLogoUrl90) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployersEmployerInfoShortLogoUrl90) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployersEmployerInfoShortLogoUrl90) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployersEmployerInfoShortLogoUrl90(val *EmployersEmployerInfoShortLogoUrl90) *NullableEmployersEmployerInfoShortLogoUrl90 {
	return &NullableEmployersEmployerInfoShortLogoUrl90{value: val, isSet: true}
}

func (v NullableEmployersEmployerInfoShortLogoUrl90) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployersEmployerInfoShortLogoUrl90) UnmarshalJSON(src []byte) error {
	v.isSet = true
