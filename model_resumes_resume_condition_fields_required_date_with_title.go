...
// checks if the ResumesResumeConditionFieldsRequiredDateWithTitle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsRequiredDateWithTitle{}

// ResumesResumeConditionFieldsRequiredDateWithTitle struct for ResumesResumeConditionFieldsRequiredDateWithTitle
type ResumesResumeConditionFieldsRequiredDateWithTitle struct {
	// Верхняя граница диапазона значений дат, включительно. Если `null` — верхняя граница даты не определена
	MaxDate NullableString `json:"max_date,omitempty"`
	// Нижняя граница диапазона значений дат, включительно. Если `null` — нижняя граница даты не определена
	MinDate NullableString `json:"min_date,omitempty"`
...
func NewResumesResumeConditionFieldsRequiredDateWithTitle() *ResumesResumeConditionFieldsRequiredDateWithTitle {
	this := ResumesResumeConditionFieldsRequiredDateWithTitle{}
	return &this
}
...
// GetMaxDate returns the MaxDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ResumesResumeConditionFieldsRequiredDateWithTitle) GetMaxDate() string {
	if o == nil || IsNil(o.MaxDate.Get()) {
		var ret string
		return ret
	}
...
// SetMaxDate gets a reference to the given NullableString and assigns it to the MaxDate field.
...
func (o *ResumesResumeConditionFieldsRequiredDateWithTitle) SetMaxDateNil() {
	o.MaxDate.Set(nil)
}
...
// GetMinDate returns the MinDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ResumesResumeConditionFieldsRequiredDateWithTitle) GetMinDate() string {
	if o == nil || IsNil(o.MinDate.Get()) {
		var ret string
		return ret
	}
	return *o.MinDate.Get()
}
...
func (o *ResumesResumeConditionFieldsRequiredDateWithTitle) GetMinDateOk() (*string, bool) {
	...
	return o.MinDate.Get(), o.MinDate.IsSet()
}
...
// SetMinDate gets a reference to the given NullableString and assigns it to the MinDate field.
...
func (o *ResumesResumeConditionFieldsRequiredDateWithTitle) SetMinDateNil() {
	o.MinDate.Set(nil)
}
...
func (o *ResumesResumeConditionFieldsRequiredDateWithTitle) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o ResumesResumeConditionFieldsRequiredDateWithTitle) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsRequiredDateWithTitle) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.MaxDate.IsSet() {
		toSerialize["max_date"] = o.MaxDate.Get()
	}
	if o.MinDate.IsSet() {
		toSerialize["min_date"] = o.MinDate.Get()
	}
	if o.Required.IsSet() {
...
type NullableResumesResumeConditionFieldsRequiredDateWithTitle struct {
	value *ResumesResumeConditionFieldsRequiredDateWithTitle
	isSet bool
}

func (v NullableResumesResumeConditionFieldsRequiredDateWithTitle) Get() *ResumesResumeConditionFieldsRequiredDateWithTitle {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsRequiredDateWithTitle) Set(val *ResumesResumeConditionFieldsRequiredDateWithTitle) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsRequiredDateWithTitle) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsRequiredDateWithTitle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsRequiredDateWithTitle(val *ResumesResumeConditionFieldsRequiredDateWithTitle) *NullableResumesResumeConditionFieldsRequiredDateWithTitle {
	return &NullableResumesResumeConditionFieldsRequiredDateWithTitle{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsRequiredDateWithTitle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsRequiredDateWithTitle) UnmarshalJSON(src []byte) error {
	v.isSet = true
