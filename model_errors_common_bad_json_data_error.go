...
// checks if the ErrorsCommonBadJsonDataError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsCommonBadJsonDataError{}

// ErrorsCommonBadJsonDataError struct for ErrorsCommonBadJsonDataError
type ErrorsCommonBadJsonDataError struct {
	// Описание ошибки
...
type _ErrorsCommonBadJsonDataError ErrorsCommonBadJsonDataError
...
func NewErrorsCommonBadJsonDataError(type_ string) *ErrorsCommonBadJsonDataError {
	this := ErrorsCommonBadJsonDataError{}
	this.Type = type_
	return &this
}
...
func (o *ErrorsCommonBadJsonDataError) SetDescriptionNil() {
...
func (o ErrorsCommonBadJsonDataError) MarshalJSON() ([]byte, error) {
...
func (o ErrorsCommonBadJsonDataError) ToMap() (map[string]interface{}, error) {
...
func (o *ErrorsCommonBadJsonDataError) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorsCommonBadJsonDataError := _ErrorsCommonBadJsonDataError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorsCommonBadJsonDataError)

	if err != nil {
		return err
	}

	*o = ErrorsCommonBadJsonDataError(varErrorsCommonBadJsonDataError)

	return err
}

type NullableErrorsCommonBadJsonDataError struct {
	value *ErrorsCommonBadJsonDataError
	isSet bool
}

func (v NullableErrorsCommonBadJsonDataError) Get() *ErrorsCommonBadJsonDataError {
	return v.value
}

func (v *NullableErrorsCommonBadJsonDataError) Set(val *ErrorsCommonBadJsonDataError) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorsCommonBadJsonDataError) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorsCommonBadJsonDataError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorsCommonBadJsonDataError(val *ErrorsCommonBadJsonDataError) *NullableErrorsCommonBadJsonDataError {
	return &NullableErrorsCommonBadJsonDataError{value: val, isSet: true}
}

func (v NullableErrorsCommonBadJsonDataError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorsCommonBadJsonDataError) UnmarshalJSON(src []byte) error {
	v.isSet = true
