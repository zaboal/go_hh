...
// checks if the IncludesIdNameUid type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesIdNameUid{}

// IncludesIdNameUid struct for IncludesIdNameUid
type IncludesIdNameUid struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _IncludesIdNameUid IncludesIdNameUid
...
func (o IncludesIdNameUid) MarshalJSON() ([]byte, error) {
...
func (o IncludesIdNameUid) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesIdNameUid) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesIdNameUid := _IncludesIdNameUid{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesIdNameUid)

	if err != nil {
		return err
	}

	*o = IncludesIdNameUid(varIncludesIdNameUid)

	return err
}

type NullableIncludesIdNameUid struct {
	value *IncludesIdNameUid
	isSet bool
}

func (v NullableIncludesIdNameUid) Get() *IncludesIdNameUid {
	return v.value
}

func (v *NullableIncludesIdNameUid) Set(val *IncludesIdNameUid) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesIdNameUid) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesIdNameUid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesIdNameUid(val *IncludesIdNameUid) *NullableIncludesIdNameUid {
	return &NullableIncludesIdNameUid{value: val, isSet: true}
}

func (v NullableIncludesIdNameUid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesIdNameUid) UnmarshalJSON(src []byte) error {
	v.isSet = true
