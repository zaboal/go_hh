...
// checks if the VacancyDepartmentOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyDepartmentOutput{}

// VacancyDepartmentOutput struct for VacancyDepartmentOutput
type VacancyDepartmentOutput struct {
...
func (o VacancyDepartmentOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyDepartmentOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyDepartmentOutput struct {
	value *VacancyDepartmentOutput
	isSet bool
}

func (v NullableVacancyDepartmentOutput) Get() *VacancyDepartmentOutput {
	return v.value
}

func (v *NullableVacancyDepartmentOutput) Set(val *VacancyDepartmentOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDepartmentOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDepartmentOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDepartmentOutput(val *VacancyDepartmentOutput) *NullableVacancyDepartmentOutput {
	return &NullableVacancyDepartmentOutput{value: val, isSet: true}
}

func (v NullableVacancyDepartmentOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDepartmentOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
