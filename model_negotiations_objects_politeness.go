...
// checks if the NegotiationsObjectsPoliteness type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsObjectsPoliteness{}

// NegotiationsObjectsPoliteness struct for NegotiationsObjectsPoliteness
type NegotiationsObjectsPoliteness struct {
	...
	// Deprecated
	IndexChange float32 `json:"index_change"`
}

type _NegotiationsObjectsPoliteness NegotiationsObjectsPoliteness
...
func NewNegotiationsObjectsPoliteness(articleUrl string, description string, hint string, index float32, indexChange float32) *NegotiationsObjectsPoliteness {
	this := NegotiationsObjectsPoliteness{}
...
// GetIndexChange returns the IndexChange field value
// Deprecated
...
// GetIndexChangeOk returns a tuple with the IndexChange field value
// and a boolean to check if the value has been set.
// Deprecated
func (o *NegotiationsObjectsPoliteness) GetIndexChangeOk() (*float32, bool) {
	...
	return &o.IndexChange, true
}

// SetIndexChange sets field value
// Deprecated
func (o *NegotiationsObjectsPoliteness) SetIndexChange(v float32) {
	o.IndexChange = v
}

func (o NegotiationsObjectsPoliteness) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsObjectsPoliteness) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["article_url"] = o.ArticleUrl
	toSerialize["description"] = o.Description
	toSerialize["hint"] = o.Hint
	toSerialize["index"] = o.Index
	toSerialize["index_change"] = o.IndexChange
	return toSerialize, nil
}

func (o *NegotiationsObjectsPoliteness) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsObjectsPoliteness := _NegotiationsObjectsPoliteness{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsObjectsPoliteness)

	if err != nil {
		return err
	}

	*o = NegotiationsObjectsPoliteness(varNegotiationsObjectsPoliteness)

	return err
}

type NullableNegotiationsObjectsPoliteness struct {
	value *NegotiationsObjectsPoliteness
	isSet bool
}

func (v NullableNegotiationsObjectsPoliteness) Get() *NegotiationsObjectsPoliteness {
	return v.value
}

func (v *NullableNegotiationsObjectsPoliteness) Set(val *NegotiationsObjectsPoliteness) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsObjectsPoliteness) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsObjectsPoliteness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsObjectsPoliteness(val *NegotiationsObjectsPoliteness) *NullableNegotiationsObjectsPoliteness {
	return &NullableNegotiationsObjectsPoliteness{value: val, isSet: true}
}

func (v NullableNegotiationsObjectsPoliteness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsObjectsPoliteness) UnmarshalJSON(src []byte) error {
	v.isSet = true
