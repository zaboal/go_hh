...
// SendNegotiationMessage404Response - struct for SendNegotiationMessage404Response
type SendNegotiationMessage404Response struct {
	ErrorsCommonNotFoundErrors *ErrorsCommonNotFoundErrors
	ErrorsNegotiationSendMessageNotFoundErrors *ErrorsNegotiationSendMessageNotFoundErrors
}

// ErrorsCommonNotFoundErrorsAsSendNegotiationMessage404Response is a convenience function that returns ErrorsCommonNotFoundErrors wrapped in SendNegotiationMessage404Response
func ErrorsCommonNotFoundErrorsAsSendNegotiationMessage404Response(v *ErrorsCommonNotFoundErrors) SendNegotiationMessage404Response {
	return SendNegotiationMessage404Response{
		ErrorsCommonNotFoundErrors: v,
	}
}

// ErrorsNegotiationSendMessageNotFoundErrorsAsSendNegotiationMessage404Response is a convenience function that returns ErrorsNegotiationSendMessageNotFoundErrors wrapped in SendNegotiationMessage404Response
func ErrorsNegotiationSendMessageNotFoundErrorsAsSendNegotiationMessage404Response(v *ErrorsNegotiationSendMessageNotFoundErrors) SendNegotiationMessage404Response {
	return SendNegotiationMessage404Response{
		ErrorsNegotiationSendMessageNotFoundErrors: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *SendNegotiationMessage404Response) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	// try to unmarshal data into ErrorsNegotiationSendMessageNotFoundErrors
	err = newStrictDecoder(data).Decode(&dst.ErrorsNegotiationSendMessageNotFoundErrors)
	if err == nil {
		jsonErrorsNegotiationSendMessageNotFoundErrors, _ := json.Marshal(dst.ErrorsNegotiationSendMessageNotFoundErrors)
		if string(jsonErrorsNegotiationSendMessageNotFoundErrors) == "{}" { // empty struct
			dst.ErrorsNegotiationSendMessageNotFoundErrors = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SendNegotiationMessage404Response)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SendNegotiationMessage404Response)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SendNegotiationMessage404Response) MarshalJSON() ([]byte, error) {
	if src.ErrorsCommonNotFoundErrors != nil {
		return json.Marshal(&src.ErrorsCommonNotFoundErrors)
	}

	if src.ErrorsNegotiationSendMessageNotFoundErrors != nil {
		return json.Marshal(&src.ErrorsNegotiationSendMessageNotFoundErrors)
	}
...
func (obj *SendNegotiationMessage404Response) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	...
	if obj.ErrorsNegotiationSendMessageNotFoundErrors != nil {
		return obj.ErrorsNegotiationSendMessageNotFoundErrors
	}
...
type NullableSendNegotiationMessage404Response struct {
	value *SendNegotiationMessage404Response
	isSet bool
}

func (v NullableSendNegotiationMessage404Response) Get() *SendNegotiationMessage404Response {
	return v.value
}

func (v *NullableSendNegotiationMessage404Response) Set(val *SendNegotiationMessage404Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSendNegotiationMessage404Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSendNegotiationMessage404Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSendNegotiationMessage404Response(val *SendNegotiationMessage404Response) *NullableSendNegotiationMessage404Response {
	return &NullableSendNegotiationMessage404Response{value: val, isSet: true}
}

func (v NullableSendNegotiationMessage404Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSendNegotiationMessage404Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
