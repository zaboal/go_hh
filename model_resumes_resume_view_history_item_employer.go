...
type ResumesResumeViewHistoryItemEmployer struct {
	EmployersEmployerItemShort *EmployersEmployerItemShort
	IncludesName *IncludesName
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *ResumesResumeViewHistoryItemEmployer) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into EmployersEmployerItemShort
	err = json.Unmarshal(data, &dst.EmployersEmployerItemShort);
	if err == nil {
		jsonEmployersEmployerItemShort, _ := json.Marshal(dst.EmployersEmployerItemShort)
		if string(jsonEmployersEmployerItemShort) == "{}" { // empty struct
			dst.EmployersEmployerItemShort = nil
		} else {
			return nil // data stored in dst.EmployersEmployerItemShort, return on the first match
		}
	} else {
		dst.EmployersEmployerItemShort = nil
	}

	// try to unmarshal JSON data into IncludesName
	err = json.Unmarshal(data, &dst.IncludesName);
	if err == nil {
		jsonIncludesName, _ := json.Marshal(dst.IncludesName)
		if string(jsonIncludesName) == "{}" { // empty struct
			dst.IncludesName = nil
		} else {
			return nil // data stored in dst.IncludesName, return on the first match
		}
	} else {
		dst.IncludesName = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(ResumesResumeViewHistoryItemEmployer)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ResumesResumeViewHistoryItemEmployer) MarshalJSON() ([]byte, error) {
	if src.EmployersEmployerItemShort != nil {
		return json.Marshal(&src.EmployersEmployerItemShort)
	}

	if src.IncludesName != nil {
		return json.Marshal(&src.IncludesName)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableResumesResumeViewHistoryItemEmployer struct {
	value *ResumesResumeViewHistoryItemEmployer
	isSet bool
}

func (v NullableResumesResumeViewHistoryItemEmployer) Get() *ResumesResumeViewHistoryItemEmployer {
	return v.value
}

func (v *NullableResumesResumeViewHistoryItemEmployer) Set(val *ResumesResumeViewHistoryItemEmployer) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeViewHistoryItemEmployer) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeViewHistoryItemEmployer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeViewHistoryItemEmployer(val *ResumesResumeViewHistoryItemEmployer) *NullableResumesResumeViewHistoryItemEmployer {
	return &NullableResumesResumeViewHistoryItemEmployer{value: val, isSet: true}
}

func (v NullableResumesResumeViewHistoryItemEmployer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeViewHistoryItemEmployer) UnmarshalJSON(src []byte) error {
	v.isSet = true
