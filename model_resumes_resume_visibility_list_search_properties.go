...
// checks if the ResumesResumeVisibilityListSearchProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeVisibilityListSearchProperties{}

// ResumesResumeVisibilityListSearchProperties struct for ResumesResumeVisibilityListSearchProperties
type ResumesResumeVisibilityListSearchProperties struct {
	// Список работодателей
	Items []ResumesResumeVisibilityListSearchPropertiesItemsInner `json:"items"`
}

type _ResumesResumeVisibilityListSearchProperties ResumesResumeVisibilityListSearchProperties
...
func NewResumesResumeVisibilityListSearchProperties(items []ResumesResumeVisibilityListSearchPropertiesItemsInner) *ResumesResumeVisibilityListSearchProperties {
	this := ResumesResumeVisibilityListSearchProperties{}
	this.Items = items
	return &this
}
...
func (o *ResumesResumeVisibilityListSearchProperties) GetItems() []ResumesResumeVisibilityListSearchPropertiesItemsInner {
	if o == nil {
		var ret []ResumesResumeVisibilityListSearchPropertiesItemsInner
		return ret
	}
...
func (o ResumesResumeVisibilityListSearchProperties) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeVisibilityListSearchProperties) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ResumesResumeVisibilityListSearchProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varResumesResumeVisibilityListSearchProperties := _ResumesResumeVisibilityListSearchProperties{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResumesResumeVisibilityListSearchProperties)

	if err != nil {
		return err
	}

	*o = ResumesResumeVisibilityListSearchProperties(varResumesResumeVisibilityListSearchProperties)

	return err
}

type NullableResumesResumeVisibilityListSearchProperties struct {
	value *ResumesResumeVisibilityListSearchProperties
	isSet bool
}

func (v NullableResumesResumeVisibilityListSearchProperties) Get() *ResumesResumeVisibilityListSearchProperties {
	return v.value
}

func (v *NullableResumesResumeVisibilityListSearchProperties) Set(val *ResumesResumeVisibilityListSearchProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeVisibilityListSearchProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeVisibilityListSearchProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeVisibilityListSearchProperties(val *ResumesResumeVisibilityListSearchProperties) *NullableResumesResumeVisibilityListSearchProperties {
	return &NullableResumesResumeVisibilityListSearchProperties{value: val, isSet: true}
}

func (v NullableResumesResumeVisibilityListSearchProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeVisibilityListSearchProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
