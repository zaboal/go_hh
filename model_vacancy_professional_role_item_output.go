...
// checks if the VacancyProfessionalRoleItemOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyProfessionalRoleItemOutput{}

// VacancyProfessionalRoleItemOutput struct for VacancyProfessionalRoleItemOutput
type VacancyProfessionalRoleItemOutput struct {
...
func NewVacancyProfessionalRoleItemOutput() *VacancyProfessionalRoleItemOutput {
	this := VacancyProfessionalRoleItemOutput{}
	return &this
}
...
func (o VacancyProfessionalRoleItemOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyProfessionalRoleItemOutput) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyProfessionalRoleItemOutput struct {
	value *VacancyProfessionalRoleItemOutput
	isSet bool
}

func (v NullableVacancyProfessionalRoleItemOutput) Get() *VacancyProfessionalRoleItemOutput {
	return v.value
}

func (v *NullableVacancyProfessionalRoleItemOutput) Set(val *VacancyProfessionalRoleItemOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyProfessionalRoleItemOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyProfessionalRoleItemOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyProfessionalRoleItemOutput(val *VacancyProfessionalRoleItemOutput) *NullableVacancyProfessionalRoleItemOutput {
	return &NullableVacancyProfessionalRoleItemOutput{value: val, isSet: true}
}

func (v NullableVacancyProfessionalRoleItemOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyProfessionalRoleItemOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
