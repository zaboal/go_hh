...
// checks if the VacanciesArguments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesArguments{}

// VacanciesArguments struct for VacanciesArguments
type VacanciesArguments struct {
...
func (o VacanciesArguments) MarshalJSON() ([]byte, error) {
...
func (o VacanciesArguments) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesArguments struct {
	value *VacanciesArguments
	isSet bool
}

func (v NullableVacanciesArguments) Get() *VacanciesArguments {
	return v.value
}

func (v *NullableVacanciesArguments) Set(val *VacanciesArguments) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesArguments) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesArguments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesArguments(val *VacanciesArguments) *NullableVacanciesArguments {
	return &NullableVacanciesArguments{value: val, isSet: true}
}

func (v NullableVacanciesArguments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesArguments) UnmarshalJSON(src []byte) error {
	v.isSet = true
