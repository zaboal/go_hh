...
// checks if the VacancyEditBillingType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyEditBillingType{}

// VacancyEditBillingType Поле, передаваемое в запросе при смене биллингового типа вакансии. Биллинговый тип можно только улучшать
type VacancyEditBillingType struct {
	BillingType VacancyBillingType `json:"billing_type"`
}

type _VacancyEditBillingType VacancyEditBillingType
...
func (o VacancyEditBillingType) MarshalJSON() ([]byte, error) {
...
func (o VacancyEditBillingType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["billing_type"] = o.BillingType
	return toSerialize, nil
}

func (o *VacancyEditBillingType) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyEditBillingType := _VacancyEditBillingType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyEditBillingType)

	if err != nil {
		return err
	}

	*o = VacancyEditBillingType(varVacancyEditBillingType)

	return err
}

type NullableVacancyEditBillingType struct {
	value *VacancyEditBillingType
	isSet bool
}

func (v NullableVacancyEditBillingType) Get() *VacancyEditBillingType {
	return v.value
}

func (v *NullableVacancyEditBillingType) Set(val *VacancyEditBillingType) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyEditBillingType) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyEditBillingType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyEditBillingType(val *VacancyEditBillingType) *NullableVacancyEditBillingType {
	return &NullableVacancyEditBillingType{value: val, isSet: true}
}

func (v NullableVacancyEditBillingType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyEditBillingType) UnmarshalJSON(src []byte) error {
	v.isSet = true
