...
// checks if the EmployerManagersAddEmployerManagerAdditionalPhone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerManagersAddEmployerManagerAdditionalPhone{}

// EmployerManagersAddEmployerManagerAdditionalPhone Дополнительный телефон менеджера
type EmployerManagersAddEmployerManagerAdditionalPhone struct {
	// Код города
...
type _EmployerManagersAddEmployerManagerAdditionalPhone EmployerManagersAddEmployerManagerAdditionalPhone
...
func NewEmployerManagersAddEmployerManagerAdditionalPhone(city string, country string, number string) *EmployerManagersAddEmployerManagerAdditionalPhone {
	this := EmployerManagersAddEmployerManagerAdditionalPhone{}
	this.City = city
...
func (o *EmployerManagersAddEmployerManagerAdditionalPhone) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o EmployerManagersAddEmployerManagerAdditionalPhone) MarshalJSON() ([]byte, error) {
...
func (o EmployerManagersAddEmployerManagerAdditionalPhone) ToMap() (map[string]interface{}, error) {
...
func (o *EmployerManagersAddEmployerManagerAdditionalPhone) UnmarshalJSON(data []byte) (err error) {
	...
	varEmployerManagersAddEmployerManagerAdditionalPhone := _EmployerManagersAddEmployerManagerAdditionalPhone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmployerManagersAddEmployerManagerAdditionalPhone)

	if err != nil {
		return err
	}

	*o = EmployerManagersAddEmployerManagerAdditionalPhone(varEmployerManagersAddEmployerManagerAdditionalPhone)

	return err
}

type NullableEmployerManagersAddEmployerManagerAdditionalPhone struct {
	value *EmployerManagersAddEmployerManagerAdditionalPhone
	isSet bool
}

func (v NullableEmployerManagersAddEmployerManagerAdditionalPhone) Get() *EmployerManagersAddEmployerManagerAdditionalPhone {
	return v.value
}

func (v *NullableEmployerManagersAddEmployerManagerAdditionalPhone) Set(val *EmployerManagersAddEmployerManagerAdditionalPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerManagersAddEmployerManagerAdditionalPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerManagersAddEmployerManagerAdditionalPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerManagersAddEmployerManagerAdditionalPhone(val *EmployerManagersAddEmployerManagerAdditionalPhone) *NullableEmployerManagersAddEmployerManagerAdditionalPhone {
	return &NullableEmployerManagersAddEmployerManagerAdditionalPhone{value: val, isSet: true}
}

func (v NullableEmployerManagersAddEmployerManagerAdditionalPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerManagersAddEmployerManagerAdditionalPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
