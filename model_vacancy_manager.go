...
// checks if the VacancyManager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyManager{}

// VacancyManager struct for VacancyManager
...
func (o *VacancyManager) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o VacancyManager) MarshalJSON() ([]byte, error) {
...
func (o VacancyManager) ToMap() (map[string]interface{}, error) {
...
type NullableVacancyManager struct {
	value *VacancyManager
	isSet bool
}

func (v NullableVacancyManager) Get() *VacancyManager {
	return v.value
}

func (v *NullableVacancyManager) Set(val *VacancyManager) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyManager) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyManager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyManager(val *VacancyManager) *NullableVacancyManager {
	return &NullableVacancyManager{value: val, isSet: true}
}

func (v NullableVacancyManager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyManager) UnmarshalJSON(src []byte) error {
	v.isSet = true
