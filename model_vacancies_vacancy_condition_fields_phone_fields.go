...
func (o *VacanciesVacancyConditionFieldsPhoneFields) GetNumber() VacanciesVacancyConditionFieldsNumberCondition {
	if o == nil || IsNil(o.Number.Get()) {
		var ret VacanciesVacancyConditionFieldsNumberCondition
		return ret
	}
	return *o.Number.Get()
}
...
// SetNumber gets a reference to the given NullableVacanciesVacancyConditionFieldsNumberCondition and assigns it to the Number field.
func (o *VacanciesVacancyConditionFieldsPhoneFields) SetNumber(v VacanciesVacancyConditionFieldsNumberCondition) {
	o.Number.Set(&v)
}
// SetNumberNil sets the value for Number to be an explicit nil
func (o *VacanciesVacancyConditionFieldsPhoneFields) SetNumberNil() {
	o.Number.Set(nil)
}
