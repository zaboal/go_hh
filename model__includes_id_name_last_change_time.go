...
// checks if the IncludesIdNameLastChangeTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesIdNameLastChangeTime{}

// IncludesIdNameLastChangeTime struct for IncludesIdNameLastChangeTime
type IncludesIdNameLastChangeTime struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
type _IncludesIdNameLastChangeTime IncludesIdNameLastChangeTime
...
func NewIncludesIdNameLastChangeTime(id string, name string) *IncludesIdNameLastChangeTime {
	this := IncludesIdNameLastChangeTime{}
	this.Id = id
	this.Name = name
	return &this
}
...
// GetLastChangeTime returns the LastChangeTime field value if set, zero value otherwise.
func (o *IncludesIdNameLastChangeTime) GetLastChangeTime() string {
	if o == nil || IsNil(o.LastChangeTime) {
		var ret string
		return ret
	}
...
// SetLastChangeTime gets a reference to the given string and assigns it to the LastChangeTime field.
func (o *IncludesIdNameLastChangeTime) SetLastChangeTime(v string) {
	o.LastChangeTime = &v
}

func (o IncludesIdNameLastChangeTime) MarshalJSON() ([]byte, error) {
...
func (o IncludesIdNameLastChangeTime) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["name"] = o.Name
	if !IsNil(o.LastChangeTime) {
		toSerialize["last_change_time"] = o.LastChangeTime
	}
	return toSerialize, nil
}

func (o *IncludesIdNameLastChangeTime) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesIdNameLastChangeTime := _IncludesIdNameLastChangeTime{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesIdNameLastChangeTime)

	if err != nil {
		return err
	}

	*o = IncludesIdNameLastChangeTime(varIncludesIdNameLastChangeTime)

	return err
}

type NullableIncludesIdNameLastChangeTime struct {
	value *IncludesIdNameLastChangeTime
	isSet bool
}

func (v NullableIncludesIdNameLastChangeTime) Get() *IncludesIdNameLastChangeTime {
	return v.value
}

func (v *NullableIncludesIdNameLastChangeTime) Set(val *IncludesIdNameLastChangeTime) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesIdNameLastChangeTime) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesIdNameLastChangeTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesIdNameLastChangeTime(val *IncludesIdNameLastChangeTime) *NullableIncludesIdNameLastChangeTime {
	return &NullableIncludesIdNameLastChangeTime{value: val, isSet: true}
}

func (v NullableIncludesIdNameLastChangeTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesIdNameLastChangeTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
