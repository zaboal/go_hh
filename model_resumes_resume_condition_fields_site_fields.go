...
// checks if the ResumesResumeConditionFieldsSiteFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResumesResumeConditionFieldsSiteFields{}

// ResumesResumeConditionFieldsSiteFields struct for ResumesResumeConditionFieldsSiteFields
type ResumesResumeConditionFieldsSiteFields struct {
	Type NullableResumesResumeConditionFieldsRequiredWithTitle `json:"type,omitempty"`
	Url NullableResumesResumeConditionFieldsRequiredLengthWithTitle `json:"url,omitempty"`
}
...
func NewResumesResumeConditionFieldsSiteFields() *ResumesResumeConditionFieldsSiteFields {
	this := ResumesResumeConditionFieldsSiteFields{}
	return &this
}
...
func (o *ResumesResumeConditionFieldsSiteFields) SetTypeNil() {
	o.Type.Set(nil)
}
...
// SetUrl gets a reference to the given NullableResumesResumeConditionFieldsRequiredLengthWithTitle and assigns it to the Url field.
func (o *ResumesResumeConditionFieldsSiteFields) SetUrl(v ResumesResumeConditionFieldsRequiredLengthWithTitle) {
	o.Url.Set(&v)
}
// SetUrlNil sets the value for Url to be an explicit nil
func (o *ResumesResumeConditionFieldsSiteFields) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o ResumesResumeConditionFieldsSiteFields) MarshalJSON() ([]byte, error) {
...
func (o ResumesResumeConditionFieldsSiteFields) ToMap() (map[string]interface{}, error) {
...
type NullableResumesResumeConditionFieldsSiteFields struct {
	value *ResumesResumeConditionFieldsSiteFields
	isSet bool
}

func (v NullableResumesResumeConditionFieldsSiteFields) Get() *ResumesResumeConditionFieldsSiteFields {
	return v.value
}

func (v *NullableResumesResumeConditionFieldsSiteFields) Set(val *ResumesResumeConditionFieldsSiteFields) {
	v.value = val
	v.isSet = true
}

func (v NullableResumesResumeConditionFieldsSiteFields) IsSet() bool {
	return v.isSet
}

func (v *NullableResumesResumeConditionFieldsSiteFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResumesResumeConditionFieldsSiteFields(val *ResumesResumeConditionFieldsSiteFields) *NullableResumesResumeConditionFieldsSiteFields {
	return &NullableResumesResumeConditionFieldsSiteFields{value: val, isSet: true}
}

func (v NullableResumesResumeConditionFieldsSiteFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResumesResumeConditionFieldsSiteFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
