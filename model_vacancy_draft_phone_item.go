...
// VacancyDraftPhoneItem - struct for VacancyDraftPhoneItem
type VacancyDraftPhoneItem struct {
	VacancyDraftPhone *VacancyDraftPhone
	VacancyDraftPhoneFormatted *VacancyDraftPhoneFormatted
}

// VacancyDraftPhoneAsVacancyDraftPhoneItem is a convenience function that returns VacancyDraftPhone wrapped in VacancyDraftPhoneItem
func VacancyDraftPhoneAsVacancyDraftPhoneItem(v *VacancyDraftPhone) VacancyDraftPhoneItem {
	return VacancyDraftPhoneItem{
		VacancyDraftPhone: v,
	}
}

// VacancyDraftPhoneFormattedAsVacancyDraftPhoneItem is a convenience function that returns VacancyDraftPhoneFormatted wrapped in VacancyDraftPhoneItem
func VacancyDraftPhoneFormattedAsVacancyDraftPhoneItem(v *VacancyDraftPhoneFormatted) VacancyDraftPhoneItem {
	return VacancyDraftPhoneItem{
		VacancyDraftPhoneFormatted: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *VacancyDraftPhoneItem) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into VacancyDraftPhone
	err = newStrictDecoder(data).Decode(&dst.VacancyDraftPhone)
	if err == nil {
		jsonVacancyDraftPhone, _ := json.Marshal(dst.VacancyDraftPhone)
		if string(jsonVacancyDraftPhone) == "{}" { // empty struct
			dst.VacancyDraftPhone = nil
		} else {
			if err = validator.Validate(dst.VacancyDraftPhone); err != nil {
				dst.VacancyDraftPhone = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into VacancyDraftPhoneFormatted
	err = newStrictDecoder(data).Decode(&dst.VacancyDraftPhoneFormatted)
	if err == nil {
		jsonVacancyDraftPhoneFormatted, _ := json.Marshal(dst.VacancyDraftPhoneFormatted)
		if string(jsonVacancyDraftPhoneFormatted) == "{}" { // empty struct
			dst.VacancyDraftPhoneFormatted = nil
		} else {
			if err = validator.Validate(dst.VacancyDraftPhoneFormatted); err != nil {
				dst.VacancyDraftPhoneFormatted = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(VacancyDraftPhoneItem)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(VacancyDraftPhoneItem)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src VacancyDraftPhoneItem) MarshalJSON() ([]byte, error) {
	if src.VacancyDraftPhone != nil {
		return json.Marshal(&src.VacancyDraftPhone)
	}

	if src.VacancyDraftPhoneFormatted != nil {
		return json.Marshal(&src.VacancyDraftPhoneFormatted)
	}
...
func (obj *VacancyDraftPhoneItem) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.VacancyDraftPhone != nil {
		return obj.VacancyDraftPhone
	}

	if obj.VacancyDraftPhoneFormatted != nil {
		return obj.VacancyDraftPhoneFormatted
	}
...
type NullableVacancyDraftPhoneItem struct {
	value *VacancyDraftPhoneItem
	isSet bool
}

func (v NullableVacancyDraftPhoneItem) Get() *VacancyDraftPhoneItem {
	return v.value
}

func (v *NullableVacancyDraftPhoneItem) Set(val *VacancyDraftPhoneItem) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyDraftPhoneItem) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyDraftPhoneItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyDraftPhoneItem(val *VacancyDraftPhoneItem) *NullableVacancyDraftPhoneItem {
	return &NullableVacancyDraftPhoneItem{value: val, isSet: true}
}

func (v NullableVacancyDraftPhoneItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyDraftPhoneItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
