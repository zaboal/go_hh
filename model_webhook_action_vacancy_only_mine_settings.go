...
// checks if the WebhookActionVacancyOnlyMineSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookActionVacancyOnlyMineSettings{}

// WebhookActionVacancyOnlyMineSettings struct for WebhookActionVacancyOnlyMineSettings
type WebhookActionVacancyOnlyMineSettings struct {
	...
	VacanciesOnlyMine *bool `json:"vacancies_only_mine,omitempty"`
}

// NewWebhookActionVacancyOnlyMineSettings instantiates a new WebhookActionVacancyOnlyMineSettings object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWebhookActionVacancyOnlyMineSettings() *WebhookActionVacancyOnlyMineSettings {
	this := WebhookActionVacancyOnlyMineSettings{}
	var vacanciesOnlyMine bool = false
	this.VacanciesOnlyMine = &vacanciesOnlyMine
	return &this
}

// NewWebhookActionVacancyOnlyMineSettingsWithDefaults instantiates a new WebhookActionVacancyOnlyMineSettings object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWebhookActionVacancyOnlyMineSettingsWithDefaults() *WebhookActionVacancyOnlyMineSettings {
	this := WebhookActionVacancyOnlyMineSettings{}
	var vacanciesOnlyMine bool = false
	this.VacanciesOnlyMine = &vacanciesOnlyMine
	return &this
...
// GetVacanciesOnlyMine returns the VacanciesOnlyMine field value if set, zero value otherwise.
func (o *WebhookActionVacancyOnlyMineSettings) GetVacanciesOnlyMine() bool {
	if o == nil || IsNil(o.VacanciesOnlyMine) {
		var ret bool
		return ret
	}
	return *o.VacanciesOnlyMine
}

// GetVacanciesOnlyMineOk returns a tuple with the VacanciesOnlyMine field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WebhookActionVacancyOnlyMineSettings) GetVacanciesOnlyMineOk() (*bool, bool) {
	if o == nil || IsNil(o.VacanciesOnlyMine) {
		return nil, false
	}
	return o.VacanciesOnlyMine, true
}

// HasVacanciesOnlyMine returns a boolean if a field has been set.
func (o *WebhookActionVacancyOnlyMineSettings) HasVacanciesOnlyMine() bool {
	if o != nil && !IsNil(o.VacanciesOnlyMine) {
		return true
	}
...
// SetVacanciesOnlyMine gets a reference to the given bool and assigns it to the VacanciesOnlyMine field.
func (o *WebhookActionVacancyOnlyMineSettings) SetVacanciesOnlyMine(v bool) {
	o.VacanciesOnlyMine = &v
}

func (o WebhookActionVacancyOnlyMineSettings) MarshalJSON() ([]byte, error) {
...
func (o WebhookActionVacancyOnlyMineSettings) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VacanciesOnlyMine) {
		toSerialize["vacancies_only_mine"] = o.VacanciesOnlyMine
	}
	return toSerialize, nil
}

type NullableWebhookActionVacancyOnlyMineSettings struct {
	value *WebhookActionVacancyOnlyMineSettings
	isSet bool
}

func (v NullableWebhookActionVacancyOnlyMineSettings) Get() *WebhookActionVacancyOnlyMineSettings {
	return v.value
}

func (v *NullableWebhookActionVacancyOnlyMineSettings) Set(val *WebhookActionVacancyOnlyMineSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookActionVacancyOnlyMineSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookActionVacancyOnlyMineSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookActionVacancyOnlyMineSettings(val *WebhookActionVacancyOnlyMineSettings) *NullableWebhookActionVacancyOnlyMineSettings {
	return &NullableWebhookActionVacancyOnlyMineSettings{value: val, isSet: true}
}

func (v NullableWebhookActionVacancyOnlyMineSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookActionVacancyOnlyMineSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
