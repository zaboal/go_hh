...
// checks if the NegotiationsAssessment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NegotiationsAssessment{}

// NegotiationsAssessment Тесты или опросники, предназначенные для прохождения соискателями
type NegotiationsAssessment struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
	Name string `json:"name"`
	// Инструменты оценки
	Actions []NegotiationsAction `json:"actions"`
}

type _NegotiationsAssessment NegotiationsAssessment
...
func (o NegotiationsAssessment) MarshalJSON() ([]byte, error) {
...
func (o NegotiationsAssessment) ToMap() (map[string]interface{}, error) {
...
func (o *NegotiationsAssessment) UnmarshalJSON(data []byte) (err error) {
	...
	varNegotiationsAssessment := _NegotiationsAssessment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNegotiationsAssessment)

	if err != nil {
		return err
	}

	*o = NegotiationsAssessment(varNegotiationsAssessment)

	return err
}

type NullableNegotiationsAssessment struct {
	value *NegotiationsAssessment
	isSet bool
}

func (v NullableNegotiationsAssessment) Get() *NegotiationsAssessment {
	return v.value
}

func (v *NullableNegotiationsAssessment) Set(val *NegotiationsAssessment) {
	v.value = val
	v.isSet = true
}

func (v NullableNegotiationsAssessment) IsSet() bool {
	return v.isSet
}

func (v *NullableNegotiationsAssessment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNegotiationsAssessment(val *NegotiationsAssessment) *NullableNegotiationsAssessment {
	return &NullableNegotiationsAssessment{value: val, isSet: true}
}

func (v NullableNegotiationsAssessment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNegotiationsAssessment) UnmarshalJSON(src []byte) error {
	v.isSet = true
