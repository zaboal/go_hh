...
// checks if the IncludesLanguageLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncludesLanguageLevel{}

// IncludesLanguageLevel struct for IncludesLanguageLevel
type IncludesLanguageLevel struct {
	// Идентификатор
	Id string `json:"id"`
	// Название
...
func (o IncludesLanguageLevel) MarshalJSON() ([]byte, error) {
...
func (o IncludesLanguageLevel) ToMap() (map[string]interface{}, error) {
...
func (o *IncludesLanguageLevel) UnmarshalJSON(data []byte) (err error) {
	...
	varIncludesLanguageLevel := _IncludesLanguageLevel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncludesLanguageLevel)

	if err != nil {
		return err
	}

	*o = IncludesLanguageLevel(varIncludesLanguageLevel)

	return err
}

type NullableIncludesLanguageLevel struct {
	value *IncludesLanguageLevel
	isSet bool
}

func (v NullableIncludesLanguageLevel) Get() *IncludesLanguageLevel {
	return v.value
}

func (v *NullableIncludesLanguageLevel) Set(val *IncludesLanguageLevel) {
	v.value = val
	v.isSet = true
}

func (v NullableIncludesLanguageLevel) IsSet() bool {
	return v.isSet
}

func (v *NullableIncludesLanguageLevel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncludesLanguageLevel(val *IncludesLanguageLevel) *NullableIncludesLanguageLevel {
	return &NullableIncludesLanguageLevel{value: val, isSet: true}
}

func (v NullableIncludesLanguageLevel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIncludesLanguageLevel) UnmarshalJSON(src []byte) error {
	v.isSet = true
