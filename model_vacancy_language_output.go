...
// checks if the VacancyLanguageOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacancyLanguageOutput{}

// VacancyLanguageOutput struct for VacancyLanguageOutput
type VacancyLanguageOutput struct {
	// Идентификатор языка. Значения из справочника [/languages](#tag/Obshie-spravochniki/operation/get-dictionaries)
	Id string `json:"id"`
	Level VacancyLanguageOutputAllOfLevel `json:"level"`
	// Название языка
	Name string `json:"name"`
}

type _VacancyLanguageOutput VacancyLanguageOutput
...
func (o *VacancyLanguageOutput) GetLevel() VacancyLanguageOutputAllOfLevel {
	if o == nil {
		var ret VacancyLanguageOutputAllOfLevel
		return ret
	}
...
func (o VacancyLanguageOutput) MarshalJSON() ([]byte, error) {
...
func (o VacancyLanguageOutput) ToMap() (map[string]interface{}, error) {
...
func (o *VacancyLanguageOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varVacancyLanguageOutput := _VacancyLanguageOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacancyLanguageOutput)

	if err != nil {
		return err
	}

	*o = VacancyLanguageOutput(varVacancyLanguageOutput)

	return err
}

type NullableVacancyLanguageOutput struct {
	value *VacancyLanguageOutput
	isSet bool
}

func (v NullableVacancyLanguageOutput) Get() *VacancyLanguageOutput {
	return v.value
}

func (v *NullableVacancyLanguageOutput) Set(val *VacancyLanguageOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableVacancyLanguageOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableVacancyLanguageOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacancyLanguageOutput(val *VacancyLanguageOutput) *NullableVacancyLanguageOutput {
	return &NullableVacancyLanguageOutput{value: val, isSet: true}
}

func (v NullableVacancyLanguageOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacancyLanguageOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
