...
// checks if the VacanciesVacancyConditionFieldsCountryCondition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesVacancyConditionFieldsCountryCondition{}

// VacanciesVacancyConditionFieldsCountryCondition struct for VacanciesVacancyConditionFieldsCountryCondition
type VacanciesVacancyConditionFieldsCountryCondition struct {
...
func NewVacanciesVacancyConditionFieldsCountryCondition() *VacanciesVacancyConditionFieldsCountryCondition {
	this := VacanciesVacancyConditionFieldsCountryCondition{}
	return &this
}
...
func (o *VacanciesVacancyConditionFieldsCountryCondition) SetMaxLength(v float32) {
	o.MaxLength.Set(&v)
}
// SetMaxLengthNil sets the value for MaxLength to be an explicit nil
func (o *VacanciesVacancyConditionFieldsCountryCondition) SetMaxLengthNil() {
	o.MaxLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsCountryCondition) SetMinLengthNil() {
	o.MinLength.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsCountryCondition) GetRequired() bool {
...
func (o *VacanciesVacancyConditionFieldsCountryCondition) SetRequiredNil() {
	o.Required.Set(nil)
}
...
func (o *VacanciesVacancyConditionFieldsCountryCondition) SetRegexpNil() {
	o.Regexp.Set(nil)
}
...
func (o VacanciesVacancyConditionFieldsCountryCondition) MarshalJSON() ([]byte, error) {
...
func (o VacanciesVacancyConditionFieldsCountryCondition) ToMap() (map[string]interface{}, error) {
...
type NullableVacanciesVacancyConditionFieldsCountryCondition struct {
	value *VacanciesVacancyConditionFieldsCountryCondition
	isSet bool
}

func (v NullableVacanciesVacancyConditionFieldsCountryCondition) Get() *VacanciesVacancyConditionFieldsCountryCondition {
	return v.value
}

func (v *NullableVacanciesVacancyConditionFieldsCountryCondition) Set(val *VacanciesVacancyConditionFieldsCountryCondition) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesVacancyConditionFieldsCountryCondition) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesVacancyConditionFieldsCountryCondition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesVacancyConditionFieldsCountryCondition(val *VacanciesVacancyConditionFieldsCountryCondition) *NullableVacanciesVacancyConditionFieldsCountryCondition {
	return &NullableVacanciesVacancyConditionFieldsCountryCondition{value: val, isSet: true}
}

func (v NullableVacanciesVacancyConditionFieldsCountryCondition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesVacancyConditionFieldsCountryCondition) UnmarshalJSON(src []byte) error {
	v.isSet = true
