...
// checks if the VacanciesUpgradeFieldsBillingTypeFull type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacanciesUpgradeFieldsBillingTypeFull{}

// VacanciesUpgradeFieldsBillingTypeFull struct for VacanciesUpgradeFieldsBillingTypeFull
type VacanciesUpgradeFieldsBillingTypeFull struct {
...
type _VacanciesUpgradeFieldsBillingTypeFull VacanciesUpgradeFieldsBillingTypeFull
...
func NewVacanciesUpgradeFieldsBillingTypeFull(id string) *VacanciesUpgradeFieldsBillingTypeFull {
	this := VacanciesUpgradeFieldsBillingTypeFull{}
	this.Id = id
	return &this
}
...
func (o VacanciesUpgradeFieldsBillingTypeFull) MarshalJSON() ([]byte, error) {
...
func (o VacanciesUpgradeFieldsBillingTypeFull) ToMap() (map[string]interface{}, error) {
...
func (o *VacanciesUpgradeFieldsBillingTypeFull) UnmarshalJSON(data []byte) (err error) {
	...
	varVacanciesUpgradeFieldsBillingTypeFull := _VacanciesUpgradeFieldsBillingTypeFull{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVacanciesUpgradeFieldsBillingTypeFull)

	if err != nil {
		return err
	}

	*o = VacanciesUpgradeFieldsBillingTypeFull(varVacanciesUpgradeFieldsBillingTypeFull)

	return err
}

type NullableVacanciesUpgradeFieldsBillingTypeFull struct {
	value *VacanciesUpgradeFieldsBillingTypeFull
	isSet bool
}

func (v NullableVacanciesUpgradeFieldsBillingTypeFull) Get() *VacanciesUpgradeFieldsBillingTypeFull {
	return v.value
}

func (v *NullableVacanciesUpgradeFieldsBillingTypeFull) Set(val *VacanciesUpgradeFieldsBillingTypeFull) {
	v.value = val
	v.isSet = true
}

func (v NullableVacanciesUpgradeFieldsBillingTypeFull) IsSet() bool {
	return v.isSet
}

func (v *NullableVacanciesUpgradeFieldsBillingTypeFull) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacanciesUpgradeFieldsBillingTypeFull(val *VacanciesUpgradeFieldsBillingTypeFull) *NullableVacanciesUpgradeFieldsBillingTypeFull {
	return &NullableVacanciesUpgradeFieldsBillingTypeFull{value: val, isSet: true}
}

func (v NullableVacanciesUpgradeFieldsBillingTypeFull) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacanciesUpgradeFieldsBillingTypeFull) UnmarshalJSON(src []byte) error {
	v.isSet = true
